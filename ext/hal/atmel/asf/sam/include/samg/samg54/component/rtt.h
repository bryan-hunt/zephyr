...
#define RTT_MR_MASK                         _U(0x117FFFF)                                  /**< \deprecated (RTT_MR) Register MASK  (Use RTT_MR_Msk instead)  */
#define RTT_MR_Msk                          _U(0x117FFFF)                                  /**< (RTT_MR) Register Mask  */
...
#define RTT_SR_MASK                         _U(0x03)                                       /**< \deprecated (RTT_SR) Register MASK  (Use RTT_SR_Msk instead)  */
#define RTT_SR_Msk                          _U(0x03)                                       /**< (RTT_SR) Register Mask  */
