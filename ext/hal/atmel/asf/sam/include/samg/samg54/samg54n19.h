...
#define IRAM_SIZE                _U(0x00018000)       /*   96kB Memory segment type: ram */
...
/* ************************************************************************** */
#define JTAGID                   _UL(0X05B3C03F)
#define CHIP_JTAGID              _UL(0X05B3C03F)
#define CHIP_CIDR                _UL(0X247E0AEA)
...
#define CHIP_FREQ_CPU_MAX              _UL(96000000)   
#define CHIP_FREQ_XTAL_32K             _UL(32768)      
#define CHIP_FLASH_WRITE_WAIT_STATE    _UL(7)          /**< \brief Embedded Flash Write Wait State*/
