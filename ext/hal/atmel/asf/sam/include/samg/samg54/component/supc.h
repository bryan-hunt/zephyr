...
#define SUPC_CR_ZERO_Msk                    (_U(0x1) << SUPC_CR_ZERO_Pos)                  /**< (SUPC_CR) This bit must always be written to 0. Mask */
...
#define SUPC_MR_VDDSEL_Msk                  (_U(0x1) << SUPC_MR_VDDSEL_Pos)                /**< (SUPC_MR) VRVDD Field Selection Mask */
...
#define   SUPC_MR_VDDSEL_FACTORY_Val        _U(0x0)                                        /**< (SUPC_MR) The voltage regulator output value is the factory-programmed value.  */
#define   SUPC_MR_VDDSEL_USER_VRVDD_Val     _U(0x1)                                        /**< (SUPC_MR) The voltage regulator output value is defined by the value programmed in the field VRVDD.  */
...
#define SUPC_MR_VRVDD_Msk                   (_U(0x7) << SUPC_MR_VRVDD_Pos)                 /**< (SUPC_MR) VRVDD Field Selection Mask */
#define SUPC_MR_VRVDD(value)                (SUPC_MR_VRVDD_Msk & ((value) << SUPC_MR_VRVDD_Pos))
#define   SUPC_MR_VRVDD_FACTORY_Val         _U(0x0)                                        /**< (SUPC_MR) The voltage regulator output value is the factory-programmed value.  */
#define   SUPC_MR_VRVDD_USER_VRVDD_Val      _U(0x1)                                        /**< (SUPC_MR) The voltage regulator output value is defined by the value programmed in the field VRVDD.  */
...
#define SUPC_MR_PSWITCH1_Msk                (_U(0x1) << SUPC_MR_PSWITCH1_Pos)              /**< (SUPC_MR) SRAM1 Power Switch Mask */
...
#define   SUPC_MR_PSWITCH1_OFF_Val          _U(0x0)                                        /**< (SUPC_MR) The SRAM1 is not powered.  */
#define   SUPC_MR_PSWITCH1_ON_Val           _U(0x1)                                        /**< (SUPC_MR) The SRAM1 is powered.  */
...
#define SUPC_MR_PSWITCH2_Msk                (_U(0x1) << SUPC_MR_PSWITCH2_Pos)              /**< (SUPC_MR) SRAM2 Power Switch Mask */
...
#define   SUPC_MR_PSWITCH2_OFF_Val          _U(0x0)                                        /**< (SUPC_MR) The SRAM2 is not powered.  */
#define   SUPC_MR_PSWITCH2_ON_Val           _U(0x1)                                        /**< (SUPC_MR) The SRAM2 is powered.  */
...
#define SUPC_MR_PSWITCH_Msk                 (_U(0x3) << SUPC_MR_PSWITCH_Pos)               /**< (SUPC_MR Mask) PSWITCH */
#define SUPC_MR_PSWITCH(value)              (SUPC_MR_PSWITCH_Msk & ((value) << SUPC_MR_PSWITCH_Pos))  
#define SUPC_MR_MASK                        _U(0xFFD03F00)                                 /**< \deprecated (SUPC_MR) Register MASK  (Use SUPC_MR_Msk instead)  */
#define SUPC_MR_Msk                         _U(0xFFD03F00)                                 /**< (SUPC_MR) Register Mask  */
...
#define SUPC_SR_MASK                        _U(0xF8)                                       /**< \deprecated (SUPC_SR) Register MASK  (Use SUPC_SR_Msk instead)  */
#define SUPC_SR_Msk                         _U(0xF8)                                       /**< (SUPC_SR) Register Mask  */
