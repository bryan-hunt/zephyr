...
#define PMC_SCER_PCK_Msk                    (_U(0x7) << PMC_SCER_PCK_Pos)                  /**< (PMC_SCER Mask) PCK */
#define PMC_SCER_PCK(value)                 (PMC_SCER_PCK_Msk & ((value) << PMC_SCER_PCK_Pos))  
#define PMC_SCER_MASK                       _U(0x700)                                      /**< \deprecated (PMC_SCER) Register MASK  (Use PMC_SCER_Msk instead)  */
#define PMC_SCER_Msk                        _U(0x700)                                      /**< (PMC_SCER) Register Mask  */
...
#define PMC_SCDR_PCK_Msk                    (_U(0x7) << PMC_SCDR_PCK_Pos)                  /**< (PMC_SCDR Mask) PCK */
#define PMC_SCDR_PCK(value)                 (PMC_SCDR_PCK_Msk & ((value) << PMC_SCDR_PCK_Pos))  
#define PMC_SCDR_MASK                       _U(0x700)                                      /**< \deprecated (PMC_SCDR) Register MASK  (Use PMC_SCDR_Msk instead)  */
#define PMC_SCDR_Msk                        _U(0x700)                                      /**< (PMC_SCDR) Register Mask  */
...
#define PMC_SCSR_PCK_Msk                    (_U(0x7) << PMC_SCSR_PCK_Pos)                  /**< (PMC_SCSR Mask) PCK */
#define PMC_SCSR_PCK(value)                 (PMC_SCSR_PCK_Msk & ((value) << PMC_SCSR_PCK_Pos))  
#define PMC_SCSR_MASK                       _U(0x700)                                      /**< \deprecated (PMC_SCSR) Register MASK  (Use PMC_SCSR_Msk instead)  */
#define PMC_SCSR_Msk                        _U(0x700)                                      /**< (PMC_SCSR) Register Mask  */
...
#define CKGR_PLLAR_MULA_Msk                 (_U(0xFFF) << CKGR_PLLAR_MULA_Pos)             /**< (CKGR_PLLAR) PLLA Multiplier Mask */
#define CKGR_PLLAR_MULA(value)              (CKGR_PLLAR_MULA_Msk & ((value) << CKGR_PLLAR_MULA_Pos))
#define CKGR_PLLAR_ZERO_Pos                 29                                             /**< (CKGR_PLLAR)  Position */
#define CKGR_PLLAR_ZERO_Msk                 (_U(0x1) << CKGR_PLLAR_ZERO_Pos)               /**< (CKGR_PLLAR)  Mask */
...
#define CKGR_PLLAR_MASK                     _U(0x2FFF3FFF)                                 /**< \deprecated (CKGR_PLLAR) Register MASK  (Use CKGR_PLLAR_Msk instead)  */
#define CKGR_PLLAR_Msk                      _U(0x2FFF3FFF)                                 /**< (CKGR_PLLAR) Register Mask  */
...
#define PMC_MCKR_MASK                       _U(0x1073)                                     /**< \deprecated (PMC_MCKR) Register MASK  (Use PMC_MCKR_Msk instead)  */
#define PMC_MCKR_Msk                        _U(0x1073)                                     /**< (PMC_MCKR) Register Mask  */
...
#define PMC_PCK_PRES_Msk                    (_U(0x7) << PMC_PCK_PRES_Pos)                  /**< (PMC_PCK) Programmable Clock Prescaler Mask */
#define PMC_PCK_PRES(value)                 (PMC_PCK_PRES_Msk & ((value) << PMC_PCK_PRES_Pos))
#define   PMC_PCK_PRES_CLK_1_Val            _U(0x0)                                        /**< (PMC_PCK) Selected clock  */
#define   PMC_PCK_PRES_CLK_2_Val            _U(0x1)                                        /**< (PMC_PCK) Selected clock divided by 2  */
#define   PMC_PCK_PRES_CLK_4_Val            _U(0x2)                                        /**< (PMC_PCK) Selected clock divided by 4  */
#define   PMC_PCK_PRES_CLK_8_Val            _U(0x3)                                        /**< (PMC_PCK) Selected clock divided by 8  */
#define   PMC_PCK_PRES_CLK_16_Val           _U(0x4)                                        /**< (PMC_PCK) Selected clock divided by 16  */
#define   PMC_PCK_PRES_CLK_32_Val           _U(0x5)                                        /**< (PMC_PCK) Selected clock divided by 32  */
#define   PMC_PCK_PRES_CLK_64_Val           _U(0x6)                                        /**< (PMC_PCK) Selected clock divided by 64  */
...
#define PMC_PCK_MASK                        _U(0x77)                                       /**< \deprecated (PMC_PCK) Register MASK  (Use PMC_PCK_Msk instead)  */
#define PMC_PCK_Msk                         _U(0x77)                                       /**< (PMC_PCK) Register Mask  */
...
#define PMC_IER_PCKRDY_Msk                  (_U(0x7) << PMC_IER_PCKRDY_Pos)                /**< (PMC_IER Mask) PCKRDY */
#define PMC_IER_PCKRDY(value)               (PMC_IER_PCKRDY_Msk & ((value) << PMC_IER_PCKRDY_Pos))  
#define PMC_IER_MASK                        _U(0x7070B)                                    /**< \deprecated (PMC_IER) Register MASK  (Use PMC_IER_Msk instead)  */
#define PMC_IER_Msk                         _U(0x7070B)                                    /**< (PMC_IER) Register Mask  */
...
#define PMC_IDR_PCKRDY_Msk                  (_U(0x7) << PMC_IDR_PCKRDY_Pos)                /**< (PMC_IDR Mask) PCKRDY */
#define PMC_IDR_PCKRDY(value)               (PMC_IDR_PCKRDY_Msk & ((value) << PMC_IDR_PCKRDY_Pos))  
#define PMC_IDR_MASK                        _U(0x7070B)                                    /**< \deprecated (PMC_IDR) Register MASK  (Use PMC_IDR_Msk instead)  */
#define PMC_IDR_Msk                         _U(0x7070B)                                    /**< (PMC_IDR) Register Mask  */
...
#define PMC_SR_PCKRDY_Msk                   (_U(0x7) << PMC_SR_PCKRDY_Pos)                 /**< (PMC_SR Mask) PCKRDY */
#define PMC_SR_PCKRDY(value)                (PMC_SR_PCKRDY_Msk & ((value) << PMC_SR_PCKRDY_Pos))  
#define PMC_SR_MASK                         _U(0x1F078B)                                   /**< \deprecated (PMC_SR) Register MASK  (Use PMC_SR_Msk instead)  */
#define PMC_SR_Msk                          _U(0x1F078B)                                   /**< (PMC_SR) Register Mask  */
...
#define PMC_IMR_PCKRDY_Msk                  (_U(0x7) << PMC_IMR_PCKRDY_Pos)                /**< (PMC_IMR Mask) PCKRDY */
#define PMC_IMR_PCKRDY(value)               (PMC_IMR_PCKRDY_Msk & ((value) << PMC_IMR_PCKRDY_Pos))  
#define PMC_IMR_MASK                        _U(0x7070B)                                    /**< \deprecated (PMC_IMR) Register MASK  (Use PMC_IMR_Msk instead)  */
#define PMC_IMR_Msk                         _U(0x7070B)                                    /**< (PMC_IMR) Register Mask  */
...
#define PMC_FSMR_MASK                       _U(0x73FFFF)                                   /**< \deprecated (PMC_FSMR) Register MASK  (Use PMC_FSMR_Msk instead)  */
#define PMC_FSMR_Msk                        _U(0x73FFFF)                                   /**< (PMC_FSMR) Register Mask  */
...
#define PMC_PMMR_MASK                       _U(0x7FF)                                      /**< \deprecated (PMC_PMMR) Register MASK  (Use PMC_PMMR_Msk instead)  */
#define PMC_PMMR_Msk                        _U(0x7FF)                                      /**< (PMC_PMMR) Register Mask  */
