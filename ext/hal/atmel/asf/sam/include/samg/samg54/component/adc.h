...
#define ADC_CR_AUTOCAL_Msk                  (_U(0x1) << ADC_CR_AUTOCAL_Pos)                /**< (ADC_CR) Automatic Calibration of ADC Mask */
...
#define ADC_CR_MASK                         _U(0x1B)                                       /**< \deprecated (ADC_CR) Register MASK  (Use ADC_CR_Msk instead)  */
#define ADC_CR_Msk                          _U(0x1B)                                       /**< (ADC_CR) Register Mask  */
...
#define   ADC_MR_TRGSEL_ADC_TRIG0_Val       _U(0x0)                                        /**< (ADC_MR) External trigger  */
#define   ADC_MR_TRGSEL_ADC_TRIG1_Val       _U(0x1)                                        /**< (ADC_MR) TIO Output of the Timer Counter Channel 0  */
#define   ADC_MR_TRGSEL_ADC_TRIG2_Val       _U(0x2)                                        /**< (ADC_MR) TIO Output of the Timer Counter Channel 1  */
#define   ADC_MR_TRGSEL_ADC_TRIG3_Val       _U(0x3)                                        /**< (ADC_MR) TIO Output of the Timer Counter Channel 2  */
#define   ADC_MR_TRGSEL_ADC_TRIG4_Val       _U(0x4)                                        /**< (ADC_MR) RTCOUT0  */
#define   ADC_MR_TRGSEL_ADC_TRIG5_Val       _U(0x5)                                        /**< (ADC_MR) RTTINC  */
...
#define ADC_MR_LOWRES_Msk                   (_U(0x1) << ADC_MR_LOWRES_Pos)                 /**< (ADC_MR) Resolution Mask */
...
#define   ADC_MR_LOWRES_BITS_10_Val         _U(0x0)                                        /**< (ADC_MR) 10-bit resolution. For higher resolution by averaging, please refer to "ADC Extended Mode Register" on page 77.  */
#define   ADC_MR_LOWRES_BITS_8_Val          _U(0x1)                                        /**< (ADC_MR) 8-bit resolution  */
...
#define   ADC_MR_SLEEP_SLEEP_Val            _U(0x1)                                        /**< (ADC_MR) Sleep Mode: The ADC core and reference voltage circuitry are OFF between conversions.  */
...
#define ADC_MR_DIV1_Msk                     (_U(0x1) << ADC_MR_DIV1_Pos)                   /**< (ADC_MR) ADC Clock Prescaler Division forced to 1 Mask */
#define ADC_MR_DIV1                         ADC_MR_DIV1_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_MR_DIV1_Msk instead */
#define   ADC_MR_DIV1_NO_DIV1_Val           _U(0x0)                                        /**< (ADC_MR) The PRESCAL field is used to generate the ADC clock unless DIV3 is written to 1.  */
#define   ADC_MR_DIV1_FORCE_DIV1_Val        _U(0x1)                                        /**< (ADC_MR) The ADC clock equals peripheral clock (PRESCAL and DIV3 fields have no effect).  */
...
#define ADC_MR_DIV3_Msk                     (_U(0x1) << ADC_MR_DIV3_Pos)                   /**< (ADC_MR) ADC Clock Prescaler Division forced to 3 Mask */
#define ADC_MR_DIV3                         ADC_MR_DIV3_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_MR_DIV3_Msk instead */
#define   ADC_MR_DIV3_NO_DIV3_Val           _U(0x0)                                        /**< (ADC_MR) The PRESCAL field is used to generate the ADC clock unless DIV1 is written to 1.  */
#define   ADC_MR_DIV3_FORCE_DIV3_Val        _U(0x1)                                        /**< (ADC_MR) The ADC clock equals peripheral clock/3 unless DIV1 is written to 1.  */
...
#define ADC_MR_MASK                         _U(0xFF4FFFBF)                                 /**< \deprecated (ADC_MR) Register MASK  (Use ADC_MR_Msk instead)  */
#define ADC_MR_Msk                          _U(0xFF4FFFBF)                                 /**< (ADC_MR) Register Mask  */
...
#define ADC_LCDR_LDATA_Msk                  (_U(0xFFF) << ADC_LCDR_LDATA_Pos)              /**< (ADC_LCDR) Last Data Converted Mask */
...
#define ADC_LCDR_CHNB_Msk                   (_U(0xF) << ADC_LCDR_CHNB_Pos)                 /**< (ADC_LCDR) Channel Number Mask */
#define ADC_LCDR_CHNB(value)                (ADC_LCDR_CHNB_Msk & ((value) << ADC_LCDR_CHNB_Pos))
#define ADC_LCDR_MASK                       _U(0xFFFF)                                     /**< \deprecated (ADC_LCDR) Register MASK  (Use ADC_LCDR_Msk instead)  */
#define ADC_LCDR_Msk                        _U(0xFFFF)                                     /**< (ADC_LCDR) Register Mask  */
...
#define ADC_IER_EOCAL_Msk                   (_U(0x1) << ADC_IER_EOCAL_Pos)                 /**< (ADC_IER) End of Calibration Sequence Mask */
...
#define ADC_IER_MASK                        _U(0x1F8800FF)                                 /**< \deprecated (ADC_IER) Register MASK  (Use ADC_IER_Msk instead)  */
#define ADC_IER_Msk                         _U(0x1F8800FF)                                 /**< (ADC_IER) Register Mask  */
...
#define ADC_IDR_EOCAL_Msk                   (_U(0x1) << ADC_IDR_EOCAL_Pos)                 /**< (ADC_IDR) End of Calibration Sequence Mask */
...
#define ADC_IDR_MASK                        _U(0x1F8800FF)                                 /**< \deprecated (ADC_IDR) Register MASK  (Use ADC_IDR_Msk instead)  */
#define ADC_IDR_Msk                         _U(0x1F8800FF)                                 /**< (ADC_IDR) Register Mask  */
...
#define ADC_IMR_EOCAL_Msk                   (_U(0x1) << ADC_IMR_EOCAL_Pos)                 /**< (ADC_IMR) End of Calibration Sequence Mask */
...
#define ADC_IMR_MASK                        _U(0x1F8800FF)                                 /**< \deprecated (ADC_IMR) Register MASK  (Use ADC_IMR_Msk instead)  */
#define ADC_IMR_Msk                         _U(0x1F8800FF)                                 /**< (ADC_IMR) Register Mask  */
...
#define ADC_ISR_EOCAL_Msk                   (_U(0x1) << ADC_ISR_EOCAL_Pos)                 /**< (ADC_ISR) End of Calibration Sequence Mask */
...
#define ADC_ISR_MASK                        _U(0x1F8800FF)                                 /**< \deprecated (ADC_ISR) Register MASK  (Use ADC_ISR_Msk instead)  */
#define ADC_ISR_Msk                         _U(0x1F8800FF)                                 /**< (ADC_ISR) Register Mask  */
...
#define ADC_EMR_OSR_Msk                     (_U(0x3) << ADC_EMR_OSR_Pos)                   /**< (ADC_EMR) Over Sampling Rate Mask */
...
#define ADC_EMR_MASK                        _U(0x13332F7)                                  /**< \deprecated (ADC_EMR) Register MASK  (Use ADC_EMR_Msk instead)  */
#define ADC_EMR_Msk                         _U(0x13332F7)                                  /**< (ADC_EMR) Register Mask  */
...
#define ADC_CWR_LOWTHRES_Msk                (_U(0xFFF) << ADC_CWR_LOWTHRES_Pos)            /**< (ADC_CWR) Low Threshold Mask */
...
#define ADC_CWR_HIGHTHRES_Msk               (_U(0xFFF) << ADC_CWR_HIGHTHRES_Pos)           /**< (ADC_CWR) High Threshold Mask */
#define ADC_CWR_HIGHTHRES(value)            (ADC_CWR_HIGHTHRES_Msk & ((value) << ADC_CWR_HIGHTHRES_Pos))
#define ADC_CWR_MASK                        _U(0xFFF0FFF)                                  /**< \deprecated (ADC_CWR) Register MASK  (Use ADC_CWR_Msk instead)  */
#define ADC_CWR_Msk                         _U(0xFFF0FFF)                                  /**< (ADC_CWR) Register Mask  */
...
#define ADC_CDR_DATA_Msk                    (_U(0xFFF) << ADC_CDR_DATA_Pos)                /**< (ADC_CDR) Converted Data Mask */
#define ADC_CDR_DATA(value)                 (ADC_CDR_DATA_Msk & ((value) << ADC_CDR_DATA_Pos))
#define ADC_CDR_MASK                        _U(0xFFF)                                      /**< \deprecated (ADC_CDR) Register MASK  (Use ADC_CDR_Msk instead)  */
#define ADC_CDR_Msk                         _U(0xFFF)                                      /**< (ADC_CDR) Register Mask  */
