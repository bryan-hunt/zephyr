...
#define UART_CR_RSTRX_Msk                   (_U(0x1) << UART_CR_RSTRX_Pos)                 /**< (UART_CR) Reset Receiver Mask */
...
#define UART_CR_RSTTX_Msk                   (_U(0x1) << UART_CR_RSTTX_Pos)                 /**< (UART_CR) Reset Transmitter Mask */
...
#define UART_CR_RXEN_Msk                    (_U(0x1) << UART_CR_RXEN_Pos)                  /**< (UART_CR) Receiver Enable Mask */
...
#define UART_CR_RXDIS_Msk                   (_U(0x1) << UART_CR_RXDIS_Pos)                 /**< (UART_CR) Receiver Disable Mask */
...
#define UART_CR_TXEN_Msk                    (_U(0x1) << UART_CR_TXEN_Pos)                  /**< (UART_CR) Transmitter Enable Mask */
...
#define UART_CR_TXDIS_Msk                   (_U(0x1) << UART_CR_TXDIS_Pos)                 /**< (UART_CR) Transmitter Disable Mask */
...
#define UART_CR_RSTSTA_Msk                  (_U(0x1) << UART_CR_RSTSTA_Pos)                /**< (UART_CR) Reset Status Mask */
...
#define UART_CR_REQCLR_Msk                  (_U(0x1) << UART_CR_REQCLR_Pos)                /**< (UART_CR) Request Clear Mask */
...
#define UART_CR_MASK                        _U(0x11FC)                                     /**< \deprecated (UART_CR) Register MASK  (Use UART_CR_Msk instead)  */
#define UART_CR_Msk                         _U(0x11FC)                                     /**< (UART_CR) Register Mask  */
...
#define UART_MR_FILTER_Msk                  (_U(0x1) << UART_MR_FILTER_Pos)                /**< (UART_MR) Receiver Digital Filter Mask */
...
#define   UART_MR_FILTER_DISABLED_Val       _U(0x0)                                        /**< (UART_MR) UART does not filter the receive line.  */
#define   UART_MR_FILTER_ENABLED_Val        _U(0x1)                                        /**< (UART_MR) UART filters the receive line using a three-sample filter (16x-bit clock) (2 over 3 majority).  */
...
#define UART_MR_PAR_Msk                     (_U(0x7) << UART_MR_PAR_Pos)                   /**< (UART_MR) Parity Type Mask */
#define UART_MR_PAR(value)                  (UART_MR_PAR_Msk & ((value) << UART_MR_PAR_Pos))
#define   UART_MR_PAR_EVEN_Val              _U(0x0)                                        /**< (UART_MR) Even Parity  */
#define   UART_MR_PAR_ODD_Val               _U(0x1)                                        /**< (UART_MR) Odd Parity  */
#define   UART_MR_PAR_SPACE_Val             _U(0x2)                                        /**< (UART_MR) Space: parity forced to 0  */
#define   UART_MR_PAR_MARK_Val              _U(0x3)                                        /**< (UART_MR) Mark: parity forced to 1  */
#define   UART_MR_PAR_NO_Val                _U(0x4)                                        /**< (UART_MR) No parity  */
...
#define UART_MR_CHMODE_Msk                  (_U(0x3) << UART_MR_CHMODE_Pos)                /**< (UART_MR) Channel Mode Mask */
#define UART_MR_CHMODE(value)               (UART_MR_CHMODE_Msk & ((value) << UART_MR_CHMODE_Pos))
#define   UART_MR_CHMODE_NORMAL_Val         _U(0x0)                                        /**< (UART_MR) Normal mode  */
#define   UART_MR_CHMODE_AUTOMATIC_Val      _U(0x1)                                        /**< (UART_MR) Automatic echo  */
#define   UART_MR_CHMODE_LOCAL_LOOPBACK_Val _U(0x2)                                        /**< (UART_MR) Local loopback  */
#define   UART_MR_CHMODE_REMOTE_LOOPBACK_Val _U(0x3)                                        /**< (UART_MR) Remote loopback  */
...
#define UART_MR_MASK                        _U(0xCE10)                                     /**< \deprecated (UART_MR) Register MASK  (Use UART_MR_Msk instead)  */
#define UART_MR_Msk                         _U(0xCE10)                                     /**< (UART_MR) Register Mask  */
...
#define UART_IER_RXRDY_Msk                  (_U(0x1) << UART_IER_RXRDY_Pos)                /**< (UART_IER) Enable RXRDY Interrupt Mask */
...
#define UART_IER_TXRDY_Msk                  (_U(0x1) << UART_IER_TXRDY_Pos)                /**< (UART_IER) Enable TXRDY Interrupt Mask */
...
#define UART_IER_ENDRX_Msk                  (_U(0x1) << UART_IER_ENDRX_Pos)                /**< (UART_IER) Enable End of Receive Transfer Interrupt Mask */
...
#define UART_IER_ENDTX_Msk                  (_U(0x1) << UART_IER_ENDTX_Pos)                /**< (UART_IER) Enable End of Transmit Interrupt Mask */
...
#define UART_IER_OVRE_Msk                   (_U(0x1) << UART_IER_OVRE_Pos)                 /**< (UART_IER) Enable Overrun Error Interrupt Mask */
...
#define UART_IER_FRAME_Msk                  (_U(0x1) << UART_IER_FRAME_Pos)                /**< (UART_IER) Enable Framing Error Interrupt Mask */
...
#define UART_IER_PARE_Msk                   (_U(0x1) << UART_IER_PARE_Pos)                 /**< (UART_IER) Enable Parity Error Interrupt Mask */
...
#define UART_IER_TXEMPTY_Msk                (_U(0x1) << UART_IER_TXEMPTY_Pos)              /**< (UART_IER) Enable TXEMPTY Interrupt Mask */
...
#define UART_IER_TXBUFE_Msk                 (_U(0x1) << UART_IER_TXBUFE_Pos)               /**< (UART_IER) Enable Buffer Empty Interrupt Mask */
...
#define UART_IER_RXBUFF_Msk                 (_U(0x1) << UART_IER_RXBUFF_Pos)               /**< (UART_IER) Enable Buffer Full Interrupt Mask */
...
#define UART_IER_CMP_Msk                    (_U(0x1) << UART_IER_CMP_Pos)                  /**< (UART_IER) Enable Comparison Interrupt Mask */
...
#define UART_IER_MASK                       _U(0x9AFB)                                     /**< \deprecated (UART_IER) Register MASK  (Use UART_IER_Msk instead)  */
#define UART_IER_Msk                        _U(0x9AFB)                                     /**< (UART_IER) Register Mask  */
...
#define UART_IDR_RXRDY_Msk                  (_U(0x1) << UART_IDR_RXRDY_Pos)                /**< (UART_IDR) Disable RXRDY Interrupt Mask */
...
#define UART_IDR_TXRDY_Msk                  (_U(0x1) << UART_IDR_TXRDY_Pos)                /**< (UART_IDR) Disable TXRDY Interrupt Mask */
...
#define UART_IDR_ENDRX_Msk                  (_U(0x1) << UART_IDR_ENDRX_Pos)                /**< (UART_IDR) Disable End of Receive Transfer Interrupt Mask */
...
#define UART_IDR_ENDTX_Msk                  (_U(0x1) << UART_IDR_ENDTX_Pos)                /**< (UART_IDR) Disable End of Transmit Interrupt Mask */
...
#define UART_IDR_OVRE_Msk                   (_U(0x1) << UART_IDR_OVRE_Pos)                 /**< (UART_IDR) Disable Overrun Error Interrupt Mask */
...
#define UART_IDR_FRAME_Msk                  (_U(0x1) << UART_IDR_FRAME_Pos)                /**< (UART_IDR) Disable Framing Error Interrupt Mask */
...
#define UART_IDR_PARE_Msk                   (_U(0x1) << UART_IDR_PARE_Pos)                 /**< (UART_IDR) Disable Parity Error Interrupt Mask */
...
#define UART_IDR_TXEMPTY_Msk                (_U(0x1) << UART_IDR_TXEMPTY_Pos)              /**< (UART_IDR) Disable TXEMPTY Interrupt Mask */
...
#define UART_IDR_TXBUFE_Msk                 (_U(0x1) << UART_IDR_TXBUFE_Pos)               /**< (UART_IDR) Disable Buffer Empty Interrupt Mask */
...
#define UART_IDR_RXBUFF_Msk                 (_U(0x1) << UART_IDR_RXBUFF_Pos)               /**< (UART_IDR) Disable Buffer Full Interrupt Mask */
...
#define UART_IDR_CMP_Msk                    (_U(0x1) << UART_IDR_CMP_Pos)                  /**< (UART_IDR) Disable Comparison Interrupt Mask */
...
#define UART_IDR_MASK                       _U(0x9AFB)                                     /**< \deprecated (UART_IDR) Register MASK  (Use UART_IDR_Msk instead)  */
#define UART_IDR_Msk                        _U(0x9AFB)                                     /**< (UART_IDR) Register Mask  */
...
#define UART_IMR_RXRDY_Msk                  (_U(0x1) << UART_IMR_RXRDY_Pos)                /**< (UART_IMR) Mask RXRDY Interrupt Mask */
...
#define UART_IMR_TXRDY_Msk                  (_U(0x1) << UART_IMR_TXRDY_Pos)                /**< (UART_IMR) Disable TXRDY Interrupt Mask */
...
#define UART_IMR_ENDRX_Msk                  (_U(0x1) << UART_IMR_ENDRX_Pos)                /**< (UART_IMR) Mask End of Receive Transfer Interrupt Mask */
...
#define UART_IMR_ENDTX_Msk                  (_U(0x1) << UART_IMR_ENDTX_Pos)                /**< (UART_IMR) Mask End of Transmit Interrupt Mask */
...
#define UART_IMR_OVRE_Msk                   (_U(0x1) << UART_IMR_OVRE_Pos)                 /**< (UART_IMR) Mask Overrun Error Interrupt Mask */
...
#define UART_IMR_FRAME_Msk                  (_U(0x1) << UART_IMR_FRAME_Pos)                /**< (UART_IMR) Mask Framing Error Interrupt Mask */
...
#define UART_IMR_PARE_Msk                   (_U(0x1) << UART_IMR_PARE_Pos)                 /**< (UART_IMR) Mask Parity Error Interrupt Mask */
...
#define UART_IMR_TXEMPTY_Msk                (_U(0x1) << UART_IMR_TXEMPTY_Pos)              /**< (UART_IMR) Mask TXEMPTY Interrupt Mask */
...
#define UART_IMR_TXBUFE_Msk                 (_U(0x1) << UART_IMR_TXBUFE_Pos)               /**< (UART_IMR) Mask TXBUFE Interrupt Mask */
...
#define UART_IMR_RXBUFF_Msk                 (_U(0x1) << UART_IMR_RXBUFF_Pos)               /**< (UART_IMR) Mask RXBUFF Interrupt Mask */
...
#define UART_IMR_CMP_Msk                    (_U(0x1) << UART_IMR_CMP_Pos)                  /**< (UART_IMR) Mask Comparison Interrupt Mask */
...
#define UART_IMR_MASK                       _U(0x9AFB)                                     /**< \deprecated (UART_IMR) Register MASK  (Use UART_IMR_Msk instead)  */
#define UART_IMR_Msk                        _U(0x9AFB)                                     /**< (UART_IMR) Register Mask  */
...
#define UART_SR_RXRDY_Msk                   (_U(0x1) << UART_SR_RXRDY_Pos)                 /**< (UART_SR) Receiver Ready Mask */
...
#define UART_SR_TXRDY_Msk                   (_U(0x1) << UART_SR_TXRDY_Pos)                 /**< (UART_SR) Transmitter Ready Mask */
...
#define UART_SR_ENDRX_Msk                   (_U(0x1) << UART_SR_ENDRX_Pos)                 /**< (UART_SR) End of Receiver Transfer Mask */
...
#define UART_SR_ENDTX_Msk                   (_U(0x1) << UART_SR_ENDTX_Pos)                 /**< (UART_SR) End of Transmitter Transfer Mask */
...
#define UART_SR_OVRE_Msk                    (_U(0x1) << UART_SR_OVRE_Pos)                  /**< (UART_SR) Overrun Error Mask */
...
#define UART_SR_FRAME_Msk                   (_U(0x1) << UART_SR_FRAME_Pos)                 /**< (UART_SR) Framing Error Mask */
...
#define UART_SR_PARE_Msk                    (_U(0x1) << UART_SR_PARE_Pos)                  /**< (UART_SR) Parity Error Mask */
...
#define UART_SR_TXEMPTY_Msk                 (_U(0x1) << UART_SR_TXEMPTY_Pos)               /**< (UART_SR) Transmitter Empty Mask */
...
#define UART_SR_TXBUFE_Msk                  (_U(0x1) << UART_SR_TXBUFE_Pos)                /**< (UART_SR) Transmission Buffer Empty Mask */
...
#define UART_SR_RXBUFF_Msk                  (_U(0x1) << UART_SR_RXBUFF_Pos)                /**< (UART_SR) Receive Buffer Full Mask */
...
#define UART_SR_CMP_Msk                     (_U(0x1) << UART_SR_CMP_Pos)                   /**< (UART_SR) Comparison Match Mask */
#define UART_SR_CMP                         UART_SR_CMP_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use UART_SR_CMP_Msk instead */
#define UART_SR_MASK                        _U(0x9AFB)                                     /**< \deprecated (UART_SR) Register MASK  (Use UART_SR_Msk instead)  */
#define UART_SR_Msk                         _U(0x9AFB)                                     /**< (UART_SR) Register Mask  */
...
#define UART_RHR_RXCHR_Msk                  (_U(0xFF) << UART_RHR_RXCHR_Pos)               /**< (UART_RHR) Received Character Mask */
#define UART_RHR_RXCHR(value)               (UART_RHR_RXCHR_Msk & ((value) << UART_RHR_RXCHR_Pos))
#define UART_RHR_MASK                       _U(0xFF)                                       /**< \deprecated (UART_RHR) Register MASK  (Use UART_RHR_Msk instead)  */
#define UART_RHR_Msk                        _U(0xFF)                                       /**< (UART_RHR) Register Mask  */
...
#define UART_THR_TXCHR_Msk                  (_U(0xFF) << UART_THR_TXCHR_Pos)               /**< (UART_THR) Character to be Transmitted Mask */
#define UART_THR_TXCHR(value)               (UART_THR_TXCHR_Msk & ((value) << UART_THR_TXCHR_Pos))
#define UART_THR_MASK                       _U(0xFF)                                       /**< \deprecated (UART_THR) Register MASK  (Use UART_THR_Msk instead)  */
#define UART_THR_Msk                        _U(0xFF)                                       /**< (UART_THR) Register Mask  */
...
#define UART_BRGR_CD_Msk                    (_U(0xFFFF) << UART_BRGR_CD_Pos)               /**< (UART_BRGR) Clock Divisor Mask */
#define UART_BRGR_CD(value)                 (UART_BRGR_CD_Msk & ((value) << UART_BRGR_CD_Pos))
#define UART_BRGR_MASK                      _U(0xFFFF)                                     /**< \deprecated (UART_BRGR) Register MASK  (Use UART_BRGR_Msk instead)  */
#define UART_BRGR_Msk                       _U(0xFFFF)                                     /**< (UART_BRGR) Register Mask  */
...
#define UART_CMPR_VAL1_Msk                  (_U(0xFF) << UART_CMPR_VAL1_Pos)               /**< (UART_CMPR) First Comparison Value for Received Character Mask */
...
#define UART_CMPR_CMPMODE_Msk               (_U(0x1) << UART_CMPR_CMPMODE_Pos)             /**< (UART_CMPR) Comparison Mode Mask */
...
#define   UART_CMPR_CMPMODE_FLAG_ONLY_Val   _U(0x0)                                        /**< (UART_CMPR) Any character is received and comparison function drives CMP flag.  */
#define   UART_CMPR_CMPMODE_START_CONDITION_Val _U(0x1)                                        /**< (UART_CMPR) Comparison condition must be met to start reception.  */
...
#define UART_CMPR_CMPPAR_Msk                (_U(0x1) << UART_CMPR_CMPPAR_Pos)              /**< (UART_CMPR) Compare Parity Mask */
...
#define UART_CMPR_VAL2_Msk                  (_U(0xFF) << UART_CMPR_VAL2_Pos)               /**< (UART_CMPR) Second Comparison Value for Received Character Mask */
#define UART_CMPR_VAL2(value)               (UART_CMPR_VAL2_Msk & ((value) << UART_CMPR_VAL2_Pos))
#define UART_CMPR_MASK                      _U(0xFF50FF)                                   /**< \deprecated (UART_CMPR) Register MASK  (Use UART_CMPR_Msk instead)  */
#define UART_CMPR_Msk                       _U(0xFF50FF)                                   /**< (UART_CMPR) Register Mask  */
...
#define UART_WPMR_WPEN_Msk                  (_U(0x1) << UART_WPMR_WPEN_Pos)                /**< (UART_WPMR) Write Protection Enable Mask */
...
#define UART_WPMR_WPKEY_Msk                 (_U(0xFFFFFF) << UART_WPMR_WPKEY_Pos)          /**< (UART_WPMR) Write Protection Key Mask */
#define UART_WPMR_WPKEY(value)              (UART_WPMR_WPKEY_Msk & ((value) << UART_WPMR_WPKEY_Pos))
#define   UART_WPMR_WPKEY_PASSWD_Val        _U(0x554152)                                   /**< (UART_WPMR) Writing any other value in this field aborts the write operation.Always reads as 0.  */
...
#define UART_WPMR_MASK                      _U(0xFFFFFF01)                                 /**< \deprecated (UART_WPMR) Register MASK  (Use UART_WPMR_Msk instead)  */
#define UART_WPMR_Msk                       _U(0xFFFFFF01)                                 /**< (UART_WPMR) Register Mask  */
...
#define UART_RPR_RXPTR_Msk                  (_U(0xFFFFFFFF) << UART_RPR_RXPTR_Pos)         /**< (UART_RPR) Receive Pointer Register Mask */
#define UART_RPR_RXPTR(value)               (UART_RPR_RXPTR_Msk & ((value) << UART_RPR_RXPTR_Pos))
#define UART_RPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (UART_RPR) Register MASK  (Use UART_RPR_Msk instead)  */
#define UART_RPR_Msk                        _U(0xFFFFFFFF)                                 /**< (UART_RPR) Register Mask  */
...
#define UART_RCR_RXCTR_Msk                  (_U(0xFFFF) << UART_RCR_RXCTR_Pos)             /**< (UART_RCR) Receive Counter Register Mask */
#define UART_RCR_RXCTR(value)               (UART_RCR_RXCTR_Msk & ((value) << UART_RCR_RXCTR_Pos))
#define UART_RCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (UART_RCR) Register MASK  (Use UART_RCR_Msk instead)  */
#define UART_RCR_Msk                        _U(0xFFFF)                                     /**< (UART_RCR) Register Mask  */
...
#define UART_TPR_TXPTR_Msk                  (_U(0xFFFFFFFF) << UART_TPR_TXPTR_Pos)         /**< (UART_TPR) Transmit Counter Register Mask */
#define UART_TPR_TXPTR(value)               (UART_TPR_TXPTR_Msk & ((value) << UART_TPR_TXPTR_Pos))
#define UART_TPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (UART_TPR) Register MASK  (Use UART_TPR_Msk instead)  */
#define UART_TPR_Msk                        _U(0xFFFFFFFF)                                 /**< (UART_TPR) Register Mask  */
...
#define UART_TCR_TXCTR_Msk                  (_U(0xFFFF) << UART_TCR_TXCTR_Pos)             /**< (UART_TCR) Transmit Counter Register Mask */
#define UART_TCR_TXCTR(value)               (UART_TCR_TXCTR_Msk & ((value) << UART_TCR_TXCTR_Pos))
#define UART_TCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (UART_TCR) Register MASK  (Use UART_TCR_Msk instead)  */
#define UART_TCR_Msk                        _U(0xFFFF)                                     /**< (UART_TCR) Register Mask  */
...
#define UART_RNPR_RXNPTR_Msk                (_U(0xFFFFFFFF) << UART_RNPR_RXNPTR_Pos)       /**< (UART_RNPR) Receive Next Pointer Mask */
#define UART_RNPR_RXNPTR(value)             (UART_RNPR_RXNPTR_Msk & ((value) << UART_RNPR_RXNPTR_Pos))
#define UART_RNPR_MASK                      _U(0xFFFFFFFF)                                 /**< \deprecated (UART_RNPR) Register MASK  (Use UART_RNPR_Msk instead)  */
#define UART_RNPR_Msk                       _U(0xFFFFFFFF)                                 /**< (UART_RNPR) Register Mask  */
...
#define UART_RNCR_RXNCTR_Msk                (_U(0xFFFF) << UART_RNCR_RXNCTR_Pos)           /**< (UART_RNCR) Receive Next Counter Mask */
#define UART_RNCR_RXNCTR(value)             (UART_RNCR_RXNCTR_Msk & ((value) << UART_RNCR_RXNCTR_Pos))
#define UART_RNCR_MASK                      _U(0xFFFF)                                     /**< \deprecated (UART_RNCR) Register MASK  (Use UART_RNCR_Msk instead)  */
#define UART_RNCR_Msk                       _U(0xFFFF)                                     /**< (UART_RNCR) Register Mask  */
...
#define UART_TNPR_TXNPTR_Msk                (_U(0xFFFFFFFF) << UART_TNPR_TXNPTR_Pos)       /**< (UART_TNPR) Transmit Next Pointer Mask */
#define UART_TNPR_TXNPTR(value)             (UART_TNPR_TXNPTR_Msk & ((value) << UART_TNPR_TXNPTR_Pos))
#define UART_TNPR_MASK                      _U(0xFFFFFFFF)                                 /**< \deprecated (UART_TNPR) Register MASK  (Use UART_TNPR_Msk instead)  */
#define UART_TNPR_Msk                       _U(0xFFFFFFFF)                                 /**< (UART_TNPR) Register Mask  */
...
#define UART_TNCR_TXNCTR_Msk                (_U(0xFFFF) << UART_TNCR_TXNCTR_Pos)           /**< (UART_TNCR) Transmit Counter Next Mask */
#define UART_TNCR_TXNCTR(value)             (UART_TNCR_TXNCTR_Msk & ((value) << UART_TNCR_TXNCTR_Pos))
#define UART_TNCR_MASK                      _U(0xFFFF)                                     /**< \deprecated (UART_TNCR) Register MASK  (Use UART_TNCR_Msk instead)  */
#define UART_TNCR_Msk                       _U(0xFFFF)                                     /**< (UART_TNCR) Register Mask  */
...
#define UART_PTCR_RXTEN_Msk                 (_U(0x1) << UART_PTCR_RXTEN_Pos)               /**< (UART_PTCR) Receiver Transfer Enable Mask */
...
#define UART_PTCR_RXTDIS_Msk                (_U(0x1) << UART_PTCR_RXTDIS_Pos)              /**< (UART_PTCR) Receiver Transfer Disable Mask */
...
#define UART_PTCR_TXTEN_Msk                 (_U(0x1) << UART_PTCR_TXTEN_Pos)               /**< (UART_PTCR) Transmitter Transfer Enable Mask */
...
#define UART_PTCR_TXTDIS_Msk                (_U(0x1) << UART_PTCR_TXTDIS_Pos)              /**< (UART_PTCR) Transmitter Transfer Disable Mask */
...
#define UART_PTCR_RXCBEN_Msk                (_U(0x1) << UART_PTCR_RXCBEN_Pos)              /**< (UART_PTCR) Receiver Circular Buffer Enable Mask */
...
#define UART_PTCR_RXCBDIS_Msk               (_U(0x1) << UART_PTCR_RXCBDIS_Pos)             /**< (UART_PTCR) Receiver Circular Buffer Disable Mask */
...
#define UART_PTCR_TXCBEN_Msk                (_U(0x1) << UART_PTCR_TXCBEN_Pos)              /**< (UART_PTCR) Transmitter Circular Buffer Enable Mask */
...
#define UART_PTCR_TXCBDIS_Msk               (_U(0x1) << UART_PTCR_TXCBDIS_Pos)             /**< (UART_PTCR) Transmitter Circular Buffer Disable Mask */
...
#define UART_PTCR_ERRCLR_Msk                (_U(0x1) << UART_PTCR_ERRCLR_Pos)              /**< (UART_PTCR) Transfer Bus Error Clear Mask */
...
#define UART_PTCR_MASK                      _U(0x10F0303)                                  /**< \deprecated (UART_PTCR) Register MASK  (Use UART_PTCR_Msk instead)  */
#define UART_PTCR_Msk                       _U(0x10F0303)                                  /**< (UART_PTCR) Register Mask  */
...
#define UART_PTSR_RXTEN_Msk                 (_U(0x1) << UART_PTSR_RXTEN_Pos)               /**< (UART_PTSR) Receiver Transfer Enable Mask */
...
#define UART_PTSR_TXTEN_Msk                 (_U(0x1) << UART_PTSR_TXTEN_Pos)               /**< (UART_PTSR) Transmitter Transfer Enable Mask */
...
#define UART_PTSR_RXCBEN_Msk                (_U(0x1) << UART_PTSR_RXCBEN_Pos)              /**< (UART_PTSR) Receiver Circular Buffer Enable Mask */
...
#define UART_PTSR_TXCBEN_Msk                (_U(0x1) << UART_PTSR_TXCBEN_Pos)              /**< (UART_PTSR) Transmitter Circular Buffer Enable Mask */
...
#define UART_PTSR_ERR_Msk                   (_U(0x1) << UART_PTSR_ERR_Pos)                 /**< (UART_PTSR) Transfer Bus Error Mask */
...
#define UART_PTSR_MASK                      _U(0x1050101)                                  /**< \deprecated (UART_PTSR) Register MASK  (Use UART_PTSR_Msk instead)  */
#define UART_PTSR_Msk                       _U(0x1050101)                                  /**< (UART_PTSR) Register Mask  */
