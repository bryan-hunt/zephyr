...
#define US_CR_RTSEN_Msk                     (_U(0x1) << US_CR_RTSEN_Pos)                   /**< (US_CR) Request to Send Pin Control Mask */
...
#define US_CR_RTSDIS_Msk                    (_U(0x1) << US_CR_RTSDIS_Pos)                  /**< (US_CR) Request to Send Pin Control Mask */
...
#define US_CR_MASK                          _U(0xC9FFC)                                    /**< \deprecated (US_CR) Register MASK  (Use US_CR_Msk instead)  */
#define US_CR_Msk                           _U(0xC9FFC)                                    /**< (US_CR) Register Mask  */
...
#define   US_MR_USART_MODE_RS485_Val        _U(0x1)                                        /**< (US_MR) RS485  */
#define   US_MR_USART_MODE_HW_HANDSHAKING_Val _U(0x2)                                        /**< (US_MR) Hardware Handshaking  */
#define   US_MR_USART_MODE_SPI_MASTER_Val   _U(0xE)                                        /**< (US_MR) SPI master  */
#define   US_MR_USART_MODE_SPI_SLAVE_Val    _U(0xF)                                        /**< (US_MR) SPI Slave  */
...
#define   US_MR_USCLKS_SCK_Val              _U(0x3)                                        /**< (US_MR) Serial clock (SCK) is selected  */
...
#define   US_MR_NBSTOP_1_5_BIT_Val          _U(0x1)                                        /**< (US_MR) 1.5 stop bit (SYNC = 0) or reserved (SYNC = 1)  */
...
#define US_MR_MASK                          _U(0x100EFFFF)                                 /**< \deprecated (US_MR) Register MASK  (Use US_MR_Msk instead)  */
#define US_MR_Msk                           _U(0x100EFFFF)                                 /**< (US_MR) Register Mask  */
...
#define US_IER_MASK                         _U(0x81BFF)                                    /**< \deprecated (US_IER) Register MASK  (Use US_IER_Msk instead)  */
#define US_IER_Msk                          _U(0x81BFF)                                    /**< (US_IER) Register Mask  */
...
#define US_IDR_ENDRX_Msk                    (_U(0x1) << US_IDR_ENDRX_Pos)                  /**< (US_IDR) End of Receive Buffer Transfer Interrupt Disable (available in all USART modes of operation) Mask */
...
#define US_IDR_TXBUFE_Msk                   (_U(0x1) << US_IDR_TXBUFE_Pos)                 /**< (US_IDR) Transmit Buffer Empty Interrupt Disable (available in all USART modes of operation) Mask */
...
#define US_IDR_RXBUFF_Msk                   (_U(0x1) << US_IDR_RXBUFF_Pos)                 /**< (US_IDR) Receive Buffer Full Interrupt Disable (available in all USART modes of operation) Mask */
...
#define US_IDR_MASK                         _U(0x81BFF)                                    /**< \deprecated (US_IDR) Register MASK  (Use US_IDR_Msk instead)  */
#define US_IDR_Msk                          _U(0x81BFF)                                    /**< (US_IDR) Register Mask  */
...
#define US_IMR_MASK                         _U(0x81BFF)                                    /**< \deprecated (US_IMR) Register MASK  (Use US_IMR_Msk instead)  */
#define US_IMR_Msk                          _U(0x81BFF)                                    /**< (US_IMR) Register Mask  */
...
#define US_CSR_RXBRK_Msk                    (_U(0x1) << US_CSR_RXBRK_Pos)                  /**< (US_CSR) Break Received/End of Break (cleared by writing a one to bit US_CR.RSTSTA) Mask */
...
#define US_CSR_OVRE_Msk                     (_U(0x1) << US_CSR_OVRE_Pos)                   /**< (US_CSR) Overrun Error (cleared by writing a one to bit US_CR.RSTSTA) Mask */
...
#define US_CSR_FRAME_Msk                    (_U(0x1) << US_CSR_FRAME_Pos)                  /**< (US_CSR) Framing Error (cleared by writing a one to bit US_CR.RSTSTA) Mask */
...
#define US_CSR_PARE_Msk                     (_U(0x1) << US_CSR_PARE_Pos)                   /**< (US_CSR) Parity Error (cleared by writing a one to bit US_CR.RSTSTA) Mask */
...
#define US_CSR_TIMEOUT_Msk                  (_U(0x1) << US_CSR_TIMEOUT_Pos)                /**< (US_CSR) Receiver Time-out (cleared by writing a one to bit US_CR.STTTO) Mask */
...
#define US_CSR_MASK                         _U(0x881BFF)                                   /**< \deprecated (US_CSR) Register MASK  (Use US_CSR_Msk instead)  */
#define US_CSR_Msk                          _U(0x881BFF)                                   /**< (US_CSR) Register Mask  */
...
#define US_RTOR_TO_Msk                      (_U(0xFFFF) << US_RTOR_TO_Pos)                 /**< (US_RTOR) Time-out Value Mask */
#define US_RTOR_TO(value)                   (US_RTOR_TO_Msk & ((value) << US_RTOR_TO_Pos))
#define US_RTOR_MASK                        _U(0xFFFF)                                     /**< \deprecated (US_RTOR) Register MASK  (Use US_RTOR_Msk instead)  */
#define US_RTOR_Msk                         _U(0xFFFF)                                     /**< (US_RTOR) Register Mask  */
