...
#define PDMIC_MR_MASK                       _U(0x7F00)                                     /**< \deprecated (PDMIC_MR) Register MASK  (Use PDMIC_MR_Msk instead)  */
#define PDMIC_MR_Msk                        _U(0x7F00)                                     /**< (PDMIC_MR) Register Mask  */
...
#define PDMIC_DSPR_HPFBYP_Msk               (_U(0x1) << PDMIC_DSPR_HPFBYP_Pos)             /**< (PDMIC_DSPR) High-Pass Filter Bypass Mask */
...
#define PDMIC_DSPR_SINBYP_Msk               (_U(0x1) << PDMIC_DSPR_SINBYP_Pos)             /**< (PDMIC_DSPR) SINCC Filter Bypass Mask */
...
#define PDMIC_DSPR_SIZE_Msk                 (_U(0x1) << PDMIC_DSPR_SIZE_Pos)               /**< (PDMIC_DSPR) Data Size Mask */
...
#define PDMIC_DSPR_OSR_Msk                  (_U(0x7) << PDMIC_DSPR_OSR_Pos)                /**< (PDMIC_DSPR) Oversampling Ratio Mask */
#define PDMIC_DSPR_OSR(value)               (PDMIC_DSPR_OSR_Msk & ((value) << PDMIC_DSPR_OSR_Pos))
#define   PDMIC_DSPR_OSR_128_Val            _U(0x0)                                        /**< (PDMIC_DSPR) Oversampling ratio is 128  */
#define   PDMIC_DSPR_OSR_64_Val             _U(0x1)                                        /**< (PDMIC_DSPR) Oversampling ratio is 64  */
...
#define PDMIC_DSPR_SCALE_Msk                (_U(0xF) << PDMIC_DSPR_SCALE_Pos)              /**< (PDMIC_DSPR) Data Scale Mask */
...
#define PDMIC_DSPR_SHIFT_Msk                (_U(0xF) << PDMIC_DSPR_SHIFT_Pos)              /**< (PDMIC_DSPR) Data Shift Mask */
#define PDMIC_DSPR_SHIFT(value)             (PDMIC_DSPR_SHIFT_Msk & ((value) << PDMIC_DSPR_SHIFT_Pos))
#define PDMIC_DSPR_MASK                     _U(0xFF7E)                                     /**< \deprecated (PDMIC_DSPR) Register MASK  (Use PDMIC_DSPR_Msk instead)  */
#define PDMIC_DSPR_Msk                      _U(0xFF7E)                                     /**< (PDMIC_DSPR) Register Mask  */
