...
#define I2SC_MR_IMCKDIV_Msk                 (_U(0x3F) << I2SC_MR_IMCKDIV_Pos)              /**< (I2SC_MR) Peripheral Clock to I2SC Master Clock Ratio Mask */
...
#define   I2SC_MR_IMCKFS_M2SF16_Val         _U(0x0)                                        /**< (I2SC_MR) Sample frequency ratio set to 16  */
#define   I2SC_MR_IMCKFS_M2SF32_Val         _U(0x1)                                        /**< (I2SC_MR) Sample frequency ratio set to 32  */
#define   I2SC_MR_IMCKFS_M2SF48_Val         _U(0x2)                                        /**< (I2SC_MR) Sample frequency ratio set to 48  */
#define   I2SC_MR_IMCKFS_M2SF64_Val         _U(0x3)                                        /**< (I2SC_MR) Sample frequency ratio set to 64  */
#define   I2SC_MR_IMCKFS_M2SF96_Val         _U(0x5)                                        /**< (I2SC_MR) Sample frequency ratio set to 96  */
#define   I2SC_MR_IMCKFS_M2SF128_Val        _U(0x7)                                        /**< (I2SC_MR) Sample frequency ratio set to 128  */
#define   I2SC_MR_IMCKFS_M2SF192_Val        _U(0xB)                                        /**< (I2SC_MR) Sample frequency ratio set to 192  */
#define   I2SC_MR_IMCKFS_M2SF256_Val        _U(0xF)                                        /**< (I2SC_MR) Sample frequency ratio set to 256  */
#define   I2SC_MR_IMCKFS_M2SF384_Val        _U(0x17)                                       /**< (I2SC_MR) Sample frequency ratio set to 384  */
#define   I2SC_MR_IMCKFS_M2SF512_Val        _U(0x1F)                                       /**< (I2SC_MR) Sample frequency ratio set to 512  */
#define   I2SC_MR_IMCKFS_M2SF768_Val        _U(0x2F)                                       /**< (I2SC_MR) Sample frequency ratio set to 768  */
#define   I2SC_MR_IMCKFS_M2SF1024_Val       _U(0x3F)                                       /**< (I2SC_MR) Sample frequency ratio set to 1024  */
