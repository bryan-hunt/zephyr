...
#define SPI_CR_MASK                         _U(0x1000083)                                  /**< \deprecated (SPI_CR) Register MASK  (Use SPI_CR_Msk instead)  */
#define SPI_CR_Msk                          _U(0x1000083)                                  /**< (SPI_CR) Register Mask  */
...
#define SPI_MR_MASK                         _U(0xFF0300B7)                                 /**< \deprecated (SPI_MR) Register MASK  (Use SPI_MR_Msk instead)  */
#define SPI_MR_Msk                          _U(0xFF0300B7)                                 /**< (SPI_MR) Register Mask  */
...
#define SPI_SR_MASK                         _U(0x107FF)                                    /**< \deprecated (SPI_SR) Register MASK  (Use SPI_SR_Msk instead)  */
#define SPI_SR_Msk                          _U(0x107FF)                                    /**< (SPI_SR) Register Mask  */
...
#define SPI_IER_MASK                        _U(0x7FF)                                      /**< \deprecated (SPI_IER) Register MASK  (Use SPI_IER_Msk instead)  */
#define SPI_IER_Msk                         _U(0x7FF)                                      /**< (SPI_IER) Register Mask  */
...
#define SPI_IDR_MASK                        _U(0x7FF)                                      /**< \deprecated (SPI_IDR) Register MASK  (Use SPI_IDR_Msk instead)  */
#define SPI_IDR_Msk                         _U(0x7FF)                                      /**< (SPI_IDR) Register Mask  */
...
#define SPI_IMR_MASK                        _U(0x7FF)                                      /**< \deprecated (SPI_IMR) Register MASK  (Use SPI_IMR_Msk instead)  */
#define SPI_IMR_Msk                         _U(0x7FF)                                      /**< (SPI_IMR) Register Mask  */
...
#define SPI_CSR_SCBR_Msk                    (_U(0xFF) << SPI_CSR_SCBR_Pos)                 /**< (SPI_CSR) Serial Clock Baud Rate Mask */
...
#define SPI_WPMR_WPKEY_Msk                  (_U(0xFFFFFF) << SPI_WPMR_WPKEY_Pos)           /**< (SPI_WPMR) Write Protection Key Mask */
