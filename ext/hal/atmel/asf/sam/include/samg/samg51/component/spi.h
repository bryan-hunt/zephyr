...
#define SPI_PTCR_MASK                       _U(0x303)                                      /**< \deprecated (SPI_PTCR) Register MASK  (Use SPI_PTCR_Msk instead)  */
#define SPI_PTCR_Msk                        _U(0x303)                                      /**< (SPI_PTCR) Register Mask  */
...
#define SPI_PTSR_MASK                       _U(0x101)                                      /**< \deprecated (SPI_PTSR) Register MASK  (Use SPI_PTSR_Msk instead)  */
#define SPI_PTSR_Msk                        _U(0x101)                                      /**< (SPI_PTSR) Register Mask  */
