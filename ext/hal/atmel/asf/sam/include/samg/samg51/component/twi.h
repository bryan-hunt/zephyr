...
#define TWI_PTCR_MASK                       _U(0x303)                                      /**< \deprecated (TWI_PTCR) Register MASK  (Use TWI_PTCR_Msk instead)  */
#define TWI_PTCR_Msk                        _U(0x303)                                      /**< (TWI_PTCR) Register Mask  */
...
#define TWI_PTSR_MASK                       _U(0x101)                                      /**< \deprecated (TWI_PTSR) Register MASK  (Use TWI_PTSR_Msk instead)  */
#define TWI_PTSR_Msk                        _U(0x101)                                      /**< (TWI_PTSR) Register Mask  */
