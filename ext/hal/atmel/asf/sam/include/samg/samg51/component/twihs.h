...
#define TWIHS_SMR_Msk                       _U(0x7F7F4D)                                   /**< (TWIHS_SMR) Register Mask  */
...
#define TWIHS_PTCR_MASK                     _U(0x303)                                      /**< \deprecated (TWIHS_PTCR) Register MASK  (Use TWIHS_PTCR_Msk instead)  */
#define TWIHS_PTCR_Msk                      _U(0x303)                                      /**< (TWIHS_PTCR) Register Mask  */
...
#define TWIHS_PTSR_MASK                     _U(0x101)                                      /**< \deprecated (TWIHS_PTSR) Register MASK  (Use TWIHS_PTSR_Msk instead)  */
#define TWIHS_PTSR_Msk                      _U(0x101)                                      /**< (TWIHS_PTSR) Register Mask  */
