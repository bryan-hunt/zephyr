...
#define US_PTCR_MASK                        _U(0x303)                                      /**< \deprecated (US_PTCR) Register MASK  (Use US_PTCR_Msk instead)  */
#define US_PTCR_Msk                         _U(0x303)                                      /**< (US_PTCR) Register Mask  */
...
#define US_PTSR_MASK                        _U(0x101)                                      /**< \deprecated (US_PTSR) Register MASK  (Use US_PTSR_Msk instead)  */
#define US_PTSR_Msk                         _U(0x101)                                      /**< (US_PTSR) Register Mask  */
