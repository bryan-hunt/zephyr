...
#define TC_RPR2_RXPTR_Msk                   (_U(0xFFFFFFFF) << TC_RPR2_RXPTR_Pos)          /**< (TC_RPR2) Receive Pointer Register Mask */
#define TC_RPR2_RXPTR(value)                (TC_RPR2_RXPTR_Msk & ((value) << TC_RPR2_RXPTR_Pos))
#define TC_RPR2_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (TC_RPR2) Register MASK  (Use TC_RPR2_Msk instead)  */
#define TC_RPR2_Msk                         _U(0xFFFFFFFF)                                 /**< (TC_RPR2) Register Mask  */
...
#define TC_RNPR2_RXNPTR_Msk                 (_U(0xFFFFFFFF) << TC_RNPR2_RXNPTR_Pos)        /**< (TC_RNPR2) Receive Next Pointer Mask */
#define TC_RNPR2_RXNPTR(value)              (TC_RNPR2_RXNPTR_Msk & ((value) << TC_RNPR2_RXNPTR_Pos))
#define TC_RNPR2_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (TC_RNPR2) Register MASK  (Use TC_RNPR2_Msk instead)  */
#define TC_RNPR2_Msk                        _U(0xFFFFFFFF)                                 /**< (TC_RNPR2) Register Mask  */
...
#define TC_RNCR2_RXNCTR_Msk                 (_U(0xFFFF) << TC_RNCR2_RXNCTR_Pos)            /**< (TC_RNCR2) Receive Next Counter Mask */
#define TC_RNCR2_RXNCTR(value)              (TC_RNCR2_RXNCTR_Msk & ((value) << TC_RNCR2_RXNCTR_Pos))
#define TC_RNCR2_MASK                       _U(0xFFFF)                                     /**< \deprecated (TC_RNCR2) Register MASK  (Use TC_RNCR2_Msk instead)  */
#define TC_RNCR2_Msk                        _U(0xFFFF)                                     /**< (TC_RNCR2) Register Mask  */
...
#define TC_PTCR2_RXTEN_Msk                  (_U(0x1) << TC_PTCR2_RXTEN_Pos)                /**< (TC_PTCR2) Receiver Transfer Enable Mask */
...
#define TC_PTCR2_RXTDIS_Msk                 (_U(0x1) << TC_PTCR2_RXTDIS_Pos)               /**< (TC_PTCR2) Receiver Transfer Disable Mask */
...
#define TC_PTCR2_TXTEN_Msk                  (_U(0x1) << TC_PTCR2_TXTEN_Pos)                /**< (TC_PTCR2) Transmitter Transfer Enable Mask */
...
#define TC_PTCR2_TXTDIS_Msk                 (_U(0x1) << TC_PTCR2_TXTDIS_Pos)               /**< (TC_PTCR2) Transmitter Transfer Disable Mask */
...
#define TC_PTCR2_MASK                       _U(0x303)                                      /**< \deprecated (TC_PTCR2) Register MASK  (Use TC_PTCR2_Msk instead)  */
#define TC_PTCR2_Msk                        _U(0x303)                                      /**< (TC_PTCR2) Register Mask  */
...
#define TC_PTSR2_RXTEN_Msk                  (_U(0x1) << TC_PTSR2_RXTEN_Pos)                /**< (TC_PTSR2) Receiver Transfer Enable Mask */
...
#define TC_PTSR2_TXTEN_Msk                  (_U(0x1) << TC_PTSR2_TXTEN_Pos)                /**< (TC_PTSR2) Transmitter Transfer Enable Mask */
...
#define TC_PTSR2_MASK                       _U(0x101)                                      /**< \deprecated (TC_PTSR2) Register MASK  (Use TC_PTSR2_Msk instead)  */
#define TC_PTSR2_Msk                        _U(0x101)                                      /**< (TC_PTSR2) Register Mask  */
