...
#define PIN_PA9B_SPI_NPCS1                         _L(9)        /**< SPI signal: NPCS1 on PA9 mux B*/
#define MUX_PA9B_SPI_NPCS1                         _L(1)       
#define PINMUX_PA9B_SPI_NPCS1                      ((PIN_PA9B_SPI_NPCS1 << 16) | MUX_PA9B_SPI_NPCS1)
#define PIO_PA9B_SPI_NPCS1                         (_UL(1) << 9)
