...
#define UART_CR_MASK                        _U(0x1FC)                                      /**< \deprecated (UART_CR) Register MASK  (Use UART_CR_Msk instead)  */
#define UART_CR_Msk                         _U(0x1FC)                                      /**< (UART_CR) Register Mask  */
...
#define UART_IER_MASK                       _U(0x1AFB)                                     /**< \deprecated (UART_IER) Register MASK  (Use UART_IER_Msk instead)  */
#define UART_IER_Msk                        _U(0x1AFB)                                     /**< (UART_IER) Register Mask  */
...
#define UART_IDR_MASK                       _U(0x1AFB)                                     /**< \deprecated (UART_IDR) Register MASK  (Use UART_IDR_Msk instead)  */
#define UART_IDR_Msk                        _U(0x1AFB)                                     /**< (UART_IDR) Register Mask  */
...
#define UART_IMR_MASK                       _U(0x1AFB)                                     /**< \deprecated (UART_IMR) Register MASK  (Use UART_IMR_Msk instead)  */
#define UART_IMR_Msk                        _U(0x1AFB)                                     /**< (UART_IMR) Register Mask  */
...
#define UART_SR_MASK                        _U(0x1AFB)                                     /**< \deprecated (UART_SR) Register MASK  (Use UART_SR_Msk instead)  */
#define UART_SR_Msk                         _U(0x1AFB)                                     /**< (UART_SR) Register Mask  */
...
#define UART_PTCR_MASK                      _U(0x303)                                      /**< \deprecated (UART_PTCR) Register MASK  (Use UART_PTCR_Msk instead)  */
#define UART_PTCR_Msk                       _U(0x303)                                      /**< (UART_PTCR) Register Mask  */
...
#define UART_PTSR_MASK                      _U(0x101)                                      /**< \deprecated (UART_PTSR) Register MASK  (Use UART_PTSR_Msk instead)  */
#define UART_PTSR_Msk                       _U(0x101)                                      /**< (UART_PTSR) Register Mask  */
