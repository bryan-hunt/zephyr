...
#define MEM2MEM_PTCR_MASK                   _U(0x303)                                      /**< \deprecated (MEM2MEM_PTCR) Register MASK  (Use MEM2MEM_PTCR_Msk instead)  */
#define MEM2MEM_PTCR_Msk                    _U(0x303)                                      /**< (MEM2MEM_PTCR) Register Mask  */
...
#define MEM2MEM_PTSR_MASK                   _U(0x101)                                      /**< \deprecated (MEM2MEM_PTSR) Register MASK  (Use MEM2MEM_PTSR_Msk instead)  */
#define MEM2MEM_PTSR_Msk                    _U(0x101)                                      /**< (MEM2MEM_PTSR) Register Mask  */
