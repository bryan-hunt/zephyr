...
#define IFLASH_SIZE              _U(0x00040000)       /*  256kB Memory segment type: flash */
#define IFLASH_PAGE_SIZE         _U(       512)
#define IFLASH_NB_OF_PAGES       _U(       512)

#define IROM_SIZE                _U(0x00400000)       /* 4096kB Memory segment type: rom */
#define IRAM_SIZE                _U(0x00010000)       /*   64kB Memory segment type: ram */
...
/* ************************************************************************** */
#define JTAGID                   _UL(0X05B3A03F)
#define CHIP_JTAGID              _UL(0X05B3A03F)
#define CHIP_CIDR                _UL(0X243B09E0)
...
#define CHIP_FREQ_FWS_0                _UL(15000000)   /**< \brief Maximum operating frequency when FWS is 0*/
#define CHIP_FREQ_FWS_1                _UL(30000000)   /**< \brief Maximum operating frequency when FWS is 1*/
#define CHIP_FREQ_FWS_2                _UL(45000000)   /**< \brief Maximum operating frequency when FWS is 2*/
#define CHIP_FREQ_FWS_3                _UL(60000000)   /**< \brief Maximum operating frequency when FWS is 3*/
