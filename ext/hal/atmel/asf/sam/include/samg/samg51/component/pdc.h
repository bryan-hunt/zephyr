...
#define PDC_PERIPH_PTCR_MASK                _U(0x303)                                      /**< \deprecated (PDC_PERIPH_PTCR) Register MASK  (Use PDC_PERIPH_PTCR_Msk instead)  */
#define PDC_PERIPH_PTCR_Msk                 _U(0x303)                                      /**< (PDC_PERIPH_PTCR) Register Mask  */
...
#define PDC_PERIPH_PTSR_MASK                _U(0x101)                                      /**< \deprecated (PDC_PERIPH_PTSR) Register MASK  (Use PDC_PERIPH_PTSR_Msk instead)  */
#define PDC_PERIPH_PTSR_Msk                 _U(0x101)                                      /**< (PDC_PERIPH_PTSR) Register Mask  */
