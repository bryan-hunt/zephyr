...
#define UHP_HCREVISION_REV_Msk              (_U(0xFF) << UHP_HCREVISION_REV_Pos)           /**< (UHP_HCREVISION) OHCI revision number Mask */
#define UHP_HCREVISION_REV(value)           (UHP_HCREVISION_REV_Msk & ((value) << UHP_HCREVISION_REV_Pos))
#define UHP_HCREVISION_MASK                 _U(0xFF)                                       /**< \deprecated (UHP_HCREVISION) Register MASK  (Use UHP_HCREVISION_Msk instead)  */
#define UHP_HCREVISION_Msk                  _U(0xFF)                                       /**< (UHP_HCREVISION) Register Mask  */
...
#define UHP_HCCONTROL_CBSR_Msk              (_U(0x3) << UHP_HCCONTROL_CBSR_Pos)            /**< (UHP_HCCONTROL) Control/bulk service ratio Mask */
...
#define UHP_HCCONTROL_PLE_Msk               (_U(0x1) << UHP_HCCONTROL_PLE_Pos)             /**< (UHP_HCCONTROL) Periodic list enable Mask */
...
#define UHP_HCCONTROL_IE_Msk                (_U(0x1) << UHP_HCCONTROL_IE_Pos)              /**< (UHP_HCCONTROL) Isochronous enable Mask */
...
#define UHP_HCCONTROL_CLE_Msk               (_U(0x1) << UHP_HCCONTROL_CLE_Pos)             /**< (UHP_HCCONTROL) Control list enable Mask */
...
#define UHP_HCCONTROL_BLE_Msk               (_U(0x1) << UHP_HCCONTROL_BLE_Pos)             /**< (UHP_HCCONTROL) Bulk list enable Mask */
...
#define UHP_HCCONTROL_HCFS_Msk              (_U(0x3) << UHP_HCCONTROL_HCFS_Pos)            /**< (UHP_HCCONTROL) Host controller functional state Mask */
...
#define UHP_HCCONTROL_IR_Msk                (_U(0x1) << UHP_HCCONTROL_IR_Pos)              /**< (UHP_HCCONTROL) Interrupt routing Mask */
...
#define UHP_HCCONTROL_RWC_Msk               (_U(0x1) << UHP_HCCONTROL_RWC_Pos)             /**< (UHP_HCCONTROL) Remote wake-up connected Mask */
...
#define UHP_HCCONTROL_RWE_Msk               (_U(0x1) << UHP_HCCONTROL_RWE_Pos)             /**< (UHP_HCCONTROL) Remote wake-up enable Mask */
...
#define UHP_HCCONTROL_MASK                  _U(0x7FF)                                      /**< \deprecated (UHP_HCCONTROL) Register MASK  (Use UHP_HCCONTROL_Msk instead)  */
#define UHP_HCCONTROL_Msk                   _U(0x7FF)                                      /**< (UHP_HCCONTROL) Register Mask  */
...
#define UHP_HCCOMMANDSTATUS_HCR_Msk         (_U(0x1) << UHP_HCCOMMANDSTATUS_HCR_Pos)       /**< (UHP_HCCOMMANDSTATUS) Host controller reset (read/write) Mask */
...
#define UHP_HCCOMMANDSTATUS_CLF_Msk         (_U(0x1) << UHP_HCCOMMANDSTATUS_CLF_Pos)       /**< (UHP_HCCOMMANDSTATUS) Control list filled (read/write) Mask */
...
#define UHP_HCCOMMANDSTATUS_BLF_Msk         (_U(0x1) << UHP_HCCOMMANDSTATUS_BLF_Pos)       /**< (UHP_HCCOMMANDSTATUS) Bulk list filled (read/write) Mask */
...
#define UHP_HCCOMMANDSTATUS_OCR_Msk         (_U(0x1) << UHP_HCCOMMANDSTATUS_OCR_Pos)       /**< (UHP_HCCOMMANDSTATUS) Ownership change request (read/write) Mask */
...
#define UHP_HCCOMMANDSTATUS_SOC_Msk         (_U(0x3) << UHP_HCCOMMANDSTATUS_SOC_Pos)       /**< (UHP_HCCOMMANDSTATUS) Scheduling overrun count (read-only) Mask */
#define UHP_HCCOMMANDSTATUS_SOC(value)      (UHP_HCCOMMANDSTATUS_SOC_Msk & ((value) << UHP_HCCOMMANDSTATUS_SOC_Pos))
#define UHP_HCCOMMANDSTATUS_MASK            _U(0x3000F)                                    /**< \deprecated (UHP_HCCOMMANDSTATUS) Register MASK  (Use UHP_HCCOMMANDSTATUS_Msk instead)  */
#define UHP_HCCOMMANDSTATUS_Msk             _U(0x3000F)                                    /**< (UHP_HCCOMMANDSTATUS) Register Mask  */
...
#define UHP_HCINTERRUPTSTATUS_SO_Msk        (_U(0x1) << UHP_HCINTERRUPTSTATUS_SO_Pos)      /**< (UHP_HCINTERRUPTSTATUS) Scheduling overrun (read/write, write '1' to clear) Mask */
...
#define UHP_HCINTERRUPTSTATUS_WDH_Msk       (_U(0x1) << UHP_HCINTERRUPTSTATUS_WDH_Pos)     /**< (UHP_HCINTERRUPTSTATUS) Write done head (read/write, write '1' to clear) Mask */
...
#define UHP_HCINTERRUPTSTATUS_SF_Msk        (_U(0x1) << UHP_HCINTERRUPTSTATUS_SF_Pos)      /**< (UHP_HCINTERRUPTSTATUS) Start of frame (read/write, write '1' to clear) Mask */
...
#define UHP_HCINTERRUPTSTATUS_RD_Msk        (_U(0x1) << UHP_HCINTERRUPTSTATUS_RD_Pos)      /**< (UHP_HCINTERRUPTSTATUS) Resume detected (read/write, write '1' to clear) Mask */
...
#define UHP_HCINTERRUPTSTATUS_UE_Msk        (_U(0x1) << UHP_HCINTERRUPTSTATUS_UE_Pos)      /**< (UHP_HCINTERRUPTSTATUS) Unrecoverable error (read/write, write '1' to clear) Mask */
...
#define UHP_HCINTERRUPTSTATUS_FNO_Msk       (_U(0x1) << UHP_HCINTERRUPTSTATUS_FNO_Pos)     /**< (UHP_HCINTERRUPTSTATUS) Frame number overflow (read/write, write '1' to clear) Mask */
...
#define UHP_HCINTERRUPTSTATUS_RHSC_Msk      (_U(0x1) << UHP_HCINTERRUPTSTATUS_RHSC_Pos)    /**< (UHP_HCINTERRUPTSTATUS) Root hub status change (read/write, write '1' to clear) Mask */
...
#define UHP_HCINTERRUPTSTATUS_OC_Msk        (_U(0x1) << UHP_HCINTERRUPTSTATUS_OC_Pos)      /**< (UHP_HCINTERRUPTSTATUS) Ownership change (read-only) Mask */
...
#define UHP_HCINTERRUPTSTATUS_MASK          _U(0x4000007F)                                 /**< \deprecated (UHP_HCINTERRUPTSTATUS) Register MASK  (Use UHP_HCINTERRUPTSTATUS_Msk instead)  */
#define UHP_HCINTERRUPTSTATUS_Msk           _U(0x4000007F)                                 /**< (UHP_HCINTERRUPTSTATUS) Register Mask  */
...
#define UHP_HCINTERRUPTENABLE_SO_Msk        (_U(0x1) << UHP_HCINTERRUPTENABLE_SO_Pos)      /**< (UHP_HCINTERRUPTENABLE) Scheduling overrun (read/write, write '1' to set) Mask */
...
#define UHP_HCINTERRUPTENABLE_WDH_Msk       (_U(0x1) << UHP_HCINTERRUPTENABLE_WDH_Pos)     /**< (UHP_HCINTERRUPTENABLE) Write done head (read/write, write '1' to set) Mask */
...
#define UHP_HCINTERRUPTENABLE_SF_Msk        (_U(0x1) << UHP_HCINTERRUPTENABLE_SF_Pos)      /**< (UHP_HCINTERRUPTENABLE) Start of frame (read/write, write '1' to set) Mask */
...
#define UHP_HCINTERRUPTENABLE_RD_Msk        (_U(0x1) << UHP_HCINTERRUPTENABLE_RD_Pos)      /**< (UHP_HCINTERRUPTENABLE) Resume detected (read/write, write '1' to set) Mask */
...
#define UHP_HCINTERRUPTENABLE_UE_Msk        (_U(0x1) << UHP_HCINTERRUPTENABLE_UE_Pos)      /**< (UHP_HCINTERRUPTENABLE) Unrecoverable error (read/write, write '1' to set) Mask */
...
#define UHP_HCINTERRUPTENABLE_FNO_Msk       (_U(0x1) << UHP_HCINTERRUPTENABLE_FNO_Pos)     /**< (UHP_HCINTERRUPTENABLE) Frame number overflow (read/write, write '1' to set) Mask */
...
#define UHP_HCINTERRUPTENABLE_RHSC_Msk      (_U(0x1) << UHP_HCINTERRUPTENABLE_RHSC_Pos)    /**< (UHP_HCINTERRUPTENABLE) Root hub status change (read/write, write '1' to set) Mask */
...
#define UHP_HCINTERRUPTENABLE_OC_Msk        (_U(0x1) << UHP_HCINTERRUPTENABLE_OC_Pos)      /**< (UHP_HCINTERRUPTENABLE) Ownership change (read-only) Mask */
...
#define UHP_HCINTERRUPTENABLE_MIE_Msk       (_U(0x1) << UHP_HCINTERRUPTENABLE_MIE_Pos)     /**< (UHP_HCINTERRUPTENABLE) Master interrupt enable (read/write, write '1' to set) Mask */
...
#define UHP_HCINTERRUPTENABLE_MASK          _U(0xC000007F)                                 /**< \deprecated (UHP_HCINTERRUPTENABLE) Register MASK  (Use UHP_HCINTERRUPTENABLE_Msk instead)  */
#define UHP_HCINTERRUPTENABLE_Msk           _U(0xC000007F)                                 /**< (UHP_HCINTERRUPTENABLE) Register Mask  */
...
#define UHP_HCINTERRUPTDISABLE_SO_Msk       (_U(0x1) << UHP_HCINTERRUPTDISABLE_SO_Pos)     /**< (UHP_HCINTERRUPTDISABLE) Scheduling overrun (read/write) Mask */
...
#define UHP_HCINTERRUPTDISABLE_WDH_Msk      (_U(0x1) << UHP_HCINTERRUPTDISABLE_WDH_Pos)    /**< (UHP_HCINTERRUPTDISABLE) Write done head (read/write) Mask */
...
#define UHP_HCINTERRUPTDISABLE_SF_Msk       (_U(0x1) << UHP_HCINTERRUPTDISABLE_SF_Pos)     /**< (UHP_HCINTERRUPTDISABLE) Start of frame (read/write) Mask */
...
#define UHP_HCINTERRUPTDISABLE_RD_Msk       (_U(0x1) << UHP_HCINTERRUPTDISABLE_RD_Pos)     /**< (UHP_HCINTERRUPTDISABLE) Resume detected (read/write) Mask */
...
#define UHP_HCINTERRUPTDISABLE_UE_Msk       (_U(0x1) << UHP_HCINTERRUPTDISABLE_UE_Pos)     /**< (UHP_HCINTERRUPTDISABLE) Unrecoverable error (read/write) Mask */
...
#define UHP_HCINTERRUPTDISABLE_FNO_Msk      (_U(0x1) << UHP_HCINTERRUPTDISABLE_FNO_Pos)    /**< (UHP_HCINTERRUPTDISABLE) Frame number overflow (read/write) Mask */
...
#define UHP_HCINTERRUPTDISABLE_RHSC_Msk     (_U(0x1) << UHP_HCINTERRUPTDISABLE_RHSC_Pos)   /**< (UHP_HCINTERRUPTDISABLE) Root hub status change (read/write) Mask */
...
#define UHP_HCINTERRUPTDISABLE_OC_Msk       (_U(0x1) << UHP_HCINTERRUPTDISABLE_OC_Pos)     /**< (UHP_HCINTERRUPTDISABLE) Ownership change (read-only) Mask */
...
#define UHP_HCINTERRUPTDISABLE_MIE_Msk      (_U(0x1) << UHP_HCINTERRUPTDISABLE_MIE_Pos)    /**< (UHP_HCINTERRUPTDISABLE) Master interrupt enable (read/write) Mask */
...
#define UHP_HCINTERRUPTDISABLE_MASK         _U(0xC000007F)                                 /**< \deprecated (UHP_HCINTERRUPTDISABLE) Register MASK  (Use UHP_HCINTERRUPTDISABLE_Msk instead)  */
#define UHP_HCINTERRUPTDISABLE_Msk          _U(0xC000007F)                                 /**< (UHP_HCINTERRUPTDISABLE) Register Mask  */
...
#define UHP_HCHCCA_HCCA_Msk                 (_U(0xFFFFFF) << UHP_HCHCCA_HCCA_Pos)          /**< (UHP_HCHCCA) Physical address of the beginning of the HCCA Mask */
#define UHP_HCHCCA_HCCA(value)              (UHP_HCHCCA_HCCA_Msk & ((value) << UHP_HCHCCA_HCCA_Pos))
#define UHP_HCHCCA_MASK                     _U(0xFFFFFF00)                                 /**< \deprecated (UHP_HCHCCA) Register MASK  (Use UHP_HCHCCA_Msk instead)  */
#define UHP_HCHCCA_Msk                      _U(0xFFFFFF00)                                 /**< (UHP_HCHCCA) Register Mask  */
...
#define UHP_HCPERIODCURRENTED_PCED_Msk      (_U(0xFFFFFFF) << UHP_HCPERIODCURRENTED_PCED_Pos)  /**< (UHP_HCPERIODCURRENTED) Physical address of the current ED on the periodic ED list Mask */
#define UHP_HCPERIODCURRENTED_PCED(value)   (UHP_HCPERIODCURRENTED_PCED_Msk & ((value) << UHP_HCPERIODCURRENTED_PCED_Pos))
#define UHP_HCPERIODCURRENTED_MASK          _U(0xFFFFFFF0)                                 /**< \deprecated (UHP_HCPERIODCURRENTED) Register MASK  (Use UHP_HCPERIODCURRENTED_Msk instead)  */
#define UHP_HCPERIODCURRENTED_Msk           _U(0xFFFFFFF0)                                 /**< (UHP_HCPERIODCURRENTED) Register Mask  */
...
#define UHP_HCCONTROLHEADED_CHED_Msk        (_U(0xFFFFFFF) << UHP_HCCONTROLHEADED_CHED_Pos)  /**< (UHP_HCCONTROLHEADED) Physical address of the head ED on the control ED list Mask */
#define UHP_HCCONTROLHEADED_CHED(value)     (UHP_HCCONTROLHEADED_CHED_Msk & ((value) << UHP_HCCONTROLHEADED_CHED_Pos))
#define UHP_HCCONTROLHEADED_MASK            _U(0xFFFFFFF0)                                 /**< \deprecated (UHP_HCCONTROLHEADED) Register MASK  (Use UHP_HCCONTROLHEADED_Msk instead)  */
#define UHP_HCCONTROLHEADED_Msk             _U(0xFFFFFFF0)                                 /**< (UHP_HCCONTROLHEADED) Register Mask  */
...
#define UHP_HCCONTROLCURRENTED_CCED_Msk     (_U(0xFFFFFFF) << UHP_HCCONTROLCURRENTED_CCED_Pos)  /**< (UHP_HCCONTROLCURRENTED) Physical address of the current ED on the control ED list Mask */
#define UHP_HCCONTROLCURRENTED_CCED(value)  (UHP_HCCONTROLCURRENTED_CCED_Msk & ((value) << UHP_HCCONTROLCURRENTED_CCED_Pos))
#define UHP_HCCONTROLCURRENTED_MASK         _U(0xFFFFFFF0)                                 /**< \deprecated (UHP_HCCONTROLCURRENTED) Register MASK  (Use UHP_HCCONTROLCURRENTED_Msk instead)  */
#define UHP_HCCONTROLCURRENTED_Msk          _U(0xFFFFFFF0)                                 /**< (UHP_HCCONTROLCURRENTED) Register Mask  */
...
#define UHP_HCBULKHEADED_BHED_Msk           (_U(0xFFFFFFF) << UHP_HCBULKHEADED_BHED_Pos)   /**< (UHP_HCBULKHEADED) Physical address of the head ED on the bulk ED list Mask */
#define UHP_HCBULKHEADED_BHED(value)        (UHP_HCBULKHEADED_BHED_Msk & ((value) << UHP_HCBULKHEADED_BHED_Pos))
#define UHP_HCBULKHEADED_MASK               _U(0xFFFFFFF0)                                 /**< \deprecated (UHP_HCBULKHEADED) Register MASK  (Use UHP_HCBULKHEADED_Msk instead)  */
#define UHP_HCBULKHEADED_Msk                _U(0xFFFFFFF0)                                 /**< (UHP_HCBULKHEADED) Register Mask  */
...
#define UHP_HCBULKCURRENTED_BCED_Msk        (_U(0xFFFFFFF) << UHP_HCBULKCURRENTED_BCED_Pos)  /**< (UHP_HCBULKCURRENTED) Physical address of the current ED on the bulk ED list Mask */
#define UHP_HCBULKCURRENTED_BCED(value)     (UHP_HCBULKCURRENTED_BCED_Msk & ((value) << UHP_HCBULKCURRENTED_BCED_Pos))
#define UHP_HCBULKCURRENTED_MASK            _U(0xFFFFFFF0)                                 /**< \deprecated (UHP_HCBULKCURRENTED) Register MASK  (Use UHP_HCBULKCURRENTED_Msk instead)  */
#define UHP_HCBULKCURRENTED_Msk             _U(0xFFFFFFF0)                                 /**< (UHP_HCBULKCURRENTED) Register Mask  */
...
#define UHP_HCDONEHEAD_DH_Msk               (_U(0xFFFFFFF) << UHP_HCDONEHEAD_DH_Pos)       /**< (UHP_HCDONEHEAD) Physical address of the last TD that has added to the done queue Mask */
#define UHP_HCDONEHEAD_DH(value)            (UHP_HCDONEHEAD_DH_Msk & ((value) << UHP_HCDONEHEAD_DH_Pos))
#define UHP_HCDONEHEAD_MASK                 _U(0xFFFFFFF0)                                 /**< \deprecated (UHP_HCDONEHEAD) Register MASK  (Use UHP_HCDONEHEAD_Msk instead)  */
#define UHP_HCDONEHEAD_Msk                  _U(0xFFFFFFF0)                                 /**< (UHP_HCDONEHEAD) Register Mask  */
...
#define UHP_HCFMINTERVAL_FRAMEINTERVAL_Msk  (_U(0x3FFF) << UHP_HCFMINTERVAL_FRAMEINTERVAL_Pos)  /**< (UHP_HCFMINTERVAL) Frame interval Mask */
...
#define UHP_HCFMINTERVAL_FSMPS_Msk          (_U(0x7FFF) << UHP_HCFMINTERVAL_FSMPS_Pos)     /**< (UHP_HCFMINTERVAL) Largest data packet Mask */
...
#define UHP_HCFMINTERVAL_FIT_Msk            (_U(0x1) << UHP_HCFMINTERVAL_FIT_Pos)          /**< (UHP_HCFMINTERVAL) Frame interval toggle Mask */
...
#define UHP_HCFMINTERVAL_MASK               _U(0xFFFF3FFF)                                 /**< \deprecated (UHP_HCFMINTERVAL) Register MASK  (Use UHP_HCFMINTERVAL_Msk instead)  */
#define UHP_HCFMINTERVAL_Msk                _U(0xFFFF3FFF)                                 /**< (UHP_HCFMINTERVAL) Register Mask  */
...
#define UHP_HCFMREMAINING_FR_Msk            (_U(0x3FFF) << UHP_HCFMREMAINING_FR_Pos)       /**< (UHP_HCFMREMAINING) Frame remaining Mask */
...
#define UHP_HCFMREMAINING_FRT_Msk           (_U(0x1) << UHP_HCFMREMAINING_FRT_Pos)         /**< (UHP_HCFMREMAINING) Frame remaining toggle Mask */
...
#define UHP_HCFMREMAINING_MASK              _U(0x80003FFF)                                 /**< \deprecated (UHP_HCFMREMAINING) Register MASK  (Use UHP_HCFMREMAINING_Msk instead)  */
#define UHP_HCFMREMAINING_Msk               _U(0x80003FFF)                                 /**< (UHP_HCFMREMAINING) Register Mask  */
...
#define UHP_HCFMNUMBER_FN_Msk               (_U(0xFFFF) << UHP_HCFMNUMBER_FN_Pos)          /**< (UHP_HCFMNUMBER) Frame number Mask */
#define UHP_HCFMNUMBER_FN(value)            (UHP_HCFMNUMBER_FN_Msk & ((value) << UHP_HCFMNUMBER_FN_Pos))
#define UHP_HCFMNUMBER_MASK                 _U(0xFFFF)                                     /**< \deprecated (UHP_HCFMNUMBER) Register MASK  (Use UHP_HCFMNUMBER_Msk instead)  */
#define UHP_HCFMNUMBER_Msk                  _U(0xFFFF)                                     /**< (UHP_HCFMNUMBER) Register Mask  */
...
#define UHP_HCPERIODICSTART_PS_Msk          (_U(0x3FFF) << UHP_HCPERIODICSTART_PS_Pos)     /**< (UHP_HCPERIODICSTART) Periodic start Mask */
#define UHP_HCPERIODICSTART_PS(value)       (UHP_HCPERIODICSTART_PS_Msk & ((value) << UHP_HCPERIODICSTART_PS_Pos))
#define UHP_HCPERIODICSTART_MASK            _U(0x3FFF)                                     /**< \deprecated (UHP_HCPERIODICSTART) Register MASK  (Use UHP_HCPERIODICSTART_Msk instead)  */
#define UHP_HCPERIODICSTART_Msk             _U(0x3FFF)                                     /**< (UHP_HCPERIODICSTART) Register Mask  */
...
#define UHP_HCLSTHRESHOLD_LST_Msk           (_U(0x3FFF) << UHP_HCLSTHRESHOLD_LST_Pos)      /**< (UHP_HCLSTHRESHOLD) Low-speed threshold Mask */
#define UHP_HCLSTHRESHOLD_LST(value)        (UHP_HCLSTHRESHOLD_LST_Msk & ((value) << UHP_HCLSTHRESHOLD_LST_Pos))
#define UHP_HCLSTHRESHOLD_MASK              _U(0x3FFF)                                     /**< \deprecated (UHP_HCLSTHRESHOLD) Register MASK  (Use UHP_HCLSTHRESHOLD_Msk instead)  */
#define UHP_HCLSTHRESHOLD_Msk               _U(0x3FFF)                                     /**< (UHP_HCLSTHRESHOLD) Register Mask  */
...
#define UHP_HCRHDESCRIPTORA_NDP_Msk         (_U(0xFF) << UHP_HCRHDESCRIPTORA_NDP_Pos)      /**< (UHP_HCRHDESCRIPTORA) Number of downstream ports (read-only) Mask */
...
#define UHP_HCRHDESCRIPTORA_PSM_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORA_PSM_Pos)       /**< (UHP_HCRHDESCRIPTORA) Power switching mode (read/write) Mask */
...
#define UHP_HCRHDESCRIPTORA_NPS_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORA_NPS_Pos)       /**< (UHP_HCRHDESCRIPTORA) No power switching (read/write) Mask */
...
#define UHP_HCRHDESCRIPTORA_DT_Msk          (_U(0x1) << UHP_HCRHDESCRIPTORA_DT_Pos)        /**< (UHP_HCRHDESCRIPTORA) Device type (read-only) Mask */
...
#define UHP_HCRHDESCRIPTORA_OCPM_Msk        (_U(0x1) << UHP_HCRHDESCRIPTORA_OCPM_Pos)      /**< (UHP_HCRHDESCRIPTORA) Overcurrent protection mode (read/write) Mask */
...
#define UHP_HCRHDESCRIPTORA_NOCP_Msk        (_U(0x1) << UHP_HCRHDESCRIPTORA_NOCP_Pos)      /**< (UHP_HCRHDESCRIPTORA) No overcurrent protection (read/write) Mask */
...
#define UHP_HCRHDESCRIPTORA_POTPG_Msk       (_U(0xFF) << UHP_HCRHDESCRIPTORA_POTPG_Pos)    /**< (UHP_HCRHDESCRIPTORA) Power-on to power-good time (read/write) Mask */
#define UHP_HCRHDESCRIPTORA_POTPG(value)    (UHP_HCRHDESCRIPTORA_POTPG_Msk & ((value) << UHP_HCRHDESCRIPTORA_POTPG_Pos))
#define UHP_HCRHDESCRIPTORA_MASK            _U(0xFF001FFF)                                 /**< \deprecated (UHP_HCRHDESCRIPTORA) Register MASK  (Use UHP_HCRHDESCRIPTORA_Msk instead)  */
#define UHP_HCRHDESCRIPTORA_Msk             _U(0xFF001FFF)                                 /**< (UHP_HCRHDESCRIPTORA) Register Mask  */
...
#define UHP_HCRHDESCRIPTORB_DR0_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR0_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR1_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR1_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR2_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR2_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR3_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR3_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR4_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR4_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR5_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR5_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR6_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR6_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR7_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR7_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR8_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR8_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR9_Msk         (_U(0x1) << UHP_HCRHDESCRIPTORB_DR9_Pos)       /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR10_Msk        (_U(0x1) << UHP_HCRHDESCRIPTORB_DR10_Pos)      /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR11_Msk        (_U(0x1) << UHP_HCRHDESCRIPTORB_DR11_Pos)      /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR12_Msk        (_U(0x1) << UHP_HCRHDESCRIPTORB_DR12_Pos)      /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR13_Msk        (_U(0x1) << UHP_HCRHDESCRIPTORB_DR13_Pos)      /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR14_Msk        (_U(0x1) << UHP_HCRHDESCRIPTORB_DR14_Pos)      /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR15_Msk        (_U(0x1) << UHP_HCRHDESCRIPTORB_DR15_Pos)      /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM0_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM0_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM1_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM1_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM2_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM2_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM3_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM3_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM4_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM4_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM5_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM5_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM6_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM6_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM7_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM7_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM8_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM8_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM9_Msk       (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM9_Pos)     /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM10_Msk      (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM10_Pos)    /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM11_Msk      (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM11_Pos)    /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM12_Msk      (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM12_Pos)    /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM13_Msk      (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM13_Pos)    /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM14_Msk      (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM14_Pos)    /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_PPCM15_Msk      (_U(0x1) << UHP_HCRHDESCRIPTORB_PPCM15_Pos)    /**< (UHP_HCRHDESCRIPTORB)  Mask */
...
#define UHP_HCRHDESCRIPTORB_DR_Msk          (_U(0xFFFF) << UHP_HCRHDESCRIPTORB_DR_Pos)     /**< (UHP_HCRHDESCRIPTORB Mask) DR */
...
#define UHP_HCRHDESCRIPTORB_PPCM_Msk        (_U(0xFFFF) << UHP_HCRHDESCRIPTORB_PPCM_Pos)   /**< (UHP_HCRHDESCRIPTORB Mask) PPCM */
#define UHP_HCRHDESCRIPTORB_PPCM(value)     (UHP_HCRHDESCRIPTORB_PPCM_Msk & ((value) << UHP_HCRHDESCRIPTORB_PPCM_Pos))  
#define UHP_HCRHDESCRIPTORB_MASK            _U(0xFFFFFFFF)                                 /**< \deprecated (UHP_HCRHDESCRIPTORB) Register MASK  (Use UHP_HCRHDESCRIPTORB_Msk instead)  */
#define UHP_HCRHDESCRIPTORB_Msk             _U(0xFFFFFFFF)                                 /**< (UHP_HCRHDESCRIPTORB) Register Mask  */
...
#define UHP_HCRHSTATUS_LPS_Msk              (_U(0x1) << UHP_HCRHSTATUS_LPS_Pos)            /**< (UHP_HCRHSTATUS) Local power status (read/write) Mask */
...
#define UHP_HCRHSTATUS_OCI_Msk              (_U(0x1) << UHP_HCRHSTATUS_OCI_Pos)            /**< (UHP_HCRHSTATUS) Overcurrent indicator (read-only) Mask */
...
#define UHP_HCRHSTATUS_DRWE_Msk             (_U(0x1) << UHP_HCRHSTATUS_DRWE_Pos)           /**< (UHP_HCRHSTATUS) Device remote wake-up enable (read/write) Mask */
...
#define UHP_HCRHSTATUS_LPSC_Msk             (_U(0x1) << UHP_HCRHSTATUS_LPSC_Pos)           /**< (UHP_HCRHSTATUS) Local power status change (read/write) Mask */
...
#define UHP_HCRHSTATUS_OCIC_Msk             (_U(0x1) << UHP_HCRHSTATUS_OCIC_Pos)           /**< (UHP_HCRHSTATUS) Overcurrent indication change (read/write) Mask */
...
#define UHP_HCRHSTATUS_CRWE_Msk             (_U(0x1) << UHP_HCRHSTATUS_CRWE_Pos)           /**< (UHP_HCRHSTATUS) Clear remote wake-up enable (read/write) Mask */
...
#define UHP_HCRHSTATUS_MASK                 _U(0x80038003)                                 /**< \deprecated (UHP_HCRHSTATUS) Register MASK  (Use UHP_HCRHSTATUS_Msk instead)  */
#define UHP_HCRHSTATUS_Msk                  _U(0x80038003)                                 /**< (UHP_HCRHSTATUS) Register Mask  */
...
#define UHP_HCRHPORTSTATUS_CCS_CPE_Msk      (_U(0x1) << UHP_HCRHPORTSTATUS_CCS_CPE_Pos)    /**< (UHP_HCRHPORTSTATUS)  Mask */
...
#define UHP_HCRHPORTSTATUS_PES_SPE_Msk      (_U(0x1) << UHP_HCRHPORTSTATUS_PES_SPE_Pos)    /**< (UHP_HCRHPORTSTATUS)  Mask */
...
#define UHP_HCRHPORTSTATUS_PSS_SPS_Msk      (_U(0x1) << UHP_HCRHPORTSTATUS_PSS_SPS_Pos)    /**< (UHP_HCRHPORTSTATUS)  Mask */
...
#define UHP_HCRHPORTSTATUS_POCI_CSS_Msk     (_U(0x1) << UHP_HCRHPORTSTATUS_POCI_CSS_Pos)   /**< (UHP_HCRHPORTSTATUS)  Mask */
...
#define UHP_HCRHPORTSTATUS_PRS_SPR_Msk      (_U(0x1) << UHP_HCRHPORTSTATUS_PRS_SPR_Pos)    /**< (UHP_HCRHPORTSTATUS)  Mask */
...
#define UHP_HCRHPORTSTATUS_PPS_SPP_Msk      (_U(0x1) << UHP_HCRHPORTSTATUS_PPS_SPP_Pos)    /**< (UHP_HCRHPORTSTATUS)  Mask */
...
#define UHP_HCRHPORTSTATUS_LSDA_CPP_Msk     (_U(0x1) << UHP_HCRHPORTSTATUS_LSDA_CPP_Pos)   /**< (UHP_HCRHPORTSTATUS)  Mask */
...
#define UHP_HCRHPORTSTATUS_CSC_Msk          (_U(0x1) << UHP_HCRHPORTSTATUS_CSC_Pos)        /**< (UHP_HCRHPORTSTATUS) Port 1 connect status change (read/write, write '1' to clear) Mask */
...
#define UHP_HCRHPORTSTATUS_PESC_Msk         (_U(0x1) << UHP_HCRHPORTSTATUS_PESC_Pos)       /**< (UHP_HCRHPORTSTATUS) Port 1 enable status change (read/write, write '1' to clear) Mask */
...
#define UHP_HCRHPORTSTATUS_PSSC_Msk         (_U(0x1) << UHP_HCRHPORTSTATUS_PSSC_Pos)       /**< (UHP_HCRHPORTSTATUS) Port 1 suspend status change (read/write, write '1' to clear) Mask */
...
#define UHP_HCRHPORTSTATUS_OCIC_Msk         (_U(0x1) << UHP_HCRHPORTSTATUS_OCIC_Pos)       /**< (UHP_HCRHPORTSTATUS) Port 1 overcurrent indicator change (read/write) Mask */
...
#define UHP_HCRHPORTSTATUS_PRSC_Msk         (_U(0x1) << UHP_HCRHPORTSTATUS_PRSC_Pos)       /**< (UHP_HCRHPORTSTATUS) Port 1 reset status change (read/write, write '1' to clear) Mask */
...
#define UHP_HCRHPORTSTATUS_MASK             _U(0x1F031F)                                   /**< \deprecated (UHP_HCRHPORTSTATUS) Register MASK  (Use UHP_HCRHPORTSTATUS_Msk instead)  */
#define UHP_HCRHPORTSTATUS_Msk              _U(0x1F031F)                                   /**< (UHP_HCRHPORTSTATUS) Register Mask  */
