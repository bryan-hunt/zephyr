...
#define CRCCU_DSCR_DSCR_Msk                 (_U(0x7FFFFF) << CRCCU_DSCR_DSCR_Pos)          /**< (CRCCU_DSCR) Descriptor Base Address Mask */
#define CRCCU_DSCR_DSCR(value)              (CRCCU_DSCR_DSCR_Msk & ((value) << CRCCU_DSCR_DSCR_Pos))
#define CRCCU_DSCR_MASK                     _U(0xFFFFFE00)                                 /**< \deprecated (CRCCU_DSCR) Register MASK  (Use CRCCU_DSCR_Msk instead)  */
#define CRCCU_DSCR_Msk                      _U(0xFFFFFE00)                                 /**< (CRCCU_DSCR) Register Mask  */
...
#define CRCCU_DMA_EN_DMAEN_Msk              (_U(0x1) << CRCCU_DMA_EN_DMAEN_Pos)            /**< (CRCCU_DMA_EN) DMA Enable Mask */
...
#define CRCCU_DMA_EN_MASK                   _U(0x01)                                       /**< \deprecated (CRCCU_DMA_EN) Register MASK  (Use CRCCU_DMA_EN_Msk instead)  */
#define CRCCU_DMA_EN_Msk                    _U(0x01)                                       /**< (CRCCU_DMA_EN) Register Mask  */
...
#define CRCCU_DMA_DIS_DMADIS_Msk            (_U(0x1) << CRCCU_DMA_DIS_DMADIS_Pos)          /**< (CRCCU_DMA_DIS) DMA Disable Mask */
...
#define CRCCU_DMA_DIS_MASK                  _U(0x01)                                       /**< \deprecated (CRCCU_DMA_DIS) Register MASK  (Use CRCCU_DMA_DIS_Msk instead)  */
#define CRCCU_DMA_DIS_Msk                   _U(0x01)                                       /**< (CRCCU_DMA_DIS) Register Mask  */
...
#define CRCCU_DMA_SR_DMASR_Msk              (_U(0x1) << CRCCU_DMA_SR_DMASR_Pos)            /**< (CRCCU_DMA_SR) DMA Status Mask */
...
#define CRCCU_DMA_SR_MASK                   _U(0x01)                                       /**< \deprecated (CRCCU_DMA_SR) Register MASK  (Use CRCCU_DMA_SR_Msk instead)  */
#define CRCCU_DMA_SR_Msk                    _U(0x01)                                       /**< (CRCCU_DMA_SR) Register Mask  */
...
#define CRCCU_DMA_IER_DMAIER_Msk            (_U(0x1) << CRCCU_DMA_IER_DMAIER_Pos)          /**< (CRCCU_DMA_IER) Interrupt Enable Mask */
...
#define CRCCU_DMA_IER_MASK                  _U(0x01)                                       /**< \deprecated (CRCCU_DMA_IER) Register MASK  (Use CRCCU_DMA_IER_Msk instead)  */
#define CRCCU_DMA_IER_Msk                   _U(0x01)                                       /**< (CRCCU_DMA_IER) Register Mask  */
...
#define CRCCU_DMA_IDR_DMAIDR_Msk            (_U(0x1) << CRCCU_DMA_IDR_DMAIDR_Pos)          /**< (CRCCU_DMA_IDR) Interrupt Disable Mask */
...
#define CRCCU_DMA_IDR_MASK                  _U(0x01)                                       /**< \deprecated (CRCCU_DMA_IDR) Register MASK  (Use CRCCU_DMA_IDR_Msk instead)  */
#define CRCCU_DMA_IDR_Msk                   _U(0x01)                                       /**< (CRCCU_DMA_IDR) Register Mask  */
...
#define CRCCU_DMA_IMR_DMAIMR_Msk            (_U(0x1) << CRCCU_DMA_IMR_DMAIMR_Pos)          /**< (CRCCU_DMA_IMR) Interrupt Mask Mask */
...
#define CRCCU_DMA_IMR_MASK                  _U(0x01)                                       /**< \deprecated (CRCCU_DMA_IMR) Register MASK  (Use CRCCU_DMA_IMR_Msk instead)  */
#define CRCCU_DMA_IMR_Msk                   _U(0x01)                                       /**< (CRCCU_DMA_IMR) Register Mask  */
...
#define CRCCU_DMA_ISR_DMAISR_Msk            (_U(0x1) << CRCCU_DMA_ISR_DMAISR_Pos)          /**< (CRCCU_DMA_ISR) Interrupt Status Mask */
...
#define CRCCU_DMA_ISR_MASK                  _U(0x01)                                       /**< \deprecated (CRCCU_DMA_ISR) Register MASK  (Use CRCCU_DMA_ISR_Msk instead)  */
#define CRCCU_DMA_ISR_Msk                   _U(0x01)                                       /**< (CRCCU_DMA_ISR) Register Mask  */
...
#define CRCCU_CR_RESET_Msk                  (_U(0x1) << CRCCU_CR_RESET_Pos)                /**< (CRCCU_CR) CRC Computation Reset Mask */
...
#define CRCCU_CR_MASK                       _U(0x01)                                       /**< \deprecated (CRCCU_CR) Register MASK  (Use CRCCU_CR_Msk instead)  */
#define CRCCU_CR_Msk                        _U(0x01)                                       /**< (CRCCU_CR) Register Mask  */
...
#define CRCCU_MR_ENABLE_Msk                 (_U(0x1) << CRCCU_MR_ENABLE_Pos)               /**< (CRCCU_MR) CRC Enable Mask */
...
#define CRCCU_MR_COMPARE_Msk                (_U(0x1) << CRCCU_MR_COMPARE_Pos)              /**< (CRCCU_MR) CRC Compare Mask */
...
#define CRCCU_MR_PTYPE_Msk                  (_U(0x3) << CRCCU_MR_PTYPE_Pos)                /**< (CRCCU_MR) Primitive Polynomial Mask */
#define CRCCU_MR_PTYPE(value)               (CRCCU_MR_PTYPE_Msk & ((value) << CRCCU_MR_PTYPE_Pos))
#define   CRCCU_MR_PTYPE_CCITT8023_Val      _U(0x0)                                        /**< (CRCCU_MR) Polynom 0x04C11DB7  */
#define   CRCCU_MR_PTYPE_CASTAGNOLI_Val     _U(0x1)                                        /**< (CRCCU_MR) Polynom 0x1EDC6F41  */
#define   CRCCU_MR_PTYPE_CCITT16_Val        _U(0x2)                                        /**< (CRCCU_MR) Polynom 0x1021  */
...
#define CRCCU_MR_DIVIDER_Msk                (_U(0xF) << CRCCU_MR_DIVIDER_Pos)              /**< (CRCCU_MR) Request Divider Mask */
...
#define CRCCU_MR_BITORDER_Msk               (_U(0x1) << CRCCU_MR_BITORDER_Pos)             /**< (CRCCU_MR) Precomputation Bit Swap Operation of the CRC Mask */
...
#define   CRCCU_MR_BITORDER_MSBFIRST_Val    _U(0x0)                                        /**< (CRCCU_MR) CRC computation is performed from the most significant bit to the least significant bit  */
#define   CRCCU_MR_BITORDER_LSBFIRST_Val    _U(0x1)                                        /**< (CRCCU_MR) CRC computation is performed from the least significant bit to the most significant bit  */
...
#define CRCCU_MR_MASK                       _U(0x200FF)                                    /**< \deprecated (CRCCU_MR) Register MASK  (Use CRCCU_MR_Msk instead)  */
#define CRCCU_MR_Msk                        _U(0x200FF)                                    /**< (CRCCU_MR) Register Mask  */
...
#define CRCCU_SR_CRC_Msk                    (_U(0xFFFFFFFF) << CRCCU_SR_CRC_Pos)           /**< (CRCCU_SR) Cyclic Redundancy Check Value Mask */
#define CRCCU_SR_CRC(value)                 (CRCCU_SR_CRC_Msk & ((value) << CRCCU_SR_CRC_Pos))
#define CRCCU_SR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (CRCCU_SR) Register MASK  (Use CRCCU_SR_Msk instead)  */
#define CRCCU_SR_Msk                        _U(0xFFFFFFFF)                                 /**< (CRCCU_SR) Register Mask  */
...
#define CRCCU_IER_ERRIER_Msk                (_U(0x1) << CRCCU_IER_ERRIER_Pos)              /**< (CRCCU_IER) CRC Error Interrupt Enable Mask */
...
#define CRCCU_IER_MASK                      _U(0x01)                                       /**< \deprecated (CRCCU_IER) Register MASK  (Use CRCCU_IER_Msk instead)  */
#define CRCCU_IER_Msk                       _U(0x01)                                       /**< (CRCCU_IER) Register Mask  */
...
#define CRCCU_IDR_ERRIDR_Msk                (_U(0x1) << CRCCU_IDR_ERRIDR_Pos)              /**< (CRCCU_IDR) CRC Error Interrupt Disable Mask */
...
#define CRCCU_IDR_MASK                      _U(0x01)                                       /**< \deprecated (CRCCU_IDR) Register MASK  (Use CRCCU_IDR_Msk instead)  */
#define CRCCU_IDR_Msk                       _U(0x01)                                       /**< (CRCCU_IDR) Register Mask  */
...
#define CRCCU_IMR_ERRIMR_Msk                (_U(0x1) << CRCCU_IMR_ERRIMR_Pos)              /**< (CRCCU_IMR) CRC Error Interrupt Mask Mask */
...
#define CRCCU_IMR_MASK                      _U(0x01)                                       /**< \deprecated (CRCCU_IMR) Register MASK  (Use CRCCU_IMR_Msk instead)  */
#define CRCCU_IMR_Msk                       _U(0x01)                                       /**< (CRCCU_IMR) Register Mask  */
...
#define CRCCU_ISR_ERRISR_Msk                (_U(0x1) << CRCCU_ISR_ERRISR_Pos)              /**< (CRCCU_ISR) CRC Error Interrupt Status Mask */
...
#define CRCCU_ISR_MASK                      _U(0x01)                                       /**< \deprecated (CRCCU_ISR) Register MASK  (Use CRCCU_ISR_Msk instead)  */
#define CRCCU_ISR_Msk                       _U(0x01)                                       /**< (CRCCU_ISR) Register Mask  */
