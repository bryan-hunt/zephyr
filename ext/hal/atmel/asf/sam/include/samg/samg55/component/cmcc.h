...
#define CMCC_TYPE_AP_Msk                    (_U(0x1) << CMCC_TYPE_AP_Pos)                  /**< (CMCC_TYPE) Access Port Access Allowed Mask */
...
#define CMCC_TYPE_GCLK_Msk                  (_U(0x1) << CMCC_TYPE_GCLK_Pos)                /**< (CMCC_TYPE) Dynamic Clock Gating Supported Mask */
...
#define CMCC_TYPE_RANDP_Msk                 (_U(0x1) << CMCC_TYPE_RANDP_Pos)               /**< (CMCC_TYPE) Random Selection Policy Supported Mask */
...
#define CMCC_TYPE_LRUP_Msk                  (_U(0x1) << CMCC_TYPE_LRUP_Pos)                /**< (CMCC_TYPE) Least Recently Used Policy Supported Mask */
...
#define CMCC_TYPE_RRP_Msk                   (_U(0x1) << CMCC_TYPE_RRP_Pos)                 /**< (CMCC_TYPE) Random Selection Policy Supported Mask */
...
#define CMCC_TYPE_WAYNUM_Msk                (_U(0x3) << CMCC_TYPE_WAYNUM_Pos)              /**< (CMCC_TYPE) Number of Ways Mask */
#define CMCC_TYPE_WAYNUM(value)             (CMCC_TYPE_WAYNUM_Msk & ((value) << CMCC_TYPE_WAYNUM_Pos))
#define   CMCC_TYPE_WAYNUM_DMAPPED_Val      _U(0x0)                                        /**< (CMCC_TYPE) Direct Mapped Cache  */
#define   CMCC_TYPE_WAYNUM_ARCH2WAY_Val     _U(0x1)                                        /**< (CMCC_TYPE) 2-way set associative  */
#define   CMCC_TYPE_WAYNUM_ARCH4WAY_Val     _U(0x2)                                        /**< (CMCC_TYPE) 4-way set associative  */
#define   CMCC_TYPE_WAYNUM_ARCH8WAY_Val     _U(0x3)                                        /**< (CMCC_TYPE) 8-way set associative  */
...
#define CMCC_TYPE_LCKDOWN_Msk               (_U(0x1) << CMCC_TYPE_LCKDOWN_Pos)             /**< (CMCC_TYPE) Lockdown Supported Mask */
...
#define CMCC_TYPE_CSIZE_Msk                 (_U(0x7) << CMCC_TYPE_CSIZE_Pos)               /**< (CMCC_TYPE) Data Cache Size Mask */
#define CMCC_TYPE_CSIZE(value)              (CMCC_TYPE_CSIZE_Msk & ((value) << CMCC_TYPE_CSIZE_Pos))
#define   CMCC_TYPE_CSIZE_CSIZE_1KB_Val     _U(0x0)                                        /**< (CMCC_TYPE) Data cache size is 1 Kbyte  */
#define   CMCC_TYPE_CSIZE_CSIZE_2KB_Val     _U(0x1)                                        /**< (CMCC_TYPE) Data cache size is 2 Kbytes  */
#define   CMCC_TYPE_CSIZE_CSIZE_4KB_Val     _U(0x2)                                        /**< (CMCC_TYPE) Data cache size is 4 Kbytes  */
#define   CMCC_TYPE_CSIZE_CSIZE_8KB_Val     _U(0x3)                                        /**< (CMCC_TYPE) Data cache size is 8 Kbytes  */
...
#define CMCC_TYPE_CLSIZE_Msk                (_U(0x7) << CMCC_TYPE_CLSIZE_Pos)              /**< (CMCC_TYPE) Cache LIne Size Mask */
#define CMCC_TYPE_CLSIZE(value)             (CMCC_TYPE_CLSIZE_Msk & ((value) << CMCC_TYPE_CLSIZE_Pos))
#define   CMCC_TYPE_CLSIZE_CLSIZE_1KB_Val   _U(0x0)                                        /**< (CMCC_TYPE) Cache line size is 4 bytes  */
#define   CMCC_TYPE_CLSIZE_CLSIZE_2KB_Val   _U(0x1)                                        /**< (CMCC_TYPE) Cache line size is 8 bytes  */
#define   CMCC_TYPE_CLSIZE_CLSIZE_4KB_Val   _U(0x2)                                        /**< (CMCC_TYPE) Cache line size is 16 bytes  */
#define   CMCC_TYPE_CLSIZE_CLSIZE_8KB_Val   _U(0x3)                                        /**< (CMCC_TYPE) Cache line size is 32 bytes  */
...
#define CMCC_TYPE_MASK                      _U(0x3FFF)                                     /**< \deprecated (CMCC_TYPE) Register MASK  (Use CMCC_TYPE_Msk instead)  */
#define CMCC_TYPE_Msk                       _U(0x3FFF)                                     /**< (CMCC_TYPE) Register Mask  */
...
#define CMCC_CFG_GCLKDIS_Msk                (_U(0x1) << CMCC_CFG_GCLKDIS_Pos)              /**< (CMCC_CFG) Disable Clock Gating Mask */
...
#define CMCC_CFG_ICDIS_Msk                  (_U(0x1) << CMCC_CFG_ICDIS_Pos)                /**< (CMCC_CFG)  Mask */
...
#define CMCC_CFG_DCDIS_Msk                  (_U(0x1) << CMCC_CFG_DCDIS_Pos)                /**< (CMCC_CFG)  Mask */
...
#define CMCC_CFG_PRGCSIZE_Msk               (_U(0x7) << CMCC_CFG_PRGCSIZE_Pos)             /**< (CMCC_CFG)  Mask */
#define CMCC_CFG_PRGCSIZE(value)            (CMCC_CFG_PRGCSIZE_Msk & ((value) << CMCC_CFG_PRGCSIZE_Pos))
#define CMCC_CFG_MASK                       _U(0x77)                                       /**< \deprecated (CMCC_CFG) Register MASK  (Use CMCC_CFG_Msk instead)  */
#define CMCC_CFG_Msk                        _U(0x77)                                       /**< (CMCC_CFG) Register Mask  */
...
#define CMCC_CTRL_CEN_Msk                   (_U(0x1) << CMCC_CTRL_CEN_Pos)                 /**< (CMCC_CTRL) Cache Controller Enable Mask */
...
#define CMCC_CTRL_MASK                      _U(0x01)                                       /**< \deprecated (CMCC_CTRL) Register MASK  (Use CMCC_CTRL_Msk instead)  */
#define CMCC_CTRL_Msk                       _U(0x01)                                       /**< (CMCC_CTRL) Register Mask  */
...
#define CMCC_SR_CSTS_Msk                    (_U(0x1) << CMCC_SR_CSTS_Pos)                  /**< (CMCC_SR) Cache Controller Status Mask */
...
#define CMCC_SR_MASK                        _U(0x01)                                       /**< \deprecated (CMCC_SR) Register MASK  (Use CMCC_SR_Msk instead)  */
#define CMCC_SR_Msk                         _U(0x01)                                       /**< (CMCC_SR) Register Mask  */
...
#define CMCC_MAINT0_INVALL_Msk              (_U(0x1) << CMCC_MAINT0_INVALL_Pos)            /**< (CMCC_MAINT0) Cache Controller Invalidate All Mask */
...
#define CMCC_MAINT0_MASK                    _U(0x01)                                       /**< \deprecated (CMCC_MAINT0) Register MASK  (Use CMCC_MAINT0_Msk instead)  */
#define CMCC_MAINT0_Msk                     _U(0x01)                                       /**< (CMCC_MAINT0) Register Mask  */
...
#define CMCC_MAINT1_INDEX_Msk               (_U(0x1F) << CMCC_MAINT1_INDEX_Pos)            /**< (CMCC_MAINT1) Invalidate Index Mask */
...
#define CMCC_MAINT1_WAY_Msk                 (_U(0x3) << CMCC_MAINT1_WAY_Pos)               /**< (CMCC_MAINT1) Invalidate Way Mask */
#define CMCC_MAINT1_WAY(value)              (CMCC_MAINT1_WAY_Msk & ((value) << CMCC_MAINT1_WAY_Pos))
#define   CMCC_MAINT1_WAY_WAY0_Val          _U(0x0)                                        /**< (CMCC_MAINT1) Way 0 is selection for index invalidation  */
#define   CMCC_MAINT1_WAY_WAY1_Val          _U(0x1)                                        /**< (CMCC_MAINT1) Way 1 is selection for index invalidation  */
#define   CMCC_MAINT1_WAY_WAY2_Val          _U(0x2)                                        /**< (CMCC_MAINT1) Way 2 is selection for index invalidation  */
#define   CMCC_MAINT1_WAY_WAY3_Val          _U(0x3)                                        /**< (CMCC_MAINT1) Way 3 is selection for index invalidation  */
...
#define CMCC_MAINT1_MASK                    _U(0xC00001F0)                                 /**< \deprecated (CMCC_MAINT1) Register MASK  (Use CMCC_MAINT1_Msk instead)  */
#define CMCC_MAINT1_Msk                     _U(0xC00001F0)                                 /**< (CMCC_MAINT1) Register Mask  */
...
#define CMCC_MCFG_MODE_Msk                  (_U(0x3) << CMCC_MCFG_MODE_Pos)                /**< (CMCC_MCFG) Cache Controller Monitor Counter Mode Mask */
#define CMCC_MCFG_MODE(value)               (CMCC_MCFG_MODE_Msk & ((value) << CMCC_MCFG_MODE_Pos))
#define   CMCC_MCFG_MODE_CYCLE_COUNT_Val    _U(0x0)                                        /**< (CMCC_MCFG) Cycle counter  */
#define   CMCC_MCFG_MODE_IHIT_COUNT_Val     _U(0x1)                                        /**< (CMCC_MCFG) Instruction hit counter  */
#define   CMCC_MCFG_MODE_DHIT_COUNT_Val     _U(0x2)                                        /**< (CMCC_MCFG) Data hit counter  */
...
#define CMCC_MCFG_MASK                      _U(0x03)                                       /**< \deprecated (CMCC_MCFG) Register MASK  (Use CMCC_MCFG_Msk instead)  */
#define CMCC_MCFG_Msk                       _U(0x03)                                       /**< (CMCC_MCFG) Register Mask  */
...
#define CMCC_MEN_MENABLE_Msk                (_U(0x1) << CMCC_MEN_MENABLE_Pos)              /**< (CMCC_MEN) Cache Controller Monitor Enable Mask */
...
#define CMCC_MEN_MASK                       _U(0x01)                                       /**< \deprecated (CMCC_MEN) Register MASK  (Use CMCC_MEN_Msk instead)  */
#define CMCC_MEN_Msk                        _U(0x01)                                       /**< (CMCC_MEN) Register Mask  */
...
#define CMCC_MCTRL_SWRST_Msk                (_U(0x1) << CMCC_MCTRL_SWRST_Pos)              /**< (CMCC_MCTRL) Monitor Mask */
...
#define CMCC_MCTRL_MASK                     _U(0x01)                                       /**< \deprecated (CMCC_MCTRL) Register MASK  (Use CMCC_MCTRL_Msk instead)  */
#define CMCC_MCTRL_Msk                      _U(0x01)                                       /**< (CMCC_MCTRL) Register Mask  */
...
#define CMCC_MSR_EVENT_CNT_Msk              (_U(0xFFFFFFFF) << CMCC_MSR_EVENT_CNT_Pos)     /**< (CMCC_MSR) Monitor Event Counter Mask */
#define CMCC_MSR_EVENT_CNT(value)           (CMCC_MSR_EVENT_CNT_Msk & ((value) << CMCC_MSR_EVENT_CNT_Pos))
#define CMCC_MSR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (CMCC_MSR) Register MASK  (Use CMCC_MSR_Msk instead)  */
#define CMCC_MSR_Msk                        _U(0xFFFFFFFF)                                 /**< (CMCC_MSR) Register Mask  */
