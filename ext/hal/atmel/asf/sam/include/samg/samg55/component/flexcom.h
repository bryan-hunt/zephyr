...
#define FLEXCOM_MR_OPMODE_Msk               (_U(0x3) << FLEXCOM_MR_OPMODE_Pos)             /**< (FLEXCOM_MR) FLEXCOM Operating Mode Mask */
#define FLEXCOM_MR_OPMODE(value)            (FLEXCOM_MR_OPMODE_Msk & ((value) << FLEXCOM_MR_OPMODE_Pos))
#define   FLEXCOM_MR_OPMODE_NO_COM_Val      _U(0x0)                                        /**< (FLEXCOM_MR) No communication  */
#define   FLEXCOM_MR_OPMODE_USART_Val       _U(0x1)                                        /**< (FLEXCOM_MR) All related USART related protocols are selected (RS232, RS485, IrDA, ISO7816, LIN,)All SPI/TWI related registers are not accessible and have no impact on IOs.  */
#define   FLEXCOM_MR_OPMODE_SPI_Val         _U(0x2)                                        /**< (FLEXCOM_MR) SPI operating mode is selected.All USART/TWI related registers are not accessible and have no impact on IOs.  */
#define   FLEXCOM_MR_OPMODE_TWI_Val         _U(0x3)                                        /**< (FLEXCOM_MR) All related TWI protocols are selected (TWI, SMBUS). All USART/SPI related registers are not accessible and have no impact on IOs.  */
...
#define FLEXCOM_MR_MASK                     _U(0x03)                                       /**< \deprecated (FLEXCOM_MR) Register MASK  (Use FLEXCOM_MR_Msk instead)  */
#define FLEXCOM_MR_Msk                      _U(0x03)                                       /**< (FLEXCOM_MR) Register Mask  */
...
#define FLEXCOM_RHR_RXDATA_Msk              (_U(0xFFFF) << FLEXCOM_RHR_RXDATA_Pos)         /**< (FLEXCOM_RHR) Receive Data Mask */
#define FLEXCOM_RHR_RXDATA(value)           (FLEXCOM_RHR_RXDATA_Msk & ((value) << FLEXCOM_RHR_RXDATA_Pos))
#define FLEXCOM_RHR_MASK                    _U(0xFFFF)                                     /**< \deprecated (FLEXCOM_RHR) Register MASK  (Use FLEXCOM_RHR_Msk instead)  */
#define FLEXCOM_RHR_Msk                     _U(0xFFFF)                                     /**< (FLEXCOM_RHR) Register Mask  */
...
#define FLEXCOM_THR_TXDATA_Msk              (_U(0xFFFF) << FLEXCOM_THR_TXDATA_Pos)         /**< (FLEXCOM_THR) Transmit Data Mask */
#define FLEXCOM_THR_TXDATA(value)           (FLEXCOM_THR_TXDATA_Msk & ((value) << FLEXCOM_THR_TXDATA_Pos))
#define FLEXCOM_THR_MASK                    _U(0xFFFF)                                     /**< \deprecated (FLEXCOM_THR) Register MASK  (Use FLEXCOM_THR_Msk instead)  */
#define FLEXCOM_THR_Msk                     _U(0xFFFF)                                     /**< (FLEXCOM_THR) Register Mask  */
