...
#define PDC_PERIPH_RPR_RXPTR_Msk            (_U(0xFFFFFFFF) << PDC_PERIPH_RPR_RXPTR_Pos)   /**< (PDC_PERIPH_RPR) Receive Pointer Register Mask */
#define PDC_PERIPH_RPR_RXPTR(value)         (PDC_PERIPH_RPR_RXPTR_Msk & ((value) << PDC_PERIPH_RPR_RXPTR_Pos))
#define PDC_PERIPH_RPR_MASK                 _U(0xFFFFFFFF)                                 /**< \deprecated (PDC_PERIPH_RPR) Register MASK  (Use PDC_PERIPH_RPR_Msk instead)  */
#define PDC_PERIPH_RPR_Msk                  _U(0xFFFFFFFF)                                 /**< (PDC_PERIPH_RPR) Register Mask  */
...
#define PDC_PERIPH_RCR_RXCTR_Msk            (_U(0xFFFF) << PDC_PERIPH_RCR_RXCTR_Pos)       /**< (PDC_PERIPH_RCR) Receive Counter Register Mask */
#define PDC_PERIPH_RCR_RXCTR(value)         (PDC_PERIPH_RCR_RXCTR_Msk & ((value) << PDC_PERIPH_RCR_RXCTR_Pos))
#define PDC_PERIPH_RCR_MASK                 _U(0xFFFF)                                     /**< \deprecated (PDC_PERIPH_RCR) Register MASK  (Use PDC_PERIPH_RCR_Msk instead)  */
#define PDC_PERIPH_RCR_Msk                  _U(0xFFFF)                                     /**< (PDC_PERIPH_RCR) Register Mask  */
...
#define PDC_PERIPH_TPR_TXPTR_Msk            (_U(0xFFFFFFFF) << PDC_PERIPH_TPR_TXPTR_Pos)   /**< (PDC_PERIPH_TPR) Transmit Counter Register Mask */
#define PDC_PERIPH_TPR_TXPTR(value)         (PDC_PERIPH_TPR_TXPTR_Msk & ((value) << PDC_PERIPH_TPR_TXPTR_Pos))
#define PDC_PERIPH_TPR_MASK                 _U(0xFFFFFFFF)                                 /**< \deprecated (PDC_PERIPH_TPR) Register MASK  (Use PDC_PERIPH_TPR_Msk instead)  */
#define PDC_PERIPH_TPR_Msk                  _U(0xFFFFFFFF)                                 /**< (PDC_PERIPH_TPR) Register Mask  */
...
#define PDC_PERIPH_TCR_TXCTR_Msk            (_U(0xFFFF) << PDC_PERIPH_TCR_TXCTR_Pos)       /**< (PDC_PERIPH_TCR) Transmit Counter Register Mask */
#define PDC_PERIPH_TCR_TXCTR(value)         (PDC_PERIPH_TCR_TXCTR_Msk & ((value) << PDC_PERIPH_TCR_TXCTR_Pos))
#define PDC_PERIPH_TCR_MASK                 _U(0xFFFF)                                     /**< \deprecated (PDC_PERIPH_TCR) Register MASK  (Use PDC_PERIPH_TCR_Msk instead)  */
#define PDC_PERIPH_TCR_Msk                  _U(0xFFFF)                                     /**< (PDC_PERIPH_TCR) Register Mask  */
...
#define PDC_PERIPH_RNPR_RXNPTR_Msk          (_U(0xFFFFFFFF) << PDC_PERIPH_RNPR_RXNPTR_Pos)  /**< (PDC_PERIPH_RNPR) Receive Next Pointer Mask */
#define PDC_PERIPH_RNPR_RXNPTR(value)       (PDC_PERIPH_RNPR_RXNPTR_Msk & ((value) << PDC_PERIPH_RNPR_RXNPTR_Pos))
#define PDC_PERIPH_RNPR_MASK                _U(0xFFFFFFFF)                                 /**< \deprecated (PDC_PERIPH_RNPR) Register MASK  (Use PDC_PERIPH_RNPR_Msk instead)  */
#define PDC_PERIPH_RNPR_Msk                 _U(0xFFFFFFFF)                                 /**< (PDC_PERIPH_RNPR) Register Mask  */
...
#define PDC_PERIPH_RNCR_RXNCTR_Msk          (_U(0xFFFF) << PDC_PERIPH_RNCR_RXNCTR_Pos)     /**< (PDC_PERIPH_RNCR) Receive Next Counter Mask */
#define PDC_PERIPH_RNCR_RXNCTR(value)       (PDC_PERIPH_RNCR_RXNCTR_Msk & ((value) << PDC_PERIPH_RNCR_RXNCTR_Pos))
#define PDC_PERIPH_RNCR_MASK                _U(0xFFFF)                                     /**< \deprecated (PDC_PERIPH_RNCR) Register MASK  (Use PDC_PERIPH_RNCR_Msk instead)  */
#define PDC_PERIPH_RNCR_Msk                 _U(0xFFFF)                                     /**< (PDC_PERIPH_RNCR) Register Mask  */
...
#define PDC_PERIPH_TNPR_TXNPTR_Msk          (_U(0xFFFFFFFF) << PDC_PERIPH_TNPR_TXNPTR_Pos)  /**< (PDC_PERIPH_TNPR) Transmit Next Pointer Mask */
#define PDC_PERIPH_TNPR_TXNPTR(value)       (PDC_PERIPH_TNPR_TXNPTR_Msk & ((value) << PDC_PERIPH_TNPR_TXNPTR_Pos))
#define PDC_PERIPH_TNPR_MASK                _U(0xFFFFFFFF)                                 /**< \deprecated (PDC_PERIPH_TNPR) Register MASK  (Use PDC_PERIPH_TNPR_Msk instead)  */
#define PDC_PERIPH_TNPR_Msk                 _U(0xFFFFFFFF)                                 /**< (PDC_PERIPH_TNPR) Register Mask  */
...
#define PDC_PERIPH_TNCR_TXNCTR_Msk          (_U(0xFFFF) << PDC_PERIPH_TNCR_TXNCTR_Pos)     /**< (PDC_PERIPH_TNCR) Transmit Counter Next Mask */
#define PDC_PERIPH_TNCR_TXNCTR(value)       (PDC_PERIPH_TNCR_TXNCTR_Msk & ((value) << PDC_PERIPH_TNCR_TXNCTR_Pos))
#define PDC_PERIPH_TNCR_MASK                _U(0xFFFF)                                     /**< \deprecated (PDC_PERIPH_TNCR) Register MASK  (Use PDC_PERIPH_TNCR_Msk instead)  */
#define PDC_PERIPH_TNCR_Msk                 _U(0xFFFF)                                     /**< (PDC_PERIPH_TNCR) Register Mask  */
...
#define PDC_PERIPH_PTCR_RXTEN_Msk           (_U(0x1) << PDC_PERIPH_PTCR_RXTEN_Pos)         /**< (PDC_PERIPH_PTCR) Receiver Transfer Enable Mask */
...
#define PDC_PERIPH_PTCR_RXTDIS_Msk          (_U(0x1) << PDC_PERIPH_PTCR_RXTDIS_Pos)        /**< (PDC_PERIPH_PTCR) Receiver Transfer Disable Mask */
...
#define PDC_PERIPH_PTCR_TXTEN_Msk           (_U(0x1) << PDC_PERIPH_PTCR_TXTEN_Pos)         /**< (PDC_PERIPH_PTCR) Transmitter Transfer Enable Mask */
...
#define PDC_PERIPH_PTCR_TXTDIS_Msk          (_U(0x1) << PDC_PERIPH_PTCR_TXTDIS_Pos)        /**< (PDC_PERIPH_PTCR) Transmitter Transfer Disable Mask */
...
#define PDC_PERIPH_PTCR_RXCBEN_Msk          (_U(0x1) << PDC_PERIPH_PTCR_RXCBEN_Pos)        /**< (PDC_PERIPH_PTCR) Receiver Circular Buffer Enable Mask */
...
#define PDC_PERIPH_PTCR_RXCBDIS_Msk         (_U(0x1) << PDC_PERIPH_PTCR_RXCBDIS_Pos)       /**< (PDC_PERIPH_PTCR) Receiver Circular Buffer Disable Mask */
...
#define PDC_PERIPH_PTCR_TXCBEN_Msk          (_U(0x1) << PDC_PERIPH_PTCR_TXCBEN_Pos)        /**< (PDC_PERIPH_PTCR) Transmitter Circular Buffer Enable Mask */
...
#define PDC_PERIPH_PTCR_TXCBDIS_Msk         (_U(0x1) << PDC_PERIPH_PTCR_TXCBDIS_Pos)       /**< (PDC_PERIPH_PTCR) Transmitter Circular Buffer Disable Mask */
...
#define PDC_PERIPH_PTCR_ERRCLR_Msk          (_U(0x1) << PDC_PERIPH_PTCR_ERRCLR_Pos)        /**< (PDC_PERIPH_PTCR) Transfer Bus Error Clear Mask */
...
#define PDC_PERIPH_PTCR_MASK                _U(0x10F0303)                                  /**< \deprecated (PDC_PERIPH_PTCR) Register MASK  (Use PDC_PERIPH_PTCR_Msk instead)  */
#define PDC_PERIPH_PTCR_Msk                 _U(0x10F0303)                                  /**< (PDC_PERIPH_PTCR) Register Mask  */
...
#define PDC_PERIPH_PTSR_RXTEN_Msk           (_U(0x1) << PDC_PERIPH_PTSR_RXTEN_Pos)         /**< (PDC_PERIPH_PTSR) Receiver Transfer Enable Mask */
...
#define PDC_PERIPH_PTSR_TXTEN_Msk           (_U(0x1) << PDC_PERIPH_PTSR_TXTEN_Pos)         /**< (PDC_PERIPH_PTSR) Transmitter Transfer Enable Mask */
...
#define PDC_PERIPH_PTSR_RXCBEN_Msk          (_U(0x1) << PDC_PERIPH_PTSR_RXCBEN_Pos)        /**< (PDC_PERIPH_PTSR) Receiver Circular Buffer Enable Mask */
...
#define PDC_PERIPH_PTSR_TXCBEN_Msk          (_U(0x1) << PDC_PERIPH_PTSR_TXCBEN_Pos)        /**< (PDC_PERIPH_PTSR) Transmitter Circular Buffer Enable Mask */
...
#define PDC_PERIPH_PTSR_ERR_Msk             (_U(0x1) << PDC_PERIPH_PTSR_ERR_Pos)           /**< (PDC_PERIPH_PTSR) Transfer Bus Error Mask */
...
#define PDC_PERIPH_PTSR_MASK                _U(0x1050101)                                  /**< \deprecated (PDC_PERIPH_PTSR) Register MASK  (Use PDC_PERIPH_PTSR_Msk instead)  */
#define PDC_PERIPH_PTSR_Msk                 _U(0x1050101)                                  /**< (PDC_PERIPH_PTSR) Register Mask  */
