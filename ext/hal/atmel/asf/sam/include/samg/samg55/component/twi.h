...
/* -------- TWI_CR : (TWI Offset: 0x00) (/W 32) TWI Control Register -------- */
...
#define TWI_CR_OFFSET                       (0x00)                                        /**<  (TWI_CR) TWI Control Register  Offset */

#define TWI_CR_START_Pos                    0                                              /**< (TWI_CR) Send a START Condition Position */
#define TWI_CR_START_Msk                    (_U(0x1) << TWI_CR_START_Pos)                  /**< (TWI_CR) Send a START Condition Mask */
...
#define TWI_CR_STOP_Msk                     (_U(0x1) << TWI_CR_STOP_Pos)                   /**< (TWI_CR) Send a STOP Condition Mask */
...
#define TWI_CR_MSEN_Msk                     (_U(0x1) << TWI_CR_MSEN_Pos)                   /**< (TWI_CR) TWI Master Mode Enabled Mask */
...
#define TWI_CR_MSDIS_Msk                    (_U(0x1) << TWI_CR_MSDIS_Pos)                  /**< (TWI_CR) TWI Master Mode Disabled Mask */
...
#define TWI_CR_SVEN_Msk                     (_U(0x1) << TWI_CR_SVEN_Pos)                   /**< (TWI_CR) TWI Slave Mode Enabled Mask */
...
#define TWI_CR_SVDIS_Msk                    (_U(0x1) << TWI_CR_SVDIS_Pos)                  /**< (TWI_CR) TWI Slave Mode Disabled Mask */
...
#define TWI_CR_QUICK_Msk                    (_U(0x1) << TWI_CR_QUICK_Pos)                  /**< (TWI_CR) SMBUS Quick Command Mask */
...
#define TWI_CR_SWRST_Msk                    (_U(0x1) << TWI_CR_SWRST_Pos)                  /**< (TWI_CR) Software Reset Mask */
...
#define TWI_CR_HSEN_Msk                     (_U(0x1) << TWI_CR_HSEN_Pos)                   /**< (TWI_CR) TWI High-Speed Mode Enabled Mask */
...
#define TWI_CR_HSDIS_Msk                    (_U(0x1) << TWI_CR_HSDIS_Pos)                  /**< (TWI_CR) TWI High-Speed Mode Disabled Mask */
...
#define TWI_CR_SMBEN_Msk                    (_U(0x1) << TWI_CR_SMBEN_Pos)                  /**< (TWI_CR) SMBus Mode Enabled Mask */
...
#define TWI_CR_SMBDIS_Msk                   (_U(0x1) << TWI_CR_SMBDIS_Pos)                 /**< (TWI_CR) SMBus Mode Disabled Mask */
...
#define TWI_CR_PECEN_Msk                    (_U(0x1) << TWI_CR_PECEN_Pos)                  /**< (TWI_CR) Packet Error Checking Enable Mask */
...
#define TWI_CR_PECDIS_Msk                   (_U(0x1) << TWI_CR_PECDIS_Pos)                 /**< (TWI_CR) Packet Error Checking Disable Mask */
...
#define TWI_CR_PECRQ_Msk                    (_U(0x1) << TWI_CR_PECRQ_Pos)                  /**< (TWI_CR) PEC Request Mask */
...
#define TWI_CR_CLEAR_Msk                    (_U(0x1) << TWI_CR_CLEAR_Pos)                  /**< (TWI_CR) Bus CLEAR Command Mask */
...
#define TWI_CR_ACMEN_Msk                    (_U(0x1) << TWI_CR_ACMEN_Pos)                  /**< (TWI_CR) Alternative Command Mode Enable Mask */
...
#define TWI_CR_ACMDIS_Msk                   (_U(0x1) << TWI_CR_ACMDIS_Pos)                 /**< (TWI_CR) Alternative Command Mode Disable Mask */
...
#define TWI_CR_THRCLR_Msk                   (_U(0x1) << TWI_CR_THRCLR_Pos)                 /**< (TWI_CR) Transmit Holding Register Clear Mask */
...
#define TWI_CR_LOCKCLR_Msk                  (_U(0x1) << TWI_CR_LOCKCLR_Pos)                /**< (TWI_CR) Lock Clear Mask */
...
#define TWI_CR_MASK                         _U(0x503FFFF)                                  /**< \deprecated (TWI_CR) Register MASK  (Use TWI_CR_Msk instead)  */
#define TWI_CR_Msk                          _U(0x503FFFF)                                  /**< (TWI_CR) Register Mask  */

/* -------- TWI_MMR : (TWI Offset: 0x04) (R/W 32) TWI Master Mode Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_MMR_OFFSET                      (0x04)                                        /**<  (TWI_MMR) TWI Master Mode Register  Offset */

#define TWI_MMR_IADRSZ_Pos                  8                                              /**< (TWI_MMR) Internal Device Address Size Position */
#define TWI_MMR_IADRSZ_Msk                  (_U(0x3) << TWI_MMR_IADRSZ_Pos)                /**< (TWI_MMR) Internal Device Address Size Mask */
#define TWI_MMR_IADRSZ(value)               (TWI_MMR_IADRSZ_Msk & ((value) << TWI_MMR_IADRSZ_Pos))
#define   TWI_MMR_IADRSZ_NONE_Val           _U(0x0)                                        /**< (TWI_MMR) No internal device address  */
#define   TWI_MMR_IADRSZ_1_BYTE_Val         _U(0x1)                                        /**< (TWI_MMR) One-byte internal device address  */
#define   TWI_MMR_IADRSZ_2_BYTE_Val         _U(0x2)                                        /**< (TWI_MMR) Two-byte internal device address  */
#define   TWI_MMR_IADRSZ_3_BYTE_Val         _U(0x3)                                        /**< (TWI_MMR) Three-byte internal device address  */
...
#define TWI_MMR_MREAD_Msk                   (_U(0x1) << TWI_MMR_MREAD_Pos)                 /**< (TWI_MMR) Master Read Direction Mask */
...
#define TWI_MMR_DADR_Msk                    (_U(0x7F) << TWI_MMR_DADR_Pos)                 /**< (TWI_MMR) Device Address Mask */
#define TWI_MMR_DADR(value)                 (TWI_MMR_DADR_Msk & ((value) << TWI_MMR_DADR_Pos))
#define TWI_MMR_MASK                        _U(0x7F1300)                                   /**< \deprecated (TWI_MMR) Register MASK  (Use TWI_MMR_Msk instead)  */
#define TWI_MMR_Msk                         _U(0x7F1300)                                   /**< (TWI_MMR) Register Mask  */

/* -------- TWI_SMR : (TWI Offset: 0x08) (R/W 32) TWI Slave Mode Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_SMR_OFFSET                      (0x08)                                        /**<  (TWI_SMR) TWI Slave Mode Register  Offset */

#define TWI_SMR_NACKEN_Pos                  0                                              /**< (TWI_SMR) Slave Receiver Data Phase NACK Enable Position */
#define TWI_SMR_NACKEN_Msk                  (_U(0x1) << TWI_SMR_NACKEN_Pos)                /**< (TWI_SMR) Slave Receiver Data Phase NACK Enable Mask */
...
#define TWI_SMR_SMDA_Msk                    (_U(0x1) << TWI_SMR_SMDA_Pos)                  /**< (TWI_SMR) SMBus Default Address Mask */
...
#define TWI_SMR_SMHH_Msk                    (_U(0x1) << TWI_SMR_SMHH_Pos)                  /**< (TWI_SMR) SMBus Host Header Mask */
...
#define TWI_SMR_SCLWSDIS_Msk                (_U(0x1) << TWI_SMR_SCLWSDIS_Pos)              /**< (TWI_SMR) Clock Wait State Disable Mask */
...
#define TWI_SMR_MASK_Msk                    (_U(0x7F) << TWI_SMR_MASK_Pos)                 /**< (TWI_SMR) Slave Address Mask Mask */
...
#define TWI_SMR_SADR_Msk                    (_U(0x7F) << TWI_SMR_SADR_Pos)                 /**< (TWI_SMR) Slave Address Mask */
...
#define TWI_SMR_SADR1EN_Msk                 (_U(0x1) << TWI_SMR_SADR1EN_Pos)               /**< (TWI_SMR) Slave Address 1 Enable Mask */
...
#define TWI_SMR_SADR2EN_Msk                 (_U(0x1) << TWI_SMR_SADR2EN_Pos)               /**< (TWI_SMR) Slave Address 2 Enable Mask */
...
#define TWI_SMR_SADR3EN_Msk                 (_U(0x1) << TWI_SMR_SADR3EN_Pos)               /**< (TWI_SMR) Slave Address 3 Enable Mask */
...
#define TWI_SMR_DATAMEN_Msk                 (_U(0x1) << TWI_SMR_DATAMEN_Pos)               /**< (TWI_SMR) Data Matching Enable Mask */
...
#define TWI_SMR_Msk                         _U(0xF07F7F4D)                                 /**< (TWI_SMR) Register Mask  */

/* -------- TWI_IADR : (TWI Offset: 0x0c) (R/W 32) TWI Internal Address Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_IADR_OFFSET                     (0x0C)                                        /**<  (TWI_IADR) TWI Internal Address Register  Offset */

#define TWI_IADR_IADR_Pos                   0                                              /**< (TWI_IADR) Internal Address Position */
#define TWI_IADR_IADR_Msk                   (_U(0xFFFFFF) << TWI_IADR_IADR_Pos)            /**< (TWI_IADR) Internal Address Mask */
#define TWI_IADR_IADR(value)                (TWI_IADR_IADR_Msk & ((value) << TWI_IADR_IADR_Pos))
#define TWI_IADR_MASK                       _U(0xFFFFFF)                                   /**< \deprecated (TWI_IADR) Register MASK  (Use TWI_IADR_Msk instead)  */
#define TWI_IADR_Msk                        _U(0xFFFFFF)                                   /**< (TWI_IADR) Register Mask  */

/* -------- TWI_CWGR : (TWI Offset: 0x10) (R/W 32) TWI Clock Waveform Generator Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_CWGR_OFFSET                     (0x10)                                        /**<  (TWI_CWGR) TWI Clock Waveform Generator Register  Offset */

#define TWI_CWGR_CLDIV_Pos                  0                                              /**< (TWI_CWGR) Clock Low Divider Position */
#define TWI_CWGR_CLDIV_Msk                  (_U(0xFF) << TWI_CWGR_CLDIV_Pos)               /**< (TWI_CWGR) Clock Low Divider Mask */
...
#define TWI_CWGR_CHDIV_Msk                  (_U(0xFF) << TWI_CWGR_CHDIV_Pos)               /**< (TWI_CWGR) Clock High Divider Mask */
...
#define TWI_CWGR_CKDIV_Msk                  (_U(0x7) << TWI_CWGR_CKDIV_Pos)                /**< (TWI_CWGR) Clock Divider Mask */
...
#define TWI_CWGR_BRSRCCLK_Msk               (_U(0x1) << TWI_CWGR_BRSRCCLK_Pos)             /**< (TWI_CWGR) Bit Rate Source Clock Mask */
...
#define TWI_CWGR_HOLD_Msk                   (_U(0x1F) << TWI_CWGR_HOLD_Pos)                /**< (TWI_CWGR) TWD Hold Time Versus TWCK Falling Mask */
#define TWI_CWGR_HOLD(value)                (TWI_CWGR_HOLD_Msk & ((value) << TWI_CWGR_HOLD_Pos))
#define TWI_CWGR_MASK                       _U(0x1F17FFFF)                                 /**< \deprecated (TWI_CWGR) Register MASK  (Use TWI_CWGR_Msk instead)  */
#define TWI_CWGR_Msk                        _U(0x1F17FFFF)                                 /**< (TWI_CWGR) Register Mask  */

/* -------- TWI_SR : (TWI Offset: 0x20) (R/ 32) TWI Status Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_SR_OFFSET                       (0x20)                                        /**<  (TWI_SR) TWI Status Register  Offset */

#define TWI_SR_TXCOMP_Pos                   0                                              /**< (TWI_SR) Transmission Completed (cleared by writing TWI_THR) Position */
#define TWI_SR_TXCOMP_Msk                   (_U(0x1) << TWI_SR_TXCOMP_Pos)                 /**< (TWI_SR) Transmission Completed (cleared by writing TWI_THR) Mask */
...
#define TWI_SR_RXRDY_Msk                    (_U(0x1) << TWI_SR_RXRDY_Pos)                  /**< (TWI_SR) Receive Holding Register Ready (cleared when reading TWI_RHR) Mask */
...
#define TWI_SR_TXRDY_Msk                    (_U(0x1) << TWI_SR_TXRDY_Pos)                  /**< (TWI_SR) Transmit Holding Register Ready (cleared by writing TWI_THR) Mask */
...
#define TWI_SR_SVREAD_Msk                   (_U(0x1) << TWI_SR_SVREAD_Pos)                 /**< (TWI_SR) Slave Read Mask */
...
#define TWI_SR_SVACC_Msk                    (_U(0x1) << TWI_SR_SVACC_Pos)                  /**< (TWI_SR) Slave Access Mask */
...
#define TWI_SR_GACC_Msk                     (_U(0x1) << TWI_SR_GACC_Pos)                   /**< (TWI_SR) General Call Access (cleared on read) Mask */
...
#define TWI_SR_OVRE_Msk                     (_U(0x1) << TWI_SR_OVRE_Pos)                   /**< (TWI_SR) Overrun Error (cleared on read) Mask */
...
#define TWI_SR_UNRE_Msk                     (_U(0x1) << TWI_SR_UNRE_Pos)                   /**< (TWI_SR) Underrun Error (cleared on read) Mask */
...
#define TWI_SR_NACK_Msk                     (_U(0x1) << TWI_SR_NACK_Pos)                   /**< (TWI_SR) Not Acknowledged (cleared on read) Mask */
...
#define TWI_SR_ARBLST_Msk                   (_U(0x1) << TWI_SR_ARBLST_Pos)                 /**< (TWI_SR) Arbitration Lost (cleared on read) Mask */
...
#define TWI_SR_SCLWS_Msk                    (_U(0x1) << TWI_SR_SCLWS_Pos)                  /**< (TWI_SR) Clock Wait State Mask */
...
#define TWI_SR_EOSACC_Msk                   (_U(0x1) << TWI_SR_EOSACC_Pos)                 /**< (TWI_SR) End Of Slave Access (cleared on read) Mask */
...
#define TWI_SR_ENDRX_Msk                    (_U(0x1) << TWI_SR_ENDRX_Pos)                  /**< (TWI_SR) End of RX Buffer (cleared by writing TWI_RCR or TWI_RNCR) Mask */
...
#define TWI_SR_ENDTX_Msk                    (_U(0x1) << TWI_SR_ENDTX_Pos)                  /**< (TWI_SR) End of TX Buffer (cleared by writing TWI_TCR or TWI_TNCR) Mask */
...
#define TWI_SR_RXBUFF_Msk                   (_U(0x1) << TWI_SR_RXBUFF_Pos)                 /**< (TWI_SR) RX Buffer Full (cleared by writing TWI_RCR or TWI_RNCR) Mask */
...
#define TWI_SR_TXBUFE_Msk                   (_U(0x1) << TWI_SR_TXBUFE_Pos)                 /**< (TWI_SR) TX Buffer Empty (cleared by writing TWI_TCR or TWI_TNCR) Mask */
...
#define TWI_SR_MCACK_Msk                    (_U(0x1) << TWI_SR_MCACK_Pos)                  /**< (TWI_SR) Master Code Acknowledge (cleared on read) Mask */
...
#define TWI_SR_TOUT_Msk                     (_U(0x1) << TWI_SR_TOUT_Pos)                   /**< (TWI_SR) Timeout Error (cleared on read) Mask */
...
#define TWI_SR_PECERR_Msk                   (_U(0x1) << TWI_SR_PECERR_Pos)                 /**< (TWI_SR) PEC Error (cleared on read) Mask */
...
#define TWI_SR_SMBDAM_Msk                   (_U(0x1) << TWI_SR_SMBDAM_Pos)                 /**< (TWI_SR) SMBus Default Address Match (cleared on read) Mask */
...
#define TWI_SR_SMBHHM_Msk                   (_U(0x1) << TWI_SR_SMBHHM_Pos)                 /**< (TWI_SR) SMBus Host Header Address Match (cleared on read) Mask */
...
#define TWI_SR_LOCK_Msk                     (_U(0x1) << TWI_SR_LOCK_Pos)                   /**< (TWI_SR) TWI Lock due to Frame Errors Mask */
...
#define TWI_SR_SCL_Msk                      (_U(0x1) << TWI_SR_SCL_Pos)                    /**< (TWI_SR) SCL line value Mask */
...
#define TWI_SR_SDA_Msk                      (_U(0x1) << TWI_SR_SDA_Pos)                    /**< (TWI_SR) SDA line value Mask */
#define TWI_SR_SDA                          TWI_SR_SDA_Msk                                 /**< \deprecated Old style mask definition for 1 bit bitfield. Use TWI_SR_SDA_Msk instead */
#define TWI_SR_MASK                         _U(0x3BDFFFF)                                  /**< \deprecated (TWI_SR) Register MASK  (Use TWI_SR_Msk instead)  */
#define TWI_SR_Msk                          _U(0x3BDFFFF)                                  /**< (TWI_SR) Register Mask  */

/* -------- TWI_IER : (TWI Offset: 0x24) (/W 32) TWI Interrupt Enable Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_IER_OFFSET                      (0x24)                                        /**<  (TWI_IER) TWI Interrupt Enable Register  Offset */

#define TWI_IER_TXCOMP_Pos                  0                                              /**< (TWI_IER) Transmission Completed Interrupt Enable Position */
#define TWI_IER_TXCOMP_Msk                  (_U(0x1) << TWI_IER_TXCOMP_Pos)                /**< (TWI_IER) Transmission Completed Interrupt Enable Mask */
...
#define TWI_IER_RXRDY_Msk                   (_U(0x1) << TWI_IER_RXRDY_Pos)                 /**< (TWI_IER) Receive Holding Register Ready Interrupt Enable Mask */
...
#define TWI_IER_TXRDY_Msk                   (_U(0x1) << TWI_IER_TXRDY_Pos)                 /**< (TWI_IER) Transmit Holding Register Ready Interrupt Enable Mask */
...
#define TWI_IER_SVACC_Msk                   (_U(0x1) << TWI_IER_SVACC_Pos)                 /**< (TWI_IER) Slave Access Interrupt Enable Mask */
...
#define TWI_IER_GACC_Msk                    (_U(0x1) << TWI_IER_GACC_Pos)                  /**< (TWI_IER) General Call Access Interrupt Enable Mask */
...
#define TWI_IER_OVRE_Msk                    (_U(0x1) << TWI_IER_OVRE_Pos)                  /**< (TWI_IER) Overrun Error Interrupt Enable Mask */
...
#define TWI_IER_UNRE_Msk                    (_U(0x1) << TWI_IER_UNRE_Pos)                  /**< (TWI_IER) Underrun Error Interrupt Enable Mask */
...
#define TWI_IER_NACK_Msk                    (_U(0x1) << TWI_IER_NACK_Pos)                  /**< (TWI_IER) Not Acknowledge Interrupt Enable Mask */
...
#define TWI_IER_ARBLST_Msk                  (_U(0x1) << TWI_IER_ARBLST_Pos)                /**< (TWI_IER) Arbitration Lost Interrupt Enable Mask */
...
#define TWI_IER_SCL_WS_Msk                  (_U(0x1) << TWI_IER_SCL_WS_Pos)                /**< (TWI_IER) Clock Wait State Interrupt Enable Mask */
...
#define TWI_IER_EOSACC_Msk                  (_U(0x1) << TWI_IER_EOSACC_Pos)                /**< (TWI_IER) End Of Slave Access Interrupt Enable Mask */
...
#define TWI_IER_ENDRX_Msk                   (_U(0x1) << TWI_IER_ENDRX_Pos)                 /**< (TWI_IER) End of Receive Buffer Interrupt Enable Mask */
...
#define TWI_IER_ENDTX_Msk                   (_U(0x1) << TWI_IER_ENDTX_Pos)                 /**< (TWI_IER) End of Transmit Buffer Interrupt Enable Mask */
...
#define TWI_IER_RXBUFF_Msk                  (_U(0x1) << TWI_IER_RXBUFF_Pos)                /**< (TWI_IER) Receive Buffer Full Interrupt Enable Mask */
...
#define TWI_IER_TXBUFE_Msk                  (_U(0x1) << TWI_IER_TXBUFE_Pos)                /**< (TWI_IER) Transmit Buffer Empty Interrupt Enable Mask */
...
#define TWI_IER_MCACK_Msk                   (_U(0x1) << TWI_IER_MCACK_Pos)                 /**< (TWI_IER) Master Code Acknowledge Interrupt Enable Mask */
...
#define TWI_IER_TOUT_Msk                    (_U(0x1) << TWI_IER_TOUT_Pos)                  /**< (TWI_IER) Timeout Error Interrupt Enable Mask */
...
#define TWI_IER_PECERR_Msk                  (_U(0x1) << TWI_IER_PECERR_Pos)                /**< (TWI_IER) PEC Error Interrupt Enable Mask */
...
#define TWI_IER_SMBDAM_Msk                  (_U(0x1) << TWI_IER_SMBDAM_Pos)                /**< (TWI_IER) SMBus Default Address Match Interrupt Enable Mask */
...
#define TWI_IER_SMBHHM_Msk                  (_U(0x1) << TWI_IER_SMBHHM_Pos)                /**< (TWI_IER) SMBus Host Header Address Match Interrupt Enable Mask */
...
#define TWI_IER_MASK                        _U(0x3DFFF7)                                   /**< \deprecated (TWI_IER) Register MASK  (Use TWI_IER_Msk instead)  */
#define TWI_IER_Msk                         _U(0x3DFFF7)                                   /**< (TWI_IER) Register Mask  */

/* -------- TWI_IDR : (TWI Offset: 0x28) (/W 32) TWI Interrupt Disable Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_IDR_OFFSET                      (0x28)                                        /**<  (TWI_IDR) TWI Interrupt Disable Register  Offset */

#define TWI_IDR_TXCOMP_Pos                  0                                              /**< (TWI_IDR) Transmission Completed Interrupt Disable Position */
#define TWI_IDR_TXCOMP_Msk                  (_U(0x1) << TWI_IDR_TXCOMP_Pos)                /**< (TWI_IDR) Transmission Completed Interrupt Disable Mask */
...
#define TWI_IDR_RXRDY_Msk                   (_U(0x1) << TWI_IDR_RXRDY_Pos)                 /**< (TWI_IDR) Receive Holding Register Ready Interrupt Disable Mask */
...
#define TWI_IDR_TXRDY_Msk                   (_U(0x1) << TWI_IDR_TXRDY_Pos)                 /**< (TWI_IDR) Transmit Holding Register Ready Interrupt Disable Mask */
...
#define TWI_IDR_SVACC_Msk                   (_U(0x1) << TWI_IDR_SVACC_Pos)                 /**< (TWI_IDR) Slave Access Interrupt Disable Mask */
...
#define TWI_IDR_GACC_Msk                    (_U(0x1) << TWI_IDR_GACC_Pos)                  /**< (TWI_IDR) General Call Access Interrupt Disable Mask */
...
#define TWI_IDR_OVRE_Msk                    (_U(0x1) << TWI_IDR_OVRE_Pos)                  /**< (TWI_IDR) Overrun Error Interrupt Disable Mask */
...
#define TWI_IDR_UNRE_Msk                    (_U(0x1) << TWI_IDR_UNRE_Pos)                  /**< (TWI_IDR) Underrun Error Interrupt Disable Mask */
...
#define TWI_IDR_NACK_Msk                    (_U(0x1) << TWI_IDR_NACK_Pos)                  /**< (TWI_IDR) Not Acknowledge Interrupt Disable Mask */
...
#define TWI_IDR_ARBLST_Msk                  (_U(0x1) << TWI_IDR_ARBLST_Pos)                /**< (TWI_IDR) Arbitration Lost Interrupt Disable Mask */
...
#define TWI_IDR_SCL_WS_Msk                  (_U(0x1) << TWI_IDR_SCL_WS_Pos)                /**< (TWI_IDR) Clock Wait State Interrupt Disable Mask */
...
#define TWI_IDR_EOSACC_Msk                  (_U(0x1) << TWI_IDR_EOSACC_Pos)                /**< (TWI_IDR) End Of Slave Access Interrupt Disable Mask */
...
#define TWI_IDR_ENDRX_Msk                   (_U(0x1) << TWI_IDR_ENDRX_Pos)                 /**< (TWI_IDR) End of Receive Buffer Interrupt Disable Mask */
...
#define TWI_IDR_ENDTX_Msk                   (_U(0x1) << TWI_IDR_ENDTX_Pos)                 /**< (TWI_IDR) End of Transmit Buffer Interrupt Disable Mask */
...
#define TWI_IDR_RXBUFF_Msk                  (_U(0x1) << TWI_IDR_RXBUFF_Pos)                /**< (TWI_IDR) Receive Buffer Full Interrupt Disable Mask */
...
#define TWI_IDR_TXBUFE_Msk                  (_U(0x1) << TWI_IDR_TXBUFE_Pos)                /**< (TWI_IDR) Transmit Buffer Empty Interrupt Disable Mask */
...
#define TWI_IDR_MCACK_Msk                   (_U(0x1) << TWI_IDR_MCACK_Pos)                 /**< (TWI_IDR) Master Code Acknowledge Interrupt Disable Mask */
...
#define TWI_IDR_TOUT_Msk                    (_U(0x1) << TWI_IDR_TOUT_Pos)                  /**< (TWI_IDR) Timeout Error Interrupt Disable Mask */
...
#define TWI_IDR_PECERR_Msk                  (_U(0x1) << TWI_IDR_PECERR_Pos)                /**< (TWI_IDR) PEC Error Interrupt Disable Mask */
...
#define TWI_IDR_SMBDAM_Msk                  (_U(0x1) << TWI_IDR_SMBDAM_Pos)                /**< (TWI_IDR) SMBus Default Address Match Interrupt Disable Mask */
...
#define TWI_IDR_SMBHHM_Msk                  (_U(0x1) << TWI_IDR_SMBHHM_Pos)                /**< (TWI_IDR) SMBus Host Header Address Match Interrupt Disable Mask */
...
#define TWI_IDR_MASK                        _U(0x3DFFF7)                                   /**< \deprecated (TWI_IDR) Register MASK  (Use TWI_IDR_Msk instead)  */
#define TWI_IDR_Msk                         _U(0x3DFFF7)                                   /**< (TWI_IDR) Register Mask  */

/* -------- TWI_IMR : (TWI Offset: 0x2c) (R/ 32) TWI Interrupt Mask Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_IMR_OFFSET                      (0x2C)                                        /**<  (TWI_IMR) TWI Interrupt Mask Register  Offset */

#define TWI_IMR_TXCOMP_Pos                  0                                              /**< (TWI_IMR) Transmission Completed Interrupt Mask Position */
#define TWI_IMR_TXCOMP_Msk                  (_U(0x1) << TWI_IMR_TXCOMP_Pos)                /**< (TWI_IMR) Transmission Completed Interrupt Mask Mask */
...
#define TWI_IMR_RXRDY_Msk                   (_U(0x1) << TWI_IMR_RXRDY_Pos)                 /**< (TWI_IMR) Receive Holding Register Ready Interrupt Mask Mask */
...
#define TWI_IMR_TXRDY_Msk                   (_U(0x1) << TWI_IMR_TXRDY_Pos)                 /**< (TWI_IMR) Transmit Holding Register Ready Interrupt Mask Mask */
...
#define TWI_IMR_SVACC_Msk                   (_U(0x1) << TWI_IMR_SVACC_Pos)                 /**< (TWI_IMR) Slave Access Interrupt Mask Mask */
...
#define TWI_IMR_GACC_Msk                    (_U(0x1) << TWI_IMR_GACC_Pos)                  /**< (TWI_IMR) General Call Access Interrupt Mask Mask */
...
#define TWI_IMR_OVRE_Msk                    (_U(0x1) << TWI_IMR_OVRE_Pos)                  /**< (TWI_IMR) Overrun Error Interrupt Mask Mask */
...
#define TWI_IMR_UNRE_Msk                    (_U(0x1) << TWI_IMR_UNRE_Pos)                  /**< (TWI_IMR) Underrun Error Interrupt Mask Mask */
...
#define TWI_IMR_NACK_Msk                    (_U(0x1) << TWI_IMR_NACK_Pos)                  /**< (TWI_IMR) Not Acknowledge Interrupt Mask Mask */
...
#define TWI_IMR_ARBLST_Msk                  (_U(0x1) << TWI_IMR_ARBLST_Pos)                /**< (TWI_IMR) Arbitration Lost Interrupt Mask Mask */
...
#define TWI_IMR_SCL_WS_Msk                  (_U(0x1) << TWI_IMR_SCL_WS_Pos)                /**< (TWI_IMR) Clock Wait State Interrupt Mask Mask */
...
#define TWI_IMR_EOSACC_Msk                  (_U(0x1) << TWI_IMR_EOSACC_Pos)                /**< (TWI_IMR) End Of Slave Access Interrupt Mask Mask */
...
#define TWI_IMR_ENDRX_Msk                   (_U(0x1) << TWI_IMR_ENDRX_Pos)                 /**< (TWI_IMR) End of Receive Buffer Interrupt Mask Mask */
...
#define TWI_IMR_ENDTX_Msk                   (_U(0x1) << TWI_IMR_ENDTX_Pos)                 /**< (TWI_IMR) End of Transmit Buffer Interrupt Mask Mask */
...
#define TWI_IMR_RXBUFF_Msk                  (_U(0x1) << TWI_IMR_RXBUFF_Pos)                /**< (TWI_IMR) Receive Buffer Full Interrupt Mask Mask */
...
#define TWI_IMR_TXBUFE_Msk                  (_U(0x1) << TWI_IMR_TXBUFE_Pos)                /**< (TWI_IMR) Transmit Buffer Empty Interrupt Mask Mask */
...
#define TWI_IMR_MCACK_Msk                   (_U(0x1) << TWI_IMR_MCACK_Pos)                 /**< (TWI_IMR) Master Code Acknowledge Interrupt Mask Mask */
...
#define TWI_IMR_TOUT_Msk                    (_U(0x1) << TWI_IMR_TOUT_Pos)                  /**< (TWI_IMR) Timeout Error Interrupt Mask Mask */
...
#define TWI_IMR_PECERR_Msk                  (_U(0x1) << TWI_IMR_PECERR_Pos)                /**< (TWI_IMR) PEC Error Interrupt Mask Mask */
...
#define TWI_IMR_SMBDAM_Msk                  (_U(0x1) << TWI_IMR_SMBDAM_Pos)                /**< (TWI_IMR) SMBus Default Address Match Interrupt Mask Mask */
...
#define TWI_IMR_SMBHHM_Msk                  (_U(0x1) << TWI_IMR_SMBHHM_Pos)                /**< (TWI_IMR) SMBus Host Header Address Match Interrupt Mask Mask */
...
#define TWI_IMR_MASK                        _U(0x3DFFF7)                                   /**< \deprecated (TWI_IMR) Register MASK  (Use TWI_IMR_Msk instead)  */
#define TWI_IMR_Msk                         _U(0x3DFFF7)                                   /**< (TWI_IMR) Register Mask  */

/* -------- TWI_RHR : (TWI Offset: 0x30) (R/ 32) TWI Receive Holding Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_RHR_OFFSET                      (0x30)                                        /**<  (TWI_RHR) TWI Receive Holding Register  Offset */

#define TWI_RHR_RXDATA_Pos                  0                                              /**< (TWI_RHR) Master or Slave Receive Holding Data Position */
#define TWI_RHR_RXDATA_Msk                  (_U(0xFF) << TWI_RHR_RXDATA_Pos)               /**< (TWI_RHR) Master or Slave Receive Holding Data Mask */
#define TWI_RHR_RXDATA(value)               (TWI_RHR_RXDATA_Msk & ((value) << TWI_RHR_RXDATA_Pos))
#define TWI_RHR_MASK                        _U(0xFF)                                       /**< \deprecated (TWI_RHR) Register MASK  (Use TWI_RHR_Msk instead)  */
#define TWI_RHR_Msk                         _U(0xFF)                                       /**< (TWI_RHR) Register Mask  */

/* -------- TWI_THR : (TWI Offset: 0x34) (/W 32) TWI Transmit Holding Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_THR_OFFSET                      (0x34)                                        /**<  (TWI_THR) TWI Transmit Holding Register  Offset */

#define TWI_THR_TXDATA_Pos                  0                                              /**< (TWI_THR) Master or Slave Transmit Holding Data Position */
#define TWI_THR_TXDATA_Msk                  (_U(0xFF) << TWI_THR_TXDATA_Pos)               /**< (TWI_THR) Master or Slave Transmit Holding Data Mask */
#define TWI_THR_TXDATA(value)               (TWI_THR_TXDATA_Msk & ((value) << TWI_THR_TXDATA_Pos))
#define TWI_THR_MASK                        _U(0xFF)                                       /**< \deprecated (TWI_THR) Register MASK  (Use TWI_THR_Msk instead)  */
#define TWI_THR_Msk                         _U(0xFF)                                       /**< (TWI_THR) Register Mask  */

/* -------- TWI_SMBTR : (TWI Offset: 0x38) (R/W 32) TWI SMBus Timing Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_SMBTR_OFFSET                    (0x38)                                        /**<  (TWI_SMBTR) TWI SMBus Timing Register  Offset */

#define TWI_SMBTR_PRESC_Pos                 0                                              /**< (TWI_SMBTR) SMBus Clock Prescaler Position */
#define TWI_SMBTR_PRESC_Msk                 (_U(0xF) << TWI_SMBTR_PRESC_Pos)               /**< (TWI_SMBTR) SMBus Clock Prescaler Mask */
...
#define TWI_SMBTR_TLOWS_Msk                 (_U(0xFF) << TWI_SMBTR_TLOWS_Pos)              /**< (TWI_SMBTR) Slave Clock Stretch Maximum Cycles Mask */
...
#define TWI_SMBTR_TLOWM_Msk                 (_U(0xFF) << TWI_SMBTR_TLOWM_Pos)              /**< (TWI_SMBTR) Master Clock Stretch Maximum Cycles Mask */
...
#define TWI_SMBTR_THMAX_Msk                 (_U(0xFF) << TWI_SMBTR_THMAX_Pos)              /**< (TWI_SMBTR) Clock High Maximum Cycles Mask */
#define TWI_SMBTR_THMAX(value)              (TWI_SMBTR_THMAX_Msk & ((value) << TWI_SMBTR_THMAX_Pos))
#define TWI_SMBTR_MASK                      _U(0xFFFFFF0F)                                 /**< \deprecated (TWI_SMBTR) Register MASK  (Use TWI_SMBTR_Msk instead)  */
#define TWI_SMBTR_Msk                       _U(0xFFFFFF0F)                                 /**< (TWI_SMBTR) Register Mask  */

/* -------- TWI_ACR : (TWI Offset: 0x40) (R/W 32) TWI Alternative Command Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_ACR_OFFSET                      (0x40)                                        /**<  (TWI_ACR) TWI Alternative Command Register  Offset */

#define TWI_ACR_DATAL_Pos                   0                                              /**< (TWI_ACR) Data Length Position */
#define TWI_ACR_DATAL_Msk                   (_U(0xFF) << TWI_ACR_DATAL_Pos)                /**< (TWI_ACR) Data Length Mask */
...
#define TWI_ACR_DIR_Msk                     (_U(0x1) << TWI_ACR_DIR_Pos)                   /**< (TWI_ACR) Transfer Direction Mask */
...
#define TWI_ACR_PEC_Msk                     (_U(0x1) << TWI_ACR_PEC_Pos)                   /**< (TWI_ACR) PEC Request (SMBus Mode only) Mask */
...
#define TWI_ACR_NDATAL_Msk                  (_U(0xFF) << TWI_ACR_NDATAL_Pos)               /**< (TWI_ACR) Next Data Length Mask */
...
#define TWI_ACR_NDIR_Msk                    (_U(0x1) << TWI_ACR_NDIR_Pos)                  /**< (TWI_ACR) Next Transfer Direction Mask */
...
#define TWI_ACR_NPEC_Msk                    (_U(0x1) << TWI_ACR_NPEC_Pos)                  /**< (TWI_ACR) Next PEC Request (SMBus Mode only) Mask */
...
#define TWI_ACR_MASK                        _U(0x3FF03FF)                                  /**< \deprecated (TWI_ACR) Register MASK  (Use TWI_ACR_Msk instead)  */
#define TWI_ACR_Msk                         _U(0x3FF03FF)                                  /**< (TWI_ACR) Register Mask  */

/* -------- TWI_FILTR : (TWI Offset: 0x44) (R/W 32) TWI Filter Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_FILTR_OFFSET                    (0x44)                                        /**<  (TWI_FILTR) TWI Filter Register  Offset */

#define TWI_FILTR_FILT_Pos                  0                                              /**< (TWI_FILTR) RX Digital Filter Position */
#define TWI_FILTR_FILT_Msk                  (_U(0x1) << TWI_FILTR_FILT_Pos)                /**< (TWI_FILTR) RX Digital Filter Mask */
...
#define TWI_FILTR_PADFEN_Msk                (_U(0x1) << TWI_FILTR_PADFEN_Pos)              /**< (TWI_FILTR) PAD Filter Enable Mask */
...
#define TWI_FILTR_PADFCFG_Msk               (_U(0x1) << TWI_FILTR_PADFCFG_Pos)             /**< (TWI_FILTR) PAD Filter Config Mask */
...
#define TWI_FILTR_THRES_Msk                 (_U(0x7) << TWI_FILTR_THRES_Pos)               /**< (TWI_FILTR) Digital Filter Threshold Mask */
#define TWI_FILTR_THRES(value)              (TWI_FILTR_THRES_Msk & ((value) << TWI_FILTR_THRES_Pos))
#define TWI_FILTR_MASK                      _U(0x707)                                      /**< \deprecated (TWI_FILTR) Register MASK  (Use TWI_FILTR_Msk instead)  */
#define TWI_FILTR_Msk                       _U(0x707)                                      /**< (TWI_FILTR) Register Mask  */

/* -------- TWI_SWMR : (TWI Offset: 0x4c) (R/W 32) TWI SleepWalking Matching Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_SWMR_OFFSET                     (0x4C)                                        /**<  (TWI_SWMR) TWI SleepWalking Matching Register  Offset */

#define TWI_SWMR_SADR1_Pos                  0                                              /**< (TWI_SWMR) Slave Address 1 Position */
#define TWI_SWMR_SADR1_Msk                  (_U(0x7F) << TWI_SWMR_SADR1_Pos)               /**< (TWI_SWMR) Slave Address 1 Mask */
...
#define TWI_SWMR_SADR2_Msk                  (_U(0x7F) << TWI_SWMR_SADR2_Pos)               /**< (TWI_SWMR) Slave Address 2 Mask */
...
#define TWI_SWMR_SADR3_Msk                  (_U(0x7F) << TWI_SWMR_SADR3_Pos)               /**< (TWI_SWMR) Slave Address 3 Mask */
...
#define TWI_SWMR_DATAM_Msk                  (_U(0xFF) << TWI_SWMR_DATAM_Pos)               /**< (TWI_SWMR) Data Match Mask */
#define TWI_SWMR_DATAM(value)               (TWI_SWMR_DATAM_Msk & ((value) << TWI_SWMR_DATAM_Pos))
#define TWI_SWMR_MASK                       _U(0xFF7F7F7F)                                 /**< \deprecated (TWI_SWMR) Register MASK  (Use TWI_SWMR_Msk instead)  */
#define TWI_SWMR_Msk                        _U(0xFF7F7F7F)                                 /**< (TWI_SWMR) Register Mask  */

/* -------- TWI_WPMR : (TWI Offset: 0xe4) (R/W 32) TWI Write Protection Mode Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_WPMR_OFFSET                     (0xE4)                                        /**<  (TWI_WPMR) TWI Write Protection Mode Register  Offset */

#define TWI_WPMR_WPEN_Pos                   0                                              /**< (TWI_WPMR) Write Protection Enable Position */
#define TWI_WPMR_WPEN_Msk                   (_U(0x1) << TWI_WPMR_WPEN_Pos)                 /**< (TWI_WPMR) Write Protection Enable Mask */
...
#define TWI_WPMR_WPKEY_Msk                  (_U(0xFFFFFF) << TWI_WPMR_WPKEY_Pos)           /**< (TWI_WPMR) Write Protection Key Mask */
#define TWI_WPMR_WPKEY(value)               (TWI_WPMR_WPKEY_Msk & ((value) << TWI_WPMR_WPKEY_Pos))
#define   TWI_WPMR_WPKEY_PASSWD_Val         _U(0x545749)                                   /**< (TWI_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit.Always reads as 0  */
...
#define TWI_WPMR_MASK                       _U(0xFFFFFF01)                                 /**< \deprecated (TWI_WPMR) Register MASK  (Use TWI_WPMR_Msk instead)  */
#define TWI_WPMR_Msk                        _U(0xFFFFFF01)                                 /**< (TWI_WPMR) Register Mask  */

/* -------- TWI_WPSR : (TWI Offset: 0xe8) (R/ 32) TWI Write Protection Status Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define TWI_WPSR_OFFSET                     (0xE8)                                        /**<  (TWI_WPSR) TWI Write Protection Status Register  Offset */

#define TWI_WPSR_WPVS_Pos                   0                                              /**< (TWI_WPSR) Write Protect Violation Status Position */
#define TWI_WPSR_WPVS_Msk                   (_U(0x1) << TWI_WPSR_WPVS_Pos)                 /**< (TWI_WPSR) Write Protect Violation Status Mask */
...
#define TWI_WPSR_WPVSRC_Msk                 (_U(0xFFFFFF) << TWI_WPSR_WPVSRC_Pos)          /**< (TWI_WPSR) Write Protection Violation Source Mask */
#define TWI_WPSR_WPVSRC(value)              (TWI_WPSR_WPVSRC_Msk & ((value) << TWI_WPSR_WPVSRC_Pos))
#define TWI_WPSR_MASK                       _U(0xFFFFFF01)                                 /**< \deprecated (TWI_WPSR) Register MASK  (Use TWI_WPSR_Msk instead)  */
#define TWI_WPSR_Msk                        _U(0xFFFFFF01)                                 /**< (TWI_WPSR) Register Mask  */
...
#define TWI_RPR_RXPTR_Msk                   (_U(0xFFFFFFFF) << TWI_RPR_RXPTR_Pos)          /**< (TWI_RPR) Receive Pointer Register Mask */
#define TWI_RPR_RXPTR(value)                (TWI_RPR_RXPTR_Msk & ((value) << TWI_RPR_RXPTR_Pos))
#define TWI_RPR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (TWI_RPR) Register MASK  (Use TWI_RPR_Msk instead)  */
#define TWI_RPR_Msk                         _U(0xFFFFFFFF)                                 /**< (TWI_RPR) Register Mask  */
...
#define TWI_RCR_RXCTR_Msk                   (_U(0xFFFF) << TWI_RCR_RXCTR_Pos)              /**< (TWI_RCR) Receive Counter Register Mask */
#define TWI_RCR_RXCTR(value)                (TWI_RCR_RXCTR_Msk & ((value) << TWI_RCR_RXCTR_Pos))
#define TWI_RCR_MASK                        _U(0xFFFF)                                     /**< \deprecated (TWI_RCR) Register MASK  (Use TWI_RCR_Msk instead)  */
#define TWI_RCR_Msk                         _U(0xFFFF)                                     /**< (TWI_RCR) Register Mask  */
...
#define TWI_TPR_TXPTR_Msk                   (_U(0xFFFFFFFF) << TWI_TPR_TXPTR_Pos)          /**< (TWI_TPR) Transmit Counter Register Mask */
#define TWI_TPR_TXPTR(value)                (TWI_TPR_TXPTR_Msk & ((value) << TWI_TPR_TXPTR_Pos))
#define TWI_TPR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (TWI_TPR) Register MASK  (Use TWI_TPR_Msk instead)  */
#define TWI_TPR_Msk                         _U(0xFFFFFFFF)                                 /**< (TWI_TPR) Register Mask  */
...
#define TWI_TCR_TXCTR_Msk                   (_U(0xFFFF) << TWI_TCR_TXCTR_Pos)              /**< (TWI_TCR) Transmit Counter Register Mask */
#define TWI_TCR_TXCTR(value)                (TWI_TCR_TXCTR_Msk & ((value) << TWI_TCR_TXCTR_Pos))
#define TWI_TCR_MASK                        _U(0xFFFF)                                     /**< \deprecated (TWI_TCR) Register MASK  (Use TWI_TCR_Msk instead)  */
#define TWI_TCR_Msk                         _U(0xFFFF)                                     /**< (TWI_TCR) Register Mask  */
...
#define TWI_RNPR_RXNPTR_Msk                 (_U(0xFFFFFFFF) << TWI_RNPR_RXNPTR_Pos)        /**< (TWI_RNPR) Receive Next Pointer Mask */
#define TWI_RNPR_RXNPTR(value)              (TWI_RNPR_RXNPTR_Msk & ((value) << TWI_RNPR_RXNPTR_Pos))
#define TWI_RNPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (TWI_RNPR) Register MASK  (Use TWI_RNPR_Msk instead)  */
#define TWI_RNPR_Msk                        _U(0xFFFFFFFF)                                 /**< (TWI_RNPR) Register Mask  */
...
#define TWI_RNCR_RXNCTR_Msk                 (_U(0xFFFF) << TWI_RNCR_RXNCTR_Pos)            /**< (TWI_RNCR) Receive Next Counter Mask */
#define TWI_RNCR_RXNCTR(value)              (TWI_RNCR_RXNCTR_Msk & ((value) << TWI_RNCR_RXNCTR_Pos))
#define TWI_RNCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (TWI_RNCR) Register MASK  (Use TWI_RNCR_Msk instead)  */
#define TWI_RNCR_Msk                        _U(0xFFFF)                                     /**< (TWI_RNCR) Register Mask  */
...
#define TWI_TNPR_TXNPTR_Msk                 (_U(0xFFFFFFFF) << TWI_TNPR_TXNPTR_Pos)        /**< (TWI_TNPR) Transmit Next Pointer Mask */
#define TWI_TNPR_TXNPTR(value)              (TWI_TNPR_TXNPTR_Msk & ((value) << TWI_TNPR_TXNPTR_Pos))
#define TWI_TNPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (TWI_TNPR) Register MASK  (Use TWI_TNPR_Msk instead)  */
#define TWI_TNPR_Msk                        _U(0xFFFFFFFF)                                 /**< (TWI_TNPR) Register Mask  */
...
#define TWI_TNCR_TXNCTR_Msk                 (_U(0xFFFF) << TWI_TNCR_TXNCTR_Pos)            /**< (TWI_TNCR) Transmit Counter Next Mask */
#define TWI_TNCR_TXNCTR(value)              (TWI_TNCR_TXNCTR_Msk & ((value) << TWI_TNCR_TXNCTR_Pos))
#define TWI_TNCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (TWI_TNCR) Register MASK  (Use TWI_TNCR_Msk instead)  */
#define TWI_TNCR_Msk                        _U(0xFFFF)                                     /**< (TWI_TNCR) Register Mask  */
...
#define TWI_PTCR_RXTEN_Msk                  (_U(0x1) << TWI_PTCR_RXTEN_Pos)                /**< (TWI_PTCR) Receiver Transfer Enable Mask */
...
#define TWI_PTCR_RXTDIS_Msk                 (_U(0x1) << TWI_PTCR_RXTDIS_Pos)               /**< (TWI_PTCR) Receiver Transfer Disable Mask */
...
#define TWI_PTCR_TXTEN_Msk                  (_U(0x1) << TWI_PTCR_TXTEN_Pos)                /**< (TWI_PTCR) Transmitter Transfer Enable Mask */
...
#define TWI_PTCR_TXTDIS_Msk                 (_U(0x1) << TWI_PTCR_TXTDIS_Pos)               /**< (TWI_PTCR) Transmitter Transfer Disable Mask */
...
#define TWI_PTCR_RXCBEN_Msk                 (_U(0x1) << TWI_PTCR_RXCBEN_Pos)               /**< (TWI_PTCR) Receiver Circular Buffer Enable Mask */
...
#define TWI_PTCR_RXCBDIS_Msk                (_U(0x1) << TWI_PTCR_RXCBDIS_Pos)              /**< (TWI_PTCR) Receiver Circular Buffer Disable Mask */
...
#define TWI_PTCR_TXCBEN_Msk                 (_U(0x1) << TWI_PTCR_TXCBEN_Pos)               /**< (TWI_PTCR) Transmitter Circular Buffer Enable Mask */
...
#define TWI_PTCR_TXCBDIS_Msk                (_U(0x1) << TWI_PTCR_TXCBDIS_Pos)              /**< (TWI_PTCR) Transmitter Circular Buffer Disable Mask */
...
#define TWI_PTCR_ERRCLR_Msk                 (_U(0x1) << TWI_PTCR_ERRCLR_Pos)               /**< (TWI_PTCR) Transfer Bus Error Clear Mask */
...
#define TWI_PTCR_MASK                       _U(0x10F0303)                                  /**< \deprecated (TWI_PTCR) Register MASK  (Use TWI_PTCR_Msk instead)  */
#define TWI_PTCR_Msk                        _U(0x10F0303)                                  /**< (TWI_PTCR) Register Mask  */
...
#define TWI_PTSR_RXTEN_Msk                  (_U(0x1) << TWI_PTSR_RXTEN_Pos)                /**< (TWI_PTSR) Receiver Transfer Enable Mask */
...
#define TWI_PTSR_TXTEN_Msk                  (_U(0x1) << TWI_PTSR_TXTEN_Pos)                /**< (TWI_PTSR) Transmitter Transfer Enable Mask */
...
#define TWI_PTSR_RXCBEN_Msk                 (_U(0x1) << TWI_PTSR_RXCBEN_Pos)               /**< (TWI_PTSR) Receiver Circular Buffer Enable Mask */
...
#define TWI_PTSR_TXCBEN_Msk                 (_U(0x1) << TWI_PTSR_TXCBEN_Pos)               /**< (TWI_PTSR) Transmitter Circular Buffer Enable Mask */
...
#define TWI_PTSR_ERR_Msk                    (_U(0x1) << TWI_PTSR_ERR_Pos)                  /**< (TWI_PTSR) Transfer Bus Error Mask */
...
#define TWI_PTSR_MASK                       _U(0x1050101)                                  /**< \deprecated (TWI_PTSR) Register MASK  (Use TWI_PTSR_Msk instead)  */
#define TWI_PTSR_Msk                        _U(0x1050101)                                  /**< (TWI_PTSR) Register Mask  */

#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
#if COMPONENT_TYPEDEF_STYLE == 'R'
/** \brief TWI hardware registers */
typedef struct {  
  __O  uint32_t TWI_CR;         /**< (TWI Offset: 0x00) TWI Control Register */
  __IO uint32_t TWI_MMR;        /**< (TWI Offset: 0x04) TWI Master Mode Register */
  __IO uint32_t TWI_SMR;        /**< (TWI Offset: 0x08) TWI Slave Mode Register */
  __IO uint32_t TWI_IADR;       /**< (TWI Offset: 0x0C) TWI Internal Address Register */
  __IO uint32_t TWI_CWGR;       /**< (TWI Offset: 0x10) TWI Clock Waveform Generator Register */
  __I  uint32_t Reserved1[3];
  __I  uint32_t TWI_SR;         /**< (TWI Offset: 0x20) TWI Status Register */
  __O  uint32_t TWI_IER;        /**< (TWI Offset: 0x24) TWI Interrupt Enable Register */
  __O  uint32_t TWI_IDR;        /**< (TWI Offset: 0x28) TWI Interrupt Disable Register */
  __I  uint32_t TWI_IMR;        /**< (TWI Offset: 0x2C) TWI Interrupt Mask Register */
  __I  uint32_t TWI_RHR;        /**< (TWI Offset: 0x30) TWI Receive Holding Register */
  __O  uint32_t TWI_THR;        /**< (TWI Offset: 0x34) TWI Transmit Holding Register */
  __IO uint32_t TWI_SMBTR;      /**< (TWI Offset: 0x38) TWI SMBus Timing Register */
  __I  uint32_t Reserved2[1];
  __IO uint32_t TWI_ACR;        /**< (TWI Offset: 0x40) TWI Alternative Command Register */
  __IO uint32_t TWI_FILTR;      /**< (TWI Offset: 0x44) TWI Filter Register */
  __I  uint32_t Reserved3[1];
  __IO uint32_t TWI_SWMR;       /**< (TWI Offset: 0x4C) TWI SleepWalking Matching Register */
  __I  uint32_t Reserved4[37];
  __IO uint32_t TWI_WPMR;       /**< (TWI Offset: 0xE4) TWI Write Protection Mode Register */
  __I  uint32_t TWI_WPSR;       /**< (TWI Offset: 0xE8) TWI Write Protection Status Register */
...
/** \brief TWI hardware registers */
typedef struct {  
  __O  TWI_CR_Type                    TWI_CR;         /**< Offset: 0x00 ( /W  32) TWI Control Register */
  __IO TWI_MMR_Type                   TWI_MMR;        /**< Offset: 0x04 (R/W  32) TWI Master Mode Register */
  __IO TWI_SMR_Type                   TWI_SMR;        /**< Offset: 0x08 (R/W  32) TWI Slave Mode Register */
  __IO TWI_IADR_Type                  TWI_IADR;       /**< Offset: 0x0C (R/W  32) TWI Internal Address Register */
  __IO TWI_CWGR_Type                  TWI_CWGR;       /**< Offset: 0x10 (R/W  32) TWI Clock Waveform Generator Register */
       RoReg8                         Reserved1[0xC];
  __I  TWI_SR_Type                    TWI_SR;         /**< Offset: 0x20 (R/   32) TWI Status Register */
  __O  TWI_IER_Type                   TWI_IER;        /**< Offset: 0x24 ( /W  32) TWI Interrupt Enable Register */
  __O  TWI_IDR_Type                   TWI_IDR;        /**< Offset: 0x28 ( /W  32) TWI Interrupt Disable Register */
  __I  TWI_IMR_Type                   TWI_IMR;        /**< Offset: 0x2C (R/   32) TWI Interrupt Mask Register */
  __I  TWI_RHR_Type                   TWI_RHR;        /**< Offset: 0x30 (R/   32) TWI Receive Holding Register */
  __O  TWI_THR_Type                   TWI_THR;        /**< Offset: 0x34 ( /W  32) TWI Transmit Holding Register */
  __IO TWI_SMBTR_Type                 TWI_SMBTR;      /**< Offset: 0x38 (R/W  32) TWI SMBus Timing Register */
       RoReg8                         Reserved2[0x4];
  __IO TWI_ACR_Type                   TWI_ACR;        /**< Offset: 0x40 (R/W  32) TWI Alternative Command Register */
  __IO TWI_FILTR_Type                 TWI_FILTR;      /**< Offset: 0x44 (R/W  32) TWI Filter Register */
       RoReg8                         Reserved3[0x4];
  __IO TWI_SWMR_Type                  TWI_SWMR;       /**< Offset: 0x4C (R/W  32) TWI SleepWalking Matching Register */
       RoReg8                         Reserved4[0x94];
  __IO TWI_WPMR_Type                  TWI_WPMR;       /**< Offset: 0xE4 (R/W  32) TWI Write Protection Mode Register */
  __I  TWI_WPSR_Type                  TWI_WPSR;       /**< Offset: 0xE8 (R/   32) TWI Write Protection Status Register */
