...
#define TC_CCR_CLKEN_Msk                    (_U(0x1) << TC_CCR_CLKEN_Pos)                  /**< (TC_CCR) Counter Clock Enable Command Mask */
...
#define TC_CCR_CLKDIS_Msk                   (_U(0x1) << TC_CCR_CLKDIS_Pos)                 /**< (TC_CCR) Counter Clock Disable Command Mask */
...
#define TC_CCR_SWTRG_Msk                    (_U(0x1) << TC_CCR_SWTRG_Pos)                  /**< (TC_CCR) Software Trigger Command Mask */
...
#define TC_CCR_MASK                         _U(0x07)                                       /**< \deprecated (TC_CCR) Register MASK  (Use TC_CCR_Msk instead)  */
#define TC_CCR_Msk                          _U(0x07)                                       /**< (TC_CCR) Register Mask  */
...
#define TC_CMR_TCCLKS_Msk                   (_U(0x7) << TC_CMR_TCCLKS_Pos)                 /**< (TC_CMR) Clock Selection Mask */
#define TC_CMR_TCCLKS(value)                (TC_CMR_TCCLKS_Msk & ((value) << TC_CMR_TCCLKS_Pos))
#define   TC_CMR_TCCLKS_TIMER_CLOCK1_Val    _U(0x0)                                        /**< (TC_CMR) Clock selected: internal TIMER_CLOCK1 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK2_Val    _U(0x1)                                        /**< (TC_CMR) Clock selected: internal TIMER_CLOCK2 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK3_Val    _U(0x2)                                        /**< (TC_CMR) Clock selected: internal TIMER_CLOCK3 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK4_Val    _U(0x3)                                        /**< (TC_CMR) Clock selected: internal TIMER_CLOCK4 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK5_Val    _U(0x4)                                        /**< (TC_CMR) Clock selected: internal TIMER_CLOCK5 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_XC0_Val             _U(0x5)                                        /**< (TC_CMR) Clock selected: XC0  */
#define   TC_CMR_TCCLKS_XC1_Val             _U(0x6)                                        /**< (TC_CMR) Clock selected: XC1  */
#define   TC_CMR_TCCLKS_XC2_Val             _U(0x7)                                        /**< (TC_CMR) Clock selected: XC2  */
...
#define TC_CMR_CLKI_Msk                     (_U(0x1) << TC_CMR_CLKI_Pos)                   /**< (TC_CMR) Clock Invert Mask */
...
#define TC_CMR_BURST_Msk                    (_U(0x3) << TC_CMR_BURST_Pos)                  /**< (TC_CMR) Burst Signal Selection Mask */
#define TC_CMR_BURST(value)                 (TC_CMR_BURST_Msk & ((value) << TC_CMR_BURST_Pos))
#define   TC_CMR_BURST_NONE_Val             _U(0x0)                                        /**< (TC_CMR) The clock is not gated by an external signal.  */
#define   TC_CMR_BURST_XC0_Val              _U(0x1)                                        /**< (TC_CMR) XC0 is ANDed with the selected clock.  */
#define   TC_CMR_BURST_XC1_Val              _U(0x2)                                        /**< (TC_CMR) XC1 is ANDed with the selected clock.  */
#define   TC_CMR_BURST_XC2_Val              _U(0x3)                                        /**< (TC_CMR) XC2 is ANDed with the selected clock.  */
...
#define TC_CMR_LDBSTOP_Msk                  (_U(0x1) << TC_CMR_LDBSTOP_Pos)                /**< (TC_CMR) Counter Clock Stopped with RB Loading Mask */
...
#define TC_CMR_LDBDIS_Msk                   (_U(0x1) << TC_CMR_LDBDIS_Pos)                 /**< (TC_CMR) Counter Clock Disable with RB Loading Mask */
...
#define TC_CMR_ETRGEDG_Msk                  (_U(0x3) << TC_CMR_ETRGEDG_Pos)                /**< (TC_CMR) External Trigger Edge Selection Mask */
#define TC_CMR_ETRGEDG(value)               (TC_CMR_ETRGEDG_Msk & ((value) << TC_CMR_ETRGEDG_Pos))
#define   TC_CMR_ETRGEDG_NONE_Val           _U(0x0)                                        /**< (TC_CMR) The clock is not gated by an external signal.  */
#define   TC_CMR_ETRGEDG_RISING_Val         _U(0x1)                                        /**< (TC_CMR) Rising edge  */
#define   TC_CMR_ETRGEDG_FALLING_Val        _U(0x2)                                        /**< (TC_CMR) Falling edge  */
#define   TC_CMR_ETRGEDG_EDGE_Val           _U(0x3)                                        /**< (TC_CMR) Each edge  */
...
#define TC_CMR_ABETRG_Msk                   (_U(0x1) << TC_CMR_ABETRG_Pos)                 /**< (TC_CMR) TIOA or TIOB External Trigger Selection Mask */
...
#define TC_CMR_CPCTRG_Msk                   (_U(0x1) << TC_CMR_CPCTRG_Pos)                 /**< (TC_CMR) RC Compare Trigger Enable Mask */
...
#define TC_CMR_WAVE_Msk                     (_U(0x1) << TC_CMR_WAVE_Pos)                   /**< (TC_CMR) Waveform Mode Mask */
...
#define TC_CMR_LDRA_Msk                     (_U(0x3) << TC_CMR_LDRA_Pos)                   /**< (TC_CMR) RA Loading Edge Selection Mask */
#define TC_CMR_LDRA(value)                  (TC_CMR_LDRA_Msk & ((value) << TC_CMR_LDRA_Pos))
#define   TC_CMR_LDRA_NONE_Val              _U(0x0)                                        /**< (TC_CMR) None  */
#define   TC_CMR_LDRA_RISING_Val            _U(0x1)                                        /**< (TC_CMR) Rising edge of TIOA  */
#define   TC_CMR_LDRA_FALLING_Val           _U(0x2)                                        /**< (TC_CMR) Falling edge of TIOA  */
#define   TC_CMR_LDRA_EDGE_Val              _U(0x3)                                        /**< (TC_CMR) Each edge of TIOA  */
...
#define TC_CMR_LDRB_Msk                     (_U(0x3) << TC_CMR_LDRB_Pos)                   /**< (TC_CMR) RB Loading Edge Selection Mask */
#define TC_CMR_LDRB(value)                  (TC_CMR_LDRB_Msk & ((value) << TC_CMR_LDRB_Pos))
#define   TC_CMR_LDRB_NONE_Val              _U(0x0)                                        /**< (TC_CMR) None  */
#define   TC_CMR_LDRB_RISING_Val            _U(0x1)                                        /**< (TC_CMR) Rising edge of TIOA  */
#define   TC_CMR_LDRB_FALLING_Val           _U(0x2)                                        /**< (TC_CMR) Falling edge of TIOA  */
#define   TC_CMR_LDRB_EDGE_Val              _U(0x3)                                        /**< (TC_CMR) Each edge of TIOA  */
...
#define TC_CMR_SBSMPLR_Msk                  (_U(0x7) << TC_CMR_SBSMPLR_Pos)                /**< (TC_CMR) Loading Edge Subsampling Ratio Mask */
#define TC_CMR_SBSMPLR(value)               (TC_CMR_SBSMPLR_Msk & ((value) << TC_CMR_SBSMPLR_Pos))
#define   TC_CMR_SBSMPLR_ONE_Val            _U(0x0)                                        /**< (TC_CMR) Load a Capture Register each selected edge  */
#define   TC_CMR_SBSMPLR_HALF_Val           _U(0x1)                                        /**< (TC_CMR) Load a Capture Register every 2 selected edges  */
#define   TC_CMR_SBSMPLR_FOURTH_Val         _U(0x2)                                        /**< (TC_CMR) Load a Capture Register every 4 selected edges  */
#define   TC_CMR_SBSMPLR_EIGHTH_Val         _U(0x3)                                        /**< (TC_CMR) Load a Capture Register every 8 selected edges  */
#define   TC_CMR_SBSMPLR_SIXTEENTH_Val      _U(0x4)                                        /**< (TC_CMR) Load a Capture Register every 16 selected edges  */
...
#define TC_CMR_MASK                         _U(0x7FC7FF)                                   /**< \deprecated (TC_CMR) Register MASK  (Use TC_CMR_Msk instead)  */
#define TC_CMR_Msk                          _U(0x7FC7FF)                                   /**< (TC_CMR) Register Mask  */
...
#define TC_SMMR_GCEN_Msk                    (_U(0x1) << TC_SMMR_GCEN_Pos)                  /**< (TC_SMMR) Gray Count Enable Mask */
...
#define TC_SMMR_DOWN_Msk                    (_U(0x1) << TC_SMMR_DOWN_Pos)                  /**< (TC_SMMR) Down Count Mask */
...
#define TC_SMMR_MASK                        _U(0x03)                                       /**< \deprecated (TC_SMMR) Register MASK  (Use TC_SMMR_Msk instead)  */
#define TC_SMMR_Msk                         _U(0x03)                                       /**< (TC_SMMR) Register Mask  */
...
#define TC_RAB_RAB_Msk                      (_U(0xFFFFFFFF) << TC_RAB_RAB_Pos)             /**< (TC_RAB) Register A or Register B Mask */
#define TC_RAB_RAB(value)                   (TC_RAB_RAB_Msk & ((value) << TC_RAB_RAB_Pos))
#define TC_RAB_MASK                         _U(0xFFFFFFFF)                                 /**< \deprecated (TC_RAB) Register MASK  (Use TC_RAB_Msk instead)  */
#define TC_RAB_Msk                          _U(0xFFFFFFFF)                                 /**< (TC_RAB) Register Mask  */
...
#define TC_CV_CV_Msk                        (_U(0xFFFFFFFF) << TC_CV_CV_Pos)               /**< (TC_CV) Counter Value Mask */
#define TC_CV_CV(value)                     (TC_CV_CV_Msk & ((value) << TC_CV_CV_Pos))   
#define TC_CV_MASK                          _U(0xFFFFFFFF)                                 /**< \deprecated (TC_CV) Register MASK  (Use TC_CV_Msk instead)  */
#define TC_CV_Msk                           _U(0xFFFFFFFF)                                 /**< (TC_CV) Register Mask  */
...
#define TC_RA_RA_Msk                        (_U(0xFFFFFFFF) << TC_RA_RA_Pos)               /**< (TC_RA) Register A Mask */
#define TC_RA_RA(value)                     (TC_RA_RA_Msk & ((value) << TC_RA_RA_Pos))   
#define TC_RA_MASK                          _U(0xFFFFFFFF)                                 /**< \deprecated (TC_RA) Register MASK  (Use TC_RA_Msk instead)  */
#define TC_RA_Msk                           _U(0xFFFFFFFF)                                 /**< (TC_RA) Register Mask  */
...
#define TC_RB_RB_Msk                        (_U(0xFFFFFFFF) << TC_RB_RB_Pos)               /**< (TC_RB) Register B Mask */
#define TC_RB_RB(value)                     (TC_RB_RB_Msk & ((value) << TC_RB_RB_Pos))   
#define TC_RB_MASK                          _U(0xFFFFFFFF)                                 /**< \deprecated (TC_RB) Register MASK  (Use TC_RB_Msk instead)  */
#define TC_RB_Msk                           _U(0xFFFFFFFF)                                 /**< (TC_RB) Register Mask  */
...
#define TC_RC_RC_Msk                        (_U(0xFFFFFFFF) << TC_RC_RC_Pos)               /**< (TC_RC) Register C Mask */
#define TC_RC_RC(value)                     (TC_RC_RC_Msk & ((value) << TC_RC_RC_Pos))   
#define TC_RC_MASK                          _U(0xFFFFFFFF)                                 /**< \deprecated (TC_RC) Register MASK  (Use TC_RC_Msk instead)  */
#define TC_RC_Msk                           _U(0xFFFFFFFF)                                 /**< (TC_RC) Register Mask  */
...
#define TC_SR_COVFS_Msk                     (_U(0x1) << TC_SR_COVFS_Pos)                   /**< (TC_SR) Counter Overflow Status (cleared on read) Mask */
...
#define TC_SR_LOVRS_Msk                     (_U(0x1) << TC_SR_LOVRS_Pos)                   /**< (TC_SR) Load Overrun Status (cleared on read) Mask */
...
#define TC_SR_CPAS_Msk                      (_U(0x1) << TC_SR_CPAS_Pos)                    /**< (TC_SR) RA Compare Status (cleared on read) Mask */
...
#define TC_SR_CPBS_Msk                      (_U(0x1) << TC_SR_CPBS_Pos)                    /**< (TC_SR) RB Compare Status (cleared on read) Mask */
...
#define TC_SR_CPCS_Msk                      (_U(0x1) << TC_SR_CPCS_Pos)                    /**< (TC_SR) RC Compare Status (cleared on read) Mask */
...
#define TC_SR_LDRAS_Msk                     (_U(0x1) << TC_SR_LDRAS_Pos)                   /**< (TC_SR) RA Loading Status (cleared on read) Mask */
...
#define TC_SR_LDRBS_Msk                     (_U(0x1) << TC_SR_LDRBS_Pos)                   /**< (TC_SR) RB Loading Status (cleared on read) Mask */
...
#define TC_SR_ETRGS_Msk                     (_U(0x1) << TC_SR_ETRGS_Pos)                   /**< (TC_SR) External Trigger Status (cleared on read) Mask */
...
#define TC_SR_ENDRX_Msk                     (_U(0x1) << TC_SR_ENDRX_Pos)                   /**< (TC_SR) End of Receiver Transfer (cleared by writing TC_RCR or TC_RNCR) Mask */
...
#define TC_SR_RXBUFF_Msk                    (_U(0x1) << TC_SR_RXBUFF_Pos)                  /**< (TC_SR) Reception Buffer Full (cleared by writing TC_RCR or TC_RNCR) Mask */
...
#define TC_SR_CLKSTA_Msk                    (_U(0x1) << TC_SR_CLKSTA_Pos)                  /**< (TC_SR) Clock Enabling Status Mask */
...
#define TC_SR_MTIOA_Msk                     (_U(0x1) << TC_SR_MTIOA_Pos)                   /**< (TC_SR) TIOA Mirror Mask */
...
#define TC_SR_MTIOB_Msk                     (_U(0x1) << TC_SR_MTIOB_Pos)                   /**< (TC_SR) TIOB Mirror Mask */
#define TC_SR_MTIOB                         TC_SR_MTIOB_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use TC_SR_MTIOB_Msk instead */
#define TC_SR_MASK                          _U(0x703FF)                                    /**< \deprecated (TC_SR) Register MASK  (Use TC_SR_Msk instead)  */
#define TC_SR_Msk                           _U(0x703FF)                                    /**< (TC_SR) Register Mask  */
...
#define TC_IER_COVFS_Msk                    (_U(0x1) << TC_IER_COVFS_Pos)                  /**< (TC_IER) Counter Overflow Mask */
...
#define TC_IER_LOVRS_Msk                    (_U(0x1) << TC_IER_LOVRS_Pos)                  /**< (TC_IER) Load Overrun Mask */
...
#define TC_IER_CPAS_Msk                     (_U(0x1) << TC_IER_CPAS_Pos)                   /**< (TC_IER) RA Compare Mask */
...
#define TC_IER_CPBS_Msk                     (_U(0x1) << TC_IER_CPBS_Pos)                   /**< (TC_IER) RB Compare Mask */
...
#define TC_IER_CPCS_Msk                     (_U(0x1) << TC_IER_CPCS_Pos)                   /**< (TC_IER) RC Compare Mask */
...
#define TC_IER_LDRAS_Msk                    (_U(0x1) << TC_IER_LDRAS_Pos)                  /**< (TC_IER) RA Loading Mask */
...
#define TC_IER_LDRBS_Msk                    (_U(0x1) << TC_IER_LDRBS_Pos)                  /**< (TC_IER) RB Loading Mask */
...
#define TC_IER_ETRGS_Msk                    (_U(0x1) << TC_IER_ETRGS_Pos)                  /**< (TC_IER) External Trigger Mask */
...
#define TC_IER_ENDRX_Msk                    (_U(0x1) << TC_IER_ENDRX_Pos)                  /**< (TC_IER) End of Receiver Transfer Mask */
...
#define TC_IER_RXBUFF_Msk                   (_U(0x1) << TC_IER_RXBUFF_Pos)                 /**< (TC_IER) Reception Buffer Full Mask */
...
#define TC_IER_MASK                         _U(0x3FF)                                      /**< \deprecated (TC_IER) Register MASK  (Use TC_IER_Msk instead)  */
#define TC_IER_Msk                          _U(0x3FF)                                      /**< (TC_IER) Register Mask  */
...
#define TC_IDR_COVFS_Msk                    (_U(0x1) << TC_IDR_COVFS_Pos)                  /**< (TC_IDR) Counter Overflow Mask */
...
#define TC_IDR_LOVRS_Msk                    (_U(0x1) << TC_IDR_LOVRS_Pos)                  /**< (TC_IDR) Load Overrun Mask */
...
#define TC_IDR_CPAS_Msk                     (_U(0x1) << TC_IDR_CPAS_Pos)                   /**< (TC_IDR) RA Compare Mask */
...
#define TC_IDR_CPBS_Msk                     (_U(0x1) << TC_IDR_CPBS_Pos)                   /**< (TC_IDR) RB Compare Mask */
...
#define TC_IDR_CPCS_Msk                     (_U(0x1) << TC_IDR_CPCS_Pos)                   /**< (TC_IDR) RC Compare Mask */
...
#define TC_IDR_LDRAS_Msk                    (_U(0x1) << TC_IDR_LDRAS_Pos)                  /**< (TC_IDR) RA Loading Mask */
...
#define TC_IDR_LDRBS_Msk                    (_U(0x1) << TC_IDR_LDRBS_Pos)                  /**< (TC_IDR) RB Loading Mask */
...
#define TC_IDR_ETRGS_Msk                    (_U(0x1) << TC_IDR_ETRGS_Pos)                  /**< (TC_IDR) External Trigger Mask */
...
#define TC_IDR_ENDRX_Msk                    (_U(0x1) << TC_IDR_ENDRX_Pos)                  /**< (TC_IDR) End of Receiver Transfer Mask */
...
#define TC_IDR_RXBUFF_Msk                   (_U(0x1) << TC_IDR_RXBUFF_Pos)                 /**< (TC_IDR) Reception Buffer Full Mask */
...
#define TC_IDR_MASK                         _U(0x3FF)                                      /**< \deprecated (TC_IDR) Register MASK  (Use TC_IDR_Msk instead)  */
#define TC_IDR_Msk                          _U(0x3FF)                                      /**< (TC_IDR) Register Mask  */
...
#define TC_IMR_COVFS_Msk                    (_U(0x1) << TC_IMR_COVFS_Pos)                  /**< (TC_IMR) Counter Overflow Mask */
...
#define TC_IMR_LOVRS_Msk                    (_U(0x1) << TC_IMR_LOVRS_Pos)                  /**< (TC_IMR) Load Overrun Mask */
...
#define TC_IMR_CPAS_Msk                     (_U(0x1) << TC_IMR_CPAS_Pos)                   /**< (TC_IMR) RA Compare Mask */
...
#define TC_IMR_CPBS_Msk                     (_U(0x1) << TC_IMR_CPBS_Pos)                   /**< (TC_IMR) RB Compare Mask */
...
#define TC_IMR_CPCS_Msk                     (_U(0x1) << TC_IMR_CPCS_Pos)                   /**< (TC_IMR) RC Compare Mask */
...
#define TC_IMR_LDRAS_Msk                    (_U(0x1) << TC_IMR_LDRAS_Pos)                  /**< (TC_IMR) RA Loading Mask */
...
#define TC_IMR_LDRBS_Msk                    (_U(0x1) << TC_IMR_LDRBS_Pos)                  /**< (TC_IMR) RB Loading Mask */
...
#define TC_IMR_ETRGS_Msk                    (_U(0x1) << TC_IMR_ETRGS_Pos)                  /**< (TC_IMR) External Trigger Mask */
...
#define TC_IMR_ENDRX_Msk                    (_U(0x1) << TC_IMR_ENDRX_Pos)                  /**< (TC_IMR) End of Receiver Transfer Mask */
...
#define TC_IMR_RXBUFF_Msk                   (_U(0x1) << TC_IMR_RXBUFF_Pos)                 /**< (TC_IMR) Reception Buffer Full Mask */
...
#define TC_IMR_MASK                         _U(0x3FF)                                      /**< \deprecated (TC_IMR) Register MASK  (Use TC_IMR_Msk instead)  */
#define TC_IMR_Msk                          _U(0x3FF)                                      /**< (TC_IMR) Register Mask  */
...
#define TC_BCR_SYNC_Msk                     (_U(0x1) << TC_BCR_SYNC_Pos)                   /**< (TC_BCR) Synchro Command Mask */
#define TC_BCR_SYNC                         TC_BCR_SYNC_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use TC_BCR_SYNC_Msk instead */
#define TC_BCR_MASK                         _U(0x01)                                       /**< \deprecated (TC_BCR) Register MASK  (Use TC_BCR_Msk instead)  */
#define TC_BCR_Msk                          _U(0x01)                                       /**< (TC_BCR) Register Mask  */
...
#define TC_BMR_TC0XC0S_Msk                  (_U(0x3) << TC_BMR_TC0XC0S_Pos)                /**< (TC_BMR) External Clock Signal 0 Selection Mask */
#define TC_BMR_TC0XC0S(value)               (TC_BMR_TC0XC0S_Msk & ((value) << TC_BMR_TC0XC0S_Pos))
#define   TC_BMR_TC0XC0S_TCLK0_Val          _U(0x0)                                        /**< (TC_BMR) Signal connected to XC0: TCLK0  */
#define   TC_BMR_TC0XC0S_TIOA1_Val          _U(0x2)                                        /**< (TC_BMR) Signal connected to XC0: TIOA1  */
#define   TC_BMR_TC0XC0S_TIOA2_Val          _U(0x3)                                        /**< (TC_BMR) Signal connected to XC0: TIOA2  */
...
#define TC_BMR_TC1XC1S_Msk                  (_U(0x3) << TC_BMR_TC1XC1S_Pos)                /**< (TC_BMR) External Clock Signal 1 Selection Mask */
#define TC_BMR_TC1XC1S(value)               (TC_BMR_TC1XC1S_Msk & ((value) << TC_BMR_TC1XC1S_Pos))
#define   TC_BMR_TC1XC1S_TCLK1_Val          _U(0x0)                                        /**< (TC_BMR) Signal connected to XC1: TCLK1  */
#define   TC_BMR_TC1XC1S_TIOA0_Val          _U(0x2)                                        /**< (TC_BMR) Signal connected to XC1: TIOA0  */
#define   TC_BMR_TC1XC1S_TIOA2_Val          _U(0x3)                                        /**< (TC_BMR) Signal connected to XC1: TIOA2  */
...
#define TC_BMR_TC2XC2S_Msk                  (_U(0x3) << TC_BMR_TC2XC2S_Pos)                /**< (TC_BMR) External Clock Signal 2 Selection Mask */
#define TC_BMR_TC2XC2S(value)               (TC_BMR_TC2XC2S_Msk & ((value) << TC_BMR_TC2XC2S_Pos))
#define   TC_BMR_TC2XC2S_TCLK2_Val          _U(0x0)                                        /**< (TC_BMR) Signal connected to XC2: TCLK2  */
#define   TC_BMR_TC2XC2S_TIOA0_Val          _U(0x2)                                        /**< (TC_BMR) Signal connected to XC2: TIOA0  */
#define   TC_BMR_TC2XC2S_TIOA1_Val          _U(0x3)                                        /**< (TC_BMR) Signal connected to XC2: TIOA1  */
...
#define TC_BMR_MASK                         _U(0x3F)                                       /**< \deprecated (TC_BMR) Register MASK  (Use TC_BMR_Msk instead)  */
#define TC_BMR_Msk                          _U(0x3F)                                       /**< (TC_BMR) Register Mask  */
...
#define TC_WPMR_WPEN_Msk                    (_U(0x1) << TC_WPMR_WPEN_Pos)                  /**< (TC_WPMR) Write Protection Enable Mask */
...
#define TC_WPMR_WPKEY_Msk                   (_U(0xFFFFFF) << TC_WPMR_WPKEY_Pos)            /**< (TC_WPMR) Write Protection Key Mask */
#define TC_WPMR_WPKEY(value)                (TC_WPMR_WPKEY_Msk & ((value) << TC_WPMR_WPKEY_Pos))
#define   TC_WPMR_WPKEY_PASSWD_Val          _U(0x54494D)                                   /**< (TC_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit.Always reads as 0.  */
...
#define TC_WPMR_MASK                        _U(0xFFFFFF01)                                 /**< \deprecated (TC_WPMR) Register MASK  (Use TC_WPMR_Msk instead)  */
#define TC_WPMR_Msk                         _U(0xFFFFFF01)                                 /**< (TC_WPMR) Register Mask  */
...
#define TC_RPR0_RXPTR_Msk                   (_U(0xFFFFFFFF) << TC_RPR0_RXPTR_Pos)          /**< (TC_RPR0) Receive Pointer Register Mask */
#define TC_RPR0_RXPTR(value)                (TC_RPR0_RXPTR_Msk & ((value) << TC_RPR0_RXPTR_Pos))
#define TC_RPR0_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (TC_RPR0) Register MASK  (Use TC_RPR0_Msk instead)  */
#define TC_RPR0_Msk                         _U(0xFFFFFFFF)                                 /**< (TC_RPR0) Register Mask  */
...
#define TC_RNPR0_RXNPTR_Msk                 (_U(0xFFFFFFFF) << TC_RNPR0_RXNPTR_Pos)        /**< (TC_RNPR0) Receive Next Pointer Mask */
#define TC_RNPR0_RXNPTR(value)              (TC_RNPR0_RXNPTR_Msk & ((value) << TC_RNPR0_RXNPTR_Pos))
#define TC_RNPR0_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (TC_RNPR0) Register MASK  (Use TC_RNPR0_Msk instead)  */
#define TC_RNPR0_Msk                        _U(0xFFFFFFFF)                                 /**< (TC_RNPR0) Register Mask  */
...
#define TC_RNCR0_RXNCTR_Msk                 (_U(0xFFFF) << TC_RNCR0_RXNCTR_Pos)            /**< (TC_RNCR0) Receive Next Counter Mask */
#define TC_RNCR0_RXNCTR(value)              (TC_RNCR0_RXNCTR_Msk & ((value) << TC_RNCR0_RXNCTR_Pos))
#define TC_RNCR0_MASK                       _U(0xFFFF)                                     /**< \deprecated (TC_RNCR0) Register MASK  (Use TC_RNCR0_Msk instead)  */
#define TC_RNCR0_Msk                        _U(0xFFFF)                                     /**< (TC_RNCR0) Register Mask  */
...
#define TC_PTCR0_RXTEN_Msk                  (_U(0x1) << TC_PTCR0_RXTEN_Pos)                /**< (TC_PTCR0) Receiver Transfer Enable Mask */
...
#define TC_PTCR0_RXTDIS_Msk                 (_U(0x1) << TC_PTCR0_RXTDIS_Pos)               /**< (TC_PTCR0) Receiver Transfer Disable Mask */
...
#define TC_PTCR0_TXTEN_Msk                  (_U(0x1) << TC_PTCR0_TXTEN_Pos)                /**< (TC_PTCR0) Transmitter Transfer Enable Mask */
...
#define TC_PTCR0_TXTDIS_Msk                 (_U(0x1) << TC_PTCR0_TXTDIS_Pos)               /**< (TC_PTCR0) Transmitter Transfer Disable Mask */
...
#define TC_PTCR0_RXCBEN_Msk                 (_U(0x1) << TC_PTCR0_RXCBEN_Pos)               /**< (TC_PTCR0) Receiver Circular Buffer Enable Mask */
...
#define TC_PTCR0_RXCBDIS_Msk                (_U(0x1) << TC_PTCR0_RXCBDIS_Pos)              /**< (TC_PTCR0) Receiver Circular Buffer Disable Mask */
...
#define TC_PTCR0_TXCBEN_Msk                 (_U(0x1) << TC_PTCR0_TXCBEN_Pos)               /**< (TC_PTCR0) Transmitter Circular Buffer Enable Mask */
...
#define TC_PTCR0_TXCBDIS_Msk                (_U(0x1) << TC_PTCR0_TXCBDIS_Pos)              /**< (TC_PTCR0) Transmitter Circular Buffer Disable Mask */
...
#define TC_PTCR0_ERRCLR_Msk                 (_U(0x1) << TC_PTCR0_ERRCLR_Pos)               /**< (TC_PTCR0) Transfer Bus Error Clear Mask */
...
#define TC_PTCR0_MASK                       _U(0x10F0303)                                  /**< \deprecated (TC_PTCR0) Register MASK  (Use TC_PTCR0_Msk instead)  */
#define TC_PTCR0_Msk                        _U(0x10F0303)                                  /**< (TC_PTCR0) Register Mask  */
...
#define TC_PTSR0_RXTEN_Msk                  (_U(0x1) << TC_PTSR0_RXTEN_Pos)                /**< (TC_PTSR0) Receiver Transfer Enable Mask */
...
#define TC_PTSR0_TXTEN_Msk                  (_U(0x1) << TC_PTSR0_TXTEN_Pos)                /**< (TC_PTSR0) Transmitter Transfer Enable Mask */
...
#define TC_PTSR0_RXCBEN_Msk                 (_U(0x1) << TC_PTSR0_RXCBEN_Pos)               /**< (TC_PTSR0) Receiver Circular Buffer Enable Mask */
...
#define TC_PTSR0_TXCBEN_Msk                 (_U(0x1) << TC_PTSR0_TXCBEN_Pos)               /**< (TC_PTSR0) Transmitter Circular Buffer Enable Mask */
...
#define TC_PTSR0_ERR_Msk                    (_U(0x1) << TC_PTSR0_ERR_Pos)                  /**< (TC_PTSR0) Transfer Bus Error Mask */
...
#define TC_PTSR0_MASK                       _U(0x1050101)                                  /**< \deprecated (TC_PTSR0) Register MASK  (Use TC_PTSR0_Msk instead)  */
#define TC_PTSR0_Msk                        _U(0x1050101)                                  /**< (TC_PTSR0) Register Mask  */
