...
#define SUPC_CR_VROFF_Msk                   (_U(0x1) << SUPC_CR_VROFF_Pos)                 /**< (SUPC_CR) Voltage Regulator Off Mask */
...
#define   SUPC_CR_VROFF_NO_EFFECT_Val       _U(0x0)                                        /**< (SUPC_CR) No effect.  */
#define   SUPC_CR_VROFF_STOP_VREG_Val       _U(0x1)                                        /**< (SUPC_CR) If KEY is correct, asserts the system reset signal and stops the voltage regulator.  */
...
#define SUPC_CR_XTALSEL_Msk                 (_U(0x1) << SUPC_CR_XTALSEL_Pos)               /**< (SUPC_CR) Crystal Oscillator Select Mask */
...
#define   SUPC_CR_XTALSEL_NO_EFFECT_Val     _U(0x0)                                        /**< (SUPC_CR) No effect.  */
#define   SUPC_CR_XTALSEL_CRYSTAL_SEL_Val   _U(0x1)                                        /**< (SUPC_CR) If KEY is correct, switches the slow clock on the crystal oscillator output.  */
...
#define SUPC_CR_KEY_Msk                     (_U(0xFF) << SUPC_CR_KEY_Pos)                  /**< (SUPC_CR) Password Mask */
#define SUPC_CR_KEY(value)                  (SUPC_CR_KEY_Msk & ((value) << SUPC_CR_KEY_Pos))
#define   SUPC_CR_KEY_PASSWD_Val            _U(0xA5)                                       /**< (SUPC_CR) Writing any other value in this field aborts the write operation.Always reads as 0.  */
...
#define SUPC_CR_MASK                        _U(0xFF00000C)                                 /**< \deprecated (SUPC_CR) Register MASK  (Use SUPC_CR_Msk instead)  */
#define SUPC_CR_Msk                         _U(0xFF00000C)                                 /**< (SUPC_CR) Register Mask  */
...
#define SUPC_SMMR_SMTH_Msk                  (_U(0xF) << SUPC_SMMR_SMTH_Pos)                /**< (SUPC_SMMR) Supply Monitor Threshold Mask */
...
#define SUPC_SMMR_SMSMPL_Msk                (_U(0x7) << SUPC_SMMR_SMSMPL_Pos)              /**< (SUPC_SMMR) Supply Monitor Sampling Period Mask */
#define SUPC_SMMR_SMSMPL(value)             (SUPC_SMMR_SMSMPL_Msk & ((value) << SUPC_SMMR_SMSMPL_Pos))
#define   SUPC_SMMR_SMSMPL_SMD_Val          _U(0x0)                                        /**< (SUPC_SMMR) Supply Monitor disabled  */
#define   SUPC_SMMR_SMSMPL_CSM_Val          _U(0x1)                                        /**< (SUPC_SMMR) Continuous Supply Monitor  */
#define   SUPC_SMMR_SMSMPL_32SLCK_Val       _U(0x2)                                        /**< (SUPC_SMMR) Supply Monitor enables one SLCK period every 32 SLCK periods  */
#define   SUPC_SMMR_SMSMPL_256SLCK_Val      _U(0x3)                                        /**< (SUPC_SMMR) Supply Monitor enables one SLCK period every 256 SLCK periods  */
#define   SUPC_SMMR_SMSMPL_2048SLCK_Val     _U(0x4)                                        /**< (SUPC_SMMR) Supply Monitor enables one SLCK period every 2,048 SLCK periods  */
...
#define SUPC_SMMR_SMRSTEN_Msk               (_U(0x1) << SUPC_SMMR_SMRSTEN_Pos)             /**< (SUPC_SMMR) Supply Monitor Reset Enable Mask */
...
#define   SUPC_SMMR_SMRSTEN_NOT_ENABLE_Val  _U(0x0)                                        /**< (SUPC_SMMR) The core reset signal vddcore_nreset is not affected when a supply monitor detection occurs.  */
#define   SUPC_SMMR_SMRSTEN_ENABLE_Val      _U(0x1)                                        /**< (SUPC_SMMR) The core reset signal vddcore_nreset is asserted when a supply monitor detection occurs.  */
...
#define SUPC_SMMR_SMIEN_Msk                 (_U(0x1) << SUPC_SMMR_SMIEN_Pos)               /**< (SUPC_SMMR) Supply Monitor Interrupt Enable Mask */
...
#define   SUPC_SMMR_SMIEN_NOT_ENABLE_Val    _U(0x0)                                        /**< (SUPC_SMMR) The SUPC interrupt signal is not affected when a supply monitor detection occurs.  */
#define   SUPC_SMMR_SMIEN_ENABLE_Val        _U(0x1)                                        /**< (SUPC_SMMR) The SUPC interrupt signal is asserted when a supply monitor detection occurs.  */
...
#define SUPC_SMMR_MASK                      _U(0x370F)                                     /**< \deprecated (SUPC_SMMR) Register MASK  (Use SUPC_SMMR_Msk instead)  */
#define SUPC_SMMR_Msk                       _U(0x370F)                                     /**< (SUPC_SMMR) Register Mask  */
...
#define SUPC_MR_BODRSTEN_Msk                (_U(0x1) << SUPC_MR_BODRSTEN_Pos)              /**< (SUPC_MR) POR Core Reset Enable Mask */
...
#define   SUPC_MR_BODRSTEN_NOT_ENABLE_Val   _U(0x0)                                        /**< (SUPC_MR) The core reset signal vddcore_nreset is not affected when a brownout detection occurs.  */
#define   SUPC_MR_BODRSTEN_ENABLE_Val       _U(0x1)                                        /**< (SUPC_MR) The core reset signal vddcore_nreset is asserted when a brownout detection occurs.  */
...
#define SUPC_MR_BODDIS_Msk                  (_U(0x1) << SUPC_MR_BODDIS_Pos)                /**< (SUPC_MR) POR Core Disable Mask */
...
#define   SUPC_MR_BODDIS_ENABLE_Val         _U(0x0)                                        /**< (SUPC_MR) The core brownout detector is enabled.  */
#define   SUPC_MR_BODDIS_DISABLE_Val        _U(0x1)                                        /**< (SUPC_MR) The core brownout detector is disabled.  */
...
#define SUPC_MR_OSCBYPASS_Msk               (_U(0x1) << SUPC_MR_OSCBYPASS_Pos)             /**< (SUPC_MR) Oscillator Bypass Mask */
...
#define   SUPC_MR_OSCBYPASS_NO_EFFECT_Val   _U(0x0)                                        /**< (SUPC_MR) No effect. Clock selection depends on XTALSEL value.  */
#define   SUPC_MR_OSCBYPASS_BYPASS_Val      _U(0x1)                                        /**< (SUPC_MR) The 32 kHz crystal oscillator is bypassed if XTALSEL=1. OSCBYPASS must be set prior to write XTALSEL=1.  */
...
#define SUPC_MR_CDPSWITCH_Msk               (_U(0x1) << SUPC_MR_CDPSWITCH_Pos)             /**< (SUPC_MR) Cache Data SRAM Power Switch Mask */
...
#define   SUPC_MR_CDPSWITCH_OFF_Val         _U(0x0)                                        /**< (SUPC_MR) The cache data SRAM is not powered.  */
#define   SUPC_MR_CDPSWITCH_ON_Val          _U(0x1)                                        /**< (SUPC_MR) The cache data SRAM is powered.  */
...
#define SUPC_MR_CTPSWITCH_Msk               (_U(0x1) << SUPC_MR_CTPSWITCH_Pos)             /**< (SUPC_MR) Cache Tag SRAM Power Switch Mask */
...
#define   SUPC_MR_CTPSWITCH_OFF_Val         _U(0x0)                                        /**< (SUPC_MR) The cache tag SRAM is not powered.  */
#define   SUPC_MR_CTPSWITCH_ON_Val          _U(0x1)                                        /**< (SUPC_MR) The cache tag SRAM is powered.  */
...
#define SUPC_MR_ONE_Msk                     (_U(0x1) << SUPC_MR_ONE_Pos)                   /**< (SUPC_MR) This bit must always be set to 1. Mask */
...
#define SUPC_MR_KEY_Msk                     (_U(0xFF) << SUPC_MR_KEY_Pos)                  /**< (SUPC_MR) Password Key Mask */
#define SUPC_MR_KEY(value)                  (SUPC_MR_KEY_Msk & ((value) << SUPC_MR_KEY_Pos))
#define   SUPC_MR_KEY_PASSWD_Val            _U(0xA5)                                       /**< (SUPC_MR) Writing any other value in this field aborts the write operation.Always reads as 0.  */
...
#define SUPC_MR_MASK                        _U(0xFFF03000)                                 /**< \deprecated (SUPC_MR) Register MASK  (Use SUPC_MR_Msk instead)  */
#define SUPC_MR_Msk                         _U(0xFFF03000)                                 /**< (SUPC_MR) Register Mask  */
...
#define SUPC_WUMR_SMEN_Msk                  (_U(0x1) << SUPC_WUMR_SMEN_Pos)                /**< (SUPC_WUMR) Supply Monitor Wake-up Enable Mask */
...
#define   SUPC_WUMR_SMEN_NOT_ENABLE_Val     _U(0x0)                                        /**< (SUPC_WUMR) The supply monitor detection has no wake-up effect.  */
#define   SUPC_WUMR_SMEN_ENABLE_Val         _U(0x1)                                        /**< (SUPC_WUMR) The supply monitor detection forces the wake-up of the core power supply.  */
...
#define SUPC_WUMR_RTTEN_Msk                 (_U(0x1) << SUPC_WUMR_RTTEN_Pos)               /**< (SUPC_WUMR) Real-time Timer Wake-up Enable Mask */
...
#define   SUPC_WUMR_RTTEN_ENABLE_Val        _U(0x1)                                        /**< (SUPC_WUMR) The RTT alarm signal forces the wake-up of the core power supply.  */
...
#define SUPC_WUMR_RTCEN_Msk                 (_U(0x1) << SUPC_WUMR_RTCEN_Pos)               /**< (SUPC_WUMR) Real-time Clock Wake-up Enable Mask */
...
#define   SUPC_WUMR_RTCEN_ENABLE_Val        _U(0x1)                                        /**< (SUPC_WUMR) The RTC alarm signal forces the wake-up of the core power supply.  */
...
#define SUPC_WUMR_LPDBCEN0_Msk              (_U(0x1) << SUPC_WUMR_LPDBCEN0_Pos)            /**< (SUPC_WUMR) Low-power Debouncer Enable WKUP0 Mask */
...
#define   SUPC_WUMR_LPDBCEN0_NOT_ENABLE_Val _U(0x0)                                        /**< (SUPC_WUMR) The WKUP0 input pin is not connected to the low-power debouncer.  */
#define   SUPC_WUMR_LPDBCEN0_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUMR) The WKUP0 input pin is connected to the low-power debouncer and forces a system wake-up.  */
...
#define SUPC_WUMR_LPDBCEN1_Msk              (_U(0x1) << SUPC_WUMR_LPDBCEN1_Pos)            /**< (SUPC_WUMR) Low-power Debouncer Enable WKUP1 Mask */
...
#define   SUPC_WUMR_LPDBCEN1_NOT_ENABLE_Val _U(0x0)                                        /**< (SUPC_WUMR) The WKUP1 input pin is not connected to the low-power debouncer.  */
#define   SUPC_WUMR_LPDBCEN1_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUMR) The WKUP1 input pin is connected to the low-power debouncer and forces a system wake-up.  */
...
#define SUPC_WUMR_LPDBCCLR_Msk              (_U(0x1) << SUPC_WUMR_LPDBCCLR_Pos)            /**< (SUPC_WUMR) Low-power Debouncer Clear Mask */
...
#define   SUPC_WUMR_LPDBCCLR_NOT_ENABLE_Val _U(0x0)                                        /**< (SUPC_WUMR) A low-power debounce event does not create an immediate clear on the first half of GPBR registers.  */
#define   SUPC_WUMR_LPDBCCLR_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUMR) A low-power debounce event on WKUP0 or WKUP1 generates an immediate clear on the first half of GPBR registers.  */
...
#define SUPC_WUMR_WKUPDBC_Msk               (_U(0x7) << SUPC_WUMR_WKUPDBC_Pos)             /**< (SUPC_WUMR) Wake-up Inputs Debouncer Period Mask */
#define SUPC_WUMR_WKUPDBC(value)            (SUPC_WUMR_WKUPDBC_Msk & ((value) << SUPC_WUMR_WKUPDBC_Pos))
#define   SUPC_WUMR_WKUPDBC_IMMEDIATE_Val   _U(0x0)                                        /**< (SUPC_WUMR) Immediate, no debouncing, detected active at least on one Slow Clock edge.  */
#define   SUPC_WUMR_WKUPDBC_3_SCLK_Val      _U(0x1)                                        /**< (SUPC_WUMR) WKUPx shall be in its active state for at least 3 SLCK periods  */
#define   SUPC_WUMR_WKUPDBC_32_SCLK_Val     _U(0x2)                                        /**< (SUPC_WUMR) WKUPx shall be in its active state for at least 32 SLCK periods  */
#define   SUPC_WUMR_WKUPDBC_512_SCLK_Val    _U(0x3)                                        /**< (SUPC_WUMR) WKUPx shall be in its active state for at least 512 SLCK periods  */
#define   SUPC_WUMR_WKUPDBC_4096_SCLK_Val   _U(0x4)                                        /**< (SUPC_WUMR) WKUPx shall be in its active state for at least 4,096 SLCK periods  */
#define   SUPC_WUMR_WKUPDBC_32768_SCLK_Val  _U(0x5)                                        /**< (SUPC_WUMR) WKUPx shall be in its active state for at least 32,768 SLCK periods  */
...
#define SUPC_WUMR_LPDBC_Msk                 (_U(0x7) << SUPC_WUMR_LPDBC_Pos)               /**< (SUPC_WUMR) Low-power Debouncer Period Mask */
#define SUPC_WUMR_LPDBC(value)              (SUPC_WUMR_LPDBC_Msk & ((value) << SUPC_WUMR_LPDBC_Pos))
#define   SUPC_WUMR_LPDBC_DISABLE_Val       _U(0x0)                                        /**< (SUPC_WUMR) Disable the low-power debouncers.  */
#define   SUPC_WUMR_LPDBC_2_RTCOUT0_Val     _U(0x1)                                        /**< (SUPC_WUMR) WKUP0/1 in active state for at least 2 RTCOUTx periods  */
#define   SUPC_WUMR_LPDBC_3_RTCOUT0_Val     _U(0x2)                                        /**< (SUPC_WUMR) WKUP0/1 in active state for at least 3 RTCOUTx periods  */
#define   SUPC_WUMR_LPDBC_4_RTCOUT0_Val     _U(0x3)                                        /**< (SUPC_WUMR) WKUP0/1 in active state for at least 4 RTCOUTx periods  */
#define   SUPC_WUMR_LPDBC_5_RTCOUT0_Val     _U(0x4)                                        /**< (SUPC_WUMR) WKUP0/1 in active state for at least 5 RTCOUTx periods  */
#define   SUPC_WUMR_LPDBC_6_RTCOUT0_Val     _U(0x5)                                        /**< (SUPC_WUMR) WKUP0/1 in active state for at least 6 RTCOUTx periods  */
#define   SUPC_WUMR_LPDBC_7_RTCOUT0_Val     _U(0x6)                                        /**< (SUPC_WUMR) WKUP0/1 in active state for at least 7 RTCOUTx periods  */
#define   SUPC_WUMR_LPDBC_8_RTCOUT0_Val     _U(0x7)                                        /**< (SUPC_WUMR) WKUP0/1 in active state for at least 8 RTCOUTx periods  */
...
#define SUPC_WUMR_LPDBCEN_Msk               (_U(0x3) << SUPC_WUMR_LPDBCEN_Pos)             /**< (SUPC_WUMR Mask) LPDBCEN */
#define SUPC_WUMR_LPDBCEN(value)            (SUPC_WUMR_LPDBCEN_Msk & ((value) << SUPC_WUMR_LPDBCEN_Pos))  
#define SUPC_WUMR_MASK                      _U(0x770EE)                                    /**< \deprecated (SUPC_WUMR) Register MASK  (Use SUPC_WUMR_Msk instead)  */
#define SUPC_WUMR_Msk                       _U(0x770EE)                                    /**< (SUPC_WUMR) Register Mask  */
...
#define SUPC_WUIR_WKUPEN0_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN0_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 0 Mask */
...
#define   SUPC_WUIR_WKUPEN0_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN0_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN1_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN1_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 1 Mask */
...
#define   SUPC_WUIR_WKUPEN1_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN1_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN2_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN2_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 2 Mask */
...
#define   SUPC_WUIR_WKUPEN2_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN2_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN3_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN3_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 3 Mask */
...
#define   SUPC_WUIR_WKUPEN3_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN3_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN4_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN4_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 4 Mask */
...
#define   SUPC_WUIR_WKUPEN4_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN4_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN5_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN5_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 5 Mask */
...
#define   SUPC_WUIR_WKUPEN5_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN5_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN6_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN6_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 6 Mask */
...
#define   SUPC_WUIR_WKUPEN6_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN6_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN7_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN7_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 7 Mask */
...
#define   SUPC_WUIR_WKUPEN7_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN7_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN8_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN8_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 8 Mask */
...
#define   SUPC_WUIR_WKUPEN8_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN8_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN9_Msk               (_U(0x1) << SUPC_WUIR_WKUPEN9_Pos)             /**< (SUPC_WUIR) Wake-up Input Enable 9 Mask */
...
#define   SUPC_WUIR_WKUPEN9_DISABLE_Val     _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN9_ENABLE_Val      _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN10_Msk              (_U(0x1) << SUPC_WUIR_WKUPEN10_Pos)            /**< (SUPC_WUIR) Wake-up Input Enable 10 Mask */
...
#define   SUPC_WUIR_WKUPEN10_DISABLE_Val    _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN10_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN11_Msk              (_U(0x1) << SUPC_WUIR_WKUPEN11_Pos)            /**< (SUPC_WUIR) Wake-up Input Enable 11 Mask */
...
#define   SUPC_WUIR_WKUPEN11_DISABLE_Val    _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN11_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN12_Msk              (_U(0x1) << SUPC_WUIR_WKUPEN12_Pos)            /**< (SUPC_WUIR) Wake-up Input Enable 12 Mask */
...
#define   SUPC_WUIR_WKUPEN12_DISABLE_Val    _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN12_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN13_Msk              (_U(0x1) << SUPC_WUIR_WKUPEN13_Pos)            /**< (SUPC_WUIR) Wake-up Input Enable 13 Mask */
...
#define   SUPC_WUIR_WKUPEN13_DISABLE_Val    _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN13_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN14_Msk              (_U(0x1) << SUPC_WUIR_WKUPEN14_Pos)            /**< (SUPC_WUIR) Wake-up Input Enable 14 Mask */
...
#define   SUPC_WUIR_WKUPEN14_DISABLE_Val    _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN14_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN15_Msk              (_U(0x1) << SUPC_WUIR_WKUPEN15_Pos)            /**< (SUPC_WUIR) Wake-up Input Enable 15 Mask */
...
#define   SUPC_WUIR_WKUPEN15_DISABLE_Val    _U(0x0)                                        /**< (SUPC_WUIR) The corresponding wake-up input has no wake-up effect.  */
#define   SUPC_WUIR_WKUPEN15_ENABLE_Val     _U(0x1)                                        /**< (SUPC_WUIR) The corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT0_Msk                (_U(0x1) << SUPC_WUIR_WKUPT0_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 0 Mask */
...
#define   SUPC_WUIR_WKUPT0_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT0_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT1_Msk                (_U(0x1) << SUPC_WUIR_WKUPT1_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 1 Mask */
...
#define   SUPC_WUIR_WKUPT1_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT1_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT2_Msk                (_U(0x1) << SUPC_WUIR_WKUPT2_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 2 Mask */
...
#define   SUPC_WUIR_WKUPT2_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT2_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT3_Msk                (_U(0x1) << SUPC_WUIR_WKUPT3_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 3 Mask */
...
#define   SUPC_WUIR_WKUPT3_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT3_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT4_Msk                (_U(0x1) << SUPC_WUIR_WKUPT4_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 4 Mask */
...
#define   SUPC_WUIR_WKUPT4_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT4_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT5_Msk                (_U(0x1) << SUPC_WUIR_WKUPT5_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 5 Mask */
...
#define   SUPC_WUIR_WKUPT5_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT5_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT6_Msk                (_U(0x1) << SUPC_WUIR_WKUPT6_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 6 Mask */
...
#define   SUPC_WUIR_WKUPT6_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT6_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT7_Msk                (_U(0x1) << SUPC_WUIR_WKUPT7_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 7 Mask */
...
#define   SUPC_WUIR_WKUPT7_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT7_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT8_Msk                (_U(0x1) << SUPC_WUIR_WKUPT8_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 8 Mask */
...
#define   SUPC_WUIR_WKUPT8_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT8_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT9_Msk                (_U(0x1) << SUPC_WUIR_WKUPT9_Pos)              /**< (SUPC_WUIR) Wake-up Input Type 9 Mask */
...
#define   SUPC_WUIR_WKUPT9_LOW_Val          _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT9_HIGH_Val         _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT10_Msk               (_U(0x1) << SUPC_WUIR_WKUPT10_Pos)             /**< (SUPC_WUIR) Wake-up Input Type 10 Mask */
...
#define   SUPC_WUIR_WKUPT10_LOW_Val         _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT10_HIGH_Val        _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT11_Msk               (_U(0x1) << SUPC_WUIR_WKUPT11_Pos)             /**< (SUPC_WUIR) Wake-up Input Type 11 Mask */
...
#define   SUPC_WUIR_WKUPT11_LOW_Val         _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT11_HIGH_Val        _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT12_Msk               (_U(0x1) << SUPC_WUIR_WKUPT12_Pos)             /**< (SUPC_WUIR) Wake-up Input Type 12 Mask */
...
#define   SUPC_WUIR_WKUPT12_LOW_Val         _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT12_HIGH_Val        _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT13_Msk               (_U(0x1) << SUPC_WUIR_WKUPT13_Pos)             /**< (SUPC_WUIR) Wake-up Input Type 13 Mask */
...
#define   SUPC_WUIR_WKUPT13_LOW_Val         _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT13_HIGH_Val        _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT14_Msk               (_U(0x1) << SUPC_WUIR_WKUPT14_Pos)             /**< (SUPC_WUIR) Wake-up Input Type 14 Mask */
...
#define   SUPC_WUIR_WKUPT14_LOW_Val         _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT14_HIGH_Val        _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPT15_Msk               (_U(0x1) << SUPC_WUIR_WKUPT15_Pos)             /**< (SUPC_WUIR) Wake-up Input Type 15 Mask */
...
#define   SUPC_WUIR_WKUPT15_LOW_Val         _U(0x0)                                        /**< (SUPC_WUIR) A falling edge followed by a low level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
#define   SUPC_WUIR_WKUPT15_HIGH_Val        _U(0x1)                                        /**< (SUPC_WUIR) A rising edge followed by a high level for a period defined by WKUPDBC on the corresponding wake-up input forces the wake-up of the core power supply.  */
...
#define SUPC_WUIR_WKUPEN_Msk                (_U(0xFFFF) << SUPC_WUIR_WKUPEN_Pos)           /**< (SUPC_WUIR Mask) WKUPEN */
...
#define SUPC_WUIR_WKUPT_Msk                 (_U(0xFFFF) << SUPC_WUIR_WKUPT_Pos)            /**< (SUPC_WUIR Mask) WKUPT */
#define SUPC_WUIR_WKUPT(value)              (SUPC_WUIR_WKUPT_Msk & ((value) << SUPC_WUIR_WKUPT_Pos))  
#define SUPC_WUIR_MASK                      _U(0xFFFFFFFF)                                 /**< \deprecated (SUPC_WUIR) Register MASK  (Use SUPC_WUIR_Msk instead)  */
#define SUPC_WUIR_Msk                       _U(0xFFFFFFFF)                                 /**< (SUPC_WUIR) Register Mask  */
...
#define SUPC_SR_WKUPS_Msk                   (_U(0x1) << SUPC_SR_WKUPS_Pos)                 /**< (SUPC_SR) WKUP Wake-up Status (cleared on read) Mask */
...
#define   SUPC_SR_WKUPS_NO_Val              _U(0x0)                                        /**< (SUPC_SR) No wake-up due to the assertion of the WKUP pins has occurred since the last read of SUPC_SR.  */
#define   SUPC_SR_WKUPS_PRESENT_Val         _U(0x1)                                        /**< (SUPC_SR) At least one wake-up due to the assertion of the WKUP pins has occurred since the last read of SUPC_SR.  */
...
#define SUPC_SR_BODRSTS_Msk                 (_U(0x1) << SUPC_SR_BODRSTS_Pos)               /**< (SUPC_SR) Brownout Detector Reset Status (cleared on read) Mask */
...
#define   SUPC_SR_BODRSTS_NO_Val            _U(0x0)                                        /**< (SUPC_SR) No core brownout rising edge event has been detected since the last read of SUPC_SR.  */
#define   SUPC_SR_BODRSTS_PRESENT_Val       _U(0x1)                                        /**< (SUPC_SR) At least one brownout output rising edge event has been detected since the last read of SUPC_SR.  */
...
#define SUPC_SR_SMRSTS_Msk                  (_U(0x1) << SUPC_SR_SMRSTS_Pos)                /**< (SUPC_SR) Supply Monitor Reset Status (cleared on read) Mask */
...
#define   SUPC_SR_SMRSTS_NO_Val             _U(0x0)                                        /**< (SUPC_SR) No supply monitor detection has generated a core reset since the last read of SUPC_SR.  */
#define   SUPC_SR_SMRSTS_PRESENT_Val        _U(0x1)                                        /**< (SUPC_SR) At least one supply monitor detection has generated a core reset since the last read of SUPC_SR.  */
...
#define SUPC_SR_SMS_Msk                     (_U(0x1) << SUPC_SR_SMS_Pos)                   /**< (SUPC_SR) Supply Monitor Status (cleared on read) Mask */
#define SUPC_SR_SMS                         SUPC_SR_SMS_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use SUPC_SR_SMS_Msk instead */
#define   SUPC_SR_SMS_NO_Val                _U(0x0)                                        /**< (SUPC_SR) No supply monitor detection since the last read of SUPC_SR.  */
#define   SUPC_SR_SMS_PRESENT_Val           _U(0x1)                                        /**< (SUPC_SR) At least one supply monitor detection since the last read of SUPC_SR.  */
...
#define SUPC_SR_SMOS_Msk                    (_U(0x1) << SUPC_SR_SMOS_Pos)                  /**< (SUPC_SR) Supply Monitor Output Status Mask */
...
#define   SUPC_SR_SMOS_HIGH_Val             _U(0x0)                                        /**< (SUPC_SR) The supply monitor detected VDDIO higher than its threshold at its last measurement.  */
#define   SUPC_SR_SMOS_LOW_Val              _U(0x1)                                        /**< (SUPC_SR) The supply monitor detected VDDIO lower than its threshold at its last measurement.  */
...
#define SUPC_SR_OSCSEL_Msk                  (_U(0x1) << SUPC_SR_OSCSEL_Pos)                /**< (SUPC_SR) 32-kHz Oscillator Selection Status Mask */
...
#define   SUPC_SR_OSCSEL_RC_Val             _U(0x0)                                        /**< (SUPC_SR) The slow clock SLCK is generated by the embedded 32 kHz RC oscillator.  */
#define   SUPC_SR_OSCSEL_CRYST_Val          _U(0x1)                                        /**< (SUPC_SR) The slow clock SLCK is generated by the 32 kHz crystal oscillator.  */
...
#define SUPC_SR_LPDBCS0_Msk                 (_U(0x1) << SUPC_SR_LPDBCS0_Pos)               /**< (SUPC_SR) Low-power Debouncer Wake-up Status on WKUP0 (cleared on read) Mask */
...
#define   SUPC_SR_LPDBCS0_NO_Val            _U(0x0)                                        /**< (SUPC_SR) No wake-up due to the assertion of the WKUP0 pin has occurred since the last read of SUPC_SR.  */
#define   SUPC_SR_LPDBCS0_PRESENT_Val       _U(0x1)                                        /**< (SUPC_SR) At least one wake-up due to the assertion of the WKUP0 pin has occurred since the last read of SUPC_SR.  */
...
#define SUPC_SR_LPDBCS1_Msk                 (_U(0x1) << SUPC_SR_LPDBCS1_Pos)               /**< (SUPC_SR) Low-power Debouncer Wake-up Status on WKUP1 (cleared on read) Mask */
...
#define   SUPC_SR_LPDBCS1_NO_Val            _U(0x0)                                        /**< (SUPC_SR) No wake-up due to the assertion of the WKUP1 pin has occurred since the last read of SUPC_SR.  */
#define   SUPC_SR_LPDBCS1_PRESENT_Val       _U(0x1)                                        /**< (SUPC_SR) At least one wake-up due to the assertion of the WKUP1 pin has occurred since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS0_Msk                 (_U(0x1) << SUPC_SR_WKUPIS0_Pos)               /**< (SUPC_SR) WKUP Input Status 0 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS0_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS0_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS1_Msk                 (_U(0x1) << SUPC_SR_WKUPIS1_Pos)               /**< (SUPC_SR) WKUP Input Status 1 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS1_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS1_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS2_Msk                 (_U(0x1) << SUPC_SR_WKUPIS2_Pos)               /**< (SUPC_SR) WKUP Input Status 2 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS2_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS2_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS3_Msk                 (_U(0x1) << SUPC_SR_WKUPIS3_Pos)               /**< (SUPC_SR) WKUP Input Status 3 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS3_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS3_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS4_Msk                 (_U(0x1) << SUPC_SR_WKUPIS4_Pos)               /**< (SUPC_SR) WKUP Input Status 4 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS4_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS4_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS5_Msk                 (_U(0x1) << SUPC_SR_WKUPIS5_Pos)               /**< (SUPC_SR) WKUP Input Status 5 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS5_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS5_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS6_Msk                 (_U(0x1) << SUPC_SR_WKUPIS6_Pos)               /**< (SUPC_SR) WKUP Input Status 6 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS6_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS6_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS7_Msk                 (_U(0x1) << SUPC_SR_WKUPIS7_Pos)               /**< (SUPC_SR) WKUP Input Status 7 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS7_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS7_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS8_Msk                 (_U(0x1) << SUPC_SR_WKUPIS8_Pos)               /**< (SUPC_SR) WKUP Input Status 8 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS8_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS8_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS9_Msk                 (_U(0x1) << SUPC_SR_WKUPIS9_Pos)               /**< (SUPC_SR) WKUP Input Status 9 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS9_DISABLED_Val      _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS9_ENABLED_Val       _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS10_Msk                (_U(0x1) << SUPC_SR_WKUPIS10_Pos)              /**< (SUPC_SR) WKUP Input Status 10 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS10_DISABLED_Val     _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS10_ENABLED_Val      _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS11_Msk                (_U(0x1) << SUPC_SR_WKUPIS11_Pos)              /**< (SUPC_SR) WKUP Input Status 11 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS11_DISABLED_Val     _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS11_ENABLED_Val      _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS12_Msk                (_U(0x1) << SUPC_SR_WKUPIS12_Pos)              /**< (SUPC_SR) WKUP Input Status 12 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS12_DISABLED_Val     _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS12_ENABLED_Val      _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS13_Msk                (_U(0x1) << SUPC_SR_WKUPIS13_Pos)              /**< (SUPC_SR) WKUP Input Status 13 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS13_DISABLED_Val     _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS13_ENABLED_Val      _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS14_Msk                (_U(0x1) << SUPC_SR_WKUPIS14_Pos)              /**< (SUPC_SR) WKUP Input Status 14 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS14_DISABLED_Val     _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS14_ENABLED_Val      _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_WKUPIS15_Msk                (_U(0x1) << SUPC_SR_WKUPIS15_Pos)              /**< (SUPC_SR) WKUP Input Status 15 (cleared on read) Mask */
...
#define   SUPC_SR_WKUPIS15_DISABLED_Val     _U(0x0)                                        /**< (SUPC_SR) The corresponding wake-up input is disabled, or was inactive at the time the debouncer triggered a wake-up event.  */
#define   SUPC_SR_WKUPIS15_ENABLED_Val      _U(0x1)                                        /**< (SUPC_SR) The corresponding wake-up input was active at the time the debouncer triggered a wake-up event since the last read of SUPC_SR.  */
...
#define SUPC_SR_LPDBCS_Msk                  (_U(0x3) << SUPC_SR_LPDBCS_Pos)                /**< (SUPC_SR Mask) LPDBCS */
...
#define SUPC_SR_WKUPIS_Msk                  (_U(0xFFFF) << SUPC_SR_WKUPIS_Pos)             /**< (SUPC_SR Mask) WKUPIS */
#define SUPC_SR_WKUPIS(value)               (SUPC_SR_WKUPIS_Msk & ((value) << SUPC_SR_WKUPIS_Pos))  
#define SUPC_SR_MASK                        _U(0xFFFF60FA)                                 /**< \deprecated (SUPC_SR) Register MASK  (Use SUPC_SR_Msk instead)  */
#define SUPC_SR_Msk                         _U(0xFFFF60FA)                                 /**< (SUPC_SR) Register Mask  */
...
#define SUPC_PWMR_LPOWERS_Msk               (_U(0x1) << SUPC_PWMR_LPOWERS_Pos)             /**< (SUPC_PWMR) Low Power Value Selection Mask */
...
#define   SUPC_PWMR_LPOWERS_FACTORY_Val     _U(0x0)                                        /**< (SUPC_PWMR) The trimming value applied to the regulator when the device is in Wait mode. This value is factory-defined.  */
#define   SUPC_PWMR_LPOWERS_USER_Val        _U(0x1)                                        /**< (SUPC_PWMR) The trimming value applied to the regulator is defined by the value programmed in the LPOWERx bits.  */
...
#define SUPC_PWMR_LPOWER0_Msk               (_U(0x1) << SUPC_PWMR_LPOWER0_Pos)             /**< (SUPC_PWMR) Low Power Value Mask */
...
#define SUPC_PWMR_LPOWER1_Msk               (_U(0x1) << SUPC_PWMR_LPOWER1_Pos)             /**< (SUPC_PWMR) Low Power Value Mask */
...
#define SUPC_PWMR_LPOWER2_Msk               (_U(0x1) << SUPC_PWMR_LPOWER2_Pos)             /**< (SUPC_PWMR) Low Power Value Mask */
...
#define SUPC_PWMR_LPOWER3_Msk               (_U(0x1) << SUPC_PWMR_LPOWER3_Pos)             /**< (SUPC_PWMR) Low Power Value Mask */
...
#define SUPC_PWMR_STUPTIME_Msk              (_U(0x1) << SUPC_PWMR_STUPTIME_Pos)            /**< (SUPC_PWMR) Start-up Time when Resuming from Wait Mode Mask */
...
#define   SUPC_PWMR_STUPTIME_FAST_Val       _U(0x0)                                        /**< (SUPC_PWMR) Fast start-up.  */
#define   SUPC_PWMR_STUPTIME_SLOW_Val       _U(0x1)                                        /**< (SUPC_PWMR) Slow start-up.  */
...
#define SUPC_PWMR_ECPWRS_Msk                (_U(0x1) << SUPC_PWMR_ECPWRS_Pos)              /**< (SUPC_PWMR) Enhanced Custom Power Value Selection Mask */
...
#define   SUPC_PWMR_ECPWRS_FACTORY_Val      _U(0x0)                                        /**< (SUPC_PWMR) The trimming value applied to the regulator when the device is in Active mode. This value is factory-defined.  */
#define   SUPC_PWMR_ECPWRS_USER_Val         _U(0x1)                                        /**< (SUPC_PWMR) The trimming value applied to the regulator is defined by the value programmed in ECPWRx bits.  */
...
#define SUPC_PWMR_ECPWR0_Msk                (_U(0x1) << SUPC_PWMR_ECPWR0_Pos)              /**< (SUPC_PWMR) Enhanced Custom Power Value Mask */
...
#define SUPC_PWMR_ECPWR1_Msk                (_U(0x1) << SUPC_PWMR_ECPWR1_Pos)              /**< (SUPC_PWMR) Enhanced Custom Power Value Mask */
...
#define SUPC_PWMR_ECPWR2_Msk                (_U(0x1) << SUPC_PWMR_ECPWR2_Pos)              /**< (SUPC_PWMR) Enhanced Custom Power Value Mask */
...
#define SUPC_PWMR_ECPWR3_Msk                (_U(0x1) << SUPC_PWMR_ECPWR3_Pos)              /**< (SUPC_PWMR) Enhanced Custom Power Value Mask */
...
#define SUPC_PWMR_SRAM0ON_Msk               (_U(0x1) << SUPC_PWMR_SRAM0ON_Pos)             /**< (SUPC_PWMR) SRAM Power Control Mask */
...
#define   SUPC_PWMR_SRAM0ON_OFF_Val         _U(0x0)                                        /**< (SUPC_PWMR) SRAMx is not powered.  */
#define   SUPC_PWMR_SRAM0ON_ON_Val          _U(0x1)                                        /**< (SUPC_PWMR) SRAMx is powered.  */
...
#define SUPC_PWMR_SRAM1ON_Msk               (_U(0x1) << SUPC_PWMR_SRAM1ON_Pos)             /**< (SUPC_PWMR) SRAM Power Control Mask */
...
#define   SUPC_PWMR_SRAM1ON_OFF_Val         _U(0x0)                                        /**< (SUPC_PWMR) SRAMx is not powered.  */
#define   SUPC_PWMR_SRAM1ON_ON_Val          _U(0x1)                                        /**< (SUPC_PWMR) SRAMx is powered.  */
...
#define SUPC_PWMR_SRAM2ON_Msk               (_U(0x1) << SUPC_PWMR_SRAM2ON_Pos)             /**< (SUPC_PWMR) SRAM Power Control Mask */
...
#define   SUPC_PWMR_SRAM2ON_OFF_Val         _U(0x0)                                        /**< (SUPC_PWMR) SRAMx is not powered.  */
#define   SUPC_PWMR_SRAM2ON_ON_Val          _U(0x1)                                        /**< (SUPC_PWMR) SRAMx is powered.  */
...
#define SUPC_PWMR_SRAM3ON_Msk               (_U(0x1) << SUPC_PWMR_SRAM3ON_Pos)             /**< (SUPC_PWMR) SRAM Power Control Mask */
...
#define   SUPC_PWMR_SRAM3ON_OFF_Val         _U(0x0)                                        /**< (SUPC_PWMR) SRAMx is not powered.  */
#define   SUPC_PWMR_SRAM3ON_ON_Val          _U(0x1)                                        /**< (SUPC_PWMR) SRAMx is powered.  */
...
#define SUPC_PWMR_SRAM4ON_Msk               (_U(0x1) << SUPC_PWMR_SRAM4ON_Pos)             /**< (SUPC_PWMR) SRAM Power Control Mask */
...
#define   SUPC_PWMR_SRAM4ON_OFF_Val         _U(0x0)                                        /**< (SUPC_PWMR) SRAMx is not powered.  */
#define   SUPC_PWMR_SRAM4ON_ON_Val          _U(0x1)                                        /**< (SUPC_PWMR) SRAMx is powered.  */
...
#define SUPC_PWMR_SRAM5ON_Msk               (_U(0x1) << SUPC_PWMR_SRAM5ON_Pos)             /**< (SUPC_PWMR) SRAM Power Control Mask */
...
#define   SUPC_PWMR_SRAM5ON_OFF_Val         _U(0x0)                                        /**< (SUPC_PWMR) SRAMx is not powered.  */
#define   SUPC_PWMR_SRAM5ON_ON_Val          _U(0x1)                                        /**< (SUPC_PWMR) SRAMx is powered.  */
...
#define SUPC_PWMR_SRAM6ON_Msk               (_U(0x1) << SUPC_PWMR_SRAM6ON_Pos)             /**< (SUPC_PWMR) SRAM Power Control Mask */
...
#define   SUPC_PWMR_SRAM6ON_OFF_Val         _U(0x0)                                        /**< (SUPC_PWMR) SRAMx is not powered.  */
#define   SUPC_PWMR_SRAM6ON_ON_Val          _U(0x1)                                        /**< (SUPC_PWMR) SRAMx is powered.  */
...
#define SUPC_PWMR_DPRAMON_Msk               (_U(0x1) << SUPC_PWMR_DPRAMON_Pos)             /**< (SUPC_PWMR) Dual-port RAM Power Control Mask */
...
#define   SUPC_PWMR_DPRAMON_OFF_Val         _U(0x0)                                        /**< (SUPC_PWMR) USB dual-port RAM is not powered.  */
#define   SUPC_PWMR_DPRAMON_ON_Val          _U(0x1)                                        /**< (SUPC_PWMR) USB dual-port RAM is powered.  */
...
#define SUPC_PWMR_KEY_Msk                   (_U(0xFF) << SUPC_PWMR_KEY_Pos)                /**< (SUPC_PWMR) Password Key Mask */
#define SUPC_PWMR_KEY(value)                (SUPC_PWMR_KEY_Msk & ((value) << SUPC_PWMR_KEY_Pos))
#define   SUPC_PWMR_KEY_PASSWD_Val          _U(0x5A)                                       /**< (SUPC_PWMR) Writing any other value in this field aborts the write operation.Always reads as 0.  */
...
#define SUPC_PWMR_LPOWER_Msk                (_U(0xF) << SUPC_PWMR_LPOWER_Pos)              /**< (SUPC_PWMR Mask) LPOWER */
...
#define SUPC_PWMR_ECPWR_Msk                 (_U(0xF) << SUPC_PWMR_ECPWR_Pos)               /**< (SUPC_PWMR Mask) ECPWR */
#define SUPC_PWMR_ECPWR(value)              (SUPC_PWMR_ECPWR_Msk & ((value) << SUPC_PWMR_ECPWR_Pos))  
#define SUPC_PWMR_MASK                      _U(0xFFFF1F9F)                                 /**< \deprecated (SUPC_PWMR) Register MASK  (Use SUPC_PWMR_Msk instead)  */
#define SUPC_PWMR_Msk                       _U(0xFFFF1F9F)                                 /**< (SUPC_PWMR) Register Mask  */
