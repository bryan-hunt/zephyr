...
#define RTT_MR_RTPRES_Msk                   (_U(0xFFFF) << RTT_MR_RTPRES_Pos)              /**< (RTT_MR) Real-time Timer Prescaler Value Mask */
...
#define RTT_MR_ALMIEN_Msk                   (_U(0x1) << RTT_MR_ALMIEN_Pos)                 /**< (RTT_MR) Alarm Interrupt Enable Mask */
...
#define RTT_MR_RTTINCIEN_Msk                (_U(0x1) << RTT_MR_RTTINCIEN_Pos)              /**< (RTT_MR) Real-time Timer Increment Interrupt Enable Mask */
...
#define RTT_MR_RTTRST_Msk                   (_U(0x1) << RTT_MR_RTTRST_Pos)                 /**< (RTT_MR) Real-time Timer Restart Mask */
...
#define RTT_MR_RTTDIS_Msk                   (_U(0x1) << RTT_MR_RTTDIS_Pos)                 /**< (RTT_MR) Real-time Timer Disable Mask */
...
#define RTT_MR_INC2AEN_Msk                  (_U(0x1) << RTT_MR_INC2AEN_Pos)                /**< (RTT_MR) RTTINC2 Alarm Enable Mask */
...
#define RTT_MR_EVAEN_Msk                    (_U(0x1) << RTT_MR_EVAEN_Pos)                  /**< (RTT_MR) Trigger Event Alarm Enable Mask */
...
#define RTT_MR_RTC1HZ_Msk                   (_U(0x1) << RTT_MR_RTC1HZ_Pos)                 /**< (RTT_MR) Real-Time Clock 1Hz Clock Selection Mask */
...
#define RTT_MR_MASK                         _U(0x177FFFF)                                  /**< \deprecated (RTT_MR) Register MASK  (Use RTT_MR_Msk instead)  */
#define RTT_MR_Msk                          _U(0x177FFFF)                                  /**< (RTT_MR) Register Mask  */
...
#define RTT_AR_ALMV_Msk                     (_U(0xFFFFFFFF) << RTT_AR_ALMV_Pos)            /**< (RTT_AR) Alarm Value Mask */
#define RTT_AR_ALMV(value)                  (RTT_AR_ALMV_Msk & ((value) << RTT_AR_ALMV_Pos))
#define RTT_AR_MASK                         _U(0xFFFFFFFF)                                 /**< \deprecated (RTT_AR) Register MASK  (Use RTT_AR_Msk instead)  */
#define RTT_AR_Msk                          _U(0xFFFFFFFF)                                 /**< (RTT_AR) Register Mask  */
...
#define RTT_VR_CRTV_Msk                     (_U(0xFFFFFFFF) << RTT_VR_CRTV_Pos)            /**< (RTT_VR) Current Real-time Value Mask */
#define RTT_VR_CRTV(value)                  (RTT_VR_CRTV_Msk & ((value) << RTT_VR_CRTV_Pos))
#define RTT_VR_MASK                         _U(0xFFFFFFFF)                                 /**< \deprecated (RTT_VR) Register MASK  (Use RTT_VR_Msk instead)  */
#define RTT_VR_Msk                          _U(0xFFFFFFFF)                                 /**< (RTT_VR) Register Mask  */
...
#define RTT_SR_ALMS_Msk                     (_U(0x1) << RTT_SR_ALMS_Pos)                   /**< (RTT_SR) Real-time Alarm Status (cleared on read) Mask */
...
#define RTT_SR_RTTINC_Msk                   (_U(0x1) << RTT_SR_RTTINC_Pos)                 /**< (RTT_SR) Prescaler Roll-over Status (cleared on read) Mask */
...
#define RTT_SR_RTTINC2_Msk                  (_U(0x1) << RTT_SR_RTTINC2_Pos)                /**< (RTT_SR) Predefined Number of Prescaler Roll-over Status (cleared on read) Mask */
...
#define RTT_SR_MASK                         _U(0x07)                                       /**< \deprecated (RTT_SR) Register MASK  (Use RTT_SR_Msk instead)  */
#define RTT_SR_Msk                          _U(0x07)                                       /**< (RTT_SR) Register Mask  */
...
#define RTT_MODR_SELINC2_Msk                (_U(0x7) << RTT_MODR_SELINC2_Pos)              /**< (RTT_MODR) Selection of the 32-bit Counter Modulo to generate RTTINC2 flag Mask */
#define RTT_MODR_SELINC2(value)             (RTT_MODR_SELINC2_Msk & ((value) << RTT_MODR_SELINC2_Pos))
#define   RTT_MODR_SELINC2_NO_RTTINC2_Val   _U(0x0)                                        /**< (RTT_MODR) The RTTINC2 flag never rises  */
#define   RTT_MODR_SELINC2_MOD64_Val        _U(0x1)                                        /**< (RTT_MODR) The RTTINC2 flag is set when CRTV modulo 64 equals 0  */
#define   RTT_MODR_SELINC2_MOD128_Val       _U(0x2)                                        /**< (RTT_MODR) The RTTINC2 flag is set when CRTV modulo 128 equals 0  */
#define   RTT_MODR_SELINC2_MOD256_Val       _U(0x3)                                        /**< (RTT_MODR) The RTTINC2 flag is set when CRTV modulo 256 equals 0  */
#define   RTT_MODR_SELINC2_MOD512_Val       _U(0x4)                                        /**< (RTT_MODR) The RTTINC2 flag is set when CRTV modulo 512 equals 0  */
#define   RTT_MODR_SELINC2_MOD1024_Val      _U(0x5)                                        /**< (RTT_MODR) The RTTINC2 flag is set when CRTV modulo 1024 equals 0.Example: If RTPRES=32 then RTTINC2 flag rises once per second if the slow clock is 32.768 kHz.  */
#define   RTT_MODR_SELINC2_MOD2048_Val      _U(0x6)                                        /**< (RTT_MODR) The RTTINC2 flag is set when CRTV modulo 2048 equals 0  */
#define   RTT_MODR_SELINC2_MOD4096_Val      _U(0x7)                                        /**< (RTT_MODR) The RTTINC2 flag is set when CRTV modulo 4096 equals 0  */
...
#define RTT_MODR_SELTRGEV_Msk               (_U(0x7) << RTT_MODR_SELTRGEV_Pos)             /**< (RTT_MODR) Selection of the 32-bit Counter Modulo to generate the trigger event Mask */
#define RTT_MODR_SELTRGEV(value)            (RTT_MODR_SELTRGEV_Msk & ((value) << RTT_MODR_SELTRGEV_Pos))
#define   RTT_MODR_SELTRGEV_NO_EVENT_Val    _U(0x0)                                        /**< (RTT_MODR) No event generated  */
#define   RTT_MODR_SELTRGEV_MOD2_Val        _U(0x1)                                        /**< (RTT_MODR) Event occurs when CRTV modulo 2 equals 0  */
#define   RTT_MODR_SELTRGEV_MOD4_Val        _U(0x2)                                        /**< (RTT_MODR) Event occurs when CRTV modulo 4 equals 0  */
#define   RTT_MODR_SELTRGEV_MOD8_Val        _U(0x3)                                        /**< (RTT_MODR) Event occurs when CRTV modulo 8 equals 0  */
#define   RTT_MODR_SELTRGEV_MOD16_Val       _U(0x4)                                        /**< (RTT_MODR) Event occurs when CRTV modulo 16 equals 0  */
#define   RTT_MODR_SELTRGEV_MOD32_Val       _U(0x5)                                        /**< (RTT_MODR) Event occurs when CRTV modulo 32 equals 0  */
#define   RTT_MODR_SELTRGEV_MOD64_Val       _U(0x6)                                        /**< (RTT_MODR) Event occurs when CRTV modulo 64 equals 0  */
#define   RTT_MODR_SELTRGEV_MOD128_Val      _U(0x7)                                        /**< (RTT_MODR) Event occurs when CRTV modulo 128 equals 0  */
...
#define RTT_MODR_MASK                       _U(0x707)                                      /**< \deprecated (RTT_MODR) Register MASK  (Use RTT_MODR_Msk instead)  */
#define RTT_MODR_Msk                        _U(0x707)                                      /**< (RTT_MODR) Register Mask  */
