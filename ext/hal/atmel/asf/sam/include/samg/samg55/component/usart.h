...
/* -------- US_CR : (USART Offset: 0x00) (/W 32) USART Control Register -------- */
...
#define US_CR_OFFSET                        (0x00)                                        /**<  (US_CR) USART Control Register  Offset */

#define US_CR_RSTRX_Pos                     2                                              /**< (US_CR) Reset Receiver Position */
#define US_CR_RSTRX_Msk                     (_U(0x1) << US_CR_RSTRX_Pos)                   /**< (US_CR) Reset Receiver Mask */
...
#define US_CR_RSTTX_Msk                     (_U(0x1) << US_CR_RSTTX_Pos)                   /**< (US_CR) Reset Transmitter Mask */
...
#define US_CR_RXEN_Msk                      (_U(0x1) << US_CR_RXEN_Pos)                    /**< (US_CR) Receiver Enable Mask */
...
#define US_CR_RXDIS_Msk                     (_U(0x1) << US_CR_RXDIS_Pos)                   /**< (US_CR) Receiver Disable Mask */
...
#define US_CR_TXEN_Msk                      (_U(0x1) << US_CR_TXEN_Pos)                    /**< (US_CR) Transmitter Enable Mask */
...
#define US_CR_TXDIS_Msk                     (_U(0x1) << US_CR_TXDIS_Pos)                   /**< (US_CR) Transmitter Disable Mask */
...
#define US_CR_RSTSTA_Msk                    (_U(0x1) << US_CR_RSTSTA_Pos)                  /**< (US_CR) Reset Status Bits Mask */
...
#define US_CR_STTBRK_Msk                    (_U(0x1) << US_CR_STTBRK_Pos)                  /**< (US_CR) Start Break Mask */
...
#define US_CR_STPBRK_Msk                    (_U(0x1) << US_CR_STPBRK_Pos)                  /**< (US_CR) Stop Break Mask */
...
#define US_CR_STTTO_Msk                     (_U(0x1) << US_CR_STTTO_Pos)                   /**< (US_CR) Clear TIMEOUT Flag and Start Time-out After Next Character Received Mask */
...
#define US_CR_SENDA_Msk                     (_U(0x1) << US_CR_SENDA_Pos)                   /**< (US_CR) Send Address Mask */
...
#define US_CR_RSTIT_Msk                     (_U(0x1) << US_CR_RSTIT_Pos)                   /**< (US_CR) Reset Iterations Mask */
...
#define US_CR_RSTNACK_Msk                   (_U(0x1) << US_CR_RSTNACK_Pos)                 /**< (US_CR) Reset Non Acknowledge Mask */
...
#define US_CR_RETTO_Msk                     (_U(0x1) << US_CR_RETTO_Pos)                   /**< (US_CR) Start Time-out Immediately Mask */
...
#define US_CR_RTSEN_Msk                     (_U(0x1) << US_CR_RTSEN_Pos)                   /**< (US_CR) Request to Send Enable Mask */
...
#define US_CR_RTSDIS_Msk                    (_U(0x1) << US_CR_RTSDIS_Pos)                  /**< (US_CR) Request to Send Disable Mask */
...
#define US_CR_LINABT_Msk                    (_U(0x1) << US_CR_LINABT_Pos)                  /**< (US_CR) Abort LIN Transmission Mask */
...
#define US_CR_LINWKUP_Msk                   (_U(0x1) << US_CR_LINWKUP_Pos)                 /**< (US_CR) Send LIN Wakeup Signal Mask */
...
#define US_CR_REQCLR_Msk                    (_U(0x1) << US_CR_REQCLR_Pos)                  /**< (US_CR) Request to Clear the Comparison Trigger Mask */
...
#define US_CR_MASK                          _U(0x103CFFFC)                                 /**< \deprecated (US_CR) Register MASK  (Use US_CR_Msk instead)  */
#define US_CR_Msk                           _U(0x103CFFFC)                                 /**< (US_CR) Register Mask  */

/* -------- US_MR : (USART Offset: 0x04) (R/W 32) USART Mode Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_MR_OFFSET                        (0x04)                                        /**<  (US_MR) USART Mode Register  Offset */

#define US_MR_USART_MODE_Pos                0                                              /**< (US_MR) USART Mode of Operation Position */
#define US_MR_USART_MODE_Msk                (_U(0xF) << US_MR_USART_MODE_Pos)              /**< (US_MR) USART Mode of Operation Mask */
#define US_MR_USART_MODE(value)             (US_MR_USART_MODE_Msk & ((value) << US_MR_USART_MODE_Pos))
#define   US_MR_USART_MODE_NORMAL_Val       _U(0x0)                                        /**< (US_MR) Normal mode  */
#define   US_MR_USART_MODE_RS485_Val        _U(0x1)                                        /**< (US_MR) RS485 mode  */
#define   US_MR_USART_MODE_HW_HANDSHAKING_Val _U(0x2)                                        /**< (US_MR) Hardware Handshaking  */
#define   US_MR_USART_MODE_IS07816_T_0_Val  _U(0x4)                                        /**< (US_MR) IS07816 Protocol: T = 0  */
#define   US_MR_USART_MODE_IS07816_T_1_Val  _U(0x6)                                        /**< (US_MR) IS07816 Protocol: T = 1  */
#define   US_MR_USART_MODE_IRDA_Val         _U(0x8)                                        /**< (US_MR) IrDA mode  */
#define   US_MR_USART_MODE_LIN_MASTER_Val   _U(0xA)                                        /**< (US_MR) LIN master mode  */
#define   US_MR_USART_MODE_LIN_SLAVE_Val    _U(0xB)                                        /**< (US_MR) LIN Slave mode  */
#define   US_MR_USART_MODE_SPI_MASTER_Val   _U(0xE)                                        /**< (US_MR) SPI master mode  */
#define   US_MR_USART_MODE_SPI_SLAVE_Val    _U(0xF)                                        /**< (US_MR) SPI Slave mode  */
...
#define US_MR_USCLKS_Msk                    (_U(0x3) << US_MR_USCLKS_Pos)                  /**< (US_MR) Clock Selection Mask */
#define US_MR_USCLKS(value)                 (US_MR_USCLKS_Msk & ((value) << US_MR_USCLKS_Pos))
#define   US_MR_USCLKS_MCK_Val              _U(0x0)                                        /**< (US_MR) Peripheral clock is selected  */
#define   US_MR_USCLKS_DIV_Val              _U(0x1)                                        /**< (US_MR) Peripheral clock Divided (DIV=8) is selected  */
#define   US_MR_USCLKS_PMC_PCK_Val          _U(0x2)                                        /**< (US_MR) PMC programmable clock (PCK) is selected.If the SCK pin is driven (CLKO=1), the CD field must be greater than 1.  */
#define   US_MR_USCLKS_SCK_Val              _U(0x3)                                        /**< (US_MR) External pin (SCK) is selected  */
...
#define US_MR_CHRL_Msk                      (_U(0x3) << US_MR_CHRL_Pos)                    /**< (US_MR) Character Length Mask */
#define US_MR_CHRL(value)                   (US_MR_CHRL_Msk & ((value) << US_MR_CHRL_Pos))
#define   US_MR_CHRL_5_BIT_Val              _U(0x0)                                        /**< (US_MR) Character length is 5 bits  */
#define   US_MR_CHRL_6_BIT_Val              _U(0x1)                                        /**< (US_MR) Character length is 6 bits  */
#define   US_MR_CHRL_7_BIT_Val              _U(0x2)                                        /**< (US_MR) Character length is 7 bits  */
#define   US_MR_CHRL_8_BIT_Val              _U(0x3)                                        /**< (US_MR) Character length is 8 bits  */
...
#define US_MR_SYNC_Msk                      (_U(0x1) << US_MR_SYNC_Pos)                    /**< (US_MR) Synchronous Mode Select Mask */
...
#define US_MR_PAR_Msk                       (_U(0x7) << US_MR_PAR_Pos)                     /**< (US_MR) Parity Type Mask */
#define US_MR_PAR(value)                    (US_MR_PAR_Msk & ((value) << US_MR_PAR_Pos)) 
#define   US_MR_PAR_EVEN_Val                _U(0x0)                                        /**< (US_MR) Even parity  */
#define   US_MR_PAR_ODD_Val                 _U(0x1)                                        /**< (US_MR) Odd parity  */
#define   US_MR_PAR_SPACE_Val               _U(0x2)                                        /**< (US_MR) Parity forced to 0 (Space)  */
#define   US_MR_PAR_MARK_Val                _U(0x3)                                        /**< (US_MR) Parity forced to 1 (Mark)  */
#define   US_MR_PAR_NO_Val                  _U(0x4)                                        /**< (US_MR) No parity  */
#define   US_MR_PAR_MULTIDROP_Val           _U(0x6)                                        /**< (US_MR) Multidrop mode  */
...
#define US_MR_NBSTOP_Msk                    (_U(0x3) << US_MR_NBSTOP_Pos)                  /**< (US_MR) Number of Stop Bits Mask */
#define US_MR_NBSTOP(value)                 (US_MR_NBSTOP_Msk & ((value) << US_MR_NBSTOP_Pos))
#define   US_MR_NBSTOP_1_BIT_Val            _U(0x0)                                        /**< (US_MR) 1 stop bit  */
#define   US_MR_NBSTOP_1_5_BIT_Val          _U(0x1)                                        /**< (US_MR) 1.5 stop bits (SYNC = 0) or reserved (SYNC = 1)  */
#define   US_MR_NBSTOP_2_BIT_Val            _U(0x2)                                        /**< (US_MR) 2 stop bits  */
...
#define US_MR_CHMODE_Msk                    (_U(0x3) << US_MR_CHMODE_Pos)                  /**< (US_MR) Channel Mode Mask */
#define US_MR_CHMODE(value)                 (US_MR_CHMODE_Msk & ((value) << US_MR_CHMODE_Pos))
#define   US_MR_CHMODE_NORMAL_Val           _U(0x0)                                        /**< (US_MR) Normal mode  */
#define   US_MR_CHMODE_AUTOMATIC_Val        _U(0x1)                                        /**< (US_MR) Automatic Echo. Receiver input is connected to the TXD pin.  */
#define   US_MR_CHMODE_LOCAL_LOOPBACK_Val   _U(0x2)                                        /**< (US_MR) Local Loopback. Transmitter output is connected to the Receiver Input.  */
#define   US_MR_CHMODE_REMOTE_LOOPBACK_Val  _U(0x3)                                        /**< (US_MR) Remote Loopback. RXD pin is internally connected to the TXD pin.  */
...
#define US_MR_MSBF_Msk                      (_U(0x1) << US_MR_MSBF_Pos)                    /**< (US_MR) Bit Order Mask */
...
#define US_MR_MODE9_Msk                     (_U(0x1) << US_MR_MODE9_Pos)                   /**< (US_MR) 9-bit Character Length Mask */
...
#define US_MR_CLKO_Msk                      (_U(0x1) << US_MR_CLKO_Pos)                    /**< (US_MR) Clock Output Select Mask */
...
#define US_MR_OVER_Msk                      (_U(0x1) << US_MR_OVER_Pos)                    /**< (US_MR) Oversampling Mode Mask */
...
#define US_MR_INACK_Msk                     (_U(0x1) << US_MR_INACK_Pos)                   /**< (US_MR) Inhibit Non Acknowledge Mask */
...
#define US_MR_DSNACK_Msk                    (_U(0x1) << US_MR_DSNACK_Pos)                  /**< (US_MR) Disable Successive NACK Mask */
...
#define US_MR_INVDATA_Msk                   (_U(0x1) << US_MR_INVDATA_Pos)                 /**< (US_MR) Inverted Data Mask */
...
#define US_MR_MAX_ITERATION_Msk             (_U(0x7) << US_MR_MAX_ITERATION_Pos)           /**< (US_MR) Maximum Number of Automatic Iteration Mask */
...
#define US_MR_FILTER_Msk                    (_U(0x1) << US_MR_FILTER_Pos)                  /**< (US_MR) Receive Line Filter Mask */
...
#define US_MR_MASK                          _U(0x17BFFFFF)                                 /**< \deprecated (US_MR) Register MASK  (Use US_MR_Msk instead)  */
#define US_MR_Msk                           _U(0x17BFFFFF)                                 /**< (US_MR) Register Mask  */

/* -------- US_IER : (USART Offset: 0x08) (/W 32) USART Interrupt Enable Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_IER_OFFSET                       (0x08)                                        /**<  (US_IER) USART Interrupt Enable Register  Offset */

#define US_IER_RXRDY_Pos                    0                                              /**< (US_IER) RXRDY Interrupt Enable Position */
#define US_IER_RXRDY_Msk                    (_U(0x1) << US_IER_RXRDY_Pos)                  /**< (US_IER) RXRDY Interrupt Enable Mask */
...
#define US_IER_TXRDY_Msk                    (_U(0x1) << US_IER_TXRDY_Pos)                  /**< (US_IER) TXRDY Interrupt Enable Mask */
...
#define US_IER_RXBRK_Msk                    (_U(0x1) << US_IER_RXBRK_Pos)                  /**< (US_IER) Receiver Break Interrupt Enable Mask */
...
#define US_IER_ENDRX_Msk                    (_U(0x1) << US_IER_ENDRX_Pos)                  /**< (US_IER) End of Receive Buffer Interrupt Enable (available in all USART modes of operation) Mask */
...
#define US_IER_ENDTX_Msk                    (_U(0x1) << US_IER_ENDTX_Pos)                  /**< (US_IER) End of Transmit Buffer Interrupt Enable (available in all USART modes of operation) Mask */
...
#define US_IER_OVRE_Msk                     (_U(0x1) << US_IER_OVRE_Pos)                   /**< (US_IER) Overrun Error Interrupt Enable Mask */
...
#define US_IER_FRAME_Msk                    (_U(0x1) << US_IER_FRAME_Pos)                  /**< (US_IER) Framing Error Interrupt Enable Mask */
...
#define US_IER_PARE_Msk                     (_U(0x1) << US_IER_PARE_Pos)                   /**< (US_IER) Parity Error Interrupt Enable Mask */
...
#define US_IER_TIMEOUT_Msk                  (_U(0x1) << US_IER_TIMEOUT_Pos)                /**< (US_IER) Time-out Interrupt Enable Mask */
...
#define US_IER_TXEMPTY_Msk                  (_U(0x1) << US_IER_TXEMPTY_Pos)                /**< (US_IER) TXEMPTY Interrupt Enable Mask */
...
#define US_IER_ITER_Msk                     (_U(0x1) << US_IER_ITER_Pos)                   /**< (US_IER) Max number of Repetitions Reached Interrupt Enable Mask */
...
#define US_IER_TXBUFE_Msk                   (_U(0x1) << US_IER_TXBUFE_Pos)                 /**< (US_IER) Transmit Buffer Empty Interrupt Enable (available in all USART modes of operation) Mask */
...
#define US_IER_RXBUFF_Msk                   (_U(0x1) << US_IER_RXBUFF_Pos)                 /**< (US_IER) Receive Buffer Full Interrupt Enable (available in all USART modes of operation) Mask */
...
#define US_IER_NACK_Msk                     (_U(0x1) << US_IER_NACK_Pos)                   /**< (US_IER) Non Acknowledge Interrupt Enable Mask */
...
#define US_IER_CTSIC_Msk                    (_U(0x1) << US_IER_CTSIC_Pos)                  /**< (US_IER) Clear to Send Input Change Interrupt Enable Mask */
...
#define US_IER_CMP_Msk                      (_U(0x1) << US_IER_CMP_Pos)                    /**< (US_IER) Comparison Interrupt Enable Mask */
#define US_IER_CMP                          US_IER_CMP_Msk                                 /**< \deprecated Old style mask definition for 1 bit bitfield. Use US_IER_CMP_Msk instead */
#define US_IER_MASK                         _U(0x483FFF)                                   /**< \deprecated (US_IER) Register MASK  (Use US_IER_Msk instead)  */
#define US_IER_Msk                          _U(0x483FFF)                                   /**< (US_IER) Register Mask  */

/* -------- US_IDR : (USART Offset: 0x0c) (/W 32) USART Interrupt Disable Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_IDR_OFFSET                       (0x0C)                                        /**<  (US_IDR) USART Interrupt Disable Register  Offset */

#define US_IDR_RXRDY_Pos                    0                                              /**< (US_IDR) RXRDY Interrupt Disable Position */
#define US_IDR_RXRDY_Msk                    (_U(0x1) << US_IDR_RXRDY_Pos)                  /**< (US_IDR) RXRDY Interrupt Disable Mask */
...
#define US_IDR_TXRDY_Msk                    (_U(0x1) << US_IDR_TXRDY_Pos)                  /**< (US_IDR) TXRDY Interrupt Disable Mask */
...
#define US_IDR_RXBRK_Msk                    (_U(0x1) << US_IDR_RXBRK_Pos)                  /**< (US_IDR) Receiver Break Interrupt Disable Mask */
...
#define US_IDR_ENDRX_Msk                    (_U(0x1) << US_IDR_ENDRX_Pos)                  /**< (US_IDR) End of Receive Buffer Interrupt Enable (available in all USART modes of operation) Mask */
...
#define US_IDR_ENDTX_Msk                    (_U(0x1) << US_IDR_ENDTX_Pos)                  /**< (US_IDR) End of Transmit Buffer Interrupt Disable (available in all USART modes of operation) Mask */
...
#define US_IDR_OVRE_Msk                     (_U(0x1) << US_IDR_OVRE_Pos)                   /**< (US_IDR) Overrun Error Interrupt Enable Mask */
...
#define US_IDR_FRAME_Msk                    (_U(0x1) << US_IDR_FRAME_Pos)                  /**< (US_IDR) Framing Error Interrupt Disable Mask */
...
#define US_IDR_PARE_Msk                     (_U(0x1) << US_IDR_PARE_Pos)                   /**< (US_IDR) Parity Error Interrupt Disable Mask */
...
#define US_IDR_TIMEOUT_Msk                  (_U(0x1) << US_IDR_TIMEOUT_Pos)                /**< (US_IDR) Time-out Interrupt Disable Mask */
...
#define US_IDR_TXEMPTY_Msk                  (_U(0x1) << US_IDR_TXEMPTY_Pos)                /**< (US_IDR) TXEMPTY Interrupt Disable Mask */
...
#define US_IDR_ITER_Msk                     (_U(0x1) << US_IDR_ITER_Pos)                   /**< (US_IDR) Max Number of Repetitions Reached Interrupt Disable Mask */
...
#define US_IDR_TXBUFE_Msk                   (_U(0x1) << US_IDR_TXBUFE_Pos)                 /**< (US_IDR) Transmit Buffer Empty Interrupt Enable (available in all USART modes of operation) Mask */
...
#define US_IDR_RXBUFF_Msk                   (_U(0x1) << US_IDR_RXBUFF_Pos)                 /**< (US_IDR) Receive Buffer Full Interrupt Enable (available in all USART modes of operation) Mask */
...
#define US_IDR_NACK_Msk                     (_U(0x1) << US_IDR_NACK_Pos)                   /**< (US_IDR) Non Acknowledge Interrupt Disable Mask */
...
#define US_IDR_CTSIC_Msk                    (_U(0x1) << US_IDR_CTSIC_Pos)                  /**< (US_IDR) Clear to Send Input Change Interrupt Disable Mask */
...
#define US_IDR_CMP_Msk                      (_U(0x1) << US_IDR_CMP_Pos)                    /**< (US_IDR) Comparison Interrupt Disable Mask */
#define US_IDR_CMP                          US_IDR_CMP_Msk                                 /**< \deprecated Old style mask definition for 1 bit bitfield. Use US_IDR_CMP_Msk instead */
#define US_IDR_MASK                         _U(0x483FFF)                                   /**< \deprecated (US_IDR) Register MASK  (Use US_IDR_Msk instead)  */
#define US_IDR_Msk                          _U(0x483FFF)                                   /**< (US_IDR) Register Mask  */

/* -------- US_IMR : (USART Offset: 0x10) (R/ 32) USART Interrupt Mask Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_IMR_OFFSET                       (0x10)                                        /**<  (US_IMR) USART Interrupt Mask Register  Offset */

#define US_IMR_RXRDY_Pos                    0                                              /**< (US_IMR) RXRDY Interrupt Mask Position */
#define US_IMR_RXRDY_Msk                    (_U(0x1) << US_IMR_RXRDY_Pos)                  /**< (US_IMR) RXRDY Interrupt Mask Mask */
...
#define US_IMR_TXRDY_Msk                    (_U(0x1) << US_IMR_TXRDY_Pos)                  /**< (US_IMR) TXRDY Interrupt Mask Mask */
...
#define US_IMR_RXBRK_Msk                    (_U(0x1) << US_IMR_RXBRK_Pos)                  /**< (US_IMR) Receiver Break Interrupt Mask Mask */
...
#define US_IMR_ENDRX_Msk                    (_U(0x1) << US_IMR_ENDRX_Pos)                  /**< (US_IMR) End of Receive Buffer Interrupt Mask (available in all USART modes of operation) Mask */
...
#define US_IMR_ENDTX_Msk                    (_U(0x1) << US_IMR_ENDTX_Pos)                  /**< (US_IMR) End of Transmit Buffer Interrupt Mask (available in all USART modes of operation) Mask */
...
#define US_IMR_OVRE_Msk                     (_U(0x1) << US_IMR_OVRE_Pos)                   /**< (US_IMR) Overrun Error Interrupt Mask Mask */
...
#define US_IMR_FRAME_Msk                    (_U(0x1) << US_IMR_FRAME_Pos)                  /**< (US_IMR) Framing Error Interrupt Mask Mask */
...
#define US_IMR_PARE_Msk                     (_U(0x1) << US_IMR_PARE_Pos)                   /**< (US_IMR) Parity Error Interrupt Mask Mask */
...
#define US_IMR_TIMEOUT_Msk                  (_U(0x1) << US_IMR_TIMEOUT_Pos)                /**< (US_IMR) Time-out Interrupt Mask Mask */
...
#define US_IMR_TXEMPTY_Msk                  (_U(0x1) << US_IMR_TXEMPTY_Pos)                /**< (US_IMR) TXEMPTY Interrupt Mask Mask */
...
#define US_IMR_ITER_Msk                     (_U(0x1) << US_IMR_ITER_Pos)                   /**< (US_IMR) Max Number of Repetitions Reached Interrupt Mask Mask */
...
#define US_IMR_TXBUFE_Msk                   (_U(0x1) << US_IMR_TXBUFE_Pos)                 /**< (US_IMR) Transmit Buffer Empty Interrupt Mask (available in all USART modes of operation) Mask */
...
#define US_IMR_RXBUFF_Msk                   (_U(0x1) << US_IMR_RXBUFF_Pos)                 /**< (US_IMR) Receive Buffer Full Interrupt Mask (available in all USART modes of operation) Mask */
...
#define US_IMR_NACK_Msk                     (_U(0x1) << US_IMR_NACK_Pos)                   /**< (US_IMR) Non Acknowledge Interrupt Mask Mask */
...
#define US_IMR_CTSIC_Msk                    (_U(0x1) << US_IMR_CTSIC_Pos)                  /**< (US_IMR) Clear to Send Input Change Interrupt Mask Mask */
...
#define US_IMR_CMP_Msk                      (_U(0x1) << US_IMR_CMP_Pos)                    /**< (US_IMR) Comparison Interrupt Mask Mask */
#define US_IMR_CMP                          US_IMR_CMP_Msk                                 /**< \deprecated Old style mask definition for 1 bit bitfield. Use US_IMR_CMP_Msk instead */
#define US_IMR_MASK                         _U(0x483FFF)                                   /**< \deprecated (US_IMR) Register MASK  (Use US_IMR_Msk instead)  */
#define US_IMR_Msk                          _U(0x483FFF)                                   /**< (US_IMR) Register Mask  */

/* -------- US_CSR : (USART Offset: 0x14) (R/ 32) USART Channel Status Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_CSR_OFFSET                       (0x14)                                        /**<  (US_CSR) USART Channel Status Register  Offset */

#define US_CSR_RXRDY_Pos                    0                                              /**< (US_CSR) Receiver Ready (cleared by reading US_RHR) Position */
#define US_CSR_RXRDY_Msk                    (_U(0x1) << US_CSR_RXRDY_Pos)                  /**< (US_CSR) Receiver Ready (cleared by reading US_RHR) Mask */
...
#define US_CSR_TXRDY_Msk                    (_U(0x1) << US_CSR_TXRDY_Pos)                  /**< (US_CSR) Transmitter Ready (cleared by writing US_THR) Mask */
...
#define US_CSR_RXBRK_Msk                    (_U(0x1) << US_CSR_RXBRK_Pos)                  /**< (US_CSR) Break Received/End of Break (cleared by writing a one to the bit US_CR.RSTSTA) Mask */
...
#define US_CSR_ENDRX_Msk                    (_U(0x1) << US_CSR_ENDRX_Pos)                  /**< (US_CSR) End of RX Buffer (cleared by writing US_RCR or US_RNCR) Mask */
...
#define US_CSR_ENDTX_Msk                    (_U(0x1) << US_CSR_ENDTX_Pos)                  /**< (US_CSR) End of TX Buffer (cleared by writing US_TCR or US_TNCR) Mask */
...
#define US_CSR_OVRE_Msk                     (_U(0x1) << US_CSR_OVRE_Pos)                   /**< (US_CSR) Overrun Error (cleared by writing a one to the bit US_CR.RSTSTA) Mask */
...
#define US_CSR_FRAME_Msk                    (_U(0x1) << US_CSR_FRAME_Pos)                  /**< (US_CSR) Framing Error (cleared by writing a one to the bit US_CR.RSTSTA) Mask */
...
#define US_CSR_PARE_Msk                     (_U(0x1) << US_CSR_PARE_Pos)                   /**< (US_CSR) Parity Error (cleared by writing a one to the US_CR.RSTSTA) Mask */
...
#define US_CSR_TIMEOUT_Msk                  (_U(0x1) << US_CSR_TIMEOUT_Pos)                /**< (US_CSR) Receiver Time-out (cleared by writing a one to the bit US_CR.STTTO) Mask */
...
#define US_CSR_TXEMPTY_Msk                  (_U(0x1) << US_CSR_TXEMPTY_Pos)                /**< (US_CSR) Transmitter Empty (cleared by writing US_THR) Mask */
...
#define US_CSR_ITER_Msk                     (_U(0x1) << US_CSR_ITER_Pos)                   /**< (US_CSR) Max Number of Repetitions Reached (cleared by writing a one to the bit US_CR.RSTIT) Mask */
...
#define US_CSR_TXBUFE_Msk                   (_U(0x1) << US_CSR_TXBUFE_Pos)                 /**< (US_CSR) TX Buffer Empty (cleared by writing US_TCR or US_TNCR) Mask */
...
#define US_CSR_RXBUFF_Msk                   (_U(0x1) << US_CSR_RXBUFF_Pos)                 /**< (US_CSR) RX Buffer Full (cleared by writing US_RCR or US_RNCR) Mask */
...
#define US_CSR_NACK_Msk                     (_U(0x1) << US_CSR_NACK_Pos)                   /**< (US_CSR) Non Acknowledge Interrupt (cleared by writing a one to the bit US_CR.RSTNACK) Mask */
...
#define US_CSR_CTSIC_Msk                    (_U(0x1) << US_CSR_CTSIC_Pos)                  /**< (US_CSR) Clear to Send Input Change Flag (cleared on read) Mask */
...
#define US_CSR_CMP_Msk                      (_U(0x1) << US_CSR_CMP_Pos)                    /**< (US_CSR) Comparison Status (cleared by writing a one to the bit US_CR.RSTSTA command) Mask */
...
#define US_CSR_CTS_Msk                      (_U(0x1) << US_CSR_CTS_Pos)                    /**< (US_CSR) Image of CTS Input Mask */
#define US_CSR_CTS                          US_CSR_CTS_Msk                                 /**< \deprecated Old style mask definition for 1 bit bitfield. Use US_CSR_CTS_Msk instead */
#define US_CSR_MASK                         _U(0xC83FFF)                                   /**< \deprecated (US_CSR) Register MASK  (Use US_CSR_Msk instead)  */
#define US_CSR_Msk                          _U(0xC83FFF)                                   /**< (US_CSR) Register Mask  */

/* -------- US_RHR : (USART Offset: 0x18) (R/ 32) USART Receive Holding Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_RHR_OFFSET                       (0x18)                                        /**<  (US_RHR) USART Receive Holding Register  Offset */

#define US_RHR_RXCHR_Pos                    0                                              /**< (US_RHR) Received Character Position */
#define US_RHR_RXCHR_Msk                    (_U(0x1FF) << US_RHR_RXCHR_Pos)                /**< (US_RHR) Received Character Mask */
...
#define US_RHR_RXSYNH_Msk                   (_U(0x1) << US_RHR_RXSYNH_Pos)                 /**< (US_RHR) Received Sync Mask */
...
#define US_RHR_MASK                         _U(0x81FF)                                     /**< \deprecated (US_RHR) Register MASK  (Use US_RHR_Msk instead)  */
#define US_RHR_Msk                          _U(0x81FF)                                     /**< (US_RHR) Register Mask  */

/* -------- US_THR : (USART Offset: 0x1c) (/W 32) USART Transmit Holding Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_THR_OFFSET                       (0x1C)                                        /**<  (US_THR) USART Transmit Holding Register  Offset */

#define US_THR_TXCHR_Pos                    0                                              /**< (US_THR) Character to be Transmitted Position */
#define US_THR_TXCHR_Msk                    (_U(0x1FF) << US_THR_TXCHR_Pos)                /**< (US_THR) Character to be Transmitted Mask */
#define US_THR_TXCHR(value)                 (US_THR_TXCHR_Msk & ((value) << US_THR_TXCHR_Pos))
#define US_THR_TXSYNH_Pos                   15                                             /**< (US_THR) Sync Field to be Transmitted Position */
#define US_THR_TXSYNH_Msk                   (_U(0x1) << US_THR_TXSYNH_Pos)                 /**< (US_THR) Sync Field to be Transmitted Mask */
...
#define US_THR_MASK                         _U(0x81FF)                                     /**< \deprecated (US_THR) Register MASK  (Use US_THR_Msk instead)  */
#define US_THR_Msk                          _U(0x81FF)                                     /**< (US_THR) Register Mask  */

/* -------- US_BRGR : (USART Offset: 0x20) (R/W 32) USART Baud Rate Generator Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_BRGR_OFFSET                      (0x20)                                        /**<  (US_BRGR) USART Baud Rate Generator Register  Offset */

#define US_BRGR_CD_Pos                      0                                              /**< (US_BRGR) Clock Divider Position */
#define US_BRGR_CD_Msk                      (_U(0xFFFF) << US_BRGR_CD_Pos)                 /**< (US_BRGR) Clock Divider Mask */
#define US_BRGR_CD(value)                   (US_BRGR_CD_Msk & ((value) << US_BRGR_CD_Pos))
#define US_BRGR_FP_Pos                      16                                             /**< (US_BRGR) Fractional Part Position */
#define US_BRGR_FP_Msk                      (_U(0x7) << US_BRGR_FP_Pos)                    /**< (US_BRGR) Fractional Part Mask */
#define US_BRGR_FP(value)                   (US_BRGR_FP_Msk & ((value) << US_BRGR_FP_Pos))
#define US_BRGR_MASK                        _U(0x7FFFF)                                    /**< \deprecated (US_BRGR) Register MASK  (Use US_BRGR_Msk instead)  */
#define US_BRGR_Msk                         _U(0x7FFFF)                                    /**< (US_BRGR) Register Mask  */

/* -------- US_RTOR : (USART Offset: 0x24) (R/W 32) USART Receiver Time-out Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_RTOR_OFFSET                      (0x24)                                        /**<  (US_RTOR) USART Receiver Time-out Register  Offset */

#define US_RTOR_TO_Pos                      0                                              /**< (US_RTOR) Time-out Value Position */
#define US_RTOR_TO_Msk                      (_U(0x1FFFF) << US_RTOR_TO_Pos)                /**< (US_RTOR) Time-out Value Mask */
#define US_RTOR_TO(value)                   (US_RTOR_TO_Msk & ((value) << US_RTOR_TO_Pos))
#define US_RTOR_MASK                        _U(0x1FFFF)                                    /**< \deprecated (US_RTOR) Register MASK  (Use US_RTOR_Msk instead)  */
#define US_RTOR_Msk                         _U(0x1FFFF)                                    /**< (US_RTOR) Register Mask  */

/* -------- US_TTGR : (USART Offset: 0x28) (R/W 32) USART Transmitter Timeguard Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_TTGR_OFFSET                      (0x28)                                        /**<  (US_TTGR) USART Transmitter Timeguard Register  Offset */

#define US_TTGR_TG_Pos                      0                                              /**< (US_TTGR) Timeguard Value Position */
#define US_TTGR_TG_Msk                      (_U(0xFF) << US_TTGR_TG_Pos)                   /**< (US_TTGR) Timeguard Value Mask */
#define US_TTGR_TG(value)                   (US_TTGR_TG_Msk & ((value) << US_TTGR_TG_Pos))
#define US_TTGR_MASK                        _U(0xFF)                                       /**< \deprecated (US_TTGR) Register MASK  (Use US_TTGR_Msk instead)  */
#define US_TTGR_Msk                         _U(0xFF)                                       /**< (US_TTGR) Register Mask  */

/* -------- US_FIDI : (USART Offset: 0x40) (R/W 32) USART FI DI Ratio Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_FIDI_OFFSET                      (0x40)                                        /**<  (US_FIDI) USART FI DI Ratio Register  Offset */

#define US_FIDI_FI_DI_RATIO_Pos             0                                              /**< (US_FIDI) FI Over DI Ratio Value Position */
#define US_FIDI_FI_DI_RATIO_Msk             (_U(0xFFFF) << US_FIDI_FI_DI_RATIO_Pos)        /**< (US_FIDI) FI Over DI Ratio Value Mask */
#define US_FIDI_FI_DI_RATIO(value)          (US_FIDI_FI_DI_RATIO_Msk & ((value) << US_FIDI_FI_DI_RATIO_Pos))
#define US_FIDI_MASK                        _U(0xFFFF)                                     /**< \deprecated (US_FIDI) Register MASK  (Use US_FIDI_Msk instead)  */
#define US_FIDI_Msk                         _U(0xFFFF)                                     /**< (US_FIDI) Register Mask  */

/* -------- US_NER : (USART Offset: 0x44) (R/ 32) USART Number of Errors Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_NER_OFFSET                       (0x44)                                        /**<  (US_NER) USART Number of Errors Register  Offset */

#define US_NER_NB_ERRORS_Pos                0                                              /**< (US_NER) Number of Errors Position */
#define US_NER_NB_ERRORS_Msk                (_U(0xFF) << US_NER_NB_ERRORS_Pos)             /**< (US_NER) Number of Errors Mask */
#define US_NER_NB_ERRORS(value)             (US_NER_NB_ERRORS_Msk & ((value) << US_NER_NB_ERRORS_Pos))
#define US_NER_MASK                         _U(0xFF)                                       /**< \deprecated (US_NER) Register MASK  (Use US_NER_Msk instead)  */
#define US_NER_Msk                          _U(0xFF)                                       /**< (US_NER) Register Mask  */

/* -------- US_IF : (USART Offset: 0x4c) (R/W 32) USART IrDA Filter Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_IF_OFFSET                        (0x4C)                                        /**<  (US_IF) USART IrDA Filter Register  Offset */

#define US_IF_IRDA_FILTER_Pos               0                                              /**< (US_IF) IrDA Filter Position */
#define US_IF_IRDA_FILTER_Msk               (_U(0xFF) << US_IF_IRDA_FILTER_Pos)            /**< (US_IF) IrDA Filter Mask */
#define US_IF_IRDA_FILTER(value)            (US_IF_IRDA_FILTER_Msk & ((value) << US_IF_IRDA_FILTER_Pos))
#define US_IF_MASK                          _U(0xFF)                                       /**< \deprecated (US_IF) Register MASK  (Use US_IF_Msk instead)  */
#define US_IF_Msk                           _U(0xFF)                                       /**< (US_IF) Register Mask  */

/* -------- US_LINMR : (USART Offset: 0x54) (R/W 32) USART LIN Mode Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_LINMR_OFFSET                     (0x54)                                        /**<  (US_LINMR) USART LIN Mode Register  Offset */

#define US_LINMR_NACT_Pos                   0                                              /**< (US_LINMR) LIN Node Action Position */
#define US_LINMR_NACT_Msk                   (_U(0x3) << US_LINMR_NACT_Pos)                 /**< (US_LINMR) LIN Node Action Mask */
#define US_LINMR_NACT(value)                (US_LINMR_NACT_Msk & ((value) << US_LINMR_NACT_Pos))
#define   US_LINMR_NACT_PUBLISH_Val         _U(0x0)                                        /**< (US_LINMR) The USART transmits the response.  */
#define   US_LINMR_NACT_SUBSCRIBE_Val       _U(0x1)                                        /**< (US_LINMR) The USART receives the response.  */
#define   US_LINMR_NACT_IGNORE_Val          _U(0x2)                                        /**< (US_LINMR) The USART does not transmit and does not receive the response.  */
...
#define US_LINMR_PARDIS_Msk                 (_U(0x1) << US_LINMR_PARDIS_Pos)               /**< (US_LINMR) Parity Disable Mask */
...
#define US_LINMR_CHKDIS_Msk                 (_U(0x1) << US_LINMR_CHKDIS_Pos)               /**< (US_LINMR) Checksum Disable Mask */
...
#define US_LINMR_CHKTYP_Msk                 (_U(0x1) << US_LINMR_CHKTYP_Pos)               /**< (US_LINMR) Checksum Type Mask */
...
#define US_LINMR_DLM_Msk                    (_U(0x1) << US_LINMR_DLM_Pos)                  /**< (US_LINMR) Data Length Mode Mask */
...
#define US_LINMR_FSDIS_Msk                  (_U(0x1) << US_LINMR_FSDIS_Pos)                /**< (US_LINMR) Frame Slot Mode Disable Mask */
...
#define US_LINMR_WKUPTYP_Msk                (_U(0x1) << US_LINMR_WKUPTYP_Pos)              /**< (US_LINMR) Wakeup Signal Type Mask */
...
#define US_LINMR_DLC_Msk                    (_U(0xFF) << US_LINMR_DLC_Pos)                 /**< (US_LINMR) Data Length Control Mask */
#define US_LINMR_DLC(value)                 (US_LINMR_DLC_Msk & ((value) << US_LINMR_DLC_Pos))
#define US_LINMR_PDCM_Pos                   16                                             /**< (US_LINMR) PDC Mode Position */
#define US_LINMR_PDCM_Msk                   (_U(0x1) << US_LINMR_PDCM_Pos)                 /**< (US_LINMR) PDC Mode Mask */
...
#define US_LINMR_SYNCDIS_Msk                (_U(0x1) << US_LINMR_SYNCDIS_Pos)              /**< (US_LINMR) Synchronization Disable Mask */
...
#define US_LINMR_MASK                       _U(0x3FFFF)                                    /**< \deprecated (US_LINMR) Register MASK  (Use US_LINMR_Msk instead)  */
#define US_LINMR_Msk                        _U(0x3FFFF)                                    /**< (US_LINMR) Register Mask  */

/* -------- US_LINIR : (USART Offset: 0x58) (R/W 32) USART LIN Identifier Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_LINIR_OFFSET                     (0x58)                                        /**<  (US_LINIR) USART LIN Identifier Register  Offset */

#define US_LINIR_IDCHR_Pos                  0                                              /**< (US_LINIR) Identifier Character Position */
#define US_LINIR_IDCHR_Msk                  (_U(0xFF) << US_LINIR_IDCHR_Pos)               /**< (US_LINIR) Identifier Character Mask */
#define US_LINIR_IDCHR(value)               (US_LINIR_IDCHR_Msk & ((value) << US_LINIR_IDCHR_Pos))
#define US_LINIR_MASK                       _U(0xFF)                                       /**< \deprecated (US_LINIR) Register MASK  (Use US_LINIR_Msk instead)  */
#define US_LINIR_Msk                        _U(0xFF)                                       /**< (US_LINIR) Register Mask  */

/* -------- US_LINBRR : (USART Offset: 0x5c) (R/ 32) USART LIN Baud Rate Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_LINBRR_OFFSET                    (0x5C)                                        /**<  (US_LINBRR) USART LIN Baud Rate Register  Offset */

#define US_LINBRR_LINCD_Pos                 0                                              /**< (US_LINBRR) Clock Divider after Synchronization Position */
#define US_LINBRR_LINCD_Msk                 (_U(0xFFFF) << US_LINBRR_LINCD_Pos)            /**< (US_LINBRR) Clock Divider after Synchronization Mask */
...
#define US_LINBRR_LINFP_Msk                 (_U(0x7) << US_LINBRR_LINFP_Pos)               /**< (US_LINBRR) Fractional Part after Synchronization Mask */
#define US_LINBRR_LINFP(value)              (US_LINBRR_LINFP_Msk & ((value) << US_LINBRR_LINFP_Pos))
#define US_LINBRR_MASK                      _U(0x7FFFF)                                    /**< \deprecated (US_LINBRR) Register MASK  (Use US_LINBRR_Msk instead)  */
#define US_LINBRR_Msk                       _U(0x7FFFF)                                    /**< (US_LINBRR) Register Mask  */

/* -------- US_CMPR : (USART Offset: 0x90) (R/W 32) USART Comparison Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_CMPR_OFFSET                      (0x90)                                        /**<  (US_CMPR) USART Comparison Register  Offset */

#define US_CMPR_VAL1_Pos                    0                                              /**< (US_CMPR) First Comparison Value for Received Character Position */
#define US_CMPR_VAL1_Msk                    (_U(0x1FF) << US_CMPR_VAL1_Pos)                /**< (US_CMPR) First Comparison Value for Received Character Mask */
...
#define US_CMPR_CMPMODE_Msk                 (_U(0x1) << US_CMPR_CMPMODE_Pos)               /**< (US_CMPR) Comparison Mode Mask */
...
#define   US_CMPR_CMPMODE_FLAG_ONLY_Val     _U(0x0)                                        /**< (US_CMPR) Any character is received and comparison function drives CMP flag.  */
#define   US_CMPR_CMPMODE_START_CONDITION_Val _U(0x1)                                        /**< (US_CMPR) Comparison condition must be met to start reception of all incoming charactersuntil REQCLR is set.  */
...
#define US_CMPR_CMPPAR_Msk                  (_U(0x1) << US_CMPR_CMPPAR_Pos)                /**< (US_CMPR) Compare Parity Mask */
...
#define US_CMPR_VAL2_Msk                    (_U(0x1FF) << US_CMPR_VAL2_Pos)                /**< (US_CMPR) Second Comparison Value for Received Character Mask */
#define US_CMPR_VAL2(value)                 (US_CMPR_VAL2_Msk & ((value) << US_CMPR_VAL2_Pos))
#define US_CMPR_MASK                        _U(0x1FF51FF)                                  /**< \deprecated (US_CMPR) Register MASK  (Use US_CMPR_Msk instead)  */
#define US_CMPR_Msk                         _U(0x1FF51FF)                                  /**< (US_CMPR) Register Mask  */

/* -------- US_WPMR : (USART Offset: 0xe4) (R/W 32) USART Write Protection Mode Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_WPMR_OFFSET                      (0xE4)                                        /**<  (US_WPMR) USART Write Protection Mode Register  Offset */

#define US_WPMR_WPEN_Pos                    0                                              /**< (US_WPMR) Write Protection Enable Position */
#define US_WPMR_WPEN_Msk                    (_U(0x1) << US_WPMR_WPEN_Pos)                  /**< (US_WPMR) Write Protection Enable Mask */
...
#define US_WPMR_WPKEY_Msk                   (_U(0xFFFFFF) << US_WPMR_WPKEY_Pos)            /**< (US_WPMR) Write Protection Key Mask */
#define US_WPMR_WPKEY(value)                (US_WPMR_WPKEY_Msk & ((value) << US_WPMR_WPKEY_Pos))
#define   US_WPMR_WPKEY_PASSWD_Val          _U(0x555341)                                   /**< (US_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit. Always reads as 0.  */
...
#define US_WPMR_MASK                        _U(0xFFFFFF01)                                 /**< \deprecated (US_WPMR) Register MASK  (Use US_WPMR_Msk instead)  */
#define US_WPMR_Msk                         _U(0xFFFFFF01)                                 /**< (US_WPMR) Register Mask  */

/* -------- US_WPSR : (USART Offset: 0xe8) (R/ 32) USART Write Protection Status Register -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { 
  struct {
...
#define US_WPSR_OFFSET                      (0xE8)                                        /**<  (US_WPSR) USART Write Protection Status Register  Offset */

#define US_WPSR_WPVS_Pos                    0                                              /**< (US_WPSR) Write Protection Violation Status Position */
#define US_WPSR_WPVS_Msk                    (_U(0x1) << US_WPSR_WPVS_Pos)                  /**< (US_WPSR) Write Protection Violation Status Mask */
...
#define US_WPSR_WPVSRC_Msk                  (_U(0xFFFF) << US_WPSR_WPVSRC_Pos)             /**< (US_WPSR) Write Protection Violation Source Mask */
#define US_WPSR_WPVSRC(value)               (US_WPSR_WPVSRC_Msk & ((value) << US_WPSR_WPVSRC_Pos))
#define US_WPSR_MASK                        _U(0xFFFF01)                                   /**< \deprecated (US_WPSR) Register MASK  (Use US_WPSR_Msk instead)  */
#define US_WPSR_Msk                         _U(0xFFFF01)                                   /**< (US_WPSR) Register Mask  */
...
#define US_RPR_RXPTR_Msk                    (_U(0xFFFFFFFF) << US_RPR_RXPTR_Pos)           /**< (US_RPR) Receive Pointer Register Mask */
#define US_RPR_RXPTR(value)                 (US_RPR_RXPTR_Msk & ((value) << US_RPR_RXPTR_Pos))
#define US_RPR_MASK                         _U(0xFFFFFFFF)                                 /**< \deprecated (US_RPR) Register MASK  (Use US_RPR_Msk instead)  */
#define US_RPR_Msk                          _U(0xFFFFFFFF)                                 /**< (US_RPR) Register Mask  */
...
#define US_RCR_RXCTR_Msk                    (_U(0xFFFF) << US_RCR_RXCTR_Pos)               /**< (US_RCR) Receive Counter Register Mask */
#define US_RCR_RXCTR(value)                 (US_RCR_RXCTR_Msk & ((value) << US_RCR_RXCTR_Pos))
#define US_RCR_MASK                         _U(0xFFFF)                                     /**< \deprecated (US_RCR) Register MASK  (Use US_RCR_Msk instead)  */
#define US_RCR_Msk                          _U(0xFFFF)                                     /**< (US_RCR) Register Mask  */
...
#define US_TPR_TXPTR_Msk                    (_U(0xFFFFFFFF) << US_TPR_TXPTR_Pos)           /**< (US_TPR) Transmit Counter Register Mask */
#define US_TPR_TXPTR(value)                 (US_TPR_TXPTR_Msk & ((value) << US_TPR_TXPTR_Pos))
#define US_TPR_MASK                         _U(0xFFFFFFFF)                                 /**< \deprecated (US_TPR) Register MASK  (Use US_TPR_Msk instead)  */
#define US_TPR_Msk                          _U(0xFFFFFFFF)                                 /**< (US_TPR) Register Mask  */
...
#define US_TCR_TXCTR_Msk                    (_U(0xFFFF) << US_TCR_TXCTR_Pos)               /**< (US_TCR) Transmit Counter Register Mask */
#define US_TCR_TXCTR(value)                 (US_TCR_TXCTR_Msk & ((value) << US_TCR_TXCTR_Pos))
#define US_TCR_MASK                         _U(0xFFFF)                                     /**< \deprecated (US_TCR) Register MASK  (Use US_TCR_Msk instead)  */
#define US_TCR_Msk                          _U(0xFFFF)                                     /**< (US_TCR) Register Mask  */
...
#define US_RNPR_RXNPTR_Msk                  (_U(0xFFFFFFFF) << US_RNPR_RXNPTR_Pos)         /**< (US_RNPR) Receive Next Pointer Mask */
#define US_RNPR_RXNPTR(value)               (US_RNPR_RXNPTR_Msk & ((value) << US_RNPR_RXNPTR_Pos))
#define US_RNPR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (US_RNPR) Register MASK  (Use US_RNPR_Msk instead)  */
#define US_RNPR_Msk                         _U(0xFFFFFFFF)                                 /**< (US_RNPR) Register Mask  */
...
#define US_RNCR_RXNCTR_Msk                  (_U(0xFFFF) << US_RNCR_RXNCTR_Pos)             /**< (US_RNCR) Receive Next Counter Mask */
#define US_RNCR_RXNCTR(value)               (US_RNCR_RXNCTR_Msk & ((value) << US_RNCR_RXNCTR_Pos))
#define US_RNCR_MASK                        _U(0xFFFF)                                     /**< \deprecated (US_RNCR) Register MASK  (Use US_RNCR_Msk instead)  */
#define US_RNCR_Msk                         _U(0xFFFF)                                     /**< (US_RNCR) Register Mask  */
...
#define US_TNPR_TXNPTR_Msk                  (_U(0xFFFFFFFF) << US_TNPR_TXNPTR_Pos)         /**< (US_TNPR) Transmit Next Pointer Mask */
#define US_TNPR_TXNPTR(value)               (US_TNPR_TXNPTR_Msk & ((value) << US_TNPR_TXNPTR_Pos))
#define US_TNPR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (US_TNPR) Register MASK  (Use US_TNPR_Msk instead)  */
#define US_TNPR_Msk                         _U(0xFFFFFFFF)                                 /**< (US_TNPR) Register Mask  */
...
#define US_TNCR_TXNCTR_Msk                  (_U(0xFFFF) << US_TNCR_TXNCTR_Pos)             /**< (US_TNCR) Transmit Counter Next Mask */
#define US_TNCR_TXNCTR(value)               (US_TNCR_TXNCTR_Msk & ((value) << US_TNCR_TXNCTR_Pos))
#define US_TNCR_MASK                        _U(0xFFFF)                                     /**< \deprecated (US_TNCR) Register MASK  (Use US_TNCR_Msk instead)  */
#define US_TNCR_Msk                         _U(0xFFFF)                                     /**< (US_TNCR) Register Mask  */
...
#define US_PTCR_RXTEN_Msk                   (_U(0x1) << US_PTCR_RXTEN_Pos)                 /**< (US_PTCR) Receiver Transfer Enable Mask */
...
#define US_PTCR_RXTDIS_Msk                  (_U(0x1) << US_PTCR_RXTDIS_Pos)                /**< (US_PTCR) Receiver Transfer Disable Mask */
...
#define US_PTCR_TXTEN_Msk                   (_U(0x1) << US_PTCR_TXTEN_Pos)                 /**< (US_PTCR) Transmitter Transfer Enable Mask */
...
#define US_PTCR_TXTDIS_Msk                  (_U(0x1) << US_PTCR_TXTDIS_Pos)                /**< (US_PTCR) Transmitter Transfer Disable Mask */
...
#define US_PTCR_RXCBEN_Msk                  (_U(0x1) << US_PTCR_RXCBEN_Pos)                /**< (US_PTCR) Receiver Circular Buffer Enable Mask */
...
#define US_PTCR_RXCBDIS_Msk                 (_U(0x1) << US_PTCR_RXCBDIS_Pos)               /**< (US_PTCR) Receiver Circular Buffer Disable Mask */
...
#define US_PTCR_TXCBEN_Msk                  (_U(0x1) << US_PTCR_TXCBEN_Pos)                /**< (US_PTCR) Transmitter Circular Buffer Enable Mask */
...
#define US_PTCR_TXCBDIS_Msk                 (_U(0x1) << US_PTCR_TXCBDIS_Pos)               /**< (US_PTCR) Transmitter Circular Buffer Disable Mask */
...
#define US_PTCR_ERRCLR_Msk                  (_U(0x1) << US_PTCR_ERRCLR_Pos)                /**< (US_PTCR) Transfer Bus Error Clear Mask */
...
#define US_PTCR_MASK                        _U(0x10F0303)                                  /**< \deprecated (US_PTCR) Register MASK  (Use US_PTCR_Msk instead)  */
#define US_PTCR_Msk                         _U(0x10F0303)                                  /**< (US_PTCR) Register Mask  */
...
#define US_PTSR_RXTEN_Msk                   (_U(0x1) << US_PTSR_RXTEN_Pos)                 /**< (US_PTSR) Receiver Transfer Enable Mask */
...
#define US_PTSR_TXTEN_Msk                   (_U(0x1) << US_PTSR_TXTEN_Pos)                 /**< (US_PTSR) Transmitter Transfer Enable Mask */
...
#define US_PTSR_RXCBEN_Msk                  (_U(0x1) << US_PTSR_RXCBEN_Pos)                /**< (US_PTSR) Receiver Circular Buffer Enable Mask */
...
#define US_PTSR_TXCBEN_Msk                  (_U(0x1) << US_PTSR_TXCBEN_Pos)                /**< (US_PTSR) Transmitter Circular Buffer Enable Mask */
...
#define US_PTSR_ERR_Msk                     (_U(0x1) << US_PTSR_ERR_Pos)                   /**< (US_PTSR) Transfer Bus Error Mask */
#define US_PTSR_ERR                         US_PTSR_ERR_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use US_PTSR_ERR_Msk instead */
#define US_PTSR_MASK                        _U(0x1050101)                                  /**< \deprecated (US_PTSR) Register MASK  (Use US_PTSR_Msk instead)  */
#define US_PTSR_Msk                         _U(0x1050101)                                  /**< (US_PTSR) Register Mask  */

#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
#if COMPONENT_TYPEDEF_STYLE == 'R'
/** \brief USART hardware registers */
typedef struct {  
  __O  uint32_t US_CR;          /**< (USART Offset: 0x00) USART Control Register */
  __IO uint32_t US_MR;          /**< (USART Offset: 0x04) USART Mode Register */
  __O  uint32_t US_IER;         /**< (USART Offset: 0x08) USART Interrupt Enable Register */
  __O  uint32_t US_IDR;         /**< (USART Offset: 0x0C) USART Interrupt Disable Register */
  __I  uint32_t US_IMR;         /**< (USART Offset: 0x10) USART Interrupt Mask Register */
  __I  uint32_t US_CSR;         /**< (USART Offset: 0x14) USART Channel Status Register */
  __I  uint32_t US_RHR;         /**< (USART Offset: 0x18) USART Receive Holding Register */
  __O  uint32_t US_THR;         /**< (USART Offset: 0x1C) USART Transmit Holding Register */
  __IO uint32_t US_BRGR;        /**< (USART Offset: 0x20) USART Baud Rate Generator Register */
  __IO uint32_t US_RTOR;        /**< (USART Offset: 0x24) USART Receiver Time-out Register */
  __IO uint32_t US_TTGR;        /**< (USART Offset: 0x28) USART Transmitter Timeguard Register */
  __I  uint32_t Reserved1[5];
  __IO uint32_t US_FIDI;        /**< (USART Offset: 0x40) USART FI DI Ratio Register */
  __I  uint32_t US_NER;         /**< (USART Offset: 0x44) USART Number of Errors Register */
  __I  uint32_t Reserved2[1];
  __IO uint32_t US_IF;          /**< (USART Offset: 0x4C) USART IrDA Filter Register */
  __I  uint32_t Reserved3[1];
  __IO uint32_t US_LINMR;       /**< (USART Offset: 0x54) USART LIN Mode Register */
  __IO uint32_t US_LINIR;       /**< (USART Offset: 0x58) USART LIN Identifier Register */
  __I  uint32_t US_LINBRR;      /**< (USART Offset: 0x5C) USART LIN Baud Rate Register */
  __I  uint32_t Reserved4[12];
  __IO uint32_t US_CMPR;        /**< (USART Offset: 0x90) USART Comparison Register */
  __I  uint32_t Reserved5[20];
  __IO uint32_t US_WPMR;        /**< (USART Offset: 0xE4) USART Write Protection Mode Register */
  __I  uint32_t US_WPSR;        /**< (USART Offset: 0xE8) USART Write Protection Status Register */
...
/** \brief USART hardware registers */
typedef struct {  
  __O  US_CR_Type                     US_CR;          /**< Offset: 0x00 ( /W  32) USART Control Register */
  __IO US_MR_Type                     US_MR;          /**< Offset: 0x04 (R/W  32) USART Mode Register */
  __O  US_IER_Type                    US_IER;         /**< Offset: 0x08 ( /W  32) USART Interrupt Enable Register */
  __O  US_IDR_Type                    US_IDR;         /**< Offset: 0x0C ( /W  32) USART Interrupt Disable Register */
  __I  US_IMR_Type                    US_IMR;         /**< Offset: 0x10 (R/   32) USART Interrupt Mask Register */
  __I  US_CSR_Type                    US_CSR;         /**< Offset: 0x14 (R/   32) USART Channel Status Register */
  __I  US_RHR_Type                    US_RHR;         /**< Offset: 0x18 (R/   32) USART Receive Holding Register */
  __O  US_THR_Type                    US_THR;         /**< Offset: 0x1C ( /W  32) USART Transmit Holding Register */
  __IO US_BRGR_Type                   US_BRGR;        /**< Offset: 0x20 (R/W  32) USART Baud Rate Generator Register */
  __IO US_RTOR_Type                   US_RTOR;        /**< Offset: 0x24 (R/W  32) USART Receiver Time-out Register */
  __IO US_TTGR_Type                   US_TTGR;        /**< Offset: 0x28 (R/W  32) USART Transmitter Timeguard Register */
       RoReg8                         Reserved1[0x14];
  __IO US_FIDI_Type                   US_FIDI;        /**< Offset: 0x40 (R/W  32) USART FI DI Ratio Register */
  __I  US_NER_Type                    US_NER;         /**< Offset: 0x44 (R/   32) USART Number of Errors Register */
       RoReg8                         Reserved2[0x4];
  __IO US_IF_Type                     US_IF;          /**< Offset: 0x4C (R/W  32) USART IrDA Filter Register */
       RoReg8                         Reserved3[0x4];
  __IO US_LINMR_Type                  US_LINMR;       /**< Offset: 0x54 (R/W  32) USART LIN Mode Register */
  __IO US_LINIR_Type                  US_LINIR;       /**< Offset: 0x58 (R/W  32) USART LIN Identifier Register */
  __I  US_LINBRR_Type                 US_LINBRR;      /**< Offset: 0x5C (R/   32) USART LIN Baud Rate Register */
       RoReg8                         Reserved4[0x30];
  __IO US_CMPR_Type                   US_CMPR;        /**< Offset: 0x90 (R/W  32) USART Comparison Register */
       RoReg8                         Reserved5[0x50];
  __IO US_WPMR_Type                   US_WPMR;        /**< Offset: 0xE4 (R/W  32) USART Write Protection Mode Register */
  __I  US_WPSR_Type                   US_WPSR;        /**< Offset: 0xE8 (R/   32) USART Write Protection Status Register */
