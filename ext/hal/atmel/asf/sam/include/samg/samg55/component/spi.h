...
#define SPI_CR_SPIEN_Msk                    (_U(0x1) << SPI_CR_SPIEN_Pos)                  /**< (SPI_CR) SPI Enable Mask */
...
#define SPI_CR_SPIDIS_Msk                   (_U(0x1) << SPI_CR_SPIDIS_Pos)                 /**< (SPI_CR) SPI Disable Mask */
...
#define SPI_CR_SWRST_Msk                    (_U(0x1) << SPI_CR_SWRST_Pos)                  /**< (SPI_CR) SPI Software Reset Mask */
...
#define SPI_CR_REQCLR_Msk                   (_U(0x1) << SPI_CR_REQCLR_Pos)                 /**< (SPI_CR) Request to Clear the Comparison Trigger Mask */
...
#define SPI_CR_LASTXFER_Msk                 (_U(0x1) << SPI_CR_LASTXFER_Pos)               /**< (SPI_CR) Last Transfer Mask */
...
#define SPI_CR_MASK                         _U(0x1001083)                                  /**< \deprecated (SPI_CR) Register MASK  (Use SPI_CR_Msk instead)  */
#define SPI_CR_Msk                          _U(0x1001083)                                  /**< (SPI_CR) Register Mask  */
...
#define SPI_MR_MSTR_Msk                     (_U(0x1) << SPI_MR_MSTR_Pos)                   /**< (SPI_MR) Master/Slave Mode Mask */
...
#define SPI_MR_PS_Msk                       (_U(0x1) << SPI_MR_PS_Pos)                     /**< (SPI_MR) Peripheral Select Mask */
...
#define SPI_MR_PCSDEC_Msk                   (_U(0x1) << SPI_MR_PCSDEC_Pos)                 /**< (SPI_MR) Chip Select Decode Mask */
...
#define SPI_MR_BRSRCCLK_Msk                 (_U(0x1) << SPI_MR_BRSRCCLK_Pos)               /**< (SPI_MR) Bit Rate Source Clock Mask */
...
#define   SPI_MR_BRSRCCLK_PERIPH_CLK_Val    _U(0x0)                                        /**< (SPI_MR) The peripheral clock is the source clock for the bit rate generation.  */
#define   SPI_MR_BRSRCCLK_PMC_PCK_Val       _U(0x1)                                        /**< (SPI_MR) PMC PCKx is the source clock for the bit rate generation, thus the bit rate can be independent of the core/peripheral clock.  */
...
#define SPI_MR_MODFDIS_Msk                  (_U(0x1) << SPI_MR_MODFDIS_Pos)                /**< (SPI_MR) Mode Fault Detection Mask */
...
#define SPI_MR_WDRBT_Msk                    (_U(0x1) << SPI_MR_WDRBT_Pos)                  /**< (SPI_MR) Wait Data Read Before Transfer Mask */
...
#define SPI_MR_LLB_Msk                      (_U(0x1) << SPI_MR_LLB_Pos)                    /**< (SPI_MR) Local Loopback Enable Mask */
...
#define SPI_MR_CMPMODE_Msk                  (_U(0x1) << SPI_MR_CMPMODE_Pos)                /**< (SPI_MR) Comparison Mode Mask */
...
#define   SPI_MR_CMPMODE_FLAG_ONLY_Val      _U(0x0)                                        /**< (SPI_MR) Any character is received and comparison function drives CMP flag.  */
#define   SPI_MR_CMPMODE_START_CONDITION_Val _U(0x1)                                        /**< (SPI_MR) Comparison condition must be met to start reception of all incoming characters until REQCLR is set.  */
...
#define SPI_MR_PCS_Msk                      (_U(0x3) << SPI_MR_PCS_Pos)                    /**< (SPI_MR) Peripheral Chip Select Mask */
#define SPI_MR_PCS(value)                   (SPI_MR_PCS_Msk & ((value) << SPI_MR_PCS_Pos))
#define SPI_MR_DLYBCS_Pos                   24                                             /**< (SPI_MR) Delay Between Chip Selects Position */
#define SPI_MR_DLYBCS_Msk                   (_U(0xFF) << SPI_MR_DLYBCS_Pos)                /**< (SPI_MR) Delay Between Chip Selects Mask */
#define SPI_MR_DLYBCS(value)                (SPI_MR_DLYBCS_Msk & ((value) << SPI_MR_DLYBCS_Pos))
#define SPI_MR_MASK                         _U(0xFF0310BF)                                 /**< \deprecated (SPI_MR) Register MASK  (Use SPI_MR_Msk instead)  */
#define SPI_MR_Msk                          _U(0xFF0310BF)                                 /**< (SPI_MR) Register Mask  */
...
#define SPI_RDR_RD_Msk                      (_U(0xFFFF) << SPI_RDR_RD_Pos)                 /**< (SPI_RDR) Receive Data Mask */
...
#define SPI_RDR_PCS_Msk                     (_U(0xF) << SPI_RDR_PCS_Pos)                   /**< (SPI_RDR) Peripheral Chip Select Mask */
#define SPI_RDR_PCS(value)                  (SPI_RDR_PCS_Msk & ((value) << SPI_RDR_PCS_Pos))
#define SPI_RDR_MASK                        _U(0xFFFFF)                                    /**< \deprecated (SPI_RDR) Register MASK  (Use SPI_RDR_Msk instead)  */
#define SPI_RDR_Msk                         _U(0xFFFFF)                                    /**< (SPI_RDR) Register Mask  */
...
#define SPI_TDR_TD_Msk                      (_U(0xFFFF) << SPI_TDR_TD_Pos)                 /**< (SPI_TDR) Transmit Data Mask */
...
#define SPI_TDR_PCS_Msk                     (_U(0xF) << SPI_TDR_PCS_Pos)                   /**< (SPI_TDR) Peripheral Chip Select Mask */
#define SPI_TDR_PCS(value)                  (SPI_TDR_PCS_Msk & ((value) << SPI_TDR_PCS_Pos))
#define SPI_TDR_LASTXFER_Pos                24                                             /**< (SPI_TDR) Last Transfer Position */
#define SPI_TDR_LASTXFER_Msk                (_U(0x1) << SPI_TDR_LASTXFER_Pos)              /**< (SPI_TDR) Last Transfer Mask */
...
#define SPI_TDR_MASK                        _U(0x10FFFFF)                                  /**< \deprecated (SPI_TDR) Register MASK  (Use SPI_TDR_Msk instead)  */
#define SPI_TDR_Msk                         _U(0x10FFFFF)                                  /**< (SPI_TDR) Register Mask  */
...
#define SPI_SR_RDRF_Msk                     (_U(0x1) << SPI_SR_RDRF_Pos)                   /**< (SPI_SR) Receive Data Register Full (cleared by reading SPI_RDR) Mask */
...
#define SPI_SR_TDRE_Msk                     (_U(0x1) << SPI_SR_TDRE_Pos)                   /**< (SPI_SR) Transmit Data Register Empty (cleared by writing SPI_TDR) Mask */
...
#define SPI_SR_MODF_Msk                     (_U(0x1) << SPI_SR_MODF_Pos)                   /**< (SPI_SR) Mode Fault Error (cleared on read) Mask */
...
#define SPI_SR_OVRES_Msk                    (_U(0x1) << SPI_SR_OVRES_Pos)                  /**< (SPI_SR) Overrun Error Status (cleared on read) Mask */
...
#define SPI_SR_ENDRX_Msk                    (_U(0x1) << SPI_SR_ENDRX_Pos)                  /**< (SPI_SR) End of RX buffer (cleared by writing SPI_RCR or SPI_RNCR) Mask */
...
#define SPI_SR_ENDTX_Msk                    (_U(0x1) << SPI_SR_ENDTX_Pos)                  /**< (SPI_SR) End of TX buffer (cleared by writing SPI_TCR or SPI_TNCR) Mask */
...
#define SPI_SR_RXBUFF_Msk                   (_U(0x1) << SPI_SR_RXBUFF_Pos)                 /**< (SPI_SR) RX Buffer Full (cleared by writing SPI_RCR or SPI_RNCR) Mask */
...
#define SPI_SR_TXBUFE_Msk                   (_U(0x1) << SPI_SR_TXBUFE_Pos)                 /**< (SPI_SR) TX Buffer Empty (cleared by writing SPI_TCR or SPI_TNCR) Mask */
...
#define SPI_SR_NSSR_Msk                     (_U(0x1) << SPI_SR_NSSR_Pos)                   /**< (SPI_SR) NSS Rising (cleared on read) Mask */
...
#define SPI_SR_TXEMPTY_Msk                  (_U(0x1) << SPI_SR_TXEMPTY_Pos)                /**< (SPI_SR) Transmission Registers Empty (cleared by writing SPI_TDR) Mask */
...
#define SPI_SR_UNDES_Msk                    (_U(0x1) << SPI_SR_UNDES_Pos)                  /**< (SPI_SR) Underrun Error Status (slave mode only) (cleared on read) Mask */
...
#define SPI_SR_CMP_Msk                      (_U(0x1) << SPI_SR_CMP_Pos)                    /**< (SPI_SR) Comparison Status (cleared on read) Mask */
...
#define SPI_SR_SPIENS_Msk                   (_U(0x1) << SPI_SR_SPIENS_Pos)                 /**< (SPI_SR) SPI Enable Status Mask */
...
#define SPI_SR_MASK                         _U(0x10FFF)                                    /**< \deprecated (SPI_SR) Register MASK  (Use SPI_SR_Msk instead)  */
#define SPI_SR_Msk                          _U(0x10FFF)                                    /**< (SPI_SR) Register Mask  */
...
#define SPI_IER_RDRF_Msk                    (_U(0x1) << SPI_IER_RDRF_Pos)                  /**< (SPI_IER) Receive Data Register Full Interrupt Enable Mask */
...
#define SPI_IER_TDRE_Msk                    (_U(0x1) << SPI_IER_TDRE_Pos)                  /**< (SPI_IER) SPI Transmit Data Register Empty Interrupt Enable Mask */
...
#define SPI_IER_MODF_Msk                    (_U(0x1) << SPI_IER_MODF_Pos)                  /**< (SPI_IER) Mode Fault Error Interrupt Enable Mask */
...
#define SPI_IER_OVRES_Msk                   (_U(0x1) << SPI_IER_OVRES_Pos)                 /**< (SPI_IER) Overrun Error Interrupt Enable Mask */
...
#define SPI_IER_ENDRX_Msk                   (_U(0x1) << SPI_IER_ENDRX_Pos)                 /**< (SPI_IER) End of Receive Buffer Interrupt Enable Mask */
...
#define SPI_IER_ENDTX_Msk                   (_U(0x1) << SPI_IER_ENDTX_Pos)                 /**< (SPI_IER) End of Transmit Buffer Interrupt Enable Mask */
...
#define SPI_IER_RXBUFF_Msk                  (_U(0x1) << SPI_IER_RXBUFF_Pos)                /**< (SPI_IER) Receive Buffer Full Interrupt Enable Mask */
...
#define SPI_IER_TXBUFE_Msk                  (_U(0x1) << SPI_IER_TXBUFE_Pos)                /**< (SPI_IER) Transmit Buffer Empty Interrupt Enable Mask */
...
#define SPI_IER_NSSR_Msk                    (_U(0x1) << SPI_IER_NSSR_Pos)                  /**< (SPI_IER) NSS Rising Interrupt Enable Mask */
...
#define SPI_IER_TXEMPTY_Msk                 (_U(0x1) << SPI_IER_TXEMPTY_Pos)               /**< (SPI_IER) Transmission Registers Empty Enable Mask */
...
#define SPI_IER_UNDES_Msk                   (_U(0x1) << SPI_IER_UNDES_Pos)                 /**< (SPI_IER) Underrun Error Interrupt Enable Mask */
...
#define SPI_IER_CMP_Msk                     (_U(0x1) << SPI_IER_CMP_Pos)                   /**< (SPI_IER) Comparison Interrupt Enable Mask */
#define SPI_IER_CMP                         SPI_IER_CMP_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use SPI_IER_CMP_Msk instead */
#define SPI_IER_MASK                        _U(0xFFF)                                      /**< \deprecated (SPI_IER) Register MASK  (Use SPI_IER_Msk instead)  */
#define SPI_IER_Msk                         _U(0xFFF)                                      /**< (SPI_IER) Register Mask  */
...
#define SPI_IDR_RDRF_Msk                    (_U(0x1) << SPI_IDR_RDRF_Pos)                  /**< (SPI_IDR) Receive Data Register Full Interrupt Disable Mask */
...
#define SPI_IDR_TDRE_Msk                    (_U(0x1) << SPI_IDR_TDRE_Pos)                  /**< (SPI_IDR) SPI Transmit Data Register Empty Interrupt Disable Mask */
...
#define SPI_IDR_MODF_Msk                    (_U(0x1) << SPI_IDR_MODF_Pos)                  /**< (SPI_IDR) Mode Fault Error Interrupt Disable Mask */
...
#define SPI_IDR_OVRES_Msk                   (_U(0x1) << SPI_IDR_OVRES_Pos)                 /**< (SPI_IDR) Overrun Error Interrupt Disable Mask */
...
#define SPI_IDR_ENDRX_Msk                   (_U(0x1) << SPI_IDR_ENDRX_Pos)                 /**< (SPI_IDR) End of Receive Buffer Interrupt Disable Mask */
...
#define SPI_IDR_ENDTX_Msk                   (_U(0x1) << SPI_IDR_ENDTX_Pos)                 /**< (SPI_IDR) End of Transmit Buffer Interrupt Disable Mask */
...
#define SPI_IDR_RXBUFF_Msk                  (_U(0x1) << SPI_IDR_RXBUFF_Pos)                /**< (SPI_IDR) Receive Buffer Full Interrupt Disable Mask */
...
#define SPI_IDR_TXBUFE_Msk                  (_U(0x1) << SPI_IDR_TXBUFE_Pos)                /**< (SPI_IDR) Transmit Buffer Empty Interrupt Disable Mask */
...
#define SPI_IDR_NSSR_Msk                    (_U(0x1) << SPI_IDR_NSSR_Pos)                  /**< (SPI_IDR) NSS Rising Interrupt Disable Mask */
...
#define SPI_IDR_TXEMPTY_Msk                 (_U(0x1) << SPI_IDR_TXEMPTY_Pos)               /**< (SPI_IDR) Transmission Registers Empty Disable Mask */
...
#define SPI_IDR_UNDES_Msk                   (_U(0x1) << SPI_IDR_UNDES_Pos)                 /**< (SPI_IDR) Underrun Error Interrupt Disable Mask */
...
#define SPI_IDR_CMP_Msk                     (_U(0x1) << SPI_IDR_CMP_Pos)                   /**< (SPI_IDR) Comparison Interrupt Disable Mask */
#define SPI_IDR_CMP                         SPI_IDR_CMP_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use SPI_IDR_CMP_Msk instead */
#define SPI_IDR_MASK                        _U(0xFFF)                                      /**< \deprecated (SPI_IDR) Register MASK  (Use SPI_IDR_Msk instead)  */
#define SPI_IDR_Msk                         _U(0xFFF)                                      /**< (SPI_IDR) Register Mask  */
...
#define SPI_IMR_RDRF_Msk                    (_U(0x1) << SPI_IMR_RDRF_Pos)                  /**< (SPI_IMR) Receive Data Register Full Interrupt Mask Mask */
...
#define SPI_IMR_TDRE_Msk                    (_U(0x1) << SPI_IMR_TDRE_Pos)                  /**< (SPI_IMR) SPI Transmit Data Register Empty Interrupt Mask Mask */
...
#define SPI_IMR_MODF_Msk                    (_U(0x1) << SPI_IMR_MODF_Pos)                  /**< (SPI_IMR) Mode Fault Error Interrupt Mask Mask */
...
#define SPI_IMR_OVRES_Msk                   (_U(0x1) << SPI_IMR_OVRES_Pos)                 /**< (SPI_IMR) Overrun Error Interrupt Mask Mask */
...
#define SPI_IMR_ENDRX_Msk                   (_U(0x1) << SPI_IMR_ENDRX_Pos)                 /**< (SPI_IMR) End of Receive Buffer Interrupt Mask Mask */
...
#define SPI_IMR_ENDTX_Msk                   (_U(0x1) << SPI_IMR_ENDTX_Pos)                 /**< (SPI_IMR) End of Transmit Buffer Interrupt Mask Mask */
...
#define SPI_IMR_RXBUFF_Msk                  (_U(0x1) << SPI_IMR_RXBUFF_Pos)                /**< (SPI_IMR) Receive Buffer Full Interrupt Mask Mask */
...
#define SPI_IMR_TXBUFE_Msk                  (_U(0x1) << SPI_IMR_TXBUFE_Pos)                /**< (SPI_IMR) Transmit Buffer Empty Interrupt Mask Mask */
...
#define SPI_IMR_NSSR_Msk                    (_U(0x1) << SPI_IMR_NSSR_Pos)                  /**< (SPI_IMR) NSS Rising Interrupt Mask Mask */
...
#define SPI_IMR_TXEMPTY_Msk                 (_U(0x1) << SPI_IMR_TXEMPTY_Pos)               /**< (SPI_IMR) Transmission Registers Empty Mask Mask */
...
#define SPI_IMR_UNDES_Msk                   (_U(0x1) << SPI_IMR_UNDES_Pos)                 /**< (SPI_IMR) Underrun Error Interrupt Mask Mask */
...
#define SPI_IMR_CMP_Msk                     (_U(0x1) << SPI_IMR_CMP_Pos)                   /**< (SPI_IMR) Comparison Interrupt Mask Mask */
#define SPI_IMR_CMP                         SPI_IMR_CMP_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use SPI_IMR_CMP_Msk instead */
#define SPI_IMR_MASK                        _U(0xFFF)                                      /**< \deprecated (SPI_IMR) Register MASK  (Use SPI_IMR_Msk instead)  */
#define SPI_IMR_Msk                         _U(0xFFF)                                      /**< (SPI_IMR) Register Mask  */
...
#define SPI_CSR_CPOL_Msk                    (_U(0x1) << SPI_CSR_CPOL_Pos)                  /**< (SPI_CSR) Clock Polarity Mask */
...
#define SPI_CSR_NCPHA_Msk                   (_U(0x1) << SPI_CSR_NCPHA_Pos)                 /**< (SPI_CSR) Clock Phase Mask */
...
#define SPI_CSR_CSNAAT_Msk                  (_U(0x1) << SPI_CSR_CSNAAT_Pos)                /**< (SPI_CSR) Chip Select Not Active After Transfer (Ignored if CSAAT = 1) Mask */
...
#define SPI_CSR_CSAAT_Msk                   (_U(0x1) << SPI_CSR_CSAAT_Pos)                 /**< (SPI_CSR) Chip Select Active After Transfer Mask */
...
#define SPI_CSR_BITS_Msk                    (_U(0xF) << SPI_CSR_BITS_Pos)                  /**< (SPI_CSR) Bits Per Transfer Mask */
#define SPI_CSR_BITS(value)                 (SPI_CSR_BITS_Msk & ((value) << SPI_CSR_BITS_Pos))
#define   SPI_CSR_BITS_8_BIT_Val            _U(0x0)                                        /**< (SPI_CSR) 8 bits for transfer  */
#define   SPI_CSR_BITS_9_BIT_Val            _U(0x1)                                        /**< (SPI_CSR) 9 bits for transfer  */
#define   SPI_CSR_BITS_10_BIT_Val           _U(0x2)                                        /**< (SPI_CSR) 10 bits for transfer  */
#define   SPI_CSR_BITS_11_BIT_Val           _U(0x3)                                        /**< (SPI_CSR) 11 bits for transfer  */
#define   SPI_CSR_BITS_12_BIT_Val           _U(0x4)                                        /**< (SPI_CSR) 12 bits for transfer  */
#define   SPI_CSR_BITS_13_BIT_Val           _U(0x5)                                        /**< (SPI_CSR) 13 bits for transfer  */
#define   SPI_CSR_BITS_14_BIT_Val           _U(0x6)                                        /**< (SPI_CSR) 14 bits for transfer  */
#define   SPI_CSR_BITS_15_BIT_Val           _U(0x7)                                        /**< (SPI_CSR) 15 bits for transfer  */
#define   SPI_CSR_BITS_16_BIT_Val           _U(0x8)                                        /**< (SPI_CSR) 16 bits for transfer  */
...
#define SPI_CSR_SCBR_Msk                    (_U(0xFF) << SPI_CSR_SCBR_Pos)                 /**< (SPI_CSR) Serial Clock Bit Rate Mask */
#define SPI_CSR_SCBR(value)                 (SPI_CSR_SCBR_Msk & ((value) << SPI_CSR_SCBR_Pos))
#define SPI_CSR_DLYBS_Pos                   16                                             /**< (SPI_CSR) Delay Before SPCK Position */
#define SPI_CSR_DLYBS_Msk                   (_U(0xFF) << SPI_CSR_DLYBS_Pos)                /**< (SPI_CSR) Delay Before SPCK Mask */
...
#define SPI_CSR_DLYBCT_Msk                  (_U(0xFF) << SPI_CSR_DLYBCT_Pos)               /**< (SPI_CSR) Delay Between Consecutive Transfers Mask */
#define SPI_CSR_DLYBCT(value)               (SPI_CSR_DLYBCT_Msk & ((value) << SPI_CSR_DLYBCT_Pos))
#define SPI_CSR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (SPI_CSR) Register MASK  (Use SPI_CSR_Msk instead)  */
#define SPI_CSR_Msk                         _U(0xFFFFFFFF)                                 /**< (SPI_CSR) Register Mask  */
...
#define SPI_CMPR_VAL1_Msk                   (_U(0xFFFF) << SPI_CMPR_VAL1_Pos)              /**< (SPI_CMPR) First Comparison Value for Received Character Mask */
...
#define SPI_CMPR_VAL2_Msk                   (_U(0xFFFF) << SPI_CMPR_VAL2_Pos)              /**< (SPI_CMPR) Second Comparison Value for Received Character Mask */
#define SPI_CMPR_VAL2(value)                (SPI_CMPR_VAL2_Msk & ((value) << SPI_CMPR_VAL2_Pos))
#define SPI_CMPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (SPI_CMPR) Register MASK  (Use SPI_CMPR_Msk instead)  */
#define SPI_CMPR_Msk                        _U(0xFFFFFFFF)                                 /**< (SPI_CMPR) Register Mask  */
...
#define SPI_WPMR_WPEN_Msk                   (_U(0x1) << SPI_WPMR_WPEN_Pos)                 /**< (SPI_WPMR) Write Protection Enable Mask */
...
#define SPI_WPMR_WPKEY_Msk                  (_U(0xFFFFFF) << SPI_WPMR_WPKEY_Pos)           /**< (SPI_WPMR) Write Protect Key Mask */
#define SPI_WPMR_WPKEY(value)               (SPI_WPMR_WPKEY_Msk & ((value) << SPI_WPMR_WPKEY_Pos))
#define   SPI_WPMR_WPKEY_PASSWD_Val         _U(0x535049)                                   /**< (SPI_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit.Always reads as 0  */
...
#define SPI_WPMR_MASK                       _U(0xFFFFFF01)                                 /**< \deprecated (SPI_WPMR) Register MASK  (Use SPI_WPMR_Msk instead)  */
#define SPI_WPMR_Msk                        _U(0xFFFFFF01)                                 /**< (SPI_WPMR) Register Mask  */
...
#define SPI_WPSR_WPVS_Msk                   (_U(0x1) << SPI_WPSR_WPVS_Pos)                 /**< (SPI_WPSR) Write Protection Violation Status Mask */
...
#define SPI_WPSR_WPVSRC_Msk                 (_U(0xFF) << SPI_WPSR_WPVSRC_Pos)              /**< (SPI_WPSR) Write Protection Violation Source Mask */
#define SPI_WPSR_WPVSRC(value)              (SPI_WPSR_WPVSRC_Msk & ((value) << SPI_WPSR_WPVSRC_Pos))
#define SPI_WPSR_MASK                       _U(0xFF01)                                     /**< \deprecated (SPI_WPSR) Register MASK  (Use SPI_WPSR_Msk instead)  */
#define SPI_WPSR_Msk                        _U(0xFF01)                                     /**< (SPI_WPSR) Register Mask  */
...
#define SPI_RPR_RXPTR_Msk                   (_U(0xFFFFFFFF) << SPI_RPR_RXPTR_Pos)          /**< (SPI_RPR) Receive Pointer Register Mask */
#define SPI_RPR_RXPTR(value)                (SPI_RPR_RXPTR_Msk & ((value) << SPI_RPR_RXPTR_Pos))
#define SPI_RPR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (SPI_RPR) Register MASK  (Use SPI_RPR_Msk instead)  */
#define SPI_RPR_Msk                         _U(0xFFFFFFFF)                                 /**< (SPI_RPR) Register Mask  */
...
#define SPI_RCR_RXCTR_Msk                   (_U(0xFFFF) << SPI_RCR_RXCTR_Pos)              /**< (SPI_RCR) Receive Counter Register Mask */
#define SPI_RCR_RXCTR(value)                (SPI_RCR_RXCTR_Msk & ((value) << SPI_RCR_RXCTR_Pos))
#define SPI_RCR_MASK                        _U(0xFFFF)                                     /**< \deprecated (SPI_RCR) Register MASK  (Use SPI_RCR_Msk instead)  */
#define SPI_RCR_Msk                         _U(0xFFFF)                                     /**< (SPI_RCR) Register Mask  */
...
#define SPI_TPR_TXPTR_Msk                   (_U(0xFFFFFFFF) << SPI_TPR_TXPTR_Pos)          /**< (SPI_TPR) Transmit Counter Register Mask */
#define SPI_TPR_TXPTR(value)                (SPI_TPR_TXPTR_Msk & ((value) << SPI_TPR_TXPTR_Pos))
#define SPI_TPR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (SPI_TPR) Register MASK  (Use SPI_TPR_Msk instead)  */
#define SPI_TPR_Msk                         _U(0xFFFFFFFF)                                 /**< (SPI_TPR) Register Mask  */
...
#define SPI_TCR_TXCTR_Msk                   (_U(0xFFFF) << SPI_TCR_TXCTR_Pos)              /**< (SPI_TCR) Transmit Counter Register Mask */
#define SPI_TCR_TXCTR(value)                (SPI_TCR_TXCTR_Msk & ((value) << SPI_TCR_TXCTR_Pos))
#define SPI_TCR_MASK                        _U(0xFFFF)                                     /**< \deprecated (SPI_TCR) Register MASK  (Use SPI_TCR_Msk instead)  */
#define SPI_TCR_Msk                         _U(0xFFFF)                                     /**< (SPI_TCR) Register Mask  */
...
#define SPI_RNPR_RXNPTR_Msk                 (_U(0xFFFFFFFF) << SPI_RNPR_RXNPTR_Pos)        /**< (SPI_RNPR) Receive Next Pointer Mask */
#define SPI_RNPR_RXNPTR(value)              (SPI_RNPR_RXNPTR_Msk & ((value) << SPI_RNPR_RXNPTR_Pos))
#define SPI_RNPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (SPI_RNPR) Register MASK  (Use SPI_RNPR_Msk instead)  */
#define SPI_RNPR_Msk                        _U(0xFFFFFFFF)                                 /**< (SPI_RNPR) Register Mask  */
...
#define SPI_RNCR_RXNCTR_Msk                 (_U(0xFFFF) << SPI_RNCR_RXNCTR_Pos)            /**< (SPI_RNCR) Receive Next Counter Mask */
#define SPI_RNCR_RXNCTR(value)              (SPI_RNCR_RXNCTR_Msk & ((value) << SPI_RNCR_RXNCTR_Pos))
#define SPI_RNCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (SPI_RNCR) Register MASK  (Use SPI_RNCR_Msk instead)  */
#define SPI_RNCR_Msk                        _U(0xFFFF)                                     /**< (SPI_RNCR) Register Mask  */
...
#define SPI_TNPR_TXNPTR_Msk                 (_U(0xFFFFFFFF) << SPI_TNPR_TXNPTR_Pos)        /**< (SPI_TNPR) Transmit Next Pointer Mask */
#define SPI_TNPR_TXNPTR(value)              (SPI_TNPR_TXNPTR_Msk & ((value) << SPI_TNPR_TXNPTR_Pos))
#define SPI_TNPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (SPI_TNPR) Register MASK  (Use SPI_TNPR_Msk instead)  */
#define SPI_TNPR_Msk                        _U(0xFFFFFFFF)                                 /**< (SPI_TNPR) Register Mask  */
...
#define SPI_TNCR_TXNCTR_Msk                 (_U(0xFFFF) << SPI_TNCR_TXNCTR_Pos)            /**< (SPI_TNCR) Transmit Counter Next Mask */
#define SPI_TNCR_TXNCTR(value)              (SPI_TNCR_TXNCTR_Msk & ((value) << SPI_TNCR_TXNCTR_Pos))
#define SPI_TNCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (SPI_TNCR) Register MASK  (Use SPI_TNCR_Msk instead)  */
#define SPI_TNCR_Msk                        _U(0xFFFF)                                     /**< (SPI_TNCR) Register Mask  */
...
#define SPI_PTCR_RXTEN_Msk                  (_U(0x1) << SPI_PTCR_RXTEN_Pos)                /**< (SPI_PTCR) Receiver Transfer Enable Mask */
...
#define SPI_PTCR_RXTDIS_Msk                 (_U(0x1) << SPI_PTCR_RXTDIS_Pos)               /**< (SPI_PTCR) Receiver Transfer Disable Mask */
...
#define SPI_PTCR_TXTEN_Msk                  (_U(0x1) << SPI_PTCR_TXTEN_Pos)                /**< (SPI_PTCR) Transmitter Transfer Enable Mask */
...
#define SPI_PTCR_TXTDIS_Msk                 (_U(0x1) << SPI_PTCR_TXTDIS_Pos)               /**< (SPI_PTCR) Transmitter Transfer Disable Mask */
...
#define SPI_PTCR_RXCBEN_Msk                 (_U(0x1) << SPI_PTCR_RXCBEN_Pos)               /**< (SPI_PTCR) Receiver Circular Buffer Enable Mask */
...
#define SPI_PTCR_RXCBDIS_Msk                (_U(0x1) << SPI_PTCR_RXCBDIS_Pos)              /**< (SPI_PTCR) Receiver Circular Buffer Disable Mask */
...
#define SPI_PTCR_TXCBEN_Msk                 (_U(0x1) << SPI_PTCR_TXCBEN_Pos)               /**< (SPI_PTCR) Transmitter Circular Buffer Enable Mask */
...
#define SPI_PTCR_TXCBDIS_Msk                (_U(0x1) << SPI_PTCR_TXCBDIS_Pos)              /**< (SPI_PTCR) Transmitter Circular Buffer Disable Mask */
...
#define SPI_PTCR_ERRCLR_Msk                 (_U(0x1) << SPI_PTCR_ERRCLR_Pos)               /**< (SPI_PTCR) Transfer Bus Error Clear Mask */
...
#define SPI_PTCR_MASK                       _U(0x10F0303)                                  /**< \deprecated (SPI_PTCR) Register MASK  (Use SPI_PTCR_Msk instead)  */
#define SPI_PTCR_Msk                        _U(0x10F0303)                                  /**< (SPI_PTCR) Register Mask  */
...
#define SPI_PTSR_RXTEN_Msk                  (_U(0x1) << SPI_PTSR_RXTEN_Pos)                /**< (SPI_PTSR) Receiver Transfer Enable Mask */
...
#define SPI_PTSR_TXTEN_Msk                  (_U(0x1) << SPI_PTSR_TXTEN_Pos)                /**< (SPI_PTSR) Transmitter Transfer Enable Mask */
...
#define SPI_PTSR_RXCBEN_Msk                 (_U(0x1) << SPI_PTSR_RXCBEN_Pos)               /**< (SPI_PTSR) Receiver Circular Buffer Enable Mask */
...
#define SPI_PTSR_TXCBEN_Msk                 (_U(0x1) << SPI_PTSR_TXCBEN_Pos)               /**< (SPI_PTSR) Transmitter Circular Buffer Enable Mask */
...
#define SPI_PTSR_ERR_Msk                    (_U(0x1) << SPI_PTSR_ERR_Pos)                  /**< (SPI_PTSR) Transfer Bus Error Mask */
...
#define SPI_PTSR_MASK                       _U(0x1050101)                                  /**< \deprecated (SPI_PTSR) Register MASK  (Use SPI_PTSR_Msk instead)  */
#define SPI_PTSR_Msk                        _U(0x1050101)                                  /**< (SPI_PTSR) Register Mask  */
