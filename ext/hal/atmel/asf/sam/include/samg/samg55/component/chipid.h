...
#define CHIPID_CIDR_VERSION_Msk             (_U(0x1F) << CHIPID_CIDR_VERSION_Pos)          /**< (CHIPID_CIDR) Version of the Device Mask */
...
#define CHIPID_CIDR_EPROC_Msk               (_U(0x7) << CHIPID_CIDR_EPROC_Pos)             /**< (CHIPID_CIDR) Embedded Processor Mask */
#define CHIPID_CIDR_EPROC(value)            (CHIPID_CIDR_EPROC_Msk & ((value) << CHIPID_CIDR_EPROC_Pos))
#define   CHIPID_CIDR_EPROC_ARM946ES_Val    _U(0x1)                                        /**< (CHIPID_CIDR) ARM946ES  */
#define   CHIPID_CIDR_EPROC_ARM7TDMI_Val    _U(0x2)                                        /**< (CHIPID_CIDR) ARM7TDMI  */
#define   CHIPID_CIDR_EPROC_CM3_Val         _U(0x3)                                        /**< (CHIPID_CIDR) Cortex-M3  */
#define   CHIPID_CIDR_EPROC_ARM920T_Val     _U(0x4)                                        /**< (CHIPID_CIDR) ARM920T  */
#define   CHIPID_CIDR_EPROC_ARM926EJS_Val   _U(0x5)                                        /**< (CHIPID_CIDR) ARM926EJS  */
#define   CHIPID_CIDR_EPROC_CA5_Val         _U(0x6)                                        /**< (CHIPID_CIDR) Cortex-A5  */
#define   CHIPID_CIDR_EPROC_CM4_Val         _U(0x7)                                        /**< (CHIPID_CIDR) Cortex-M4  */
...
#define CHIPID_CIDR_NVPSIZ_Msk              (_U(0xF) << CHIPID_CIDR_NVPSIZ_Pos)            /**< (CHIPID_CIDR) Nonvolatile Program Memory Size Mask */
#define CHIPID_CIDR_NVPSIZ(value)           (CHIPID_CIDR_NVPSIZ_Msk & ((value) << CHIPID_CIDR_NVPSIZ_Pos))
#define   CHIPID_CIDR_NVPSIZ_NONE_Val       _U(0x0)                                        /**< (CHIPID_CIDR) None  */
#define   CHIPID_CIDR_NVPSIZ_8K_Val         _U(0x1)                                        /**< (CHIPID_CIDR) 8 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_16K_Val        _U(0x2)                                        /**< (CHIPID_CIDR) 16 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_32K_Val        _U(0x3)                                        /**< (CHIPID_CIDR) 32 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_64K_Val        _U(0x5)                                        /**< (CHIPID_CIDR) 64 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_128K_Val       _U(0x7)                                        /**< (CHIPID_CIDR) 128 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_160K_Val       _U(0x8)                                        /**< (CHIPID_CIDR) 160 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_256K_Val       _U(0x9)                                        /**< (CHIPID_CIDR) 256 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_512K_Val       _U(0xA)                                        /**< (CHIPID_CIDR) 512 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_1024K_Val      _U(0xC)                                        /**< (CHIPID_CIDR) 1024 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ_2048K_Val      _U(0xE)                                        /**< (CHIPID_CIDR) 2048 Kbytes  */
...
#define CHIPID_CIDR_NVPSIZ2_Msk             (_U(0xF) << CHIPID_CIDR_NVPSIZ2_Pos)           /**< (CHIPID_CIDR) Second Nonvolatile Program Memory Size Mask */
#define CHIPID_CIDR_NVPSIZ2(value)          (CHIPID_CIDR_NVPSIZ2_Msk & ((value) << CHIPID_CIDR_NVPSIZ2_Pos))
#define   CHIPID_CIDR_NVPSIZ2_NONE_Val      _U(0x0)                                        /**< (CHIPID_CIDR) None  */
#define   CHIPID_CIDR_NVPSIZ2_8K_Val        _U(0x1)                                        /**< (CHIPID_CIDR) 8 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ2_16K_Val       _U(0x2)                                        /**< (CHIPID_CIDR) 16 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ2_32K_Val       _U(0x3)                                        /**< (CHIPID_CIDR) 32 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ2_64K_Val       _U(0x5)                                        /**< (CHIPID_CIDR) 64 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ2_128K_Val      _U(0x7)                                        /**< (CHIPID_CIDR) 128 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ2_256K_Val      _U(0x9)                                        /**< (CHIPID_CIDR) 256 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ2_512K_Val      _U(0xA)                                        /**< (CHIPID_CIDR) 512 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ2_1024K_Val     _U(0xC)                                        /**< (CHIPID_CIDR) 1024 Kbytes  */
#define   CHIPID_CIDR_NVPSIZ2_2048K_Val     _U(0xE)                                        /**< (CHIPID_CIDR) 2048 Kbytes  */
...
#define CHIPID_CIDR_SRAMSIZ_Msk             (_U(0xF) << CHIPID_CIDR_SRAMSIZ_Pos)           /**< (CHIPID_CIDR) Internal SRAM Size Mask */
#define CHIPID_CIDR_SRAMSIZ(value)          (CHIPID_CIDR_SRAMSIZ_Msk & ((value) << CHIPID_CIDR_SRAMSIZ_Pos))
#define   CHIPID_CIDR_SRAMSIZ_48K_Val       _U(0x0)                                        /**< (CHIPID_CIDR) 48 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_192K_Val      _U(0x1)                                        /**< (CHIPID_CIDR) 192 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_384K_Val      _U(0x2)                                        /**< (CHIPID_CIDR) 384 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_6K_Val        _U(0x3)                                        /**< (CHIPID_CIDR) 6 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_24K_Val       _U(0x4)                                        /**< (CHIPID_CIDR) 24 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_4K_Val        _U(0x5)                                        /**< (CHIPID_CIDR) 4 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_80K_Val       _U(0x6)                                        /**< (CHIPID_CIDR) 80 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_160K_Val      _U(0x7)                                        /**< (CHIPID_CIDR) 160 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_8K_Val        _U(0x8)                                        /**< (CHIPID_CIDR) 8 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_16K_Val       _U(0x9)                                        /**< (CHIPID_CIDR) 16 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_32K_Val       _U(0xA)                                        /**< (CHIPID_CIDR) 32 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_64K_Val       _U(0xB)                                        /**< (CHIPID_CIDR) 64 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_128K_Val      _U(0xC)                                        /**< (CHIPID_CIDR) 128 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_256K_Val      _U(0xD)                                        /**< (CHIPID_CIDR) 256 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_96K_Val       _U(0xE)                                        /**< (CHIPID_CIDR) 96 Kbytes  */
#define   CHIPID_CIDR_SRAMSIZ_512K_Val      _U(0xF)                                        /**< (CHIPID_CIDR) 512 Kbytes  */
...
#define CHIPID_CIDR_ARCH_Msk                (_U(0xFF) << CHIPID_CIDR_ARCH_Pos)             /**< (CHIPID_CIDR) Architecture Identifier Mask */
#define CHIPID_CIDR_ARCH(value)             (CHIPID_CIDR_ARCH_Msk & ((value) << CHIPID_CIDR_ARCH_Pos))
#define   CHIPID_CIDR_ARCH_SAMG55_Val       _U(0x44)                                       /**< (CHIPID_CIDR) SAM G55 (49-lead version)  */
...
#define CHIPID_CIDR_NVPTYP_Msk              (_U(0x7) << CHIPID_CIDR_NVPTYP_Pos)            /**< (CHIPID_CIDR) Nonvolatile Program Memory Type Mask */
#define CHIPID_CIDR_NVPTYP(value)           (CHIPID_CIDR_NVPTYP_Msk & ((value) << CHIPID_CIDR_NVPTYP_Pos))
#define   CHIPID_CIDR_NVPTYP_ROM_Val        _U(0x0)                                        /**< (CHIPID_CIDR) ROM  */
#define   CHIPID_CIDR_NVPTYP_ROMLESS_Val    _U(0x1)                                        /**< (CHIPID_CIDR) ROMless or on-chip Flash  */
#define   CHIPID_CIDR_NVPTYP_FLASH_Val      _U(0x2)                                        /**< (CHIPID_CIDR) Embedded Flash Memory  */
#define   CHIPID_CIDR_NVPTYP_ROM_FLASH_Val  _U(0x3)                                        /**< (CHIPID_CIDR) ROM and Embedded Flash Memory- NVPSIZ is ROM size- NVPSIZ2 is Flash size  */
#define   CHIPID_CIDR_NVPTYP_SRAM_Val       _U(0x4)                                        /**< (CHIPID_CIDR) SRAM emulating ROM  */
...
#define CHIPID_CIDR_EXT_Msk                 (_U(0x1) << CHIPID_CIDR_EXT_Pos)               /**< (CHIPID_CIDR) Extension Flag Mask */
...
#define CHIPID_CIDR_MASK                    _U(0xFFFFFFFF)                                 /**< \deprecated (CHIPID_CIDR) Register MASK  (Use CHIPID_CIDR_Msk instead)  */
#define CHIPID_CIDR_Msk                     _U(0xFFFFFFFF)                                 /**< (CHIPID_CIDR) Register Mask  */
...
#define CHIPID_EXID_EXID_Msk                (_U(0xFFFFFFFF) << CHIPID_EXID_EXID_Pos)       /**< (CHIPID_EXID) Chip ID Extension Mask */
#define CHIPID_EXID_EXID(value)             (CHIPID_EXID_EXID_Msk & ((value) << CHIPID_EXID_EXID_Pos))
#define CHIPID_EXID_MASK                    _U(0xFFFFFFFF)                                 /**< \deprecated (CHIPID_EXID) Register MASK  (Use CHIPID_EXID_Msk instead)  */
#define CHIPID_EXID_Msk                     _U(0xFFFFFFFF)                                 /**< (CHIPID_EXID) Register Mask  */
