...
typedef struct _DeviceVectors
{
  ...
  void* pfnMemManage_Handler;                    /* 4   Cortex-M4 Memory Management Interrupt  */
  ...
  void* pfnSVC_Handler;                          /* 11  Cortex-M4 SV Call Interrupt          */
  void* pfnDebugMon_Handler;                     /* 12  Cortex-M4 Debug Monitor Interrupt    */
...
#define PERIPHERALS_SIZE         _U(0x20000000)       /* 524288kB Memory segment type: io */
#define SYSTEM_SIZE              _U(0x10000000)       /* 262144kB Memory segment type: io */
#define IFLASH_SIZE              _U(0x00080000)       /*  512kB Memory segment type: flash */
#define IFLASH_PAGE_SIZE         _U(       512)
#define IFLASH_NB_OF_PAGES       _U(      1024)

#define IROM_SIZE                _U(0x00400000)       /* 4096kB Memory segment type: rom */
#define IRAM_SIZE                _U(0x00028000)       /*  160kB Memory segment type: ram */
#define CMCC_SIZE                _U(0x00004000)       /*   16kB Memory segment type: other */

#define PERIPHERALS_ADDR         _U(0x40000000)       /**< PERIPHERALS base address (type: io)*/
#define SYSTEM_ADDR              _U(0xe0000000)       /**< SYSTEM base address (type: io)*/
#define IFLASH_ADDR              _U(0x00400000)       /**< IFLASH base address (type: flash)*/
#define IROM_ADDR                _U(0x00800000)       /**< IROM base address (type: rom)*/
#define IRAM_ADDR                _U(0x20000000)       /**< IRAM base address (type: ram)*/
#define CMCC_ADDR                _U(0x1fc00000)       /**< CMCC base address (type: other)*/

/* ************************************************************************** */
/**  DEVICE SIGNATURES FOR SAMG55J19 */
/* ************************************************************************** */
#define JTAGID                   _UL(0X05B3E03F)
#define CHIP_JTAGID              _UL(0X05B3E03F)
#define CHIP_CIDR                _UL(0X24570AE0)
#define CHIP_EXID                _UL(0X00000000)

/* ************************************************************************** */
/**  ELECTRICAL DEFINITIONS FOR SAMG55J19 */
/* ************************************************************************** */
#define CHIP_FREQ_SLCK_RC_MIN          _UL(20000)      
#define CHIP_FREQ_SLCK_RC              _UL(32000)      
#define CHIP_FREQ_SLCK_RC_MAX          _UL(44000)      
#define CHIP_FREQ_MAINCK_RC_8MHZ       _UL(8000000)    
#define CHIP_FREQ_MAINCK_RC_16MHZ      _UL(16000000)   
#define CHIP_FREQ_MAINCK_RC_24MHZ      _UL(24000000)   
#define CHIP_FREQ_CPU_MAX              _UL(120000000)  
#define CHIP_FREQ_XTAL_32K             _UL(32768)      
#define CHIP_FLASH_WRITE_WAIT_STATE    _UL(8)          /**< \brief Embedded Flash Write Wait State*/
#define CHIP_FREQ_FWS_0                _UL(14000000)   /**< \brief Maximum operating frequency when FWS is 0*/
#define CHIP_FREQ_FWS_1                _UL(28000000)   /**< \brief Maximum operating frequency when FWS is 1*/
#define CHIP_FREQ_FWS_2                _UL(42000000)   /**< \brief Maximum operating frequency when FWS is 2*/
#define CHIP_FREQ_FWS_3                _UL(56000000)   /**< \brief Maximum operating frequency when FWS is 3*/
#define CHIP_FREQ_FWS_4                _UL(70000000)   /**< \brief Maximum operating frequency when FWS is 4*/
#define CHIP_FREQ_FWS_5                _UL(84000000)   /**< \brief Maximum operating frequency when FWS is 5*/
#define CHIP_FREQ_FWS_6                _UL(96000000)   /**< \brief Maximum operating frequency when FWS is 6*/
#define CHIP_FREQ_FWS_7                _UL(108000000)  /**< \brief Maximum operating frequency when FWS is 7*/
#define CHIP_FREQ_FWS_8                _UL(120000000)  /**< \brief Maximum operating frequency when FWS is 8*/
