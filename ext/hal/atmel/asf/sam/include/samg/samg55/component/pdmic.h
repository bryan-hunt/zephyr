...
#define PDMIC_CR_SWRST_Msk                  (_U(0x1) << PDMIC_CR_SWRST_Pos)                /**< (PDMIC_CR) Software Reset Mask */
...
#define PDMIC_CR_ENPDM_Msk                  (_U(0x1) << PDMIC_CR_ENPDM_Pos)                /**< (PDMIC_CR) Enable PDM Mask */
...
#define PDMIC_CR_MASK                       _U(0x11)                                       /**< \deprecated (PDMIC_CR) Register MASK  (Use PDMIC_CR_Msk instead)  */
#define PDMIC_CR_Msk                        _U(0x11)                                       /**< (PDMIC_CR) Register Mask  */
...
#define PDMIC_MR_CLKS_Msk                   (_U(0x1) << PDMIC_MR_CLKS_Pos)                 /**< (PDMIC_MR) Clock Source Selection Mask */
...
#define PDMIC_MR_PRESCAL_Msk                (_U(0x7F) << PDMIC_MR_PRESCAL_Pos)             /**< (PDMIC_MR) Prescaler Rate Selection Mask */
#define PDMIC_MR_PRESCAL(value)             (PDMIC_MR_PRESCAL_Msk & ((value) << PDMIC_MR_PRESCAL_Pos))
#define PDMIC_MR_MASK                       _U(0x7F10)                                     /**< \deprecated (PDMIC_MR) Register MASK  (Use PDMIC_MR_Msk instead)  */
#define PDMIC_MR_Msk                        _U(0x7F10)                                     /**< (PDMIC_MR) Register Mask  */
...
#define PDMIC_CDR_DATA_Msk                  (_U(0xFFFFFFFF) << PDMIC_CDR_DATA_Pos)         /**< (PDMIC_CDR) Data Converted Mask */
#define PDMIC_CDR_DATA(value)               (PDMIC_CDR_DATA_Msk & ((value) << PDMIC_CDR_DATA_Pos))
#define PDMIC_CDR_MASK                      _U(0xFFFFFFFF)                                 /**< \deprecated (PDMIC_CDR) Register MASK  (Use PDMIC_CDR_Msk instead)  */
#define PDMIC_CDR_Msk                       _U(0xFFFFFFFF)                                 /**< (PDMIC_CDR) Register Mask  */
...
#define PDMIC_IER_DRDY_Msk                  (_U(0x1) << PDMIC_IER_DRDY_Pos)                /**< (PDMIC_IER) Data Ready Interrupt Enable Mask */
...
#define PDMIC_IER_OVRE_Msk                  (_U(0x1) << PDMIC_IER_OVRE_Pos)                /**< (PDMIC_IER) Overrun Error Interrupt Enable Mask */
...
#define PDMIC_IER_ENDRX_Msk                 (_U(0x1) << PDMIC_IER_ENDRX_Pos)               /**< (PDMIC_IER) End of Receive Buffer Interrupt Enable Mask */
...
#define PDMIC_IER_RXBUFF_Msk                (_U(0x1) << PDMIC_IER_RXBUFF_Pos)              /**< (PDMIC_IER) Receive Buffer Full Interrupt Enable Mask */
...
#define PDMIC_IER_MASK                      _U(0x1B000000)                                 /**< \deprecated (PDMIC_IER) Register MASK  (Use PDMIC_IER_Msk instead)  */
#define PDMIC_IER_Msk                       _U(0x1B000000)                                 /**< (PDMIC_IER) Register Mask  */
...
#define PDMIC_IDR_DRDY_Msk                  (_U(0x1) << PDMIC_IDR_DRDY_Pos)                /**< (PDMIC_IDR) Data Ready Interrupt Disable Mask */
...
#define PDMIC_IDR_OVRE_Msk                  (_U(0x1) << PDMIC_IDR_OVRE_Pos)                /**< (PDMIC_IDR) General Overrun Error Interrupt Disable Mask */
...
#define PDMIC_IDR_ENDRX_Msk                 (_U(0x1) << PDMIC_IDR_ENDRX_Pos)               /**< (PDMIC_IDR) End of Receive Buffer Interrupt Disable Mask */
...
#define PDMIC_IDR_RXBUFF_Msk                (_U(0x1) << PDMIC_IDR_RXBUFF_Pos)              /**< (PDMIC_IDR) Receive Buffer Full Interrupt Disable Mask */
...
#define PDMIC_IDR_MASK                      _U(0x1B000000)                                 /**< \deprecated (PDMIC_IDR) Register MASK  (Use PDMIC_IDR_Msk instead)  */
#define PDMIC_IDR_Msk                       _U(0x1B000000)                                 /**< (PDMIC_IDR) Register Mask  */
...
#define PDMIC_IMR_DRDY_Msk                  (_U(0x1) << PDMIC_IMR_DRDY_Pos)                /**< (PDMIC_IMR) Data Ready Interrupt Mask Mask */
...
#define PDMIC_IMR_OVRE_Msk                  (_U(0x1) << PDMIC_IMR_OVRE_Pos)                /**< (PDMIC_IMR) General Overrun Error Interrupt Mask Mask */
...
#define PDMIC_IMR_ENDRX_Msk                 (_U(0x1) << PDMIC_IMR_ENDRX_Pos)               /**< (PDMIC_IMR) End of Receive Buffer Interrupt Mask Mask */
...
#define PDMIC_IMR_RXBUFF_Msk                (_U(0x1) << PDMIC_IMR_RXBUFF_Pos)              /**< (PDMIC_IMR) Receive Buffer Full Interrupt Mask Mask */
...
#define PDMIC_IMR_MASK                      _U(0x1B000000)                                 /**< \deprecated (PDMIC_IMR) Register MASK  (Use PDMIC_IMR_Msk instead)  */
#define PDMIC_IMR_Msk                       _U(0x1B000000)                                 /**< (PDMIC_IMR) Register Mask  */
...
#define PDMIC_ISR_FIFOCNT_Msk               (_U(0xFF) << PDMIC_ISR_FIFOCNT_Pos)            /**< (PDMIC_ISR) FIFO Count Mask */
...
#define PDMIC_ISR_DRDY_Msk                  (_U(0x1) << PDMIC_ISR_DRDY_Pos)                /**< (PDMIC_ISR) Data Ready Mask */
...
#define PDMIC_ISR_OVRE_Msk                  (_U(0x1) << PDMIC_ISR_OVRE_Pos)                /**< (PDMIC_ISR) Overrun Error Mask */
...
#define PDMIC_ISR_ENDRX_Msk                 (_U(0x1) << PDMIC_ISR_ENDRX_Pos)               /**< (PDMIC_ISR) End of RX Buffer Mask */
...
#define PDMIC_ISR_RXBUFF_Msk                (_U(0x1) << PDMIC_ISR_RXBUFF_Pos)              /**< (PDMIC_ISR) RX Buffer Full Mask */
...
#define PDMIC_ISR_MASK                      _U(0x1BFF0000)                                 /**< \deprecated (PDMIC_ISR) Register MASK  (Use PDMIC_ISR_Msk instead)  */
#define PDMIC_ISR_Msk                       _U(0x1BFF0000)                                 /**< (PDMIC_ISR) Register Mask  */
...
#define PDMIC_DSPR0_HPFBYP_Msk              (_U(0x1) << PDMIC_DSPR0_HPFBYP_Pos)            /**< (PDMIC_DSPR0) High-Pass Filter Bypass Mask */
...
#define PDMIC_DSPR0_SINBYP_Msk              (_U(0x1) << PDMIC_DSPR0_SINBYP_Pos)            /**< (PDMIC_DSPR0) SINCC Filter Bypass Mask */
...
#define PDMIC_DSPR0_SIZE_Msk                (_U(0x1) << PDMIC_DSPR0_SIZE_Pos)              /**< (PDMIC_DSPR0) Data Size Mask */
...
#define PDMIC_DSPR0_OSR_Msk                 (_U(0x7) << PDMIC_DSPR0_OSR_Pos)               /**< (PDMIC_DSPR0) Oversampling Ratio Mask */
#define PDMIC_DSPR0_OSR(value)              (PDMIC_DSPR0_OSR_Msk & ((value) << PDMIC_DSPR0_OSR_Pos))
#define   PDMIC_DSPR0_OSR_128_Val           _U(0x0)                                        /**< (PDMIC_DSPR0) Oversampling ratio is 128  */
#define   PDMIC_DSPR0_OSR_64_Val            _U(0x1)                                        /**< (PDMIC_DSPR0) Oversampling ratio is 64  */
...
#define PDMIC_DSPR0_SCALE_Msk               (_U(0xF) << PDMIC_DSPR0_SCALE_Pos)             /**< (PDMIC_DSPR0) Data Scale Mask */
...
#define PDMIC_DSPR0_SHIFT_Msk               (_U(0xF) << PDMIC_DSPR0_SHIFT_Pos)             /**< (PDMIC_DSPR0) Data Shift Mask */
#define PDMIC_DSPR0_SHIFT(value)            (PDMIC_DSPR0_SHIFT_Msk & ((value) << PDMIC_DSPR0_SHIFT_Pos))
#define PDMIC_DSPR0_MASK                    _U(0xFF7E)                                     /**< \deprecated (PDMIC_DSPR0) Register MASK  (Use PDMIC_DSPR0_Msk instead)  */
#define PDMIC_DSPR0_Msk                     _U(0xFF7E)                                     /**< (PDMIC_DSPR0) Register Mask  */
...
#define PDMIC_DSPR1_DGAIN_Msk               (_U(0x7FFF) << PDMIC_DSPR1_DGAIN_Pos)          /**< (PDMIC_DSPR1) Gain Correction Mask */
...
#define PDMIC_DSPR1_OFST_Msk                (_U(0xFFFF) << PDMIC_DSPR1_OFST_Pos)           /**< (PDMIC_DSPR1) Offset Correction Mask */
#define PDMIC_DSPR1_OFST(value)             (PDMIC_DSPR1_OFST_Msk & ((value) << PDMIC_DSPR1_OFST_Pos))
#define PDMIC_DSPR1_MASK                    _U(0xFFFF7FFF)                                 /**< \deprecated (PDMIC_DSPR1) Register MASK  (Use PDMIC_DSPR1_Msk instead)  */
#define PDMIC_DSPR1_Msk                     _U(0xFFFF7FFF)                                 /**< (PDMIC_DSPR1) Register Mask  */
...
#define PDMIC_WPMR_WPEN_Msk                 (_U(0x1) << PDMIC_WPMR_WPEN_Pos)               /**< (PDMIC_WPMR) Write Protection Enable Mask */
...
#define PDMIC_WPMR_WPKEY_Msk                (_U(0xFFFFFF) << PDMIC_WPMR_WPKEY_Pos)         /**< (PDMIC_WPMR) Write Protect Key Mask */
#define PDMIC_WPMR_WPKEY(value)             (PDMIC_WPMR_WPKEY_Msk & ((value) << PDMIC_WPMR_WPKEY_Pos))
#define   PDMIC_WPMR_WPKEY_PASSWD_Val       _U(0x414443)                                   /**< (PDMIC_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit.Always reads as 0.  */
...
#define PDMIC_WPMR_MASK                     _U(0xFFFFFF01)                                 /**< \deprecated (PDMIC_WPMR) Register MASK  (Use PDMIC_WPMR_Msk instead)  */
#define PDMIC_WPMR_Msk                      _U(0xFFFFFF01)                                 /**< (PDMIC_WPMR) Register Mask  */
...
#define PDMIC_WPSR_WPVS_Msk                 (_U(0x1) << PDMIC_WPSR_WPVS_Pos)               /**< (PDMIC_WPSR) Write Protection Violation Status Mask */
...
#define PDMIC_WPSR_WPVSRC_Msk               (_U(0xFFFF) << PDMIC_WPSR_WPVSRC_Pos)          /**< (PDMIC_WPSR) Write Protection Violation Source Mask */
#define PDMIC_WPSR_WPVSRC(value)            (PDMIC_WPSR_WPVSRC_Msk & ((value) << PDMIC_WPSR_WPVSRC_Pos))
#define PDMIC_WPSR_MASK                     _U(0xFFFF01)                                   /**< \deprecated (PDMIC_WPSR) Register MASK  (Use PDMIC_WPSR_Msk instead)  */
#define PDMIC_WPSR_Msk                      _U(0xFFFF01)                                   /**< (PDMIC_WPSR) Register Mask  */
...
#define PDMIC_RPR_RXPTR_Msk                 (_U(0xFFFFFFFF) << PDMIC_RPR_RXPTR_Pos)        /**< (PDMIC_RPR) Receive Pointer Register Mask */
#define PDMIC_RPR_RXPTR(value)              (PDMIC_RPR_RXPTR_Msk & ((value) << PDMIC_RPR_RXPTR_Pos))
#define PDMIC_RPR_MASK                      _U(0xFFFFFFFF)                                 /**< \deprecated (PDMIC_RPR) Register MASK  (Use PDMIC_RPR_Msk instead)  */
#define PDMIC_RPR_Msk                       _U(0xFFFFFFFF)                                 /**< (PDMIC_RPR) Register Mask  */
...
#define PDMIC_RCR_RXCTR_Msk                 (_U(0xFFFF) << PDMIC_RCR_RXCTR_Pos)            /**< (PDMIC_RCR) Receive Counter Register Mask */
#define PDMIC_RCR_RXCTR(value)              (PDMIC_RCR_RXCTR_Msk & ((value) << PDMIC_RCR_RXCTR_Pos))
#define PDMIC_RCR_MASK                      _U(0xFFFF)                                     /**< \deprecated (PDMIC_RCR) Register MASK  (Use PDMIC_RCR_Msk instead)  */
#define PDMIC_RCR_Msk                       _U(0xFFFF)                                     /**< (PDMIC_RCR) Register Mask  */
...
#define PDMIC_RNPR_RXNPTR_Msk               (_U(0xFFFFFFFF) << PDMIC_RNPR_RXNPTR_Pos)      /**< (PDMIC_RNPR) Receive Next Pointer Mask */
#define PDMIC_RNPR_RXNPTR(value)            (PDMIC_RNPR_RXNPTR_Msk & ((value) << PDMIC_RNPR_RXNPTR_Pos))
#define PDMIC_RNPR_MASK                     _U(0xFFFFFFFF)                                 /**< \deprecated (PDMIC_RNPR) Register MASK  (Use PDMIC_RNPR_Msk instead)  */
#define PDMIC_RNPR_Msk                      _U(0xFFFFFFFF)                                 /**< (PDMIC_RNPR) Register Mask  */
...
#define PDMIC_RNCR_RXNCTR_Msk               (_U(0xFFFF) << PDMIC_RNCR_RXNCTR_Pos)          /**< (PDMIC_RNCR) Receive Next Counter Mask */
#define PDMIC_RNCR_RXNCTR(value)            (PDMIC_RNCR_RXNCTR_Msk & ((value) << PDMIC_RNCR_RXNCTR_Pos))
#define PDMIC_RNCR_MASK                     _U(0xFFFF)                                     /**< \deprecated (PDMIC_RNCR) Register MASK  (Use PDMIC_RNCR_Msk instead)  */
#define PDMIC_RNCR_Msk                      _U(0xFFFF)                                     /**< (PDMIC_RNCR) Register Mask  */
...
#define PDMIC_PTCR_RXTEN_Msk                (_U(0x1) << PDMIC_PTCR_RXTEN_Pos)              /**< (PDMIC_PTCR) Receiver Transfer Enable Mask */
...
#define PDMIC_PTCR_RXTDIS_Msk               (_U(0x1) << PDMIC_PTCR_RXTDIS_Pos)             /**< (PDMIC_PTCR) Receiver Transfer Disable Mask */
...
#define PDMIC_PTCR_TXTEN_Msk                (_U(0x1) << PDMIC_PTCR_TXTEN_Pos)              /**< (PDMIC_PTCR) Transmitter Transfer Enable Mask */
...
#define PDMIC_PTCR_TXTDIS_Msk               (_U(0x1) << PDMIC_PTCR_TXTDIS_Pos)             /**< (PDMIC_PTCR) Transmitter Transfer Disable Mask */
...
#define PDMIC_PTCR_RXCBEN_Msk               (_U(0x1) << PDMIC_PTCR_RXCBEN_Pos)             /**< (PDMIC_PTCR) Receiver Circular Buffer Enable Mask */
...
#define PDMIC_PTCR_RXCBDIS_Msk              (_U(0x1) << PDMIC_PTCR_RXCBDIS_Pos)            /**< (PDMIC_PTCR) Receiver Circular Buffer Disable Mask */
...
#define PDMIC_PTCR_TXCBEN_Msk               (_U(0x1) << PDMIC_PTCR_TXCBEN_Pos)             /**< (PDMIC_PTCR) Transmitter Circular Buffer Enable Mask */
...
#define PDMIC_PTCR_TXCBDIS_Msk              (_U(0x1) << PDMIC_PTCR_TXCBDIS_Pos)            /**< (PDMIC_PTCR) Transmitter Circular Buffer Disable Mask */
...
#define PDMIC_PTCR_ERRCLR_Msk               (_U(0x1) << PDMIC_PTCR_ERRCLR_Pos)             /**< (PDMIC_PTCR) Transfer Bus Error Clear Mask */
...
#define PDMIC_PTCR_MASK                     _U(0x10F0303)                                  /**< \deprecated (PDMIC_PTCR) Register MASK  (Use PDMIC_PTCR_Msk instead)  */
#define PDMIC_PTCR_Msk                      _U(0x10F0303)                                  /**< (PDMIC_PTCR) Register Mask  */
...
#define PDMIC_PTSR_RXTEN_Msk                (_U(0x1) << PDMIC_PTSR_RXTEN_Pos)              /**< (PDMIC_PTSR) Receiver Transfer Enable Mask */
...
#define PDMIC_PTSR_TXTEN_Msk                (_U(0x1) << PDMIC_PTSR_TXTEN_Pos)              /**< (PDMIC_PTSR) Transmitter Transfer Enable Mask */
...
#define PDMIC_PTSR_RXCBEN_Msk               (_U(0x1) << PDMIC_PTSR_RXCBEN_Pos)             /**< (PDMIC_PTSR) Receiver Circular Buffer Enable Mask */
...
#define PDMIC_PTSR_TXCBEN_Msk               (_U(0x1) << PDMIC_PTSR_TXCBEN_Pos)             /**< (PDMIC_PTSR) Transmitter Circular Buffer Enable Mask */
...
#define PDMIC_PTSR_ERR_Msk                  (_U(0x1) << PDMIC_PTSR_ERR_Pos)                /**< (PDMIC_PTSR) Transfer Bus Error Mask */
...
#define PDMIC_PTSR_MASK                     _U(0x1050101)                                  /**< \deprecated (PDMIC_PTSR) Register MASK  (Use PDMIC_PTSR_Msk instead)  */
#define PDMIC_PTSR_Msk                      _U(0x1050101)                                  /**< (PDMIC_PTSR) Register Mask  */
