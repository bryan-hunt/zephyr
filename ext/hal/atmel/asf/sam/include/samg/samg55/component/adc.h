...
#define ADC_CR_SWRST_Msk                    (_U(0x1) << ADC_CR_SWRST_Pos)                  /**< (ADC_CR) Software Reset Mask */
...
#define ADC_CR_START_Msk                    (_U(0x1) << ADC_CR_START_Pos)                  /**< (ADC_CR) Start Conversion Mask */
...
#define ADC_CR_CMPRST_Msk                   (_U(0x1) << ADC_CR_CMPRST_Pos)                 /**< (ADC_CR) Comparison Restart Mask */
...
#define ADC_CR_MASK                         _U(0x13)                                       /**< \deprecated (ADC_CR) Register MASK  (Use ADC_CR_Msk instead)  */
#define ADC_CR_Msk                          _U(0x13)                                       /**< (ADC_CR) Register Mask  */
...
#define ADC_MR_TRGEN_Msk                    (_U(0x1) << ADC_MR_TRGEN_Pos)                  /**< (ADC_MR) Trigger Enable Mask */
...
#define   ADC_MR_TRGEN_DIS_Val              _U(0x0)                                        /**< (ADC_MR) Hardware triggers are disabled. Starting a conversion is only possible by software.  */
#define   ADC_MR_TRGEN_EN_Val               _U(0x1)                                        /**< (ADC_MR) Hardware trigger selected by TRGSEL field is enabled.  */
...
#define ADC_MR_TRGSEL_Msk                   (_U(0x7) << ADC_MR_TRGSEL_Pos)                 /**< (ADC_MR) Trigger Selection Mask */
#define ADC_MR_TRGSEL(value)                (ADC_MR_TRGSEL_Msk & ((value) << ADC_MR_TRGSEL_Pos))
#define   ADC_MR_TRGSEL_ADC_TRIG0_Val       _U(0x0)                                        /**< (ADC_MR) ADTRG External trigger  */
#define   ADC_MR_TRGSEL_ADC_TRIG1_Val       _U(0x1)                                        /**< (ADC_MR) TIOA0 Output of the Timer Counter Channel 0  */
#define   ADC_MR_TRGSEL_ADC_TRIG2_Val       _U(0x2)                                        /**< (ADC_MR) TIOA1 Output of the Timer Counter Channel 1  */
#define   ADC_MR_TRGSEL_ADC_TRIG3_Val       _U(0x3)                                        /**< (ADC_MR) TIOA2 Output of the Timer Counter Channel 2  */
#define   ADC_MR_TRGSEL_ADC_TRIG4_Val       _U(0x4)                                        /**< (ADC_MR) RTCOUT0  */
#define   ADC_MR_TRGSEL_ADC_TRIG5_Val       _U(0x5)                                        /**< (ADC_MR) RTT 16-Bit prescaler output  */
#define   ADC_MR_TRGSEL_ADC_TRIG6_Val       _U(0x6)                                        /**< (ADC_MR) RTTEVENT  */
#define   ADC_MR_TRGSEL_ADC_TRIG7_Val       _U(0x7)                                        /**< (ADC_MR) -  */
...
#define ADC_MR_SLEEP_Msk                    (_U(0x1) << ADC_MR_SLEEP_Pos)                  /**< (ADC_MR) Sleep Mode Mask */
...
#define   ADC_MR_SLEEP_NORMAL_Val           _U(0x0)                                        /**< (ADC_MR) Normal Mode: The ADC core and reference voltage circuitry are kept ON between conversions.  */
#define   ADC_MR_SLEEP_SLEEP_Val            _U(0x1)                                        /**< (ADC_MR) Sleep Mode: The wake-up time can be modified by programming FWUP bit.  */
...
#define ADC_MR_FWUP_Msk                     (_U(0x1) << ADC_MR_FWUP_Pos)                   /**< (ADC_MR) Fast Wake Up Mask */
#define ADC_MR_FWUP                         ADC_MR_FWUP_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_MR_FWUP_Msk instead */
#define   ADC_MR_FWUP_OFF_Val               _U(0x0)                                        /**< (ADC_MR) If SLEEP is 1, then both ADC core and reference voltage circuitry are OFF between conversions  */
#define   ADC_MR_FWUP_ON_Val                _U(0x1)                                        /**< (ADC_MR) If SLEEP is 1, then Fast Wake-up Sleep mode: The voltage reference is ON between conversions and ADC core is OFF  */
...
#define ADC_MR_FREERUN_Msk                  (_U(0x1) << ADC_MR_FREERUN_Pos)                /**< (ADC_MR) Free Run Mode Mask */
...
#define   ADC_MR_FREERUN_OFF_Val            _U(0x0)                                        /**< (ADC_MR) Normal Mode  */
#define   ADC_MR_FREERUN_ON_Val             _U(0x1)                                        /**< (ADC_MR) Free Run Mode: Never wait for any trigger.  */
...
#define ADC_MR_PRESCAL_Msk                  (_U(0xFF) << ADC_MR_PRESCAL_Pos)               /**< (ADC_MR) Prescaler Rate Selection Mask */
...
#define ADC_MR_STARTUP_Msk                  (_U(0xF) << ADC_MR_STARTUP_Pos)                /**< (ADC_MR) Start Up Time Mask */
#define ADC_MR_STARTUP(value)               (ADC_MR_STARTUP_Msk & ((value) << ADC_MR_STARTUP_Pos))
#define   ADC_MR_STARTUP_SUT0_Val           _U(0x0)                                        /**< (ADC_MR) 0 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT8_Val           _U(0x1)                                        /**< (ADC_MR) 8 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT16_Val          _U(0x2)                                        /**< (ADC_MR) 16 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT24_Val          _U(0x3)                                        /**< (ADC_MR) 24 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT64_Val          _U(0x4)                                        /**< (ADC_MR) 64 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT80_Val          _U(0x5)                                        /**< (ADC_MR) 80 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT96_Val          _U(0x6)                                        /**< (ADC_MR) 96 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT112_Val         _U(0x7)                                        /**< (ADC_MR) 112 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT512_Val         _U(0x8)                                        /**< (ADC_MR) 512 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT576_Val         _U(0x9)                                        /**< (ADC_MR) 576 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT640_Val         _U(0xA)                                        /**< (ADC_MR) 640 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT704_Val         _U(0xB)                                        /**< (ADC_MR) 704 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT768_Val         _U(0xC)                                        /**< (ADC_MR) 768 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT832_Val         _U(0xD)                                        /**< (ADC_MR) 832 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT896_Val         _U(0xE)                                        /**< (ADC_MR) 896 periods of ADCCLK  */
#define   ADC_MR_STARTUP_SUT960_Val         _U(0xF)                                        /**< (ADC_MR) 960 periods of ADCCLK  */
...
#define ADC_MR_SETTLING_Msk                 (_U(0x3) << ADC_MR_SETTLING_Pos)               /**< (ADC_MR) Analog Settling Time Mask */
#define ADC_MR_SETTLING(value)              (ADC_MR_SETTLING_Msk & ((value) << ADC_MR_SETTLING_Pos))
#define   ADC_MR_SETTLING_AST3_Val          _U(0x0)                                        /**< (ADC_MR) 3 periods of ADCCLK  */
#define   ADC_MR_SETTLING_AST5_Val          _U(0x1)                                        /**< (ADC_MR) 5 periods of ADCCLK  */
#define   ADC_MR_SETTLING_AST9_Val          _U(0x2)                                        /**< (ADC_MR) 9 periods of ADCCLK  */
#define   ADC_MR_SETTLING_AST17_Val         _U(0x3)                                        /**< (ADC_MR) 17 periods of ADCCLK  */
...
#define ADC_MR_ANACH_Msk                    (_U(0x1) << ADC_MR_ANACH_Pos)                  /**< (ADC_MR) Analog Change Mask */
...
#define   ADC_MR_ANACH_NONE_Val             _U(0x0)                                        /**< (ADC_MR) No analog change on channel switching: DIFF0, and OFF0 are used for all channels.  */
#define   ADC_MR_ANACH_ALLOWED_Val          _U(0x1)                                        /**< (ADC_MR) Allows different analog settings for each channel. See ADC_COR registers.  */
...
#define ADC_MR_TRACKTIM_Msk                 (_U(0xF) << ADC_MR_TRACKTIM_Pos)               /**< (ADC_MR) Tracking Time Mask */
...
#define ADC_MR_TRANSFER_Msk                 (_U(0x3) << ADC_MR_TRANSFER_Pos)               /**< (ADC_MR) Transfer Period Mask */
...
#define ADC_MR_USEQ_Msk                     (_U(0x1) << ADC_MR_USEQ_Pos)                   /**< (ADC_MR) Use Sequence Enable Mask */
#define ADC_MR_USEQ                         ADC_MR_USEQ_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_MR_USEQ_Msk instead */
#define   ADC_MR_USEQ_NUM_ORDER_Val         _U(0x0)                                        /**< (ADC_MR) Normal Mode: The controller converts channels in a simple numeric order depending only on the channel index.  */
#define   ADC_MR_USEQ_REG_ORDER_Val         _U(0x1)                                        /**< (ADC_MR) User Sequence Mode: The sequence respects what is defined in ADC_SEQR1 register and can be used to convert the same channel several times.  */
...
#define ADC_MR_MASK                         _U(0xBFBFFFEF)                                 /**< \deprecated (ADC_MR) Register MASK  (Use ADC_MR_Msk instead)  */
#define ADC_MR_Msk                          _U(0xBFBFFFEF)                                 /**< (ADC_MR) Register Mask  */
...
#define ADC_SEQR1_USCH1_Msk                 (_U(0xF) << ADC_SEQR1_USCH1_Pos)               /**< (ADC_SEQR1) User Sequence Number 1 Mask */
...
#define ADC_SEQR1_USCH2_Msk                 (_U(0xF) << ADC_SEQR1_USCH2_Pos)               /**< (ADC_SEQR1) User Sequence Number 2 Mask */
...
#define ADC_SEQR1_USCH3_Msk                 (_U(0xF) << ADC_SEQR1_USCH3_Pos)               /**< (ADC_SEQR1) User Sequence Number 3 Mask */
...
#define ADC_SEQR1_USCH4_Msk                 (_U(0xF) << ADC_SEQR1_USCH4_Pos)               /**< (ADC_SEQR1) User Sequence Number 4 Mask */
...
#define ADC_SEQR1_USCH5_Msk                 (_U(0xF) << ADC_SEQR1_USCH5_Pos)               /**< (ADC_SEQR1) User Sequence Number 5 Mask */
...
#define ADC_SEQR1_USCH6_Msk                 (_U(0xF) << ADC_SEQR1_USCH6_Pos)               /**< (ADC_SEQR1) User Sequence Number 6 Mask */
...
#define ADC_SEQR1_USCH7_Msk                 (_U(0xF) << ADC_SEQR1_USCH7_Pos)               /**< (ADC_SEQR1) User Sequence Number 7 Mask */
#define ADC_SEQR1_USCH7(value)              (ADC_SEQR1_USCH7_Msk & ((value) << ADC_SEQR1_USCH7_Pos))
#define ADC_SEQR1_MASK                      _U(0xFFFFFFF)                                  /**< \deprecated (ADC_SEQR1) Register MASK  (Use ADC_SEQR1_Msk instead)  */
#define ADC_SEQR1_Msk                       _U(0xFFFFFFF)                                  /**< (ADC_SEQR1) Register Mask  */
...
#define ADC_CHER_CH0_Msk                    (_U(0x1) << ADC_CHER_CH0_Pos)                  /**< (ADC_CHER) Channel 0 Enable Mask */
...
#define ADC_CHER_CH1_Msk                    (_U(0x1) << ADC_CHER_CH1_Pos)                  /**< (ADC_CHER) Channel 1 Enable Mask */
...
#define ADC_CHER_CH2_Msk                    (_U(0x1) << ADC_CHER_CH2_Pos)                  /**< (ADC_CHER) Channel 2 Enable Mask */
...
#define ADC_CHER_CH3_Msk                    (_U(0x1) << ADC_CHER_CH3_Pos)                  /**< (ADC_CHER) Channel 3 Enable Mask */
...
#define ADC_CHER_CH4_Msk                    (_U(0x1) << ADC_CHER_CH4_Pos)                  /**< (ADC_CHER) Channel 4 Enable Mask */
...
#define ADC_CHER_CH5_Msk                    (_U(0x1) << ADC_CHER_CH5_Pos)                  /**< (ADC_CHER) Channel 5 Enable Mask */
...
#define ADC_CHER_CH6_Msk                    (_U(0x1) << ADC_CHER_CH6_Pos)                  /**< (ADC_CHER) Channel 6 Enable Mask */
...
#define ADC_CHER_CH7_Msk                    (_U(0x1) << ADC_CHER_CH7_Pos)                  /**< (ADC_CHER) Channel 7 Enable Mask */
...
#define ADC_CHER_CH_Msk                     (_U(0xFF) << ADC_CHER_CH_Pos)                  /**< (ADC_CHER Mask) CH */
#define ADC_CHER_CH(value)                  (ADC_CHER_CH_Msk & ((value) << ADC_CHER_CH_Pos))  
#define ADC_CHER_MASK                       _U(0xFF)                                       /**< \deprecated (ADC_CHER) Register MASK  (Use ADC_CHER_Msk instead)  */
#define ADC_CHER_Msk                        _U(0xFF)                                       /**< (ADC_CHER) Register Mask  */
...
#define ADC_CHDR_CH0_Msk                    (_U(0x1) << ADC_CHDR_CH0_Pos)                  /**< (ADC_CHDR) Channel 0 Disable Mask */
...
#define ADC_CHDR_CH1_Msk                    (_U(0x1) << ADC_CHDR_CH1_Pos)                  /**< (ADC_CHDR) Channel 1 Disable Mask */
...
#define ADC_CHDR_CH2_Msk                    (_U(0x1) << ADC_CHDR_CH2_Pos)                  /**< (ADC_CHDR) Channel 2 Disable Mask */
...
#define ADC_CHDR_CH3_Msk                    (_U(0x1) << ADC_CHDR_CH3_Pos)                  /**< (ADC_CHDR) Channel 3 Disable Mask */
...
#define ADC_CHDR_CH4_Msk                    (_U(0x1) << ADC_CHDR_CH4_Pos)                  /**< (ADC_CHDR) Channel 4 Disable Mask */
...
#define ADC_CHDR_CH5_Msk                    (_U(0x1) << ADC_CHDR_CH5_Pos)                  /**< (ADC_CHDR) Channel 5 Disable Mask */
...
#define ADC_CHDR_CH6_Msk                    (_U(0x1) << ADC_CHDR_CH6_Pos)                  /**< (ADC_CHDR) Channel 6 Disable Mask */
...
#define ADC_CHDR_CH7_Msk                    (_U(0x1) << ADC_CHDR_CH7_Pos)                  /**< (ADC_CHDR) Channel 7 Disable Mask */
...
#define ADC_CHDR_CH_Msk                     (_U(0xFF) << ADC_CHDR_CH_Pos)                  /**< (ADC_CHDR Mask) CH */
#define ADC_CHDR_CH(value)                  (ADC_CHDR_CH_Msk & ((value) << ADC_CHDR_CH_Pos))  
#define ADC_CHDR_MASK                       _U(0xFF)                                       /**< \deprecated (ADC_CHDR) Register MASK  (Use ADC_CHDR_Msk instead)  */
#define ADC_CHDR_Msk                        _U(0xFF)                                       /**< (ADC_CHDR) Register Mask  */
...
#define ADC_CHSR_CH0_Msk                    (_U(0x1) << ADC_CHSR_CH0_Pos)                  /**< (ADC_CHSR) Channel 0 Status Mask */
...
#define ADC_CHSR_CH1_Msk                    (_U(0x1) << ADC_CHSR_CH1_Pos)                  /**< (ADC_CHSR) Channel 1 Status Mask */
...
#define ADC_CHSR_CH2_Msk                    (_U(0x1) << ADC_CHSR_CH2_Pos)                  /**< (ADC_CHSR) Channel 2 Status Mask */
...
#define ADC_CHSR_CH3_Msk                    (_U(0x1) << ADC_CHSR_CH3_Pos)                  /**< (ADC_CHSR) Channel 3 Status Mask */
...
#define ADC_CHSR_CH4_Msk                    (_U(0x1) << ADC_CHSR_CH4_Pos)                  /**< (ADC_CHSR) Channel 4 Status Mask */
...
#define ADC_CHSR_CH5_Msk                    (_U(0x1) << ADC_CHSR_CH5_Pos)                  /**< (ADC_CHSR) Channel 5 Status Mask */
...
#define ADC_CHSR_CH6_Msk                    (_U(0x1) << ADC_CHSR_CH6_Pos)                  /**< (ADC_CHSR) Channel 6 Status Mask */
...
#define ADC_CHSR_CH7_Msk                    (_U(0x1) << ADC_CHSR_CH7_Pos)                  /**< (ADC_CHSR) Channel 7 Status Mask */
...
#define ADC_CHSR_CH_Msk                     (_U(0xFF) << ADC_CHSR_CH_Pos)                  /**< (ADC_CHSR Mask) CH */
#define ADC_CHSR_CH(value)                  (ADC_CHSR_CH_Msk & ((value) << ADC_CHSR_CH_Pos))  
#define ADC_CHSR_MASK                       _U(0xFF)                                       /**< \deprecated (ADC_CHSR) Register MASK  (Use ADC_CHSR_Msk instead)  */
#define ADC_CHSR_Msk                        _U(0xFF)                                       /**< (ADC_CHSR) Register Mask  */
...
#define ADC_LCDR_LDATA_Msk                  (_U(0xFFFF) << ADC_LCDR_LDATA_Pos)             /**< (ADC_LCDR) Last Data Converted Mask */
...
#define ADC_LCDR_CHNBOSR_Msk                (_U(0x1F) << ADC_LCDR_CHNBOSR_Pos)             /**< (ADC_LCDR) Channel Number in Oversampling Mode Mask */
#define ADC_LCDR_CHNBOSR(value)             (ADC_LCDR_CHNBOSR_Msk & ((value) << ADC_LCDR_CHNBOSR_Pos))
#define ADC_LCDR_MASK                       _U(0x1F00FFFF)                                 /**< \deprecated (ADC_LCDR) Register MASK  (Use ADC_LCDR_Msk instead)  */
#define ADC_LCDR_Msk                        _U(0x1F00FFFF)                                 /**< (ADC_LCDR) Register Mask  */
...
#define ADC_IER_EOC0_Msk                    (_U(0x1) << ADC_IER_EOC0_Pos)                  /**< (ADC_IER) End of Conversion Interrupt Enable 0 Mask */
...
#define ADC_IER_EOC1_Msk                    (_U(0x1) << ADC_IER_EOC1_Pos)                  /**< (ADC_IER) End of Conversion Interrupt Enable 1 Mask */
...
#define ADC_IER_EOC2_Msk                    (_U(0x1) << ADC_IER_EOC2_Pos)                  /**< (ADC_IER) End of Conversion Interrupt Enable 2 Mask */
...
#define ADC_IER_EOC3_Msk                    (_U(0x1) << ADC_IER_EOC3_Pos)                  /**< (ADC_IER) End of Conversion Interrupt Enable 3 Mask */
...
#define ADC_IER_EOC4_Msk                    (_U(0x1) << ADC_IER_EOC4_Pos)                  /**< (ADC_IER) End of Conversion Interrupt Enable 4 Mask */
...
#define ADC_IER_EOC5_Msk                    (_U(0x1) << ADC_IER_EOC5_Pos)                  /**< (ADC_IER) End of Conversion Interrupt Enable 5 Mask */
...
#define ADC_IER_EOC6_Msk                    (_U(0x1) << ADC_IER_EOC6_Pos)                  /**< (ADC_IER) End of Conversion Interrupt Enable 6 Mask */
...
#define ADC_IER_EOC7_Msk                    (_U(0x1) << ADC_IER_EOC7_Pos)                  /**< (ADC_IER) End of Conversion Interrupt Enable 7 Mask */
...
#define ADC_IER_LCCHG_Msk                   (_U(0x1) << ADC_IER_LCCHG_Pos)                 /**< (ADC_IER) Last Channel Change Interrupt Enable Mask */
...
#define ADC_IER_DRDY_Msk                    (_U(0x1) << ADC_IER_DRDY_Pos)                  /**< (ADC_IER) Data Ready Interrupt Enable Mask */
...
#define ADC_IER_GOVRE_Msk                   (_U(0x1) << ADC_IER_GOVRE_Pos)                 /**< (ADC_IER) General Overrun Error Interrupt Enable Mask */
...
#define ADC_IER_COMPE_Msk                   (_U(0x1) << ADC_IER_COMPE_Pos)                 /**< (ADC_IER) Comparison Event Interrupt Enable Mask */
...
#define ADC_IER_ENDRX_Msk                   (_U(0x1) << ADC_IER_ENDRX_Pos)                 /**< (ADC_IER) End of Receive Buffer Interrupt Enable Mask */
...
#define ADC_IER_RXBUFF_Msk                  (_U(0x1) << ADC_IER_RXBUFF_Pos)                /**< (ADC_IER) Receive Buffer Full Interrupt Enable Mask */
...
#define ADC_IER_EOC_Msk                     (_U(0xFF) << ADC_IER_EOC_Pos)                  /**< (ADC_IER Mask) EOC */
#define ADC_IER_EOC(value)                  (ADC_IER_EOC_Msk & ((value) << ADC_IER_EOC_Pos))  
#define ADC_IER_MASK                        _U(0x1F0800FF)                                 /**< \deprecated (ADC_IER) Register MASK  (Use ADC_IER_Msk instead)  */
#define ADC_IER_Msk                         _U(0x1F0800FF)                                 /**< (ADC_IER) Register Mask  */
...
#define ADC_IDR_EOC0_Msk                    (_U(0x1) << ADC_IDR_EOC0_Pos)                  /**< (ADC_IDR) End of Conversion Interrupt Disable 0 Mask */
...
#define ADC_IDR_EOC1_Msk                    (_U(0x1) << ADC_IDR_EOC1_Pos)                  /**< (ADC_IDR) End of Conversion Interrupt Disable 1 Mask */
...
#define ADC_IDR_EOC2_Msk                    (_U(0x1) << ADC_IDR_EOC2_Pos)                  /**< (ADC_IDR) End of Conversion Interrupt Disable 2 Mask */
...
#define ADC_IDR_EOC3_Msk                    (_U(0x1) << ADC_IDR_EOC3_Pos)                  /**< (ADC_IDR) End of Conversion Interrupt Disable 3 Mask */
...
#define ADC_IDR_EOC4_Msk                    (_U(0x1) << ADC_IDR_EOC4_Pos)                  /**< (ADC_IDR) End of Conversion Interrupt Disable 4 Mask */
...
#define ADC_IDR_EOC5_Msk                    (_U(0x1) << ADC_IDR_EOC5_Pos)                  /**< (ADC_IDR) End of Conversion Interrupt Disable 5 Mask */
...
#define ADC_IDR_EOC6_Msk                    (_U(0x1) << ADC_IDR_EOC6_Pos)                  /**< (ADC_IDR) End of Conversion Interrupt Disable 6 Mask */
...
#define ADC_IDR_EOC7_Msk                    (_U(0x1) << ADC_IDR_EOC7_Pos)                  /**< (ADC_IDR) End of Conversion Interrupt Disable 7 Mask */
...
#define ADC_IDR_LCCHG_Msk                   (_U(0x1) << ADC_IDR_LCCHG_Pos)                 /**< (ADC_IDR) Last Channel Change Interrupt Disable Mask */
...
#define ADC_IDR_DRDY_Msk                    (_U(0x1) << ADC_IDR_DRDY_Pos)                  /**< (ADC_IDR) Data Ready Interrupt Disable Mask */
...
#define ADC_IDR_GOVRE_Msk                   (_U(0x1) << ADC_IDR_GOVRE_Pos)                 /**< (ADC_IDR) General Overrun Error Interrupt Disable Mask */
...
#define ADC_IDR_COMPE_Msk                   (_U(0x1) << ADC_IDR_COMPE_Pos)                 /**< (ADC_IDR) Comparison Event Interrupt Disable Mask */
...
#define ADC_IDR_ENDRX_Msk                   (_U(0x1) << ADC_IDR_ENDRX_Pos)                 /**< (ADC_IDR) End of Receive Buffer Interrupt Disable Mask */
...
#define ADC_IDR_RXBUFF_Msk                  (_U(0x1) << ADC_IDR_RXBUFF_Pos)                /**< (ADC_IDR) Receive Buffer Full Interrupt Disable Mask */
...
#define ADC_IDR_EOC_Msk                     (_U(0xFF) << ADC_IDR_EOC_Pos)                  /**< (ADC_IDR Mask) EOC */
#define ADC_IDR_EOC(value)                  (ADC_IDR_EOC_Msk & ((value) << ADC_IDR_EOC_Pos))  
#define ADC_IDR_MASK                        _U(0x1F0800FF)                                 /**< \deprecated (ADC_IDR) Register MASK  (Use ADC_IDR_Msk instead)  */
#define ADC_IDR_Msk                         _U(0x1F0800FF)                                 /**< (ADC_IDR) Register Mask  */
...
#define ADC_IMR_EOC0_Msk                    (_U(0x1) << ADC_IMR_EOC0_Pos)                  /**< (ADC_IMR) End of Conversion Interrupt Mask 0 Mask */
...
#define ADC_IMR_EOC1_Msk                    (_U(0x1) << ADC_IMR_EOC1_Pos)                  /**< (ADC_IMR) End of Conversion Interrupt Mask 1 Mask */
...
#define ADC_IMR_EOC2_Msk                    (_U(0x1) << ADC_IMR_EOC2_Pos)                  /**< (ADC_IMR) End of Conversion Interrupt Mask 2 Mask */
...
#define ADC_IMR_EOC3_Msk                    (_U(0x1) << ADC_IMR_EOC3_Pos)                  /**< (ADC_IMR) End of Conversion Interrupt Mask 3 Mask */
...
#define ADC_IMR_EOC4_Msk                    (_U(0x1) << ADC_IMR_EOC4_Pos)                  /**< (ADC_IMR) End of Conversion Interrupt Mask 4 Mask */
...
#define ADC_IMR_EOC5_Msk                    (_U(0x1) << ADC_IMR_EOC5_Pos)                  /**< (ADC_IMR) End of Conversion Interrupt Mask 5 Mask */
...
#define ADC_IMR_EOC6_Msk                    (_U(0x1) << ADC_IMR_EOC6_Pos)                  /**< (ADC_IMR) End of Conversion Interrupt Mask 6 Mask */
...
#define ADC_IMR_EOC7_Msk                    (_U(0x1) << ADC_IMR_EOC7_Pos)                  /**< (ADC_IMR) End of Conversion Interrupt Mask 7 Mask */
...
#define ADC_IMR_LCCHG_Msk                   (_U(0x1) << ADC_IMR_LCCHG_Pos)                 /**< (ADC_IMR) Last Channel Change Interrupt Mask Mask */
...
#define ADC_IMR_DRDY_Msk                    (_U(0x1) << ADC_IMR_DRDY_Pos)                  /**< (ADC_IMR) Data Ready Interrupt Mask Mask */
...
#define ADC_IMR_GOVRE_Msk                   (_U(0x1) << ADC_IMR_GOVRE_Pos)                 /**< (ADC_IMR) General Overrun Error Interrupt Mask Mask */
...
#define ADC_IMR_COMPE_Msk                   (_U(0x1) << ADC_IMR_COMPE_Pos)                 /**< (ADC_IMR) Comparison Event Interrupt Mask Mask */
...
#define ADC_IMR_ENDRX_Msk                   (_U(0x1) << ADC_IMR_ENDRX_Pos)                 /**< (ADC_IMR) End of Receive Buffer Interrupt Mask Mask */
...
#define ADC_IMR_RXBUFF_Msk                  (_U(0x1) << ADC_IMR_RXBUFF_Pos)                /**< (ADC_IMR) Receive Buffer Full Interrupt Mask Mask */
...
#define ADC_IMR_EOC_Msk                     (_U(0xFF) << ADC_IMR_EOC_Pos)                  /**< (ADC_IMR Mask) EOC */
#define ADC_IMR_EOC(value)                  (ADC_IMR_EOC_Msk & ((value) << ADC_IMR_EOC_Pos))  
#define ADC_IMR_MASK                        _U(0x1F0800FF)                                 /**< \deprecated (ADC_IMR) Register MASK  (Use ADC_IMR_Msk instead)  */
#define ADC_IMR_Msk                         _U(0x1F0800FF)                                 /**< (ADC_IMR) Register Mask  */
...
#define ADC_ISR_EOC0_Msk                    (_U(0x1) << ADC_ISR_EOC0_Pos)                  /**< (ADC_ISR) End of Conversion 0 (automatically set / cleared) Mask */
...
#define ADC_ISR_EOC1_Msk                    (_U(0x1) << ADC_ISR_EOC1_Pos)                  /**< (ADC_ISR) End of Conversion 1 (automatically set / cleared) Mask */
...
#define ADC_ISR_EOC2_Msk                    (_U(0x1) << ADC_ISR_EOC2_Pos)                  /**< (ADC_ISR) End of Conversion 2 (automatically set / cleared) Mask */
...
#define ADC_ISR_EOC3_Msk                    (_U(0x1) << ADC_ISR_EOC3_Pos)                  /**< (ADC_ISR) End of Conversion 3 (automatically set / cleared) Mask */
...
#define ADC_ISR_EOC4_Msk                    (_U(0x1) << ADC_ISR_EOC4_Pos)                  /**< (ADC_ISR) End of Conversion 4 (automatically set / cleared) Mask */
...
#define ADC_ISR_EOC5_Msk                    (_U(0x1) << ADC_ISR_EOC5_Pos)                  /**< (ADC_ISR) End of Conversion 5 (automatically set / cleared) Mask */
...
#define ADC_ISR_EOC6_Msk                    (_U(0x1) << ADC_ISR_EOC6_Pos)                  /**< (ADC_ISR) End of Conversion 6 (automatically set / cleared) Mask */
...
#define ADC_ISR_EOC7_Msk                    (_U(0x1) << ADC_ISR_EOC7_Pos)                  /**< (ADC_ISR) End of Conversion 7 (automatically set / cleared) Mask */
...
#define ADC_ISR_LCCHG_Msk                   (_U(0x1) << ADC_ISR_LCCHG_Pos)                 /**< (ADC_ISR) Last Channel Change (cleared on read) Mask */
...
#define ADC_ISR_DRDY_Msk                    (_U(0x1) << ADC_ISR_DRDY_Pos)                  /**< (ADC_ISR) Data Ready (automatically set / cleared) Mask */
...
#define ADC_ISR_GOVRE_Msk                   (_U(0x1) << ADC_ISR_GOVRE_Pos)                 /**< (ADC_ISR) General Overrun Error (cleared on read) Mask */
...
#define ADC_ISR_COMPE_Msk                   (_U(0x1) << ADC_ISR_COMPE_Pos)                 /**< (ADC_ISR) Comparison Event (cleared on read) Mask */
...
#define ADC_ISR_ENDRX_Msk                   (_U(0x1) << ADC_ISR_ENDRX_Pos)                 /**< (ADC_ISR) End of Receive Transfer (cleared by writing ADC_RCR or ADC_RNCR) Mask */
...
#define ADC_ISR_RXBUFF_Msk                  (_U(0x1) << ADC_ISR_RXBUFF_Pos)                /**< (ADC_ISR) Receive Buffer Full (cleared by writing ADC_RCR or ADC_RNCR) Mask */
...
#define ADC_ISR_EOC_Msk                     (_U(0xFF) << ADC_ISR_EOC_Pos)                  /**< (ADC_ISR Mask) EOC */
#define ADC_ISR_EOC(value)                  (ADC_ISR_EOC_Msk & ((value) << ADC_ISR_EOC_Pos))  
#define ADC_ISR_MASK                        _U(0x1F0800FF)                                 /**< \deprecated (ADC_ISR) Register MASK  (Use ADC_ISR_Msk instead)  */
#define ADC_ISR_Msk                         _U(0x1F0800FF)                                 /**< (ADC_ISR) Register Mask  */
...
#define ADC_LCTMR_DUALTRIG_Msk              (_U(0x1) << ADC_LCTMR_DUALTRIG_Pos)            /**< (ADC_LCTMR) Dual Trigger ON Mask */
...
#define ADC_LCTMR_CMPMOD_Msk                (_U(0x3) << ADC_LCTMR_CMPMOD_Pos)              /**< (ADC_LCTMR) Last Channel Comparison Mode Mask */
#define ADC_LCTMR_CMPMOD(value)             (ADC_LCTMR_CMPMOD_Msk & ((value) << ADC_LCTMR_CMPMOD_Pos))
#define   ADC_LCTMR_CMPMOD_LOW_Val          _U(0x0)                                        /**< (ADC_LCTMR) Generates an event when the converted data is lower than the low threshold of the window.  */
#define   ADC_LCTMR_CMPMOD_HIGH_Val         _U(0x1)                                        /**< (ADC_LCTMR) Generates an event when the converted data is higher than the high threshold of the window.  */
#define   ADC_LCTMR_CMPMOD_IN_Val           _U(0x2)                                        /**< (ADC_LCTMR) Generates an event when the converted data is in the comparison window.  */
#define   ADC_LCTMR_CMPMOD_OUT_Val          _U(0x3)                                        /**< (ADC_LCTMR) Generates an event when the converted data is out of the comparison window.  */
...
#define ADC_LCTMR_MASK                      _U(0x31)                                       /**< \deprecated (ADC_LCTMR) Register MASK  (Use ADC_LCTMR_Msk instead)  */
#define ADC_LCTMR_Msk                       _U(0x31)                                       /**< (ADC_LCTMR) Register Mask  */
...
#define ADC_LCCWR_LOWTHRES_Msk              (_U(0xFFF) << ADC_LCCWR_LOWTHRES_Pos)          /**< (ADC_LCCWR) Low Threshold Mask */
...
#define ADC_LCCWR_HIGHTHRES_Msk             (_U(0xFFF) << ADC_LCCWR_HIGHTHRES_Pos)         /**< (ADC_LCCWR) High Threshold Mask */
#define ADC_LCCWR_HIGHTHRES(value)          (ADC_LCCWR_HIGHTHRES_Msk & ((value) << ADC_LCCWR_HIGHTHRES_Pos))
#define ADC_LCCWR_MASK                      _U(0xFFF0FFF)                                  /**< \deprecated (ADC_LCCWR) Register MASK  (Use ADC_LCCWR_Msk instead)  */
#define ADC_LCCWR_Msk                       _U(0xFFF0FFF)                                  /**< (ADC_LCCWR) Register Mask  */
...
#define ADC_OVER_OVRE0_Msk                  (_U(0x1) << ADC_OVER_OVRE0_Pos)                /**< (ADC_OVER) Overrun Error 0 Mask */
...
#define ADC_OVER_OVRE1_Msk                  (_U(0x1) << ADC_OVER_OVRE1_Pos)                /**< (ADC_OVER) Overrun Error 1 Mask */
...
#define ADC_OVER_OVRE2_Msk                  (_U(0x1) << ADC_OVER_OVRE2_Pos)                /**< (ADC_OVER) Overrun Error 2 Mask */
...
#define ADC_OVER_OVRE3_Msk                  (_U(0x1) << ADC_OVER_OVRE3_Pos)                /**< (ADC_OVER) Overrun Error 3 Mask */
...
#define ADC_OVER_OVRE4_Msk                  (_U(0x1) << ADC_OVER_OVRE4_Pos)                /**< (ADC_OVER) Overrun Error 4 Mask */
...
#define ADC_OVER_OVRE5_Msk                  (_U(0x1) << ADC_OVER_OVRE5_Pos)                /**< (ADC_OVER) Overrun Error 5 Mask */
...
#define ADC_OVER_OVRE6_Msk                  (_U(0x1) << ADC_OVER_OVRE6_Pos)                /**< (ADC_OVER) Overrun Error 6 Mask */
...
#define ADC_OVER_OVRE7_Msk                  (_U(0x1) << ADC_OVER_OVRE7_Pos)                /**< (ADC_OVER) Overrun Error 7 Mask */
...
#define ADC_OVER_OVRE_Msk                   (_U(0xFF) << ADC_OVER_OVRE_Pos)                /**< (ADC_OVER Mask) OVRE */
#define ADC_OVER_OVRE(value)                (ADC_OVER_OVRE_Msk & ((value) << ADC_OVER_OVRE_Pos))  
#define ADC_OVER_MASK                       _U(0xFF)                                       /**< \deprecated (ADC_OVER) Register MASK  (Use ADC_OVER_Msk instead)  */
#define ADC_OVER_Msk                        _U(0xFF)                                       /**< (ADC_OVER) Register Mask  */
...
#define ADC_EMR_CMPMODE_Msk                 (_U(0x3) << ADC_EMR_CMPMODE_Pos)               /**< (ADC_EMR) Comparison Mode Mask */
#define ADC_EMR_CMPMODE(value)              (ADC_EMR_CMPMODE_Msk & ((value) << ADC_EMR_CMPMODE_Pos))
#define   ADC_EMR_CMPMODE_LOW_Val           _U(0x0)                                        /**< (ADC_EMR) Generates an event when the converted data is lower than the low threshold of the window.  */
#define   ADC_EMR_CMPMODE_HIGH_Val          _U(0x1)                                        /**< (ADC_EMR) Generates an event when the converted data is higher than the high threshold of the window.  */
#define   ADC_EMR_CMPMODE_IN_Val            _U(0x2)                                        /**< (ADC_EMR) Generates an event when the converted data is in the comparison window.  */
#define   ADC_EMR_CMPMODE_OUT_Val           _U(0x3)                                        /**< (ADC_EMR) Generates an event when the converted data is out of the comparison window.  */
...
#define ADC_EMR_CMPTYPE_Msk                 (_U(0x1) << ADC_EMR_CMPTYPE_Pos)               /**< (ADC_EMR) Comparison Type Mask */
...
#define   ADC_EMR_CMPTYPE_FLAG_ONLY_Val     _U(0x0)                                        /**< (ADC_EMR) Any conversion is performed and comparison function drives the COMPE flag.  */
#define   ADC_EMR_CMPTYPE_START_CONDITION_Val _U(0x1)                                        /**< (ADC_EMR) Comparison conditions must be met to start the storage of all conversions until the CMPRST bit is set.  */
...
#define ADC_EMR_CMPSEL_Msk                  (_U(0xF) << ADC_EMR_CMPSEL_Pos)                /**< (ADC_EMR) Comparison Selected Channel Mask */
...
#define ADC_EMR_CMPALL_Msk                  (_U(0x1) << ADC_EMR_CMPALL_Pos)                /**< (ADC_EMR) Compare All Channels Mask */
...
#define ADC_EMR_CMPFILTER_Msk               (_U(0x3) << ADC_EMR_CMPFILTER_Pos)             /**< (ADC_EMR) Compare Event Filtering Mask */
...
#define ADC_EMR_OSR_Msk                     (_U(0x7) << ADC_EMR_OSR_Pos)                   /**< (ADC_EMR) Over Sampling Rate Mask */
#define ADC_EMR_OSR(value)                  (ADC_EMR_OSR_Msk & ((value) << ADC_EMR_OSR_Pos))
#define   ADC_EMR_OSR_NO_AVERAGE_Val        _U(0x0)                                        /**< (ADC_EMR) No averaging. ADC sample rate is maximum.  */
#define   ADC_EMR_OSR_OSR4_Val              _U(0x1)                                        /**< (ADC_EMR) 1-bit enhanced resolution by averaging. ADC sample rate divided by 4.  */
#define   ADC_EMR_OSR_OSR16_Val             _U(0x2)                                        /**< (ADC_EMR) 2-bit enhanced resolution by averaging. ADC sample rate divided by 16.  */
#define   ADC_EMR_OSR_OSR64_Val             _U(0x3)                                        /**< (ADC_EMR) 3-bit enhanced resolution by averaging. ADC sample rate divided by 64.  */
#define   ADC_EMR_OSR_OSR256_Val            _U(0x4)                                        /**< (ADC_EMR) 4-bit enhanced resolution by averaging. ADC sample rate divided by 256.  */
...
#define ADC_EMR_ASTE_Msk                    (_U(0x1) << ADC_EMR_ASTE_Pos)                  /**< (ADC_EMR) Averaging on Single Trigger Event Mask */
...
#define   ADC_EMR_ASTE_MULTI_TRIG_AVERAGE_Val _U(0x0)                                        /**< (ADC_EMR) The average requests several trigger events.  */
#define   ADC_EMR_ASTE_SINGLE_TRIG_AVERAGE_Val _U(0x1)                                        /**< (ADC_EMR) The average requests only one trigger event.  */
...
#define ADC_EMR_SRCCLK_Msk                  (_U(0x1) << ADC_EMR_SRCCLK_Pos)                /**< (ADC_EMR) External Clock Selection Mask */
...
#define   ADC_EMR_SRCCLK_PERIPH_CLK_Val     _U(0x0)                                        /**< (ADC_EMR) The peripheral clock is the source for the ADC prescaler.  */
#define   ADC_EMR_SRCCLK_PMC_PCK_Val        _U(0x1)                                        /**< (ADC_EMR) PMC PCKx is the source clock for the ADC prescaler, thus the ADC clock can be independent of the core/peripheral clock.  */
...
#define ADC_EMR_TAG_Msk                     (_U(0x1) << ADC_EMR_TAG_Pos)                   /**< (ADC_EMR) Tag of the ADC_LCDR Mask */
#define ADC_EMR_TAG                         ADC_EMR_TAG_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_EMR_TAG_Msk instead */
#define ADC_EMR_MASK                        _U(0x13732F7)                                  /**< \deprecated (ADC_EMR) Register MASK  (Use ADC_EMR_Msk instead)  */
#define ADC_EMR_Msk                         _U(0x13732F7)                                  /**< (ADC_EMR) Register Mask  */
...
#define ADC_CWR_LOWTHRES_Msk                (_U(0xFFFF) << ADC_CWR_LOWTHRES_Pos)           /**< (ADC_CWR) Low Threshold Mask */
...
#define ADC_CWR_HIGHTHRES_Msk               (_U(0xFFFF) << ADC_CWR_HIGHTHRES_Pos)          /**< (ADC_CWR) High Threshold Mask */
#define ADC_CWR_HIGHTHRES(value)            (ADC_CWR_HIGHTHRES_Msk & ((value) << ADC_CWR_HIGHTHRES_Pos))
#define ADC_CWR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (ADC_CWR) Register MASK  (Use ADC_CWR_Msk instead)  */
#define ADC_CWR_Msk                         _U(0xFFFFFFFF)                                 /**< (ADC_CWR) Register Mask  */
...
#define ADC_COR_OFF0_Msk                    (_U(0x1) << ADC_COR_OFF0_Pos)                  /**< (ADC_COR) Offset for Channel 0 Mask */
...
#define ADC_COR_OFF1_Msk                    (_U(0x1) << ADC_COR_OFF1_Pos)                  /**< (ADC_COR) Offset for Channel 1 Mask */
...
#define ADC_COR_OFF2_Msk                    (_U(0x1) << ADC_COR_OFF2_Pos)                  /**< (ADC_COR) Offset for Channel 2 Mask */
...
#define ADC_COR_OFF3_Msk                    (_U(0x1) << ADC_COR_OFF3_Pos)                  /**< (ADC_COR) Offset for Channel 3 Mask */
...
#define ADC_COR_OFF4_Msk                    (_U(0x1) << ADC_COR_OFF4_Pos)                  /**< (ADC_COR) Offset for Channel 4 Mask */
...
#define ADC_COR_OFF5_Msk                    (_U(0x1) << ADC_COR_OFF5_Pos)                  /**< (ADC_COR) Offset for Channel 5 Mask */
...
#define ADC_COR_OFF6_Msk                    (_U(0x1) << ADC_COR_OFF6_Pos)                  /**< (ADC_COR) Offset for Channel 6 Mask */
...
#define ADC_COR_OFF7_Msk                    (_U(0x1) << ADC_COR_OFF7_Pos)                  /**< (ADC_COR) Offset for Channel 7 Mask */
...
#define ADC_COR_DIFF0_Msk                   (_U(0x1) << ADC_COR_DIFF0_Pos)                 /**< (ADC_COR) Differential Inputs for Channel 0 Mask */
...
#define ADC_COR_DIFF1_Msk                   (_U(0x1) << ADC_COR_DIFF1_Pos)                 /**< (ADC_COR) Differential Inputs for Channel 1 Mask */
...
#define ADC_COR_DIFF2_Msk                   (_U(0x1) << ADC_COR_DIFF2_Pos)                 /**< (ADC_COR) Differential Inputs for Channel 2 Mask */
...
#define ADC_COR_DIFF3_Msk                   (_U(0x1) << ADC_COR_DIFF3_Pos)                 /**< (ADC_COR) Differential Inputs for Channel 3 Mask */
...
#define ADC_COR_DIFF4_Msk                   (_U(0x1) << ADC_COR_DIFF4_Pos)                 /**< (ADC_COR) Differential Inputs for Channel 4 Mask */
...
#define ADC_COR_DIFF5_Msk                   (_U(0x1) << ADC_COR_DIFF5_Pos)                 /**< (ADC_COR) Differential Inputs for Channel 5 Mask */
...
#define ADC_COR_DIFF6_Msk                   (_U(0x1) << ADC_COR_DIFF6_Pos)                 /**< (ADC_COR) Differential Inputs for Channel 6 Mask */
...
#define ADC_COR_DIFF7_Msk                   (_U(0x1) << ADC_COR_DIFF7_Pos)                 /**< (ADC_COR) Differential Inputs for Channel 7 Mask */
...
#define ADC_COR_OFF_Msk                     (_U(0xFF) << ADC_COR_OFF_Pos)                  /**< (ADC_COR Mask) OFF */
...
#define ADC_COR_DIFF_Msk                    (_U(0xFF) << ADC_COR_DIFF_Pos)                 /**< (ADC_COR Mask) DIFF */
#define ADC_COR_DIFF(value)                 (ADC_COR_DIFF_Msk & ((value) << ADC_COR_DIFF_Pos))  
#define ADC_COR_MASK                        _U(0xFF00FF)                                   /**< \deprecated (ADC_COR) Register MASK  (Use ADC_COR_Msk instead)  */
#define ADC_COR_Msk                         _U(0xFF00FF)                                   /**< (ADC_COR) Register Mask  */
...
#define ADC_CDR_DATA_Msk                    (_U(0xFFFF) << ADC_CDR_DATA_Pos)               /**< (ADC_CDR) Converted Data Mask */
#define ADC_CDR_DATA(value)                 (ADC_CDR_DATA_Msk & ((value) << ADC_CDR_DATA_Pos))
#define ADC_CDR_MASK                        _U(0xFFFF)                                     /**< \deprecated (ADC_CDR) Register MASK  (Use ADC_CDR_Msk instead)  */
#define ADC_CDR_Msk                         _U(0xFFFF)                                     /**< (ADC_CDR) Register Mask  */
...
#define ADC_ACR_AUTOTEST_Msk                (_U(0x3) << ADC_ACR_AUTOTEST_Pos)              /**< (ADC_ACR) ADC Auto-test modes Mask */
#define ADC_ACR_AUTOTEST(value)             (ADC_ACR_AUTOTEST_Msk & ((value) << ADC_ACR_AUTOTEST_Pos))
#define   ADC_ACR_AUTOTEST_NO_AUTOTEST_Val  _U(0x0)                                        /**< (ADC_ACR) No auto test, normal mode of operation  */
#define   ADC_ACR_AUTOTEST_OFFSET_ERROR_Val _U(0x1)                                        /**< (ADC_ACR) Offset Error test (refer to ADC cell datasheet)  */
#define   ADC_ACR_AUTOTEST_GAIN_ERROR_HIGH_Val _U(0x2)                                        /**< (ADC_ACR) Gain Error (high code) test (refer to ADC cell datasheet)  */
#define   ADC_ACR_AUTOTEST_GAIN_ERROR_LOW_Val _U(0x3)                                        /**< (ADC_ACR) Gain Error (low code) test (refer to ADC cell datasheet)  */
...
#define ADC_ACR_MASK                        _U(0xC0000000)                                 /**< \deprecated (ADC_ACR) Register MASK  (Use ADC_ACR_Msk instead)  */
#define ADC_ACR_Msk                         _U(0xC0000000)                                 /**< (ADC_ACR) Register Mask  */
...
#define ADC_WPMR_WPEN_Msk                   (_U(0x1) << ADC_WPMR_WPEN_Pos)                 /**< (ADC_WPMR) Write Protection Enable Mask */
...
#define ADC_WPMR_WPKEY_Msk                  (_U(0xFFFFFF) << ADC_WPMR_WPKEY_Pos)           /**< (ADC_WPMR) Write Protection Key Mask */
#define ADC_WPMR_WPKEY(value)               (ADC_WPMR_WPKEY_Msk & ((value) << ADC_WPMR_WPKEY_Pos))
#define   ADC_WPMR_WPKEY_PASSWD_Val         _U(0x414443)                                   /**< (ADC_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit.Always reads as 0  */
...
#define ADC_WPMR_MASK                       _U(0xFFFFFF01)                                 /**< \deprecated (ADC_WPMR) Register MASK  (Use ADC_WPMR_Msk instead)  */
#define ADC_WPMR_Msk                        _U(0xFFFFFF01)                                 /**< (ADC_WPMR) Register Mask  */
...
#define ADC_WPSR_WPVS_Msk                   (_U(0x1) << ADC_WPSR_WPVS_Pos)                 /**< (ADC_WPSR) Write Protection Violation Status Mask */
...
#define ADC_WPSR_WPVSRC_Msk                 (_U(0xFFFF) << ADC_WPSR_WPVSRC_Pos)            /**< (ADC_WPSR) Write Protection Violation Source Mask */
#define ADC_WPSR_WPVSRC(value)              (ADC_WPSR_WPVSRC_Msk & ((value) << ADC_WPSR_WPVSRC_Pos))
#define ADC_WPSR_MASK                       _U(0xFFFF01)                                   /**< \deprecated (ADC_WPSR) Register MASK  (Use ADC_WPSR_Msk instead)  */
#define ADC_WPSR_Msk                        _U(0xFFFF01)                                   /**< (ADC_WPSR) Register Mask  */
...
#define ADC_RPR_RXPTR_Msk                   (_U(0xFFFFFFFF) << ADC_RPR_RXPTR_Pos)          /**< (ADC_RPR) Receive Pointer Register Mask */
#define ADC_RPR_RXPTR(value)                (ADC_RPR_RXPTR_Msk & ((value) << ADC_RPR_RXPTR_Pos))
#define ADC_RPR_MASK                        _U(0xFFFFFFFF)                                 /**< \deprecated (ADC_RPR) Register MASK  (Use ADC_RPR_Msk instead)  */
#define ADC_RPR_Msk                         _U(0xFFFFFFFF)                                 /**< (ADC_RPR) Register Mask  */
...
#define ADC_RCR_RXCTR_Msk                   (_U(0xFFFF) << ADC_RCR_RXCTR_Pos)              /**< (ADC_RCR) Receive Counter Register Mask */
#define ADC_RCR_RXCTR(value)                (ADC_RCR_RXCTR_Msk & ((value) << ADC_RCR_RXCTR_Pos))
#define ADC_RCR_MASK                        _U(0xFFFF)                                     /**< \deprecated (ADC_RCR) Register MASK  (Use ADC_RCR_Msk instead)  */
#define ADC_RCR_Msk                         _U(0xFFFF)                                     /**< (ADC_RCR) Register Mask  */
...
#define ADC_RNPR_RXNPTR_Msk                 (_U(0xFFFFFFFF) << ADC_RNPR_RXNPTR_Pos)        /**< (ADC_RNPR) Receive Next Pointer Mask */
#define ADC_RNPR_RXNPTR(value)              (ADC_RNPR_RXNPTR_Msk & ((value) << ADC_RNPR_RXNPTR_Pos))
#define ADC_RNPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (ADC_RNPR) Register MASK  (Use ADC_RNPR_Msk instead)  */
#define ADC_RNPR_Msk                        _U(0xFFFFFFFF)                                 /**< (ADC_RNPR) Register Mask  */
...
#define ADC_RNCR_RXNCTR_Msk                 (_U(0xFFFF) << ADC_RNCR_RXNCTR_Pos)            /**< (ADC_RNCR) Receive Next Counter Mask */
#define ADC_RNCR_RXNCTR(value)              (ADC_RNCR_RXNCTR_Msk & ((value) << ADC_RNCR_RXNCTR_Pos))
#define ADC_RNCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (ADC_RNCR) Register MASK  (Use ADC_RNCR_Msk instead)  */
#define ADC_RNCR_Msk                        _U(0xFFFF)                                     /**< (ADC_RNCR) Register Mask  */
...
#define ADC_PTCR_RXTEN_Msk                  (_U(0x1) << ADC_PTCR_RXTEN_Pos)                /**< (ADC_PTCR) Receiver Transfer Enable Mask */
...
#define ADC_PTCR_RXTDIS_Msk                 (_U(0x1) << ADC_PTCR_RXTDIS_Pos)               /**< (ADC_PTCR) Receiver Transfer Disable Mask */
...
#define ADC_PTCR_TXTEN_Msk                  (_U(0x1) << ADC_PTCR_TXTEN_Pos)                /**< (ADC_PTCR) Transmitter Transfer Enable Mask */
...
#define ADC_PTCR_TXTDIS_Msk                 (_U(0x1) << ADC_PTCR_TXTDIS_Pos)               /**< (ADC_PTCR) Transmitter Transfer Disable Mask */
...
#define ADC_PTCR_RXCBEN_Msk                 (_U(0x1) << ADC_PTCR_RXCBEN_Pos)               /**< (ADC_PTCR) Receiver Circular Buffer Enable Mask */
...
#define ADC_PTCR_RXCBDIS_Msk                (_U(0x1) << ADC_PTCR_RXCBDIS_Pos)              /**< (ADC_PTCR) Receiver Circular Buffer Disable Mask */
...
#define ADC_PTCR_TXCBEN_Msk                 (_U(0x1) << ADC_PTCR_TXCBEN_Pos)               /**< (ADC_PTCR) Transmitter Circular Buffer Enable Mask */
...
#define ADC_PTCR_TXCBDIS_Msk                (_U(0x1) << ADC_PTCR_TXCBDIS_Pos)              /**< (ADC_PTCR) Transmitter Circular Buffer Disable Mask */
...
#define ADC_PTCR_ERRCLR_Msk                 (_U(0x1) << ADC_PTCR_ERRCLR_Pos)               /**< (ADC_PTCR) Transfer Bus Error Clear Mask */
...
#define ADC_PTCR_MASK                       _U(0x10F0303)                                  /**< \deprecated (ADC_PTCR) Register MASK  (Use ADC_PTCR_Msk instead)  */
#define ADC_PTCR_Msk                        _U(0x10F0303)                                  /**< (ADC_PTCR) Register Mask  */
...
#define ADC_PTSR_RXTEN_Msk                  (_U(0x1) << ADC_PTSR_RXTEN_Pos)                /**< (ADC_PTSR) Receiver Transfer Enable Mask */
...
#define ADC_PTSR_TXTEN_Msk                  (_U(0x1) << ADC_PTSR_TXTEN_Pos)                /**< (ADC_PTSR) Transmitter Transfer Enable Mask */
...
#define ADC_PTSR_RXCBEN_Msk                 (_U(0x1) << ADC_PTSR_RXCBEN_Pos)               /**< (ADC_PTSR) Receiver Circular Buffer Enable Mask */
...
#define ADC_PTSR_TXCBEN_Msk                 (_U(0x1) << ADC_PTSR_TXCBEN_Pos)               /**< (ADC_PTSR) Transmitter Circular Buffer Enable Mask */
...
#define ADC_PTSR_ERR_Msk                    (_U(0x1) << ADC_PTSR_ERR_Pos)                  /**< (ADC_PTSR) Transfer Bus Error Mask */
...
#define ADC_PTSR_MASK                       _U(0x1050101)                                  /**< \deprecated (ADC_PTSR) Register MASK  (Use ADC_PTSR_Msk instead)  */
#define ADC_PTSR_Msk                        _U(0x1050101)                                  /**< (ADC_PTSR) Register Mask  */
