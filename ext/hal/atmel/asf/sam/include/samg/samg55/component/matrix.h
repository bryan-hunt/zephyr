...
#define MATRIX_MCFG_ULBT_Msk                (_U(0x7) << MATRIX_MCFG_ULBT_Pos)              /**< (MATRIX_MCFG) Undefined Length Burst Type Mask */
#define MATRIX_MCFG_ULBT(value)             (MATRIX_MCFG_ULBT_Msk & ((value) << MATRIX_MCFG_ULBT_Pos))
#define   MATRIX_MCFG_ULBT_UNLIMITED_Val    _U(0x0)                                        /**< (MATRIX_MCFG) No predicted end of burst is generated and therefore INCR bursts coming from this master cannot be broken.  */
#define   MATRIX_MCFG_ULBT_SINGLE_Val       _U(0x1)                                        /**< (MATRIX_MCFG) The undefined length burst is treated as a succession of single access allowing rearbitration at each beat of the INCR burst.  */
#define   MATRIX_MCFG_ULBT_4_BEAT_Val       _U(0x2)                                        /**< (MATRIX_MCFG) The undefined length burst is split into a 4-beat bursts allowing rearbitration at each 4-beat burst end.  */
#define   MATRIX_MCFG_ULBT_8_BEAT_Val       _U(0x3)                                        /**< (MATRIX_MCFG) The undefined length burst is split into 8-beat bursts allowing rearbitration at each 8-beat burst end.  */
#define   MATRIX_MCFG_ULBT_16_BEAT_Val      _U(0x4)                                        /**< (MATRIX_MCFG) The undefined length burst is split into 16-beat bursts allowing rearbitration at each 16-beat burst end.  */
...
#define MATRIX_MCFG_MASK                    _U(0x07)                                       /**< \deprecated (MATRIX_MCFG) Register MASK  (Use MATRIX_MCFG_Msk instead)  */
#define MATRIX_MCFG_Msk                     _U(0x07)                                       /**< (MATRIX_MCFG) Register Mask  */
...
#define MATRIX_SCFG_SLOT_CYCLE_Msk          (_U(0xFF) << MATRIX_SCFG_SLOT_CYCLE_Pos)       /**< (MATRIX_SCFG) Maximum Number of Allowed Cycles for a Burst Mask */
#define MATRIX_SCFG_SLOT_CYCLE(value)       (MATRIX_SCFG_SLOT_CYCLE_Msk & ((value) << MATRIX_SCFG_SLOT_CYCLE_Pos))
#define MATRIX_SCFG_DEFMSTR_TYPE_Pos        16                                             /**< (MATRIX_SCFG) Default Master Type Position */
#define MATRIX_SCFG_DEFMSTR_TYPE_Msk        (_U(0x3) << MATRIX_SCFG_DEFMSTR_TYPE_Pos)      /**< (MATRIX_SCFG) Default Master Type Mask */
#define MATRIX_SCFG_DEFMSTR_TYPE(value)     (MATRIX_SCFG_DEFMSTR_TYPE_Msk & ((value) << MATRIX_SCFG_DEFMSTR_TYPE_Pos))
#define   MATRIX_SCFG_DEFMSTR_TYPE_NO_DEFAULT_Val _U(0x0)                                        /**< (MATRIX_SCFG) At the end of current slave access, if no other master request is pending, the slave is disconnected from all masters.This results in having a one cycle latency for the first access of a burst transfer or for a single access.  */
#define   MATRIX_SCFG_DEFMSTR_TYPE_LAST_Val _U(0x1)                                        /**< (MATRIX_SCFG) At the end of current slave access, if no other master request is pending, the slave stays connected to the last master having accessed it.This results in not having the one cycle latency when the last master tries to access the slave again.  */
#define   MATRIX_SCFG_DEFMSTR_TYPE_FIXED_Val _U(0x2)                                        /**< (MATRIX_SCFG) At the end of the current slave access, if no other master request is pending, the slave connects to the fixed master the number that has been written in the FIXED_DEFMSTR field.This results in not having the one cycle latency when the fixed master tries to access the slave again.  */
...
#define MATRIX_SCFG_FIXED_DEFMSTR_Msk       (_U(0x7) << MATRIX_SCFG_FIXED_DEFMSTR_Pos)     /**< (MATRIX_SCFG) Fixed Default Master Mask */
#define MATRIX_SCFG_FIXED_DEFMSTR(value)    (MATRIX_SCFG_FIXED_DEFMSTR_Msk & ((value) << MATRIX_SCFG_FIXED_DEFMSTR_Pos))
#define MATRIX_SCFG_MASK                    _U(0x1F00FF)                                   /**< \deprecated (MATRIX_SCFG) Register MASK  (Use MATRIX_SCFG_Msk instead)  */
#define MATRIX_SCFG_Msk                     _U(0x1F00FF)                                   /**< (MATRIX_SCFG) Register Mask  */
...
#define MATRIX_PRAS0_M0PR_Msk               (_U(0x3) << MATRIX_PRAS0_M0PR_Pos)             /**< (MATRIX_PRAS0) Master 0 Priority Mask */
...
#define MATRIX_PRAS0_M1PR_Msk               (_U(0x3) << MATRIX_PRAS0_M1PR_Pos)             /**< (MATRIX_PRAS0) Master 1 Priority Mask */
...
#define MATRIX_PRAS0_M2PR_Msk               (_U(0x3) << MATRIX_PRAS0_M2PR_Pos)             /**< (MATRIX_PRAS0) Master 2 Priority Mask */
...
#define MATRIX_PRAS0_M3PR_Msk               (_U(0x3) << MATRIX_PRAS0_M3PR_Pos)             /**< (MATRIX_PRAS0) Master 3 Priority Mask */
#define MATRIX_PRAS0_M3PR(value)            (MATRIX_PRAS0_M3PR_Msk & ((value) << MATRIX_PRAS0_M3PR_Pos))
#define MATRIX_PRAS0_MASK                   _U(0x3333)                                     /**< \deprecated (MATRIX_PRAS0) Register MASK  (Use MATRIX_PRAS0_Msk instead)  */
#define MATRIX_PRAS0_Msk                    _U(0x3333)                                     /**< (MATRIX_PRAS0) Register Mask  */
...
#define MATRIX_PRAS1_M0PR_Msk               (_U(0x3) << MATRIX_PRAS1_M0PR_Pos)             /**< (MATRIX_PRAS1) Master 0 Priority Mask */
...
#define MATRIX_PRAS1_M1PR_Msk               (_U(0x3) << MATRIX_PRAS1_M1PR_Pos)             /**< (MATRIX_PRAS1) Master 1 Priority Mask */
...
#define MATRIX_PRAS1_M2PR_Msk               (_U(0x3) << MATRIX_PRAS1_M2PR_Pos)             /**< (MATRIX_PRAS1) Master 2 Priority Mask */
...
#define MATRIX_PRAS1_M3PR_Msk               (_U(0x3) << MATRIX_PRAS1_M3PR_Pos)             /**< (MATRIX_PRAS1) Master 3 Priority Mask */
#define MATRIX_PRAS1_M3PR(value)            (MATRIX_PRAS1_M3PR_Msk & ((value) << MATRIX_PRAS1_M3PR_Pos))
#define MATRIX_PRAS1_MASK                   _U(0x3333)                                     /**< \deprecated (MATRIX_PRAS1) Register MASK  (Use MATRIX_PRAS1_Msk instead)  */
#define MATRIX_PRAS1_Msk                    _U(0x3333)                                     /**< (MATRIX_PRAS1) Register Mask  */
...
#define MATRIX_PRAS2_M0PR_Msk               (_U(0x3) << MATRIX_PRAS2_M0PR_Pos)             /**< (MATRIX_PRAS2) Master 0 Priority Mask */
...
#define MATRIX_PRAS2_M1PR_Msk               (_U(0x3) << MATRIX_PRAS2_M1PR_Pos)             /**< (MATRIX_PRAS2) Master 1 Priority Mask */
...
#define MATRIX_PRAS2_M2PR_Msk               (_U(0x3) << MATRIX_PRAS2_M2PR_Pos)             /**< (MATRIX_PRAS2) Master 2 Priority Mask */
...
#define MATRIX_PRAS2_M3PR_Msk               (_U(0x3) << MATRIX_PRAS2_M3PR_Pos)             /**< (MATRIX_PRAS2) Master 3 Priority Mask */
#define MATRIX_PRAS2_M3PR(value)            (MATRIX_PRAS2_M3PR_Msk & ((value) << MATRIX_PRAS2_M3PR_Pos))
#define MATRIX_PRAS2_MASK                   _U(0x3333)                                     /**< \deprecated (MATRIX_PRAS2) Register MASK  (Use MATRIX_PRAS2_Msk instead)  */
#define MATRIX_PRAS2_Msk                    _U(0x3333)                                     /**< (MATRIX_PRAS2) Register Mask  */
...
#define MATRIX_PRAS3_M0PR_Msk               (_U(0x3) << MATRIX_PRAS3_M0PR_Pos)             /**< (MATRIX_PRAS3) Master 0 Priority Mask */
...
#define MATRIX_PRAS3_M1PR_Msk               (_U(0x3) << MATRIX_PRAS3_M1PR_Pos)             /**< (MATRIX_PRAS3) Master 1 Priority Mask */
...
#define MATRIX_PRAS3_M2PR_Msk               (_U(0x3) << MATRIX_PRAS3_M2PR_Pos)             /**< (MATRIX_PRAS3) Master 2 Priority Mask */
...
#define MATRIX_PRAS3_M3PR_Msk               (_U(0x3) << MATRIX_PRAS3_M3PR_Pos)             /**< (MATRIX_PRAS3) Master 3 Priority Mask */
#define MATRIX_PRAS3_M3PR(value)            (MATRIX_PRAS3_M3PR_Msk & ((value) << MATRIX_PRAS3_M3PR_Pos))
#define MATRIX_PRAS3_MASK                   _U(0x3333)                                     /**< \deprecated (MATRIX_PRAS3) Register MASK  (Use MATRIX_PRAS3_Msk instead)  */
#define MATRIX_PRAS3_Msk                    _U(0x3333)                                     /**< (MATRIX_PRAS3) Register Mask  */
...
#define CCFG_SYSIO_SYSIO4_Msk               (_U(0x1) << CCFG_SYSIO_SYSIO4_Pos)             /**< (CCFG_SYSIO) PB4 or TDI Assignment Mask */
...
#define CCFG_SYSIO_SYSIO5_Msk               (_U(0x1) << CCFG_SYSIO_SYSIO5_Pos)             /**< (CCFG_SYSIO) PB5 or TDO/TRACESWO Assignment Mask */
...
#define CCFG_SYSIO_SYSIO6_Msk               (_U(0x1) << CCFG_SYSIO_SYSIO6_Pos)             /**< (CCFG_SYSIO) PB6 or TMS/SWDIO Assignment Mask */
...
#define CCFG_SYSIO_SYSIO7_Msk               (_U(0x1) << CCFG_SYSIO_SYSIO7_Pos)             /**< (CCFG_SYSIO) PB7 or TCK/SWCLK Assignment Mask */
...
#define CCFG_SYSIO_SYSIO10_Msk              (_U(0x1) << CCFG_SYSIO_SYSIO10_Pos)            /**< (CCFG_SYSIO) PA21 or DM Assignment Mask */
...
#define CCFG_SYSIO_SYSIO11_Msk              (_U(0x1) << CCFG_SYSIO_SYSIO11_Pos)            /**< (CCFG_SYSIO) PA22 or DP Assignment Mask */
...
#define CCFG_SYSIO_SYSIO12_Msk              (_U(0x1) << CCFG_SYSIO_SYSIO12_Pos)            /**< (CCFG_SYSIO) PB12 or ERASE Assignment Mask */
...
#define CCFG_SYSIO_SYSIO_Msk                (_U(0x7F) << CCFG_SYSIO_SYSIO_Pos)             /**< (CCFG_SYSIO Mask) SYSIO */
#define CCFG_SYSIO_SYSIO(value)             (CCFG_SYSIO_SYSIO_Msk & ((value) << CCFG_SYSIO_SYSIO_Pos))  
#define CCFG_SYSIO_MASK                     _U(0x1CF0)                                     /**< \deprecated (CCFG_SYSIO) Register MASK  (Use CCFG_SYSIO_Msk instead)  */
#define CCFG_SYSIO_Msk                      _U(0x1CF0)                                     /**< (CCFG_SYSIO) Register Mask  */
...
#define CCFG_DYNCKG_MATCKG_Msk              (_U(0x1) << CCFG_DYNCKG_MATCKG_Pos)            /**< (CCFG_DYNCKG) MATRIX Dynamic Clock Gating Mask */
...
#define CCFG_DYNCKG_BRIDCKG_Msk             (_U(0x1) << CCFG_DYNCKG_BRIDCKG_Pos)           /**< (CCFG_DYNCKG) Bridge Dynamic Clock Gating Enable Mask */
...
#define CCFG_DYNCKG_EFCCKG_Msk              (_U(0x1) << CCFG_DYNCKG_EFCCKG_Pos)            /**< (CCFG_DYNCKG) EFC Dynamic Clock Gating Enable Mask */
...
#define CCFG_DYNCKG_MASK                    _U(0x07)                                       /**< \deprecated (CCFG_DYNCKG) Register MASK  (Use CCFG_DYNCKG_Msk instead)  */
#define CCFG_DYNCKG_Msk                     _U(0x07)                                       /**< (CCFG_DYNCKG) Register Mask  */
...
#define CCFG_I2SCLKSEL_CLKSEL0_Msk          (_U(0x1) << CCFG_I2SCLKSEL_CLKSEL0_Pos)        /**< (CCFG_I2SCLKSEL) I2S0 Clock Source Mask */
...
#define CCFG_I2SCLKSEL_CLKSEL1_Msk          (_U(0x1) << CCFG_I2SCLKSEL_CLKSEL1_Pos)        /**< (CCFG_I2SCLKSEL) I2S1 Clock Source Mask */
...
#define CCFG_I2SCLKSEL_CLKSEL_Msk           (_U(0x3) << CCFG_I2SCLKSEL_CLKSEL_Pos)         /**< (CCFG_I2SCLKSEL Mask) CLKSEL */
#define CCFG_I2SCLKSEL_CLKSEL(value)        (CCFG_I2SCLKSEL_CLKSEL_Msk & ((value) << CCFG_I2SCLKSEL_CLKSEL_Pos))  
#define CCFG_I2SCLKSEL_MASK                 _U(0x03)                                       /**< \deprecated (CCFG_I2SCLKSEL) Register MASK  (Use CCFG_I2SCLKSEL_Msk instead)  */
#define CCFG_I2SCLKSEL_Msk                  _U(0x03)                                       /**< (CCFG_I2SCLKSEL) Register Mask  */
...
#define CCFG_USBMR_USBMODE_Msk              (_U(0x1) << CCFG_USBMR_USBMODE_Pos)            /**< (CCFG_USBMR) USB Mode Selection Mask */
...
#define CCFG_USBMR_USBHTSSC_Msk             (_U(0x1) << CCFG_USBMR_USBHTSSC_Pos)           /**< (CCFG_USBMR) USB Transceiver Suspend Software Control Mask */
...
#define CCFG_USBMR_USBHTSC_Msk              (_U(0x1) << CCFG_USBMR_USBHTSC_Pos)            /**< (CCFG_USBMR) USB Host Transceiver Suspend Control Mask */
...
#define CCFG_USBMR_MASK                     _U(0x07)                                       /**< \deprecated (CCFG_USBMR) Register MASK  (Use CCFG_USBMR_Msk instead)  */
#define CCFG_USBMR_Msk                      _U(0x07)                                       /**< (CCFG_USBMR) Register Mask  */
...
#define MATRIX_WPMR_WPEN_Msk                (_U(0x1) << MATRIX_WPMR_WPEN_Pos)              /**< (MATRIX_WPMR) Write Protection Enable Mask */
...
#define MATRIX_WPMR_WPKEY_Msk               (_U(0xFFFFFF) << MATRIX_WPMR_WPKEY_Pos)        /**< (MATRIX_WPMR) Write Protection Key Mask */
#define MATRIX_WPMR_WPKEY(value)            (MATRIX_WPMR_WPKEY_Msk & ((value) << MATRIX_WPMR_WPKEY_Pos))
#define   MATRIX_WPMR_WPKEY_PASSWD_Val      _U(0x4D4154)                                   /**< (MATRIX_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit. Always reads as 0.  */
...
#define MATRIX_WPMR_MASK                    _U(0xFFFFFF01)                                 /**< \deprecated (MATRIX_WPMR) Register MASK  (Use MATRIX_WPMR_Msk instead)  */
#define MATRIX_WPMR_Msk                     _U(0xFFFFFF01)                                 /**< (MATRIX_WPMR) Register Mask  */
...
#define MATRIX_WPSR_WPVS_Msk                (_U(0x1) << MATRIX_WPSR_WPVS_Pos)              /**< (MATRIX_WPSR) Write Protection Violation Status Mask */
...
#define MATRIX_WPSR_WPVSRC_Msk              (_U(0xFFFF) << MATRIX_WPSR_WPVSRC_Pos)         /**< (MATRIX_WPSR) Write Protection Violation Source Mask */
#define MATRIX_WPSR_WPVSRC(value)           (MATRIX_WPSR_WPVSRC_Msk & ((value) << MATRIX_WPSR_WPVSRC_Pos))
#define MATRIX_WPSR_MASK                    _U(0xFFFF01)                                   /**< \deprecated (MATRIX_WPSR) Register MASK  (Use MATRIX_WPSR_Msk instead)  */
#define MATRIX_WPSR_Msk                     _U(0xFFFF01)                                   /**< (MATRIX_WPSR) Register Mask  */
