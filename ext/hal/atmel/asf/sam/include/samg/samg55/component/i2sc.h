...
#define I2SC_CR_RXEN_Msk                    (_U(0x1) << I2SC_CR_RXEN_Pos)                  /**< (I2SC_CR) Receiver Enable Mask */
...
#define I2SC_CR_RXDIS_Msk                   (_U(0x1) << I2SC_CR_RXDIS_Pos)                 /**< (I2SC_CR) Receiver Disable Mask */
...
#define I2SC_CR_CKEN_Msk                    (_U(0x1) << I2SC_CR_CKEN_Pos)                  /**< (I2SC_CR) Clocks Enable Mask */
...
#define I2SC_CR_CKDIS_Msk                   (_U(0x1) << I2SC_CR_CKDIS_Pos)                 /**< (I2SC_CR) Clocks Disable Mask */
...
#define I2SC_CR_TXEN_Msk                    (_U(0x1) << I2SC_CR_TXEN_Pos)                  /**< (I2SC_CR) Transmitter Enable Mask */
...
#define I2SC_CR_TXDIS_Msk                   (_U(0x1) << I2SC_CR_TXDIS_Pos)                 /**< (I2SC_CR) Transmitter Disable Mask */
...
#define I2SC_CR_SWRST_Msk                   (_U(0x1) << I2SC_CR_SWRST_Pos)                 /**< (I2SC_CR) Software Reset Mask */
...
#define I2SC_CR_MASK                        _U(0xBF)                                       /**< \deprecated (I2SC_CR) Register MASK  (Use I2SC_CR_Msk instead)  */
#define I2SC_CR_Msk                         _U(0xBF)                                       /**< (I2SC_CR) Register Mask  */
...
#define I2SC_MR_MODE_Msk                    (_U(0x1) << I2SC_MR_MODE_Pos)                  /**< (I2SC_MR) Inter-IC Sound Controller Mode Mask */
...
#define   I2SC_MR_MODE_SLAVE_Val            _U(0x0)                                        /**< (I2SC_MR) I2SCK and i2SWS pin inputs used as bit clock and word select/frame synchronization.  */
#define   I2SC_MR_MODE_MASTER_Val           _U(0x1)                                        /**< (I2SC_MR) Bit clock and word select/frame synchronization generated by I2SC from MCK and output to I2SCK and I2SWS pins. MCK is output as master clock on I2SMCK if I2SC_MR.IMCKMODE is set.  */
...
#define I2SC_MR_DATALENGTH_Msk              (_U(0x7) << I2SC_MR_DATALENGTH_Pos)            /**< (I2SC_MR) Data Word Length Mask */
#define I2SC_MR_DATALENGTH(value)           (I2SC_MR_DATALENGTH_Msk & ((value) << I2SC_MR_DATALENGTH_Pos))
#define   I2SC_MR_DATALENGTH_32_BITS_Val    _U(0x0)                                        /**< (I2SC_MR) Data length is set to 32 bits  */
#define   I2SC_MR_DATALENGTH_24_BITS_Val    _U(0x1)                                        /**< (I2SC_MR) Data length is set to 24 bits  */
#define   I2SC_MR_DATALENGTH_20_BITS_Val    _U(0x2)                                        /**< (I2SC_MR) Data length is set to 20 bits  */
#define   I2SC_MR_DATALENGTH_18_BITS_Val    _U(0x3)                                        /**< (I2SC_MR) Data length is set to 18 bits  */
#define   I2SC_MR_DATALENGTH_16_BITS_Val    _U(0x4)                                        /**< (I2SC_MR) Data length is set to 16 bits  */
#define   I2SC_MR_DATALENGTH_16_BITS_COMPACT_Val _U(0x5)                                        /**< (I2SC_MR) Data length is set to 16-bit compact stereo. Left sample in bits 15:0 and right sample in bits 31:16 of same word.  */
#define   I2SC_MR_DATALENGTH_8_BITS_Val     _U(0x6)                                        /**< (I2SC_MR) Data length is set to 8 bits  */
#define   I2SC_MR_DATALENGTH_8_BITS_COMPACT_Val _U(0x7)                                        /**< (I2SC_MR) Data length is set to 8-bit compact stereo. Left sample in bits 7:0 and right sample in bits 15:8 of the same word.  */
...
#define I2SC_MR_RXMONO_Msk                  (_U(0x1) << I2SC_MR_RXMONO_Pos)                /**< (I2SC_MR) Receive Mono Mask */
...
#define I2SC_MR_RXDMA_Msk                   (_U(0x1) << I2SC_MR_RXDMA_Pos)                 /**< (I2SC_MR) Single or Multiple PDC Channels for Receiver Mask */
...
#define I2SC_MR_RXLOOP_Msk                  (_U(0x1) << I2SC_MR_RXLOOP_Pos)                /**< (I2SC_MR) Loop-back Test Mode Mask */
...
#define I2SC_MR_TXMONO_Msk                  (_U(0x1) << I2SC_MR_TXMONO_Pos)                /**< (I2SC_MR) Transmit Mono Mask */
...
#define I2SC_MR_TXDMA_Msk                   (_U(0x1) << I2SC_MR_TXDMA_Pos)                 /**< (I2SC_MR) Single or Multiple PDC Channels for Transmitter Mask */
...
#define I2SC_MR_TXSAME_Msk                  (_U(0x1) << I2SC_MR_TXSAME_Pos)                /**< (I2SC_MR) Transmit Data when Underrun Mask */
...
#define I2SC_MR_IMCKDIV_Msk                 (_U(0x3F) << I2SC_MR_IMCKDIV_Pos)              /**< (I2SC_MR) Selected Clock to I2SC Master Clock Ratio Mask */
...
#define I2SC_MR_IMCKFS_Msk                  (_U(0x3F) << I2SC_MR_IMCKFS_Pos)               /**< (I2SC_MR) Master Clock to fs Ratio Mask */
#define I2SC_MR_IMCKFS(value)               (I2SC_MR_IMCKFS_Msk & ((value) << I2SC_MR_IMCKFS_Pos))
#define   I2SC_MR_IMCKFS_M2SF32_Val         _U(0x0)                                        /**< (I2SC_MR) Sample frequency ratio set to 32  */
#define   I2SC_MR_IMCKFS_M2SF64_Val         _U(0x1)                                        /**< (I2SC_MR) Sample frequency ratio set to 64  */
#define   I2SC_MR_IMCKFS_M2SF96_Val         _U(0x2)                                        /**< (I2SC_MR) Sample frequency ratio set to 96  */
#define   I2SC_MR_IMCKFS_M2SF128_Val        _U(0x3)                                        /**< (I2SC_MR) Sample frequency ratio set to 128  */
#define   I2SC_MR_IMCKFS_M2SF192_Val        _U(0x5)                                        /**< (I2SC_MR) Sample frequency ratio set to 192  */
#define   I2SC_MR_IMCKFS_M2SF256_Val        _U(0x7)                                        /**< (I2SC_MR) Sample frequency ratio set to 256  */
#define   I2SC_MR_IMCKFS_M2SF384_Val        _U(0xB)                                        /**< (I2SC_MR) Sample frequency ratio set to 384  */
#define   I2SC_MR_IMCKFS_M2SF512_Val        _U(0xF)                                        /**< (I2SC_MR) Sample frequency ratio set to 512  */
#define   I2SC_MR_IMCKFS_M2SF768_Val        _U(0x17)                                       /**< (I2SC_MR) Sample frequency ratio set to 768  */
#define   I2SC_MR_IMCKFS_M2SF1024_Val       _U(0x1F)                                       /**< (I2SC_MR) Sample frequency ratio set to 1024  */
#define   I2SC_MR_IMCKFS_M2SF1536_Val       _U(0x2F)                                       /**< (I2SC_MR) Sample frequency ratio set to 1536  */
#define   I2SC_MR_IMCKFS_M2SF2048_Val       _U(0x3F)                                       /**< (I2SC_MR) Sample frequency ratio set to 2048  */
...
#define I2SC_MR_IMCKMODE_Msk                (_U(0x1) << I2SC_MR_IMCKMODE_Pos)              /**< (I2SC_MR) Master Clock Mode Mask */
...
#define I2SC_MR_IWS_Msk                     (_U(0x1) << I2SC_MR_IWS_Pos)                   /**< (I2SC_MR) I2SWS TDM Slot Width Mask */
#define I2SC_MR_IWS                         I2SC_MR_IWS_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use I2SC_MR_IWS_Msk instead */
#define I2SC_MR_MASK                        _U(0xFF3F771D)                                 /**< \deprecated (I2SC_MR) Register MASK  (Use I2SC_MR_Msk instead)  */
#define I2SC_MR_Msk                         _U(0xFF3F771D)                                 /**< (I2SC_MR) Register Mask  */
...
#define I2SC_SR_RXEN_Msk                    (_U(0x1) << I2SC_SR_RXEN_Pos)                  /**< (I2SC_SR) Receiver Enabled Mask */
...
#define I2SC_SR_RXRDY_Msk                   (_U(0x1) << I2SC_SR_RXRDY_Pos)                 /**< (I2SC_SR) Receive Ready Mask */
...
#define I2SC_SR_RXOR_Msk                    (_U(0x1) << I2SC_SR_RXOR_Pos)                  /**< (I2SC_SR) Receive Overrun Mask */
...
#define I2SC_SR_ENDRX_Msk                   (_U(0x1) << I2SC_SR_ENDRX_Pos)                 /**< (I2SC_SR) End of Receiver Transfer Mask */
...
#define I2SC_SR_TXEN_Msk                    (_U(0x1) << I2SC_SR_TXEN_Pos)                  /**< (I2SC_SR) Transmitter Enabled Mask */
...
#define I2SC_SR_TXRDY_Msk                   (_U(0x1) << I2SC_SR_TXRDY_Pos)                 /**< (I2SC_SR) Transmit Ready Mask */
...
#define I2SC_SR_TXUR_Msk                    (_U(0x1) << I2SC_SR_TXUR_Pos)                  /**< (I2SC_SR) Transmit Underrun Mask */
...
#define I2SC_SR_ENDTX_Msk                   (_U(0x1) << I2SC_SR_ENDTX_Pos)                 /**< (I2SC_SR) End of Transmitter Transfer Mask */
...
#define I2SC_SR_RXORCH_Msk                  (_U(0x3) << I2SC_SR_RXORCH_Pos)                /**< (I2SC_SR) Receive Overrun Channel Mask */
...
#define I2SC_SR_RXBUFF_Msk                  (_U(0x1) << I2SC_SR_RXBUFF_Pos)                /**< (I2SC_SR) Receive Buffer Full Mask */
...
#define I2SC_SR_TXURCH_Msk                  (_U(0x3) << I2SC_SR_TXURCH_Pos)                /**< (I2SC_SR) Transmit Underrun Channel Mask */
...
#define I2SC_SR_TXBUFE_Msk                  (_U(0x1) << I2SC_SR_TXBUFE_Pos)                /**< (I2SC_SR) Transmit Buffer Empty Mask */
...
#define I2SC_SR_MASK                        _U(0x803803FF)                                 /**< \deprecated (I2SC_SR) Register MASK  (Use I2SC_SR_Msk instead)  */
#define I2SC_SR_Msk                         _U(0x803803FF)                                 /**< (I2SC_SR) Register Mask  */
...
#define I2SC_SCR_RXOR_Msk                   (_U(0x1) << I2SC_SCR_RXOR_Pos)                 /**< (I2SC_SCR) Receive Overrun Status Clear Mask */
...
#define I2SC_SCR_TXUR_Msk                   (_U(0x1) << I2SC_SCR_TXUR_Pos)                 /**< (I2SC_SCR) Transmit Underrun Status Clear Mask */
...
#define I2SC_SCR_RXORCH_Msk                 (_U(0x3) << I2SC_SCR_RXORCH_Pos)               /**< (I2SC_SCR) Receive Overrun Per Channel Status Clear Mask */
...
#define I2SC_SCR_TXURCH_Msk                 (_U(0x3) << I2SC_SCR_TXURCH_Pos)               /**< (I2SC_SCR) Transmit Underrun Per Channel Status Clear Mask */
#define I2SC_SCR_TXURCH(value)              (I2SC_SCR_TXURCH_Msk & ((value) << I2SC_SCR_TXURCH_Pos))
#define I2SC_SCR_MASK                       _U(0x300344)                                   /**< \deprecated (I2SC_SCR) Register MASK  (Use I2SC_SCR_Msk instead)  */
#define I2SC_SCR_Msk                        _U(0x300344)                                   /**< (I2SC_SCR) Register Mask  */
...
#define I2SC_SSR_RXOR_Msk                   (_U(0x1) << I2SC_SSR_RXOR_Pos)                 /**< (I2SC_SSR) Receive Overrun Status Set Mask */
...
#define I2SC_SSR_TXUR_Msk                   (_U(0x1) << I2SC_SSR_TXUR_Pos)                 /**< (I2SC_SSR) Transmit Underrun Status Set Mask */
...
#define I2SC_SSR_RXORCH_Msk                 (_U(0x3) << I2SC_SSR_RXORCH_Pos)               /**< (I2SC_SSR) Receive Overrun Per Channel Status Set Mask */
...
#define I2SC_SSR_TXURCH_Msk                 (_U(0x3) << I2SC_SSR_TXURCH_Pos)               /**< (I2SC_SSR) Transmit Underrun Per Channel Status Set Mask */
#define I2SC_SSR_TXURCH(value)              (I2SC_SSR_TXURCH_Msk & ((value) << I2SC_SSR_TXURCH_Pos))
#define I2SC_SSR_MASK                       _U(0x300344)                                   /**< \deprecated (I2SC_SSR) Register MASK  (Use I2SC_SSR_Msk instead)  */
#define I2SC_SSR_Msk                        _U(0x300344)                                   /**< (I2SC_SSR) Register Mask  */
...
#define I2SC_IER_RXRDY_Msk                  (_U(0x1) << I2SC_IER_RXRDY_Pos)                /**< (I2SC_IER) Receiver Ready Interrupt Enable Mask */
...
#define I2SC_IER_RXOR_Msk                   (_U(0x1) << I2SC_IER_RXOR_Pos)                 /**< (I2SC_IER) Receiver Overrun Interrupt Enable Mask */
...
#define I2SC_IER_ENDRX_Msk                  (_U(0x1) << I2SC_IER_ENDRX_Pos)                /**< (I2SC_IER) End of Reception Interrupt Enable Mask */
...
#define I2SC_IER_TXRDY_Msk                  (_U(0x1) << I2SC_IER_TXRDY_Pos)                /**< (I2SC_IER) Transmit Ready Interrupt Enable Mask */
...
#define I2SC_IER_TXUR_Msk                   (_U(0x1) << I2SC_IER_TXUR_Pos)                 /**< (I2SC_IER) Transmit Underflow Interrupt Enable Mask */
...
#define I2SC_IER_ENDTX_Msk                  (_U(0x1) << I2SC_IER_ENDTX_Pos)                /**< (I2SC_IER) End of Transmission Interrupt Enable Mask */
...
#define I2SC_IER_RXFULL_Msk                 (_U(0x1) << I2SC_IER_RXFULL_Pos)               /**< (I2SC_IER) Receive Buffer Full Interrupt Enable Mask */
...
#define I2SC_IER_TXEMPTY_Msk                (_U(0x1) << I2SC_IER_TXEMPTY_Pos)              /**< (I2SC_IER) Transmit Buffer Empty Interrupt Enable Mask */
...
#define I2SC_IER_MASK                       _U(0x800800EE)                                 /**< \deprecated (I2SC_IER) Register MASK  (Use I2SC_IER_Msk instead)  */
#define I2SC_IER_Msk                        _U(0x800800EE)                                 /**< (I2SC_IER) Register Mask  */
...
#define I2SC_IDR_RXRDY_Msk                  (_U(0x1) << I2SC_IDR_RXRDY_Pos)                /**< (I2SC_IDR) Receiver Ready Interrupt Disable Mask */
...
#define I2SC_IDR_RXOR_Msk                   (_U(0x1) << I2SC_IDR_RXOR_Pos)                 /**< (I2SC_IDR) Receiver Overrun Interrupt Disable Mask */
...
#define I2SC_IDR_ENDRX_Msk                  (_U(0x1) << I2SC_IDR_ENDRX_Pos)                /**< (I2SC_IDR) End of Reception Interrupt Disable Mask */
...
#define I2SC_IDR_TXRDY_Msk                  (_U(0x1) << I2SC_IDR_TXRDY_Pos)                /**< (I2SC_IDR) Transmit Ready Interrupt Disable Mask */
...
#define I2SC_IDR_TXUR_Msk                   (_U(0x1) << I2SC_IDR_TXUR_Pos)                 /**< (I2SC_IDR) Transmit Underflow Interrupt Disable Mask */
...
#define I2SC_IDR_ENDTX_Msk                  (_U(0x1) << I2SC_IDR_ENDTX_Pos)                /**< (I2SC_IDR) End of Transmission Interrupt Disable Mask */
...
#define I2SC_IDR_RXFULL_Msk                 (_U(0x1) << I2SC_IDR_RXFULL_Pos)               /**< (I2SC_IDR) Receive Buffer Full Interrupt Disable Mask */
...
#define I2SC_IDR_TXEMPTY_Msk                (_U(0x1) << I2SC_IDR_TXEMPTY_Pos)              /**< (I2SC_IDR) Transmit Buffer Empty Interrupt Disable Mask */
...
#define I2SC_IDR_MASK                       _U(0x800800EE)                                 /**< \deprecated (I2SC_IDR) Register MASK  (Use I2SC_IDR_Msk instead)  */
#define I2SC_IDR_Msk                        _U(0x800800EE)                                 /**< (I2SC_IDR) Register Mask  */
...
#define I2SC_IMR_RXRDY_Msk                  (_U(0x1) << I2SC_IMR_RXRDY_Pos)                /**< (I2SC_IMR) Receiver Ready Interrupt Disable Mask */
...
#define I2SC_IMR_RXOR_Msk                   (_U(0x1) << I2SC_IMR_RXOR_Pos)                 /**< (I2SC_IMR) Receiver Overrun Interrupt Disable Mask */
...
#define I2SC_IMR_ENDRX_Msk                  (_U(0x1) << I2SC_IMR_ENDRX_Pos)                /**< (I2SC_IMR) End of Reception Interrupt Disable Mask */
...
#define I2SC_IMR_TXRDY_Msk                  (_U(0x1) << I2SC_IMR_TXRDY_Pos)                /**< (I2SC_IMR) Transmit Ready Interrupt Disable Mask */
...
#define I2SC_IMR_TXUR_Msk                   (_U(0x1) << I2SC_IMR_TXUR_Pos)                 /**< (I2SC_IMR) Transmit Underflow Interrupt Disable Mask */
...
#define I2SC_IMR_ENDTX_Msk                  (_U(0x1) << I2SC_IMR_ENDTX_Pos)                /**< (I2SC_IMR) End of Transmission Interrupt Disable Mask */
...
#define I2SC_IMR_RXFULL_Msk                 (_U(0x1) << I2SC_IMR_RXFULL_Pos)               /**< (I2SC_IMR) Receive Buffer Full Interrupt Disable Mask */
...
#define I2SC_IMR_TXEMPTY_Msk                (_U(0x1) << I2SC_IMR_TXEMPTY_Pos)              /**< (I2SC_IMR) Transmit Buffer Empty Interrupt Disable Mask */
...
#define I2SC_IMR_MASK                       _U(0x800800EE)                                 /**< \deprecated (I2SC_IMR) Register MASK  (Use I2SC_IMR_Msk instead)  */
#define I2SC_IMR_Msk                        _U(0x800800EE)                                 /**< (I2SC_IMR) Register Mask  */
...
#define I2SC_RHR_RHR_Msk                    (_U(0xFFFFFFFF) << I2SC_RHR_RHR_Pos)           /**< (I2SC_RHR) Receiver Holding Register Mask */
#define I2SC_RHR_RHR(value)                 (I2SC_RHR_RHR_Msk & ((value) << I2SC_RHR_RHR_Pos))
#define I2SC_RHR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (I2SC_RHR) Register MASK  (Use I2SC_RHR_Msk instead)  */
#define I2SC_RHR_Msk                        _U(0xFFFFFFFF)                                 /**< (I2SC_RHR) Register Mask  */
...
#define I2SC_THR_THR_Msk                    (_U(0xFFFFFFFF) << I2SC_THR_THR_Pos)           /**< (I2SC_THR) Transmitter Holding Register Mask */
#define I2SC_THR_THR(value)                 (I2SC_THR_THR_Msk & ((value) << I2SC_THR_THR_Pos))
#define I2SC_THR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (I2SC_THR) Register MASK  (Use I2SC_THR_Msk instead)  */
#define I2SC_THR_Msk                        _U(0xFFFFFFFF)                                 /**< (I2SC_THR) Register Mask  */
...
#define I2SC_RPR_RXPTR_Msk                  (_U(0xFFFFFFFF) << I2SC_RPR_RXPTR_Pos)         /**< (I2SC_RPR) Receive Pointer Register Mask */
#define I2SC_RPR_RXPTR(value)               (I2SC_RPR_RXPTR_Msk & ((value) << I2SC_RPR_RXPTR_Pos))
#define I2SC_RPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (I2SC_RPR) Register MASK  (Use I2SC_RPR_Msk instead)  */
#define I2SC_RPR_Msk                        _U(0xFFFFFFFF)                                 /**< (I2SC_RPR) Register Mask  */
...
#define I2SC_RCR_RXCTR_Msk                  (_U(0xFFFF) << I2SC_RCR_RXCTR_Pos)             /**< (I2SC_RCR) Receive Counter Register Mask */
#define I2SC_RCR_RXCTR(value)               (I2SC_RCR_RXCTR_Msk & ((value) << I2SC_RCR_RXCTR_Pos))
#define I2SC_RCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (I2SC_RCR) Register MASK  (Use I2SC_RCR_Msk instead)  */
#define I2SC_RCR_Msk                        _U(0xFFFF)                                     /**< (I2SC_RCR) Register Mask  */
...
#define I2SC_TPR_TXPTR_Msk                  (_U(0xFFFFFFFF) << I2SC_TPR_TXPTR_Pos)         /**< (I2SC_TPR) Transmit Counter Register Mask */
#define I2SC_TPR_TXPTR(value)               (I2SC_TPR_TXPTR_Msk & ((value) << I2SC_TPR_TXPTR_Pos))
#define I2SC_TPR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (I2SC_TPR) Register MASK  (Use I2SC_TPR_Msk instead)  */
#define I2SC_TPR_Msk                        _U(0xFFFFFFFF)                                 /**< (I2SC_TPR) Register Mask  */
...
#define I2SC_TCR_TXCTR_Msk                  (_U(0xFFFF) << I2SC_TCR_TXCTR_Pos)             /**< (I2SC_TCR) Transmit Counter Register Mask */
#define I2SC_TCR_TXCTR(value)               (I2SC_TCR_TXCTR_Msk & ((value) << I2SC_TCR_TXCTR_Pos))
#define I2SC_TCR_MASK                       _U(0xFFFF)                                     /**< \deprecated (I2SC_TCR) Register MASK  (Use I2SC_TCR_Msk instead)  */
#define I2SC_TCR_Msk                        _U(0xFFFF)                                     /**< (I2SC_TCR) Register Mask  */
...
#define I2SC_RNPR_RXNPTR_Msk                (_U(0xFFFFFFFF) << I2SC_RNPR_RXNPTR_Pos)       /**< (I2SC_RNPR) Receive Next Pointer Mask */
#define I2SC_RNPR_RXNPTR(value)             (I2SC_RNPR_RXNPTR_Msk & ((value) << I2SC_RNPR_RXNPTR_Pos))
#define I2SC_RNPR_MASK                      _U(0xFFFFFFFF)                                 /**< \deprecated (I2SC_RNPR) Register MASK  (Use I2SC_RNPR_Msk instead)  */
#define I2SC_RNPR_Msk                       _U(0xFFFFFFFF)                                 /**< (I2SC_RNPR) Register Mask  */
...
#define I2SC_RNCR_RXNCTR_Msk                (_U(0xFFFF) << I2SC_RNCR_RXNCTR_Pos)           /**< (I2SC_RNCR) Receive Next Counter Mask */
#define I2SC_RNCR_RXNCTR(value)             (I2SC_RNCR_RXNCTR_Msk & ((value) << I2SC_RNCR_RXNCTR_Pos))
#define I2SC_RNCR_MASK                      _U(0xFFFF)                                     /**< \deprecated (I2SC_RNCR) Register MASK  (Use I2SC_RNCR_Msk instead)  */
#define I2SC_RNCR_Msk                       _U(0xFFFF)                                     /**< (I2SC_RNCR) Register Mask  */
...
#define I2SC_TNPR_TXNPTR_Msk                (_U(0xFFFFFFFF) << I2SC_TNPR_TXNPTR_Pos)       /**< (I2SC_TNPR) Transmit Next Pointer Mask */
#define I2SC_TNPR_TXNPTR(value)             (I2SC_TNPR_TXNPTR_Msk & ((value) << I2SC_TNPR_TXNPTR_Pos))
#define I2SC_TNPR_MASK                      _U(0xFFFFFFFF)                                 /**< \deprecated (I2SC_TNPR) Register MASK  (Use I2SC_TNPR_Msk instead)  */
#define I2SC_TNPR_Msk                       _U(0xFFFFFFFF)                                 /**< (I2SC_TNPR) Register Mask  */
...
#define I2SC_TNCR_TXNCTR_Msk                (_U(0xFFFF) << I2SC_TNCR_TXNCTR_Pos)           /**< (I2SC_TNCR) Transmit Counter Next Mask */
#define I2SC_TNCR_TXNCTR(value)             (I2SC_TNCR_TXNCTR_Msk & ((value) << I2SC_TNCR_TXNCTR_Pos))
#define I2SC_TNCR_MASK                      _U(0xFFFF)                                     /**< \deprecated (I2SC_TNCR) Register MASK  (Use I2SC_TNCR_Msk instead)  */
#define I2SC_TNCR_Msk                       _U(0xFFFF)                                     /**< (I2SC_TNCR) Register Mask  */
...
#define I2SC_PTCR_RXTEN_Msk                 (_U(0x1) << I2SC_PTCR_RXTEN_Pos)               /**< (I2SC_PTCR) Receiver Transfer Enable Mask */
...
#define I2SC_PTCR_RXTDIS_Msk                (_U(0x1) << I2SC_PTCR_RXTDIS_Pos)              /**< (I2SC_PTCR) Receiver Transfer Disable Mask */
...
#define I2SC_PTCR_TXTEN_Msk                 (_U(0x1) << I2SC_PTCR_TXTEN_Pos)               /**< (I2SC_PTCR) Transmitter Transfer Enable Mask */
...
#define I2SC_PTCR_TXTDIS_Msk                (_U(0x1) << I2SC_PTCR_TXTDIS_Pos)              /**< (I2SC_PTCR) Transmitter Transfer Disable Mask */
...
#define I2SC_PTCR_RXCBEN_Msk                (_U(0x1) << I2SC_PTCR_RXCBEN_Pos)              /**< (I2SC_PTCR) Receiver Circular Buffer Enable Mask */
...
#define I2SC_PTCR_RXCBDIS_Msk               (_U(0x1) << I2SC_PTCR_RXCBDIS_Pos)             /**< (I2SC_PTCR) Receiver Circular Buffer Disable Mask */
...
#define I2SC_PTCR_TXCBEN_Msk                (_U(0x1) << I2SC_PTCR_TXCBEN_Pos)              /**< (I2SC_PTCR) Transmitter Circular Buffer Enable Mask */
...
#define I2SC_PTCR_TXCBDIS_Msk               (_U(0x1) << I2SC_PTCR_TXCBDIS_Pos)             /**< (I2SC_PTCR) Transmitter Circular Buffer Disable Mask */
...
#define I2SC_PTCR_ERRCLR_Msk                (_U(0x1) << I2SC_PTCR_ERRCLR_Pos)              /**< (I2SC_PTCR) Transfer Bus Error Clear Mask */
...
#define I2SC_PTCR_MASK                      _U(0x10F0303)                                  /**< \deprecated (I2SC_PTCR) Register MASK  (Use I2SC_PTCR_Msk instead)  */
#define I2SC_PTCR_Msk                       _U(0x10F0303)                                  /**< (I2SC_PTCR) Register Mask  */
...
#define I2SC_PTSR_RXTEN_Msk                 (_U(0x1) << I2SC_PTSR_RXTEN_Pos)               /**< (I2SC_PTSR) Receiver Transfer Enable Mask */
...
#define I2SC_PTSR_TXTEN_Msk                 (_U(0x1) << I2SC_PTSR_TXTEN_Pos)               /**< (I2SC_PTSR) Transmitter Transfer Enable Mask */
...
#define I2SC_PTSR_RXCBEN_Msk                (_U(0x1) << I2SC_PTSR_RXCBEN_Pos)              /**< (I2SC_PTSR) Receiver Circular Buffer Enable Mask */
...
#define I2SC_PTSR_TXCBEN_Msk                (_U(0x1) << I2SC_PTSR_TXCBEN_Pos)              /**< (I2SC_PTSR) Transmitter Circular Buffer Enable Mask */
...
#define I2SC_PTSR_ERR_Msk                   (_U(0x1) << I2SC_PTSR_ERR_Pos)                 /**< (I2SC_PTSR) Transfer Bus Error Mask */
...
#define I2SC_PTSR_MASK                      _U(0x1050101)                                  /**< \deprecated (I2SC_PTSR) Register MASK  (Use I2SC_PTSR_Msk instead)  */
#define I2SC_PTSR_Msk                       _U(0x1050101)                                  /**< (I2SC_PTSR) Register Mask  */
