...
#define RTC_CR_UPDTIM_Msk                   (_U(0x1) << RTC_CR_UPDTIM_Pos)                 /**< (RTC_CR) Update Request Time Register Mask */
...
#define RTC_CR_UPDCAL_Msk                   (_U(0x1) << RTC_CR_UPDCAL_Pos)                 /**< (RTC_CR) Update Request Calendar Register Mask */
...
#define RTC_CR_TIMEVSEL_Msk                 (_U(0x3) << RTC_CR_TIMEVSEL_Pos)               /**< (RTC_CR) Time Event Selection Mask */
#define RTC_CR_TIMEVSEL(value)              (RTC_CR_TIMEVSEL_Msk & ((value) << RTC_CR_TIMEVSEL_Pos))
#define   RTC_CR_TIMEVSEL_MINUTE_Val        _U(0x0)                                        /**< (RTC_CR) Minute change  */
#define   RTC_CR_TIMEVSEL_HOUR_Val          _U(0x1)                                        /**< (RTC_CR) Hour change  */
#define   RTC_CR_TIMEVSEL_MIDNIGHT_Val      _U(0x2)                                        /**< (RTC_CR) Every day at midnight  */
#define   RTC_CR_TIMEVSEL_NOON_Val          _U(0x3)                                        /**< (RTC_CR) Every day at noon  */
...
#define RTC_CR_CALEVSEL_Msk                 (_U(0x3) << RTC_CR_CALEVSEL_Pos)               /**< (RTC_CR) Calendar Event Selection Mask */
#define RTC_CR_CALEVSEL(value)              (RTC_CR_CALEVSEL_Msk & ((value) << RTC_CR_CALEVSEL_Pos))
#define   RTC_CR_CALEVSEL_WEEK_Val          _U(0x0)                                        /**< (RTC_CR) Week change (every Monday at time 00:00:00)  */
#define   RTC_CR_CALEVSEL_MONTH_Val         _U(0x1)                                        /**< (RTC_CR) Month change (every 01 of each month at time 00:00:00)  */
#define   RTC_CR_CALEVSEL_YEAR_Val          _U(0x2)                                        /**< (RTC_CR) Year change (every January 1 at time 00:00:00)  */
...
#define RTC_CR_MASK                         _U(0x30303)                                    /**< \deprecated (RTC_CR) Register MASK  (Use RTC_CR_Msk instead)  */
#define RTC_CR_Msk                          _U(0x30303)                                    /**< (RTC_CR) Register Mask  */
...
#define RTC_MR_HRMOD_Msk                    (_U(0x1) << RTC_MR_HRMOD_Pos)                  /**< (RTC_MR) 12-/24-hour Mode Mask */
...
#define RTC_MR_PERSIAN_Msk                  (_U(0x1) << RTC_MR_PERSIAN_Pos)                /**< (RTC_MR) PERSIAN Calendar Mask */
...
#define RTC_MR_NEGPPM_Msk                   (_U(0x1) << RTC_MR_NEGPPM_Pos)                 /**< (RTC_MR) NEGative PPM Correction Mask */
...
#define RTC_MR_CORRECTION_Msk               (_U(0x7F) << RTC_MR_CORRECTION_Pos)            /**< (RTC_MR) Slow Clock Correction Mask */
...
#define RTC_MR_HIGHPPM_Msk                  (_U(0x1) << RTC_MR_HIGHPPM_Pos)                /**< (RTC_MR) HIGH PPM Correction Mask */
...
#define RTC_MR_OUT0_Msk                     (_U(0x7) << RTC_MR_OUT0_Pos)                   /**< (RTC_MR) All ADC Channel Trigger Event Source Selection Mask */
#define RTC_MR_OUT0(value)                  (RTC_MR_OUT0_Msk & ((value) << RTC_MR_OUT0_Pos))
#define   RTC_MR_OUT0_NO_WAVE_Val           _U(0x0)                                        /**< (RTC_MR) No waveform, stuck at '0'  */
#define   RTC_MR_OUT0_FREQ1HZ_Val           _U(0x1)                                        /**< (RTC_MR) 1 Hz square wave  */
#define   RTC_MR_OUT0_FREQ32HZ_Val          _U(0x2)                                        /**< (RTC_MR) 32 Hz square wave  */
#define   RTC_MR_OUT0_FREQ64HZ_Val          _U(0x3)                                        /**< (RTC_MR) 64 Hz square wave  */
#define   RTC_MR_OUT0_FREQ512HZ_Val         _U(0x4)                                        /**< (RTC_MR) 512 Hz square wave  */
#define   RTC_MR_OUT0_ALARM_FLAG_Val        _U(0x6)                                        /**< (RTC_MR) Output is a copy of the alarm flag  */
...
#define RTC_MR_OUT1_Msk                     (_U(0x7) << RTC_MR_OUT1_Pos)                   /**< (RTC_MR) ADC Last Channel Trigger Event Source Selection Mask */
#define RTC_MR_OUT1(value)                  (RTC_MR_OUT1_Msk & ((value) << RTC_MR_OUT1_Pos))
#define   RTC_MR_OUT1_NO_WAVE_Val           _U(0x0)                                        /**< (RTC_MR) No waveform, stuck at '0'  */
#define   RTC_MR_OUT1_FREQ1HZ_Val           _U(0x1)                                        /**< (RTC_MR) 1 Hz square wave  */
#define   RTC_MR_OUT1_FREQ32HZ_Val          _U(0x2)                                        /**< (RTC_MR) 32 Hz square wave  */
#define   RTC_MR_OUT1_FREQ64HZ_Val          _U(0x3)                                        /**< (RTC_MR) 64 Hz square wave  */
#define   RTC_MR_OUT1_FREQ512HZ_Val         _U(0x4)                                        /**< (RTC_MR) 512 Hz square wave  */
#define   RTC_MR_OUT1_ALARM_FLAG_Val        _U(0x6)                                        /**< (RTC_MR) Output is a copy of the alarm flag  */
...
#define RTC_MR_MASK                         _U(0x77FF13)                                   /**< \deprecated (RTC_MR) Register MASK  (Use RTC_MR_Msk instead)  */
#define RTC_MR_Msk                          _U(0x77FF13)                                   /**< (RTC_MR) Register Mask  */
...
#define RTC_TIMR_SEC_Msk                    (_U(0x7F) << RTC_TIMR_SEC_Pos)                 /**< (RTC_TIMR) Current Second Mask */
...
#define RTC_TIMR_MIN_Msk                    (_U(0x7F) << RTC_TIMR_MIN_Pos)                 /**< (RTC_TIMR) Current Minute Mask */
...
#define RTC_TIMR_HOUR_Msk                   (_U(0x3F) << RTC_TIMR_HOUR_Pos)                /**< (RTC_TIMR) Current Hour Mask */
...
#define RTC_TIMR_AMPM_Msk                   (_U(0x1) << RTC_TIMR_AMPM_Pos)                 /**< (RTC_TIMR) Ante Meridiem Post Meridiem Indicator Mask */
...
#define RTC_TIMR_MASK                       _U(0x7F7F7F)                                   /**< \deprecated (RTC_TIMR) Register MASK  (Use RTC_TIMR_Msk instead)  */
#define RTC_TIMR_Msk                        _U(0x7F7F7F)                                   /**< (RTC_TIMR) Register Mask  */
...
#define RTC_CALR_CENT_Msk                   (_U(0x7F) << RTC_CALR_CENT_Pos)                /**< (RTC_CALR) Current Century Mask */
...
#define RTC_CALR_YEAR_Msk                   (_U(0xFF) << RTC_CALR_YEAR_Pos)                /**< (RTC_CALR) Current Year Mask */
...
#define RTC_CALR_MONTH_Msk                  (_U(0x1F) << RTC_CALR_MONTH_Pos)               /**< (RTC_CALR) Current Month Mask */
...
#define RTC_CALR_DAY_Msk                    (_U(0x7) << RTC_CALR_DAY_Pos)                  /**< (RTC_CALR) Current Day in Current Week Mask */
...
#define RTC_CALR_DATE_Msk                   (_U(0x3F) << RTC_CALR_DATE_Pos)                /**< (RTC_CALR) Current Day in Current Month Mask */
#define RTC_CALR_DATE(value)                (RTC_CALR_DATE_Msk & ((value) << RTC_CALR_DATE_Pos))
#define RTC_CALR_MASK                       _U(0x3FFFFF7F)                                 /**< \deprecated (RTC_CALR) Register MASK  (Use RTC_CALR_Msk instead)  */
#define RTC_CALR_Msk                        _U(0x3FFFFF7F)                                 /**< (RTC_CALR) Register Mask  */
...
#define RTC_TIMALR_SEC_Msk                  (_U(0x7F) << RTC_TIMALR_SEC_Pos)               /**< (RTC_TIMALR) Second Alarm Mask */
...
#define RTC_TIMALR_SECEN_Msk                (_U(0x1) << RTC_TIMALR_SECEN_Pos)              /**< (RTC_TIMALR) Second Alarm Enable Mask */
...
#define RTC_TIMALR_MIN_Msk                  (_U(0x7F) << RTC_TIMALR_MIN_Pos)               /**< (RTC_TIMALR) Minute Alarm Mask */
...
#define RTC_TIMALR_MINEN_Msk                (_U(0x1) << RTC_TIMALR_MINEN_Pos)              /**< (RTC_TIMALR) Minute Alarm Enable Mask */
...
#define RTC_TIMALR_HOUR_Msk                 (_U(0x3F) << RTC_TIMALR_HOUR_Pos)              /**< (RTC_TIMALR) Hour Alarm Mask */
...
#define RTC_TIMALR_AMPM_Msk                 (_U(0x1) << RTC_TIMALR_AMPM_Pos)               /**< (RTC_TIMALR) AM/PM Indicator Mask */
...
#define RTC_TIMALR_HOUREN_Msk               (_U(0x1) << RTC_TIMALR_HOUREN_Pos)             /**< (RTC_TIMALR) Hour Alarm Enable Mask */
...
#define RTC_TIMALR_MASK                     _U(0xFFFFFF)                                   /**< \deprecated (RTC_TIMALR) Register MASK  (Use RTC_TIMALR_Msk instead)  */
#define RTC_TIMALR_Msk                      _U(0xFFFFFF)                                   /**< (RTC_TIMALR) Register Mask  */
...
#define RTC_CALALR_MONTH_Msk                (_U(0x1F) << RTC_CALALR_MONTH_Pos)             /**< (RTC_CALALR) Month Alarm Mask */
#define RTC_CALALR_MONTH(value)             (RTC_CALALR_MONTH_Msk & ((value) << RTC_CALALR_MONTH_Pos))
#define RTC_CALALR_MTHEN_Pos                23                                             /**< (RTC_CALALR) Month Alarm Enable Position */
#define RTC_CALALR_MTHEN_Msk                (_U(0x1) << RTC_CALALR_MTHEN_Pos)              /**< (RTC_CALALR) Month Alarm Enable Mask */
...
#define RTC_CALALR_DATE_Msk                 (_U(0x3F) << RTC_CALALR_DATE_Pos)              /**< (RTC_CALALR) Date Alarm Mask */
...
#define RTC_CALALR_DATEEN_Msk               (_U(0x1) << RTC_CALALR_DATEEN_Pos)             /**< (RTC_CALALR) Date Alarm Enable Mask */
...
#define RTC_CALALR_MASK                     _U(0xBF9F0000)                                 /**< \deprecated (RTC_CALALR) Register MASK  (Use RTC_CALALR_Msk instead)  */
#define RTC_CALALR_Msk                      _U(0xBF9F0000)                                 /**< (RTC_CALALR) Register Mask  */
...
#define RTC_SR_ACKUPD_Msk                   (_U(0x1) << RTC_SR_ACKUPD_Pos)                 /**< (RTC_SR) Acknowledge for Update Mask */
...
#define   RTC_SR_ACKUPD_FREERUN_Val         _U(0x0)                                        /**< (RTC_SR) Time and calendar registers cannot be updated.  */
#define   RTC_SR_ACKUPD_UPDATE_Val          _U(0x1)                                        /**< (RTC_SR) Time and calendar registers can be updated.  */
...
#define RTC_SR_ALARM_Msk                    (_U(0x1) << RTC_SR_ALARM_Pos)                  /**< (RTC_SR) Alarm Flag Mask */
...
#define   RTC_SR_ALARM_NO_ALARMEVENT_Val    _U(0x0)                                        /**< (RTC_SR) No alarm matching condition occurred.  */
#define   RTC_SR_ALARM_ALARMEVENT_Val       _U(0x1)                                        /**< (RTC_SR) An alarm matching condition has occurred.  */
...
#define RTC_SR_SEC_Msk                      (_U(0x1) << RTC_SR_SEC_Pos)                    /**< (RTC_SR) Second Event Mask */
#define RTC_SR_SEC                          RTC_SR_SEC_Msk                                 /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_SR_SEC_Msk instead */
#define   RTC_SR_SEC_NO_SECEVENT_Val        _U(0x0)                                        /**< (RTC_SR) No second event has occurred since the last clear.  */
#define   RTC_SR_SEC_SECEVENT_Val           _U(0x1)                                        /**< (RTC_SR) At least one second event has occurred since the last clear.  */
...
#define RTC_SR_TIMEV_Msk                    (_U(0x1) << RTC_SR_TIMEV_Pos)                  /**< (RTC_SR) Time Event Mask */
...
#define   RTC_SR_TIMEV_NO_TIMEVENT_Val      _U(0x0)                                        /**< (RTC_SR) No time event has occurred since the last clear.  */
#define   RTC_SR_TIMEV_TIMEVENT_Val         _U(0x1)                                        /**< (RTC_SR) At least one time event has occurred since the last clear.  */
...
#define RTC_SR_CALEV_Msk                    (_U(0x1) << RTC_SR_CALEV_Pos)                  /**< (RTC_SR) Calendar Event Mask */
...
#define   RTC_SR_CALEV_NO_CALEVENT_Val      _U(0x0)                                        /**< (RTC_SR) No calendar event has occurred since the last clear.  */
#define   RTC_SR_CALEV_CALEVENT_Val         _U(0x1)                                        /**< (RTC_SR) At least one calendar event has occurred since the last clear.  */
...
#define RTC_SR_TDERR_Msk                    (_U(0x1) << RTC_SR_TDERR_Pos)                  /**< (RTC_SR) Time and/or Date Free Running Error Mask */
...
#define   RTC_SR_TDERR_CORRECT_Val          _U(0x0)                                        /**< (RTC_SR) The internal free running counters are carrying valid values since the last read of the Status Register (RTC_SR).  */
#define   RTC_SR_TDERR_ERR_TIMEDATE_Val     _U(0x1)                                        /**< (RTC_SR) The internal free running counters have been corrupted (invalid date or time, non-BCD values) since the last read and/or they are still invalid.  */
...
#define RTC_SR_MASK                         _U(0x3F)                                       /**< \deprecated (RTC_SR) Register MASK  (Use RTC_SR_Msk instead)  */
#define RTC_SR_Msk                          _U(0x3F)                                       /**< (RTC_SR) Register Mask  */
...
#define RTC_SCCR_ACKCLR_Msk                 (_U(0x1) << RTC_SCCR_ACKCLR_Pos)               /**< (RTC_SCCR) Acknowledge Clear Mask */
...
#define RTC_SCCR_ALRCLR_Msk                 (_U(0x1) << RTC_SCCR_ALRCLR_Pos)               /**< (RTC_SCCR) Alarm Clear Mask */
...
#define RTC_SCCR_SECCLR_Msk                 (_U(0x1) << RTC_SCCR_SECCLR_Pos)               /**< (RTC_SCCR) Second Clear Mask */
...
#define RTC_SCCR_TIMCLR_Msk                 (_U(0x1) << RTC_SCCR_TIMCLR_Pos)               /**< (RTC_SCCR) Time Clear Mask */
...
#define RTC_SCCR_CALCLR_Msk                 (_U(0x1) << RTC_SCCR_CALCLR_Pos)               /**< (RTC_SCCR) Calendar Clear Mask */
...
#define RTC_SCCR_TDERRCLR_Msk               (_U(0x1) << RTC_SCCR_TDERRCLR_Pos)             /**< (RTC_SCCR) Time and/or Date Free Running Error Clear Mask */
...
#define RTC_SCCR_MASK                       _U(0x3F)                                       /**< \deprecated (RTC_SCCR) Register MASK  (Use RTC_SCCR_Msk instead)  */
#define RTC_SCCR_Msk                        _U(0x3F)                                       /**< (RTC_SCCR) Register Mask  */
...
#define RTC_IER_ACKEN_Msk                   (_U(0x1) << RTC_IER_ACKEN_Pos)                 /**< (RTC_IER) Acknowledge Update Interrupt Enable Mask */
...
#define RTC_IER_ALREN_Msk                   (_U(0x1) << RTC_IER_ALREN_Pos)                 /**< (RTC_IER) Alarm Interrupt Enable Mask */
...
#define RTC_IER_SECEN_Msk                   (_U(0x1) << RTC_IER_SECEN_Pos)                 /**< (RTC_IER) Second Event Interrupt Enable Mask */
...
#define RTC_IER_TIMEN_Msk                   (_U(0x1) << RTC_IER_TIMEN_Pos)                 /**< (RTC_IER) Time Event Interrupt Enable Mask */
...
#define RTC_IER_CALEN_Msk                   (_U(0x1) << RTC_IER_CALEN_Pos)                 /**< (RTC_IER) Calendar Event Interrupt Enable Mask */
...
#define RTC_IER_TDERREN_Msk                 (_U(0x1) << RTC_IER_TDERREN_Pos)               /**< (RTC_IER) Time and/or Date Error Interrupt Enable Mask */
...
#define RTC_IER_MASK                        _U(0x3F)                                       /**< \deprecated (RTC_IER) Register MASK  (Use RTC_IER_Msk instead)  */
#define RTC_IER_Msk                         _U(0x3F)                                       /**< (RTC_IER) Register Mask  */
...
#define RTC_IDR_ACKDIS_Msk                  (_U(0x1) << RTC_IDR_ACKDIS_Pos)                /**< (RTC_IDR) Acknowledge Update Interrupt Disable Mask */
...
#define RTC_IDR_ALRDIS_Msk                  (_U(0x1) << RTC_IDR_ALRDIS_Pos)                /**< (RTC_IDR) Alarm Interrupt Disable Mask */
...
#define RTC_IDR_SECDIS_Msk                  (_U(0x1) << RTC_IDR_SECDIS_Pos)                /**< (RTC_IDR) Second Event Interrupt Disable Mask */
...
#define RTC_IDR_TIMDIS_Msk                  (_U(0x1) << RTC_IDR_TIMDIS_Pos)                /**< (RTC_IDR) Time Event Interrupt Disable Mask */
...
#define RTC_IDR_CALDIS_Msk                  (_U(0x1) << RTC_IDR_CALDIS_Pos)                /**< (RTC_IDR) Calendar Event Interrupt Disable Mask */
...
#define RTC_IDR_TDERRDIS_Msk                (_U(0x1) << RTC_IDR_TDERRDIS_Pos)              /**< (RTC_IDR) Time and/or Date Error Interrupt Disable Mask */
...
#define RTC_IDR_MASK                        _U(0x3F)                                       /**< \deprecated (RTC_IDR) Register MASK  (Use RTC_IDR_Msk instead)  */
#define RTC_IDR_Msk                         _U(0x3F)                                       /**< (RTC_IDR) Register Mask  */
...
#define RTC_IMR_ACK_Msk                     (_U(0x1) << RTC_IMR_ACK_Pos)                   /**< (RTC_IMR) Acknowledge Update Interrupt Mask Mask */
...
#define RTC_IMR_ALR_Msk                     (_U(0x1) << RTC_IMR_ALR_Pos)                   /**< (RTC_IMR) Alarm Interrupt Mask Mask */
...
#define RTC_IMR_SEC_Msk                     (_U(0x1) << RTC_IMR_SEC_Pos)                   /**< (RTC_IMR) Second Event Interrupt Mask Mask */
...
#define RTC_IMR_TIM_Msk                     (_U(0x1) << RTC_IMR_TIM_Pos)                   /**< (RTC_IMR) Time Event Interrupt Mask Mask */
...
#define RTC_IMR_CAL_Msk                     (_U(0x1) << RTC_IMR_CAL_Pos)                   /**< (RTC_IMR) Calendar Event Interrupt Mask Mask */
...
#define RTC_IMR_TDERR_Msk                   (_U(0x1) << RTC_IMR_TDERR_Pos)                 /**< (RTC_IMR) Time and/or Date Error Mask Mask */
...
#define RTC_IMR_MASK                        _U(0x3F)                                       /**< \deprecated (RTC_IMR) Register MASK  (Use RTC_IMR_Msk instead)  */
#define RTC_IMR_Msk                         _U(0x3F)                                       /**< (RTC_IMR) Register Mask  */
...
#define RTC_VER_NVTIM_Msk                   (_U(0x1) << RTC_VER_NVTIM_Pos)                 /**< (RTC_VER) Non-valid Time Mask */
...
#define RTC_VER_NVCAL_Msk                   (_U(0x1) << RTC_VER_NVCAL_Pos)                 /**< (RTC_VER) Non-valid Calendar Mask */
...
#define RTC_VER_NVTIMALR_Msk                (_U(0x1) << RTC_VER_NVTIMALR_Pos)              /**< (RTC_VER) Non-valid Time Alarm Mask */
...
#define RTC_VER_NVCALALR_Msk                (_U(0x1) << RTC_VER_NVCALALR_Pos)              /**< (RTC_VER) Non-valid Calendar Alarm Mask */
...
#define RTC_VER_MASK                        _U(0x0F)                                       /**< \deprecated (RTC_VER) Register MASK  (Use RTC_VER_Msk instead)  */
#define RTC_VER_Msk                         _U(0x0F)                                       /**< (RTC_VER) Register Mask  */
...
#define RTC_MSR_MS_Msk                      (_U(0x3FF) << RTC_MSR_MS_Pos)                  /**< (RTC_MSR) Number of 1/1024 seconds elapsed within 1 second Mask */
#define RTC_MSR_MS(value)                   (RTC_MSR_MS_Msk & ((value) << RTC_MSR_MS_Pos))
#define RTC_MSR_MASK                        _U(0x3FF)                                      /**< \deprecated (RTC_MSR) Register MASK  (Use RTC_MSR_Msk instead)  */
#define RTC_MSR_Msk                         _U(0x3FF)                                      /**< (RTC_MSR) Register Mask  */
...
#define RTC_WPMR_WPEN_Msk                   (_U(0x1) << RTC_WPMR_WPEN_Pos)                 /**< (RTC_WPMR) Write Protection Enable Mask */
...
#define RTC_WPMR_WPKEY_Msk                  (_U(0xFFFFFF) << RTC_WPMR_WPKEY_Pos)           /**< (RTC_WPMR) Write Protection Key Mask */
#define RTC_WPMR_WPKEY(value)               (RTC_WPMR_WPKEY_Msk & ((value) << RTC_WPMR_WPKEY_Pos))
#define   RTC_WPMR_WPKEY_PASSWD_Val         _U(0x525443)                                   /**< (RTC_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit.Always reads as 0.  */
...
#define RTC_WPMR_MASK                       _U(0xFFFFFF01)                                 /**< \deprecated (RTC_WPMR) Register MASK  (Use RTC_WPMR_Msk instead)  */
#define RTC_WPMR_Msk                        _U(0xFFFFFF01)                                 /**< (RTC_WPMR) Register Mask  */
