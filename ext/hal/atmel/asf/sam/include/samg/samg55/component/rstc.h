...
#define RSTC_CR_PROCRST_Msk                 (_U(0x1) << RSTC_CR_PROCRST_Pos)               /**< (RSTC_CR) Processor Reset Mask */
...
#define RSTC_CR_PERRST_Msk                  (_U(0x1) << RSTC_CR_PERRST_Pos)                /**< (RSTC_CR) Peripheral Reset Mask */
...
#define RSTC_CR_EXTRST_Msk                  (_U(0x1) << RSTC_CR_EXTRST_Pos)                /**< (RSTC_CR) External Reset Mask */
...
#define RSTC_CR_KEY_Msk                     (_U(0xFF) << RSTC_CR_KEY_Pos)                  /**< (RSTC_CR) System Reset Key Mask */
#define RSTC_CR_KEY(value)                  (RSTC_CR_KEY_Msk & ((value) << RSTC_CR_KEY_Pos))
#define   RSTC_CR_KEY_PASSWD_Val            _U(0xA5)                                       /**< (RSTC_CR) Writing any other value in this field aborts the write operation.  */
...
#define RSTC_CR_MASK                        _U(0xFF00000D)                                 /**< \deprecated (RSTC_CR) Register MASK  (Use RSTC_CR_Msk instead)  */
#define RSTC_CR_Msk                         _U(0xFF00000D)                                 /**< (RSTC_CR) Register Mask  */
...
#define RSTC_SR_URSTS_Msk                   (_U(0x1) << RSTC_SR_URSTS_Pos)                 /**< (RSTC_SR) User Reset Status Mask */
...
#define RSTC_SR_RSTTYP_Msk                  (_U(0x7) << RSTC_SR_RSTTYP_Pos)                /**< (RSTC_SR) Reset Type Mask */
#define RSTC_SR_RSTTYP(value)               (RSTC_SR_RSTTYP_Msk & ((value) << RSTC_SR_RSTTYP_Pos))
#define   RSTC_SR_RSTTYP_GENERAL_RST_Val    _U(0x0)                                        /**< (RSTC_SR) First power-up reset  */
#define   RSTC_SR_RSTTYP_BACKUP_RST_Val     _U(0x1)                                        /**< (RSTC_SR) Return from Backup Mode  */
#define   RSTC_SR_RSTTYP_WDT_RST_Val        _U(0x2)                                        /**< (RSTC_SR) Watchdog fault occurred  */
#define   RSTC_SR_RSTTYP_SOFT_RST_Val       _U(0x3)                                        /**< (RSTC_SR) Processor reset required by the software  */
#define   RSTC_SR_RSTTYP_USER_RST_Val       _U(0x4)                                        /**< (RSTC_SR) NRST pin detected low  */
#define   RSTC_SR_RSTTYP_SLCK_XTAL_RST_Val  _U(0x7)                                        /**< (RSTC_SR) Slow Crystal Failure Detection fault occured  */
...
#define RSTC_SR_NRSTL_Msk                   (_U(0x1) << RSTC_SR_NRSTL_Pos)                 /**< (RSTC_SR) NRST Pin Level Mask */
...
#define RSTC_SR_SRCMP_Msk                   (_U(0x1) << RSTC_SR_SRCMP_Pos)                 /**< (RSTC_SR) Software Reset Command in Progress Mask */
...
#define RSTC_SR_MASK                        _U(0x30701)                                    /**< \deprecated (RSTC_SR) Register MASK  (Use RSTC_SR_Msk instead)  */
#define RSTC_SR_Msk                         _U(0x30701)                                    /**< (RSTC_SR) Register Mask  */
...
#define RSTC_MR_URSTEN_Msk                  (_U(0x1) << RSTC_MR_URSTEN_Pos)                /**< (RSTC_MR) User Reset Enable Mask */
...
#define RSTC_MR_SCKSW_Msk                   (_U(0x1) << RSTC_MR_SCKSW_Pos)                 /**< (RSTC_MR) Slow Clock Switching Mask */
...
#define RSTC_MR_URSTIEN_Msk                 (_U(0x1) << RSTC_MR_URSTIEN_Pos)               /**< (RSTC_MR) User Reset Interrupt Enable Mask */
...
#define RSTC_MR_ERSTL_Msk                   (_U(0xF) << RSTC_MR_ERSTL_Pos)                 /**< (RSTC_MR) External Reset Length Mask */
...
#define RSTC_MR_KEY_Msk                     (_U(0xFF) << RSTC_MR_KEY_Pos)                  /**< (RSTC_MR) Write Access Password Mask */
#define RSTC_MR_KEY(value)                  (RSTC_MR_KEY_Msk & ((value) << RSTC_MR_KEY_Pos))
#define   RSTC_MR_KEY_PASSWD_Val            _U(0xA5)                                       /**< (RSTC_MR) Writing any other value in this field aborts the write operation.Always reads as 0.  */
...
#define RSTC_MR_MASK                        _U(0xFF000F13)                                 /**< \deprecated (RSTC_MR) Register MASK  (Use RSTC_MR_Msk instead)  */
#define RSTC_MR_Msk                         _U(0xFF000F13)                                 /**< (RSTC_MR) Register Mask  */
