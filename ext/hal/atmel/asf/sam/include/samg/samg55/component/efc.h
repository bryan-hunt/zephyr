...
#define EEFC_FMR_FRDY_Msk                   (_U(0x1) << EEFC_FMR_FRDY_Pos)                 /**< (EEFC_FMR) Flash Ready Interrupt Enable Mask */
...
#define EEFC_FMR_FWS_Msk                    (_U(0xF) << EEFC_FMR_FWS_Pos)                  /**< (EEFC_FMR) Flash Wait State Mask */
#define EEFC_FMR_FWS(value)                 (EEFC_FMR_FWS_Msk & ((value) << EEFC_FMR_FWS_Pos))
#define EEFC_FMR_SCOD_Pos                   16                                             /**< (EEFC_FMR) Sequential Code Optimization Disable Position */
#define EEFC_FMR_SCOD_Msk                   (_U(0x1) << EEFC_FMR_SCOD_Pos)                 /**< (EEFC_FMR) Sequential Code Optimization Disable Mask */
...
#define EEFC_FMR_FAM_Msk                    (_U(0x1) << EEFC_FMR_FAM_Pos)                  /**< (EEFC_FMR) Flash Access Mode Mask */
...
#define EEFC_FMR_CLOE_Msk                   (_U(0x1) << EEFC_FMR_CLOE_Pos)                 /**< (EEFC_FMR) Code Loop Optimization Enable Mask */
...
#define EEFC_FMR_MASK                       _U(0x5010F01)                                  /**< \deprecated (EEFC_FMR) Register MASK  (Use EEFC_FMR_Msk instead)  */
#define EEFC_FMR_Msk                        _U(0x5010F01)                                  /**< (EEFC_FMR) Register Mask  */
...
#define EEFC_FCR_FCMD_Msk                   (_U(0xFF) << EEFC_FCR_FCMD_Pos)                /**< (EEFC_FCR) Flash Command Mask */
#define EEFC_FCR_FCMD(value)                (EEFC_FCR_FCMD_Msk & ((value) << EEFC_FCR_FCMD_Pos))
#define   EEFC_FCR_FCMD_GETD_Val            _U(0x0)                                        /**< (EEFC_FCR) Get Flash descriptor  */
#define   EEFC_FCR_FCMD_WP_Val              _U(0x1)                                        /**< (EEFC_FCR) Write page  */
#define   EEFC_FCR_FCMD_WPL_Val             _U(0x2)                                        /**< (EEFC_FCR) Write page and lock  */
#define   EEFC_FCR_FCMD_EWP_Val             _U(0x3)                                        /**< (EEFC_FCR) Erase page and write page  */
#define   EEFC_FCR_FCMD_EWPL_Val            _U(0x4)                                        /**< (EEFC_FCR) Erase page and write page then lock  */
#define   EEFC_FCR_FCMD_EA_Val              _U(0x5)                                        /**< (EEFC_FCR) Erase all  */
#define   EEFC_FCR_FCMD_EPA_Val             _U(0x7)                                        /**< (EEFC_FCR) Erase pages  */
#define   EEFC_FCR_FCMD_SLB_Val             _U(0x8)                                        /**< (EEFC_FCR) Set lock bit  */
#define   EEFC_FCR_FCMD_CLB_Val             _U(0x9)                                        /**< (EEFC_FCR) Clear lock bit  */
#define   EEFC_FCR_FCMD_GLB_Val             _U(0xA)                                        /**< (EEFC_FCR) Get lock bit  */
#define   EEFC_FCR_FCMD_SGPB_Val            _U(0xB)                                        /**< (EEFC_FCR) Set GPNVM bit  */
#define   EEFC_FCR_FCMD_CGPB_Val            _U(0xC)                                        /**< (EEFC_FCR) Clear GPNVM bit  */
#define   EEFC_FCR_FCMD_GGPB_Val            _U(0xD)                                        /**< (EEFC_FCR) Get GPNVM bit  */
#define   EEFC_FCR_FCMD_STUI_Val            _U(0xE)                                        /**< (EEFC_FCR) Start read unique identifier  */
#define   EEFC_FCR_FCMD_SPUI_Val            _U(0xF)                                        /**< (EEFC_FCR) Stop read unique identifier  */
#define   EEFC_FCR_FCMD_GCALB_Val           _U(0x10)                                       /**< (EEFC_FCR) Get CALIB bit  */
#define   EEFC_FCR_FCMD_ES_Val              _U(0x11)                                       /**< (EEFC_FCR) Erase sector  */
#define   EEFC_FCR_FCMD_WUS_Val             _U(0x12)                                       /**< (EEFC_FCR) Write user signature  */
#define   EEFC_FCR_FCMD_EUS_Val             _U(0x13)                                       /**< (EEFC_FCR) Erase user signature  */
#define   EEFC_FCR_FCMD_STUS_Val            _U(0x14)                                       /**< (EEFC_FCR) Start read user signature  */
#define   EEFC_FCR_FCMD_SPUS_Val            _U(0x15)                                       /**< (EEFC_FCR) Stop read user signature  */
...
#define EEFC_FCR_FARG_Msk                   (_U(0xFFFF) << EEFC_FCR_FARG_Pos)              /**< (EEFC_FCR) Flash Command Argument Mask */
...
#define EEFC_FCR_FKEY_Msk                   (_U(0xFF) << EEFC_FCR_FKEY_Pos)                /**< (EEFC_FCR) Flash Writing Protection Key Mask */
#define EEFC_FCR_FKEY(value)                (EEFC_FCR_FKEY_Msk & ((value) << EEFC_FCR_FKEY_Pos))
#define   EEFC_FCR_FKEY_PASSWD_Val          _U(0x5A)                                       /**< (EEFC_FCR) The 0x5A value enables the command defined by the bits of the register. If the field is written with a different value, the write is not performed and no action is started.  */
...
#define EEFC_FCR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (EEFC_FCR) Register MASK  (Use EEFC_FCR_Msk instead)  */
#define EEFC_FCR_Msk                        _U(0xFFFFFFFF)                                 /**< (EEFC_FCR) Register Mask  */
...
#define EEFC_FSR_FRDY_Msk                   (_U(0x1) << EEFC_FSR_FRDY_Pos)                 /**< (EEFC_FSR) Flash Ready Status (cleared when Flash is busy) Mask */
...
#define EEFC_FSR_FCMDE_Msk                  (_U(0x1) << EEFC_FSR_FCMDE_Pos)                /**< (EEFC_FSR) Flash Command Error Status (cleared on read or by writing EEFC_FCR) Mask */
...
#define EEFC_FSR_FLOCKE_Msk                 (_U(0x1) << EEFC_FSR_FLOCKE_Pos)               /**< (EEFC_FSR) Flash Lock Error Status (cleared on read) Mask */
...
#define EEFC_FSR_FLERR_Msk                  (_U(0x1) << EEFC_FSR_FLERR_Pos)                /**< (EEFC_FSR) Flash Error Status (cleared when a programming operation starts) Mask */
...
#define EEFC_FSR_MASK                       _U(0x0F)                                       /**< \deprecated (EEFC_FSR) Register MASK  (Use EEFC_FSR_Msk instead)  */
#define EEFC_FSR_Msk                        _U(0x0F)                                       /**< (EEFC_FSR) Register Mask  */
...
#define EEFC_FRR_FVALUE_Msk                 (_U(0xFFFFFFFF) << EEFC_FRR_FVALUE_Pos)        /**< (EEFC_FRR) Flash Result Value Mask */
#define EEFC_FRR_FVALUE(value)              (EEFC_FRR_FVALUE_Msk & ((value) << EEFC_FRR_FVALUE_Pos))
#define EEFC_FRR_MASK                       _U(0xFFFFFFFF)                                 /**< \deprecated (EEFC_FRR) Register MASK  (Use EEFC_FRR_Msk instead)  */
#define EEFC_FRR_Msk                        _U(0xFFFFFFFF)                                 /**< (EEFC_FRR) Register Mask  */
...
#define EEFC_WPMR_WPEN_Msk                  (_U(0x1) << EEFC_WPMR_WPEN_Pos)                /**< (EEFC_WPMR) Write Protection Enable Mask */
...
#define EEFC_WPMR_WPKEY_Msk                 (_U(0xFFFFFF) << EEFC_WPMR_WPKEY_Pos)          /**< (EEFC_WPMR) Write Protection Key Mask */
#define EEFC_WPMR_WPKEY(value)              (EEFC_WPMR_WPKEY_Msk & ((value) << EEFC_WPMR_WPKEY_Pos))
#define   EEFC_WPMR_WPKEY_PASSWD_Val        _U(0x454643)                                   /**< (EEFC_WPMR) Writing any other value in this field aborts the write operation.Always reads as 0.  */
...
#define EEFC_WPMR_MASK                      _U(0xFFFFFF01)                                 /**< \deprecated (EEFC_WPMR) Register MASK  (Use EEFC_WPMR_Msk instead)  */
#define EEFC_WPMR_Msk                       _U(0xFFFFFF01)                                 /**< (EEFC_WPMR) Register Mask  */
