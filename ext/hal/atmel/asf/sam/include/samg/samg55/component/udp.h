...
#define UDP_FRM_NUM_FRM_NUM_Msk             (_U(0x7FF) << UDP_FRM_NUM_FRM_NUM_Pos)         /**< (UDP_FRM_NUM) Frame Number as Defined in the Packet Field Formats Mask */
...
#define UDP_FRM_NUM_FRM_ERR_Msk             (_U(0x1) << UDP_FRM_NUM_FRM_ERR_Pos)           /**< (UDP_FRM_NUM) Frame Error Mask */
...
#define UDP_FRM_NUM_FRM_OK_Msk              (_U(0x1) << UDP_FRM_NUM_FRM_OK_Pos)            /**< (UDP_FRM_NUM) Frame OK Mask */
...
#define UDP_FRM_NUM_MASK                    _U(0x307FF)                                    /**< \deprecated (UDP_FRM_NUM) Register MASK  (Use UDP_FRM_NUM_Msk instead)  */
#define UDP_FRM_NUM_Msk                     _U(0x307FF)                                    /**< (UDP_FRM_NUM) Register Mask  */
...
#define UDP_GLB_STAT_FADDEN_Msk             (_U(0x1) << UDP_GLB_STAT_FADDEN_Pos)           /**< (UDP_GLB_STAT) Function Address Enable Mask */
...
#define UDP_GLB_STAT_CONFG_Msk              (_U(0x1) << UDP_GLB_STAT_CONFG_Pos)            /**< (UDP_GLB_STAT) Configured Mask */
...
#define UDP_GLB_STAT_ESR_Msk                (_U(0x1) << UDP_GLB_STAT_ESR_Pos)              /**< (UDP_GLB_STAT) Enable Send Resume Mask */
...
#define UDP_GLB_STAT_RSMINPR_Msk            (_U(0x1) << UDP_GLB_STAT_RSMINPR_Pos)          /**< (UDP_GLB_STAT)  Mask */
...
#define UDP_GLB_STAT_RMWUPE_Msk             (_U(0x1) << UDP_GLB_STAT_RMWUPE_Pos)           /**< (UDP_GLB_STAT) Remote Wakeup Enable Mask */
...
#define UDP_GLB_STAT_MASK                   _U(0x1F)                                       /**< \deprecated (UDP_GLB_STAT) Register MASK  (Use UDP_GLB_STAT_Msk instead)  */
#define UDP_GLB_STAT_Msk                    _U(0x1F)                                       /**< (UDP_GLB_STAT) Register Mask  */
...
#define UDP_FADDR_FADD_Msk                  (_U(0x7F) << UDP_FADDR_FADD_Pos)               /**< (UDP_FADDR) Function Address Value Mask */
...
#define UDP_FADDR_FEN_Msk                   (_U(0x1) << UDP_FADDR_FEN_Pos)                 /**< (UDP_FADDR) Function Enable Mask */
...
#define UDP_FADDR_MASK                      _U(0x17F)                                      /**< \deprecated (UDP_FADDR) Register MASK  (Use UDP_FADDR_Msk instead)  */
#define UDP_FADDR_Msk                       _U(0x17F)                                      /**< (UDP_FADDR) Register Mask  */
...
#define UDP_IER_EP0INT_Msk                  (_U(0x1) << UDP_IER_EP0INT_Pos)                /**< (UDP_IER) Enable Endpoint 0 Interrupt Mask */
...
#define UDP_IER_EP1INT_Msk                  (_U(0x1) << UDP_IER_EP1INT_Pos)                /**< (UDP_IER) Enable Endpoint 1 Interrupt Mask */
...
#define UDP_IER_EP2INT_Msk                  (_U(0x1) << UDP_IER_EP2INT_Pos)                /**< (UDP_IER) Enable Endpoint 2Interrupt Mask */
...
#define UDP_IER_EP3INT_Msk                  (_U(0x1) << UDP_IER_EP3INT_Pos)                /**< (UDP_IER) Enable Endpoint 3 Interrupt Mask */
...
#define UDP_IER_EP4INT_Msk                  (_U(0x1) << UDP_IER_EP4INT_Pos)                /**< (UDP_IER) Enable Endpoint 4 Interrupt Mask */
...
#define UDP_IER_EP5INT_Msk                  (_U(0x1) << UDP_IER_EP5INT_Pos)                /**< (UDP_IER) Enable Endpoint 5 Interrupt Mask */
...
#define UDP_IER_RXSUSP_Msk                  (_U(0x1) << UDP_IER_RXSUSP_Pos)                /**< (UDP_IER) Enable UDP Suspend Interrupt Mask */
...
#define UDP_IER_RXRSM_Msk                   (_U(0x1) << UDP_IER_RXRSM_Pos)                 /**< (UDP_IER) Enable UDP Resume Interrupt Mask */
...
#define UDP_IER_EXTRSM_Msk                  (_U(0x1) << UDP_IER_EXTRSM_Pos)                /**< (UDP_IER)  Mask */
...
#define UDP_IER_SOFINT_Msk                  (_U(0x1) << UDP_IER_SOFINT_Pos)                /**< (UDP_IER) Enable Start Of Frame Interrupt Mask */
...
#define UDP_IER_WAKEUP_Msk                  (_U(0x1) << UDP_IER_WAKEUP_Pos)                /**< (UDP_IER) Enable UDP Bus Wakeup Interrupt Mask */
...
#define UDP_IER_MASK                        _U(0x2F3F)                                     /**< \deprecated (UDP_IER) Register MASK  (Use UDP_IER_Msk instead)  */
#define UDP_IER_Msk                         _U(0x2F3F)                                     /**< (UDP_IER) Register Mask  */
...
#define UDP_IDR_EP0INT_Msk                  (_U(0x1) << UDP_IDR_EP0INT_Pos)                /**< (UDP_IDR) Disable Endpoint 0 Interrupt Mask */
...
#define UDP_IDR_EP1INT_Msk                  (_U(0x1) << UDP_IDR_EP1INT_Pos)                /**< (UDP_IDR) Disable Endpoint 1 Interrupt Mask */
...
#define UDP_IDR_EP2INT_Msk                  (_U(0x1) << UDP_IDR_EP2INT_Pos)                /**< (UDP_IDR) Disable Endpoint 2 Interrupt Mask */
...
#define UDP_IDR_EP3INT_Msk                  (_U(0x1) << UDP_IDR_EP3INT_Pos)                /**< (UDP_IDR) Disable Endpoint 3 Interrupt Mask */
...
#define UDP_IDR_EP4INT_Msk                  (_U(0x1) << UDP_IDR_EP4INT_Pos)                /**< (UDP_IDR) Disable Endpoint 4 Interrupt Mask */
...
#define UDP_IDR_EP5INT_Msk                  (_U(0x1) << UDP_IDR_EP5INT_Pos)                /**< (UDP_IDR) Disable Endpoint 5 Interrupt Mask */
...
#define UDP_IDR_RXSUSP_Msk                  (_U(0x1) << UDP_IDR_RXSUSP_Pos)                /**< (UDP_IDR) Disable UDP Suspend Interrupt Mask */
...
#define UDP_IDR_RXRSM_Msk                   (_U(0x1) << UDP_IDR_RXRSM_Pos)                 /**< (UDP_IDR) Disable UDP Resume Interrupt Mask */
...
#define UDP_IDR_EXTRSM_Msk                  (_U(0x1) << UDP_IDR_EXTRSM_Pos)                /**< (UDP_IDR)  Mask */
...
#define UDP_IDR_SOFINT_Msk                  (_U(0x1) << UDP_IDR_SOFINT_Pos)                /**< (UDP_IDR) Disable Start Of Frame Interrupt Mask */
...
#define UDP_IDR_WAKEUP_Msk                  (_U(0x1) << UDP_IDR_WAKEUP_Pos)                /**< (UDP_IDR) Disable USB Bus Interrupt Mask */
...
#define UDP_IDR_MASK                        _U(0x2F3F)                                     /**< \deprecated (UDP_IDR) Register MASK  (Use UDP_IDR_Msk instead)  */
#define UDP_IDR_Msk                         _U(0x2F3F)                                     /**< (UDP_IDR) Register Mask  */
...
#define UDP_IMR_EP0INT_Msk                  (_U(0x1) << UDP_IMR_EP0INT_Pos)                /**< (UDP_IMR) Mask Endpoint 0 Interrupt Mask */
...
#define UDP_IMR_EP1INT_Msk                  (_U(0x1) << UDP_IMR_EP1INT_Pos)                /**< (UDP_IMR) Mask Endpoint 1 Interrupt Mask */
...
#define UDP_IMR_EP2INT_Msk                  (_U(0x1) << UDP_IMR_EP2INT_Pos)                /**< (UDP_IMR) Mask Endpoint 2 Interrupt Mask */
...
#define UDP_IMR_EP3INT_Msk                  (_U(0x1) << UDP_IMR_EP3INT_Pos)                /**< (UDP_IMR) Mask Endpoint 3 Interrupt Mask */
...
#define UDP_IMR_EP4INT_Msk                  (_U(0x1) << UDP_IMR_EP4INT_Pos)                /**< (UDP_IMR) Mask Endpoint 4 Interrupt Mask */
...
#define UDP_IMR_EP5INT_Msk                  (_U(0x1) << UDP_IMR_EP5INT_Pos)                /**< (UDP_IMR) Mask Endpoint 5 Interrupt Mask */
...
#define UDP_IMR_RXSUSP_Msk                  (_U(0x1) << UDP_IMR_RXSUSP_Pos)                /**< (UDP_IMR) Mask UDP Suspend Interrupt Mask */
...
#define UDP_IMR_RXRSM_Msk                   (_U(0x1) << UDP_IMR_RXRSM_Pos)                 /**< (UDP_IMR) Mask UDP Resume Interrupt. Mask */
...
#define UDP_IMR_EXTRSM_Msk                  (_U(0x1) << UDP_IMR_EXTRSM_Pos)                /**< (UDP_IMR)  Mask */
...
#define UDP_IMR_SOFINT_Msk                  (_U(0x1) << UDP_IMR_SOFINT_Pos)                /**< (UDP_IMR) Mask Start Of Frame Interrupt Mask */
...
#define UDP_IMR_BIT12_Msk                   (_U(0x1) << UDP_IMR_BIT12_Pos)                 /**< (UDP_IMR) UDP_IMR Bit 12 Mask */
...
#define UDP_IMR_WAKEUP_Msk                  (_U(0x1) << UDP_IMR_WAKEUP_Pos)                /**< (UDP_IMR) USB Bus Wakeup Interrupt Mask */
...
#define UDP_IMR_MASK                        _U(0x3F3F)                                     /**< \deprecated (UDP_IMR) Register MASK  (Use UDP_IMR_Msk instead)  */
#define UDP_IMR_Msk                         _U(0x3F3F)                                     /**< (UDP_IMR) Register Mask  */
...
#define UDP_ISR_EP0INT_Msk                  (_U(0x1) << UDP_ISR_EP0INT_Pos)                /**< (UDP_ISR) Endpoint 0 Interrupt Status Mask */
...
#define UDP_ISR_EP1INT_Msk                  (_U(0x1) << UDP_ISR_EP1INT_Pos)                /**< (UDP_ISR) Endpoint 1 Interrupt Status Mask */
...
#define UDP_ISR_EP2INT_Msk                  (_U(0x1) << UDP_ISR_EP2INT_Pos)                /**< (UDP_ISR) Endpoint 2 Interrupt Status Mask */
...
#define UDP_ISR_EP3INT_Msk                  (_U(0x1) << UDP_ISR_EP3INT_Pos)                /**< (UDP_ISR) Endpoint 3 Interrupt Status Mask */
...
#define UDP_ISR_EP4INT_Msk                  (_U(0x1) << UDP_ISR_EP4INT_Pos)                /**< (UDP_ISR) Endpoint 4 Interrupt Status Mask */
...
#define UDP_ISR_EP5INT_Msk                  (_U(0x1) << UDP_ISR_EP5INT_Pos)                /**< (UDP_ISR) Endpoint 5 Interrupt Status Mask */
...
#define UDP_ISR_RXSUSP_Msk                  (_U(0x1) << UDP_ISR_RXSUSP_Pos)                /**< (UDP_ISR) UDP Suspend Interrupt Status Mask */
...
#define UDP_ISR_RXRSM_Msk                   (_U(0x1) << UDP_ISR_RXRSM_Pos)                 /**< (UDP_ISR) UDP Resume Interrupt Status Mask */
...
#define UDP_ISR_EXTRSM_Msk                  (_U(0x1) << UDP_ISR_EXTRSM_Pos)                /**< (UDP_ISR)  Mask */
...
#define UDP_ISR_SOFINT_Msk                  (_U(0x1) << UDP_ISR_SOFINT_Pos)                /**< (UDP_ISR) Start of Frame Interrupt Status Mask */
...
#define UDP_ISR_ENDBUSRES_Msk               (_U(0x1) << UDP_ISR_ENDBUSRES_Pos)             /**< (UDP_ISR) End of BUS Reset Interrupt Status Mask */
...
#define UDP_ISR_WAKEUP_Msk                  (_U(0x1) << UDP_ISR_WAKEUP_Pos)                /**< (UDP_ISR) UDP Resume Interrupt Status Mask */
...
#define UDP_ISR_MASK                        _U(0x3F3F)                                     /**< \deprecated (UDP_ISR) Register MASK  (Use UDP_ISR_Msk instead)  */
#define UDP_ISR_Msk                         _U(0x3F3F)                                     /**< (UDP_ISR) Register Mask  */
...
#define UDP_ICR_RXSUSP_Msk                  (_U(0x1) << UDP_ICR_RXSUSP_Pos)                /**< (UDP_ICR) Clear UDP Suspend Interrupt Mask */
...
#define UDP_ICR_RXRSM_Msk                   (_U(0x1) << UDP_ICR_RXRSM_Pos)                 /**< (UDP_ICR) Clear UDP Resume Interrupt Mask */
...
#define UDP_ICR_EXTRSM_Msk                  (_U(0x1) << UDP_ICR_EXTRSM_Pos)                /**< (UDP_ICR)  Mask */
...
#define UDP_ICR_SOFINT_Msk                  (_U(0x1) << UDP_ICR_SOFINT_Pos)                /**< (UDP_ICR) Clear Start Of Frame Interrupt Mask */
...
#define UDP_ICR_ENDBUSRES_Msk               (_U(0x1) << UDP_ICR_ENDBUSRES_Pos)             /**< (UDP_ICR) Clear End of Bus Reset Interrupt Mask */
...
#define UDP_ICR_WAKEUP_Msk                  (_U(0x1) << UDP_ICR_WAKEUP_Pos)                /**< (UDP_ICR) Clear Wakeup Interrupt Mask */
...
#define UDP_ICR_MASK                        _U(0x3F00)                                     /**< \deprecated (UDP_ICR) Register MASK  (Use UDP_ICR_Msk instead)  */
#define UDP_ICR_Msk                         _U(0x3F00)                                     /**< (UDP_ICR) Register Mask  */
...
#define UDP_RST_EP_EP0_Msk                  (_U(0x1) << UDP_RST_EP_EP0_Pos)                /**< (UDP_RST_EP) Reset Endpoint 0 Mask */
...
#define UDP_RST_EP_EP1_Msk                  (_U(0x1) << UDP_RST_EP_EP1_Pos)                /**< (UDP_RST_EP) Reset Endpoint 1 Mask */
...
#define UDP_RST_EP_EP2_Msk                  (_U(0x1) << UDP_RST_EP_EP2_Pos)                /**< (UDP_RST_EP) Reset Endpoint 2 Mask */
...
#define UDP_RST_EP_EP3_Msk                  (_U(0x1) << UDP_RST_EP_EP3_Pos)                /**< (UDP_RST_EP) Reset Endpoint 3 Mask */
...
#define UDP_RST_EP_EP4_Msk                  (_U(0x1) << UDP_RST_EP_EP4_Pos)                /**< (UDP_RST_EP) Reset Endpoint 4 Mask */
...
#define UDP_RST_EP_EP5_Msk                  (_U(0x1) << UDP_RST_EP_EP5_Pos)                /**< (UDP_RST_EP) Reset Endpoint 5 Mask */
...
#define UDP_RST_EP_EP_Msk                   (_U(0x3F) << UDP_RST_EP_EP_Pos)                /**< (UDP_RST_EP Mask) EP */
#define UDP_RST_EP_EP(value)                (UDP_RST_EP_EP_Msk & ((value) << UDP_RST_EP_EP_Pos))  
#define UDP_RST_EP_MASK                     _U(0x3F)                                       /**< \deprecated (UDP_RST_EP) Register MASK  (Use UDP_RST_EP_Msk instead)  */
#define UDP_RST_EP_Msk                      _U(0x3F)                                       /**< (UDP_RST_EP) Register Mask  */
...
#define UDP_CSR_TXCOMP_Msk                  (_U(0x1) << UDP_CSR_TXCOMP_Pos)                /**< (UDP_CSR) Generates an IN Packet with Data Previously Written in the DPR Mask */
...
#define UDP_CSR_RX_DATA_BK0_Msk             (_U(0x1) << UDP_CSR_RX_DATA_BK0_Pos)           /**< (UDP_CSR) Receive Data Bank 0 Mask */
...
#define UDP_CSR_RXSETUP_Msk                 (_U(0x1) << UDP_CSR_RXSETUP_Pos)               /**< (UDP_CSR) Received Setup Mask */
...
#define UDP_CSR_STALLSENT_Msk               (_U(0x1) << UDP_CSR_STALLSENT_Pos)             /**< (UDP_CSR) Stall Sent Mask */
...
#define UDP_CSR_TXPKTRDY_Msk                (_U(0x1) << UDP_CSR_TXPKTRDY_Pos)              /**< (UDP_CSR) Transmit Packet Ready Mask */
...
#define UDP_CSR_FORCESTALL_Msk              (_U(0x1) << UDP_CSR_FORCESTALL_Pos)            /**< (UDP_CSR) Force Stall (used by Control, Bulk and Isochronous Endpoints) Mask */
...
#define UDP_CSR_RX_DATA_BK1_Msk             (_U(0x1) << UDP_CSR_RX_DATA_BK1_Pos)           /**< (UDP_CSR) Receive Data Bank 1 (only used by endpoints with ping-pong attributes) Mask */
...
#define UDP_CSR_DIR_Msk                     (_U(0x1) << UDP_CSR_DIR_Pos)                   /**< (UDP_CSR) Transfer Direction (only available for control endpoints) (Read/Write) Mask */
...
#define UDP_CSR_EPTYPE_Msk                  (_U(0x7) << UDP_CSR_EPTYPE_Pos)                /**< (UDP_CSR) Endpoint Type (Read/Write) Mask */
#define UDP_CSR_EPTYPE(value)               (UDP_CSR_EPTYPE_Msk & ((value) << UDP_CSR_EPTYPE_Pos))
#define   UDP_CSR_EPTYPE_CTRL_Val           _U(0x0)                                        /**< (UDP_CSR) Control  */
#define   UDP_CSR_EPTYPE_ISO_OUT_Val        _U(0x1)                                        /**< (UDP_CSR) Isochronous OUT  */
#define   UDP_CSR_EPTYPE_BULK_OUT_Val       _U(0x2)                                        /**< (UDP_CSR) Bulk OUT  */
#define   UDP_CSR_EPTYPE_INT_OUT_Val        _U(0x3)                                        /**< (UDP_CSR) Interrupt OUT  */
#define   UDP_CSR_EPTYPE_ISO_IN_Val         _U(0x5)                                        /**< (UDP_CSR) Isochronous IN  */
#define   UDP_CSR_EPTYPE_BULK_IN_Val        _U(0x6)                                        /**< (UDP_CSR) Bulk IN  */
#define   UDP_CSR_EPTYPE_INT_IN_Val         _U(0x7)                                        /**< (UDP_CSR) Interrupt IN  */
...
#define UDP_CSR_DTGLE_Msk                   (_U(0x1) << UDP_CSR_DTGLE_Pos)                 /**< (UDP_CSR) Data Toggle (Read-only) Mask */
...
#define UDP_CSR_EPEDS_Msk                   (_U(0x1) << UDP_CSR_EPEDS_Pos)                 /**< (UDP_CSR) Endpoint Enable Disable Mask */
...
#define UDP_CSR_RXBYTECNT_Msk               (_U(0x7FF) << UDP_CSR_RXBYTECNT_Pos)           /**< (UDP_CSR) Number of Bytes Available in the FIFO (Read-only) Mask */
#define UDP_CSR_RXBYTECNT(value)            (UDP_CSR_RXBYTECNT_Msk & ((value) << UDP_CSR_RXBYTECNT_Pos))
#define UDP_CSR_MASK                        _U(0x7FF8FFF)                                  /**< \deprecated (UDP_CSR) Register MASK  (Use UDP_CSR_Msk instead)  */
#define UDP_CSR_Msk                         _U(0x7FF8FFF)                                  /**< (UDP_CSR) Register Mask  */
...
#define UDP_FDR_FIFO_DATA_Msk               (_U(0xFF) << UDP_FDR_FIFO_DATA_Pos)            /**< (UDP_FDR) FIFO Data Value Mask */
#define UDP_FDR_FIFO_DATA(value)            (UDP_FDR_FIFO_DATA_Msk & ((value) << UDP_FDR_FIFO_DATA_Pos))
#define UDP_FDR_MASK                        _U(0xFF)                                       /**< \deprecated (UDP_FDR) Register MASK  (Use UDP_FDR_Msk instead)  */
#define UDP_FDR_Msk                         _U(0xFF)                                       /**< (UDP_FDR) Register Mask  */
...
#define UDP_TXVC_TXVDIS_Msk                 (_U(0x1) << UDP_TXVC_TXVDIS_Pos)               /**< (UDP_TXVC) Transceiver Disable Mask */
...
#define UDP_TXVC_PUON_Msk                   (_U(0x1) << UDP_TXVC_PUON_Pos)                 /**< (UDP_TXVC) Pull-up On Mask */
...
#define UDP_TXVC_MASK                       _U(0x300)                                      /**< \deprecated (UDP_TXVC) Register MASK  (Use UDP_TXVC_Msk instead)  */
#define UDP_TXVC_Msk                        _U(0x300)                                      /**< (UDP_TXVC) Register Mask  */
