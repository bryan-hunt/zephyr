...
#define WDT_CR_WDRSTT_Msk                   (_U(0x1) << WDT_CR_WDRSTT_Pos)                 /**< (WDT_CR) Watchdog Restart Mask */
...
#define WDT_CR_KEY_Msk                      (_U(0xFF) << WDT_CR_KEY_Pos)                   /**< (WDT_CR) Password. Mask */
#define WDT_CR_KEY(value)                   (WDT_CR_KEY_Msk & ((value) << WDT_CR_KEY_Pos))
#define   WDT_CR_KEY_PASSWD_Val             _U(0xA5)                                       /**< (WDT_CR) Writing any other value in this field aborts the write operation.  */
...
#define WDT_CR_MASK                         _U(0xFF000001)                                 /**< \deprecated (WDT_CR) Register MASK  (Use WDT_CR_Msk instead)  */
#define WDT_CR_Msk                          _U(0xFF000001)                                 /**< (WDT_CR) Register Mask  */
...
#define WDT_MR_WDV_Msk                      (_U(0xFFF) << WDT_MR_WDV_Pos)                  /**< (WDT_MR) Watchdog Counter Value Mask */
...
#define WDT_MR_WDFIEN_Msk                   (_U(0x1) << WDT_MR_WDFIEN_Pos)                 /**< (WDT_MR) Watchdog Fault Interrupt Enable Mask */
...
#define WDT_MR_WDRSTEN_Msk                  (_U(0x1) << WDT_MR_WDRSTEN_Pos)                /**< (WDT_MR) Watchdog Reset Enable Mask */
...
#define WDT_MR_WDRPROC_Msk                  (_U(0x1) << WDT_MR_WDRPROC_Pos)                /**< (WDT_MR) Watchdog Reset Processor Mask */
...
#define WDT_MR_WDDIS_Msk                    (_U(0x1) << WDT_MR_WDDIS_Pos)                  /**< (WDT_MR) Watchdog Disable Mask */
...
#define WDT_MR_WDD_Msk                      (_U(0xFFF) << WDT_MR_WDD_Pos)                  /**< (WDT_MR) Watchdog Delta Value Mask */
...
#define WDT_MR_WDDBGHLT_Msk                 (_U(0x1) << WDT_MR_WDDBGHLT_Pos)               /**< (WDT_MR) Watchdog Debug Halt Mask */
...
#define WDT_MR_WDIDLEHLT_Msk                (_U(0x1) << WDT_MR_WDIDLEHLT_Pos)              /**< (WDT_MR) Watchdog Idle Halt Mask */
...
#define WDT_MR_MASK                         _U(0x3FFFFFFF)                                 /**< \deprecated (WDT_MR) Register MASK  (Use WDT_MR_Msk instead)  */
#define WDT_MR_Msk                          _U(0x3FFFFFFF)                                 /**< (WDT_MR) Register Mask  */
...
#define WDT_SR_WDUNF_Msk                    (_U(0x1) << WDT_SR_WDUNF_Pos)                  /**< (WDT_SR) Watchdog Underflow Mask */
...
#define WDT_SR_WDERR_Msk                    (_U(0x1) << WDT_SR_WDERR_Pos)                  /**< (WDT_SR) Watchdog Error Mask */
...
#define WDT_SR_MASK                         _U(0x03)                                       /**< \deprecated (WDT_SR) Register MASK  (Use WDT_SR_Msk instead)  */
#define WDT_SR_Msk                          _U(0x03)                                       /**< (WDT_SR) Register Mask  */
