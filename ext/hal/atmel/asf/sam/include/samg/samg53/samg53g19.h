...
#define CHIP_CIDR                _UL(0X247E0AE0)
...
#define CHIP_FREQ_CPU_MAX              _UL(48000000)   
#define CHIP_FREQ_XTAL_32K             _UL(32768)      
#define CHIP_FLASH_WRITE_WAIT_STATE    _UL(6)          /**< \brief Embedded Flash Write Wait State*/
#define CHIP_FREQ_FWS_0                _UL(12000000)   /**< \brief Maximum operating frequency when FWS is 0*/
#define CHIP_FREQ_FWS_1                _UL(25000000)   /**< \brief Maximum operating frequency when FWS is 1*/
#define CHIP_FREQ_FWS_2                _UL(38000000)   /**< \brief Maximum operating frequency when FWS is 2*/
#define CHIP_FREQ_FWS_3                _UL(48000000)   /**< \brief Maximum operating frequency when FWS is 3*/
