...
#define TWI_CR_MASK                         _U(0xFF)                                       /**< \deprecated (TWI_CR) Register MASK  (Use TWI_CR_Msk instead)  */
#define TWI_CR_Msk                          _U(0xFF)                                       /**< (TWI_CR) Register Mask  */
...
#define TWI_SMR_MASK                        _U(0x7F0000)                                   /**< \deprecated (TWI_SMR) Register MASK  (Use TWI_SMR_Msk instead)  */
#define TWI_SMR_Msk                         _U(0x7F0000)                                   /**< (TWI_SMR) Register Mask  */
...
#define TWI_CWGR_MASK                       _U(0x1F07FFFF)                                 /**< \deprecated (TWI_CWGR) Register MASK  (Use TWI_CWGR_Msk instead)  */
#define TWI_CWGR_Msk                        _U(0x1F07FFFF)                                 /**< (TWI_CWGR) Register Mask  */
...
#define TWI_SR_RXRDY_Msk                    (_U(0x1) << TWI_SR_RXRDY_Pos)                  /**< (TWI_SR) Receive Holding Register Ready (cleared by reading TWI_RHR) Mask */
...
#define TWI_SR_MASK                         _U(0xFF7F)                                     /**< \deprecated (TWI_SR) Register MASK  (Use TWI_SR_Msk instead)  */
#define TWI_SR_Msk                          _U(0xFF7F)                                     /**< (TWI_SR) Register Mask  */
...
#define TWI_IER_MASK                        _U(0xFF77)                                     /**< \deprecated (TWI_IER) Register MASK  (Use TWI_IER_Msk instead)  */
#define TWI_IER_Msk                         _U(0xFF77)                                     /**< (TWI_IER) Register Mask  */
...
#define TWI_IDR_MASK                        _U(0xFF77)                                     /**< \deprecated (TWI_IDR) Register MASK  (Use TWI_IDR_Msk instead)  */
#define TWI_IDR_Msk                         _U(0xFF77)                                     /**< (TWI_IDR) Register Mask  */
...
#define TWI_IMR_MASK                        _U(0xFF77)                                     /**< \deprecated (TWI_IMR) Register MASK  (Use TWI_IMR_Msk instead)  */
#define TWI_IMR_Msk                         _U(0xFF77)                                     /**< (TWI_IMR) Register Mask  */
...
#define TWI_WPSR_WPVS_Msk                   (_U(0x1) << TWI_WPSR_WPVS_Pos)                 /**< (TWI_WPSR) Write Protection Violation Status Mask */
