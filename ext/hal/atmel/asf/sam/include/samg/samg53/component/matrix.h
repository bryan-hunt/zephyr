...
#define   MATRIX_MCFG_ULBT_INFINITE_Val     _U(0x0)                                        /**< (MATRIX_MCFG) No predicted end of burst is generated and therefore INCR bursts coming from this master cannot be broken.  */
...
#define   MATRIX_MCFG_ULBT_FOUR_BEAT_Val    _U(0x2)                                        /**< (MATRIX_MCFG) The undefined length burst is split into a 4-beat bursts allowing rearbitration at each 4-beat burst end.  */
#define   MATRIX_MCFG_ULBT_EIGHT_BEAT_Val   _U(0x3)                                        /**< (MATRIX_MCFG) The undefined length burst is split into 8-beat bursts allowing rearbitration at each 8-beat burst end.  */
#define   MATRIX_MCFG_ULBT_SIXTEEN_BEAT_Val _U(0x4)                                        /**< (MATRIX_MCFG) The undefined length burst is split into 16-beat bursts allowing rearbitration at each 16-beat burst end.  */
...
#define CCFG_SYSIO_SYSIO_Msk                (_U(0x1F) << CCFG_SYSIO_SYSIO_Pos)             /**< (CCFG_SYSIO Mask) SYSIO */
#define CCFG_SYSIO_SYSIO(value)             (CCFG_SYSIO_SYSIO_Msk & ((value) << CCFG_SYSIO_SYSIO_Pos))  
#define CCFG_SYSIO_MASK                     _U(0x10F0)                                     /**< \deprecated (CCFG_SYSIO) Register MASK  (Use CCFG_SYSIO_Msk instead)  */
#define CCFG_SYSIO_Msk                      _U(0x10F0)                                     /**< (CCFG_SYSIO) Register Mask  */
