...
/* Serial Peripheral Interfac (SPI) */

#define PIN_SPI0_MISO  {PIO_PA12A_MISO, PIOA, ID_PIOA, SOC_GPIO_FUNC_A}
#define PIN_SPI0_MOSI  {PIO_PA13A_MOSI, PIOA, ID_PIOA, SOC_GPIO_FUNC_A}
#define PIN_SPI0_SCLK  {PIO_PA14A_SPCK, PIOA, ID_PIOA, SOC_GPIO_FUNC_A}

#define PINS_SPI0 {PIN_SPI0_MISO, PIN_SPI0_MOSI, PIN_SPI0_SCLK}
